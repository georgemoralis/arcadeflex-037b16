...
import static gr.codebb.arcadeflex.v037b16.mame.cpuintrf.cpu_gettotalcpu;
import static gr.codebb.arcadeflex.v037b16.mame.cpuintrf.cpunum_address_mask;
...
/*TODO*///                        cpunum_write_byte(subcheat.cpu, subcheat.address, subcheat.data);
...
/*TODO*///                                   cpunum_write_byte(subcheat.cpu, subcheat.address, subcheat.data);
 ...
 /* When the timer ends, change the location */
                            ...
                            case 6:
                            case 7:
     /*TODO*///                              if ((subcheat.flags & SUBCHEAT_FLAG_TIMED) != 0) {
    /*TODO*///                                   cpunum_write_byte(subcheat.cpu, subcheat.address, subcheat.data);
     /*TODO*///                                  subcheat.flags &= ~SUBCHEAT_FLAG_TIMED;
     /*TODO*///                              } else if (cpunum_read_byte(subcheat.cpu, subcheat.address) != subcheat.data) {
     /*TODO*///                                  subcheat.frame_count = subcheat.frames_til_trigger;
     /*TODO*///                                  subcheat.flags |= SUBCHEAT_FLAG_TIMED;
    /*TODO*///                               }
                                break;
						  ...
						  This is to try to not change the value of an energy bar
				 		  ...
				 		  See Kung Fu Master */
                            ...
                            case 11:
     /*TODO*///                              if ((subcheat.flags & SUBCHEAT_FLAG_TIMED) != 0) {
     /*TODO*///                                  /* Check the value to see if it has increased over the original value by 1 or more */
     /*TODO*///                                  if (cpunum_read_byte(subcheat.cpu, subcheat.address) != subcheat.backup - (kCheatSpecial_Backup1 - subcheat.code + 1)) {
     /*TODO*///                                      cpunum_write_byte(subcheat.cpu, subcheat.address, subcheat.data);
    /*TODO*///                                   }
    /*TODO*///                                   subcheat.flags &= ~SUBCHEAT_FLAG_TIMED;
    /*TODO*///                               } else {
     /*TODO*///                                  subcheat.backup = cpunum_read_byte(subcheat.cpu, subcheat.address);
     /*TODO*///                                  subcheat.frame_count = 1;
     /*TODO*///   /*TODO*///                                  subcheat.flags |= SUBCHEAT_FLAG_TIMED;
      /*TODO*///                             }
                                break;

                            /* 20-24: set bits */
                            case 20:
      /*TODO*///                             cpunum_write_byte(subcheat.cpu, subcheat.address, cpunum_read_byte(subcheat.cpu, subcheat.address) | subcheat.data);
                                break;
                            case 21:
      /*TODO*///                             cpunum_write_byte(subcheat.cpu, subcheat.address, cpunum_read_byte(subcheat.cpu, subcheat.address) | subcheat.data);
                                subcheat.flags |= SUBCHEAT_FLAG_DONE;
    ...
    /*TODO*///                               cpunum_write_byte(subcheat.cpu, subcheat.address, cpunum_read_byte(subcheat.cpu, subcheat.address) | subcheat.data);
       ...
       /*TODO*///                            cpunum_write_byte(subcheat.cpu, subcheat.address, cpunum_read_byte(subcheat.cpu, subcheat.address) & ~subcheat.data);
         ...
         /*TODO*///                          cpunum_write_byte(subcheat.cpu, subcheat.address, cpunum_read_byte(subcheat.cpu, subcheat.address) & ~subcheat.data);
                            ...
                            case 65:
         /*TODO*///                          if ((subcheat.flags & SUBCHEAT_FLAG_TIMED) != 0) {
        /*TODO*///                               if (cpunum_read_byte(subcheat.cpu, subcheat.address) != subcheat.backup) {
        /*TODO*///                                   cpunum_write_byte(subcheat.cpu, subcheat.address, subcheat.data);
        /*TODO*///                                   subcheat.flags |= SUBCHEAT_FLAG_DONE;
        /*TODO*///                               }
         /*TODO*///                          } else {
         /*TODO*///                              subcheat.backup = cpunum_read_byte(subcheat.cpu, subcheat.address);
          /*TODO*///                             subcheat.frame_count = 1;
