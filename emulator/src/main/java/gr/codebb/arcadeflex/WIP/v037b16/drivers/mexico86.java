...
import static gr.codebb.arcadeflex.WIP.v037b16.machine.mexico86.*;
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.generic.*;
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.mexico86.*;
...
public class mexico86
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_kikikai = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "a85-15.rom", 0x00000, 0x10000, 0xaebc8c32 );	ROM_LOAD( "a85-14.rom", 0x10000, 0x10000, 0xa9df0453 );	ROM_LOAD( "a85-13.rom", 0x20000, 0x10000, 0x3eeaf878 );	ROM_LOAD( "a85-12.rom", 0x30000, 0x10000, 0x91e58067 );
