...
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.gbusters.*;
...
/*TODO*///		{
/*TODO*///			char baf[40];
/*TODO*///			sprintf(baf,"snd_bankswitch = %02x", data);
...
/*TODO*///	#endif
	...
	public static Memory_ReadAddress gbusters_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x1f90, 0x1f90, input_port_3_r ),		/* coinsw & startsw */
	...
	public static Memory_WriteAddress gbusters_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x1f80, 0x1f80, gbusters_coin_counter_w ),	/* coin counters */
	...
	public static Memory_ReadAddress gbusters_readmem_sound[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x7fff, MRA_ROM ),				/* ROM 878h01.rom */
	...
	public static Memory_WriteAddress gbusters_writemem_sound[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x7fff, MWA_ROM ),					/* ROM 878h01.rom */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_gbusters = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "878a09.rom",   0x0000, 0x0100, 0xe2d09a1b );/* priority encoder (not used) */
