...
public class cclimber
{
	...
	***************************************************************************/
	...
	public static VhConvertColorPromPtr swimmer_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(char []palette, char []colortable, UBytePtr color_prom) 
	{
		...
		for (i = 0;i < 256;i++)
		{
			...
			palette[_palette++] = (char) (0x20 * bit0 + 0x40 * bit1 + 0x80 * bit2);
			/* green component */
		...
		palette[_palette++] = 0x24;
		palette[_palette++] = 0x5d;
		palette[_palette++] = 0x4e;
	} };
	...
	***************************************************************************/
	...
	{
/*TODO*///		set_vh_global_attribute(palettebank, data & 1);
	} };
	...
	{
/*TODO*///		set_vh_global_attribute(sidepanel_enabled, data );
	} };
