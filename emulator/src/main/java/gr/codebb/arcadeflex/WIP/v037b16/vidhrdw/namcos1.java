...
public class namcos1
{
	...
	public static int BACKGROUNDCOLOR(){ return(SPRITECOLORS+2*TILECOLORS); }
	...
	*/
	...
	public static class _playfield {
		public int 	color;
	};
        
        _playfield playfield = new _playfield();
	
	static _playfield[] playfields = new _playfield[MAX_PLAYFIELDS];
	...
	static char[] sprite_palette_state = new char[MAX_SPRITES+1];
	static char[] tilemap_palette_state = new char[MAX_PLAYFIELDS];
	...
	public static WriteHandlerPtr namcos1_playfield_control_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		else if ( offset < 30 )
		{
			int whichone = offset - 24;
                        ...
                        if (playfields[whichone] == null)
                            playfields[whichone] = new _playfield();
...
/*TODO*///	#endif
	...
	static void mark_sprites_colors()
	{
		...
		short[] palette_map = new short[128];
