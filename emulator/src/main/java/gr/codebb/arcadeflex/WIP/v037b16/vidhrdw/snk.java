...
public class snk {
 ...
 /* to be moved to memmap */
    ...
    public static VhStartPtr sgladiat_vh_start = new VhStartPtr() {
        public int handler() {
            dirtybuffer = new char[MAX_VRAM_SIZE];
            if (dirtybuffer != null) {
    ...
    static void sgladiat_draw_background(osd_bitmap bitmap, int scrollx, int scrolly) {
        rectangle clip = Machine.visible_area;
        GfxElement gfx = Machine.gfx[1];
        int offs;
    ...
    public static VhUpdatePtr sgladiat_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
