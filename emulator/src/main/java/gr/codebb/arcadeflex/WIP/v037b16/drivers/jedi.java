...
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.jedi.*;
...
public class jedi
{
	...
	/* constants */
	public static final int MAIN_CPU_OSC		= 10000000;
	public static final int SOUND_CPU_OSC		= 12096000;
	...
	PORT_START(); 	/* 0C00 */
		...
		PORT_START(); 	/* 0C01 */
		PORT_BIT( 0x03, IP_ACTIVE_LOW,  IPT_UNUSED );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_TILT );	PORT_BIT( 0x18, IP_ACTIVE_LOW,  IPT_UNUSED );	PORT_BIT( 0x60, IP_ACTIVE_HIGH, IPT_SPECIAL );/* sound comm */
	...
	static RomLoadPtr rom_jedi = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x02000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "11t_215.bin",  0x00000, 0x2000, 0x3e49491f );/* Alphanumeric */
	
		ROM_REGION( 0x10000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "06r_126.bin",  0x00000, 0x8000, 0x9c55ece8 );/* Playfield */
		ROM_LOAD( "06n_127.bin",  0x08000, 0x8000, 0x4b09dcc5 );
		ROM_REGION( 0x20000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "01h_130.bin",  0x00000, 0x8000, 0x2646a793 );/* Sprites */
