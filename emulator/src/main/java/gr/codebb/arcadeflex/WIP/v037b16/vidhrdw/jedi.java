...
import static mame037b16.drawgfx.copyscrollbitmap;
...
public class jedi
{
	...
	static UBytePtr fgdirty=new UBytePtr(), bgdirty=new UBytePtr();
	static osd_bitmap fgbitmap, mobitmap, bgbitmap, bgexbitmap;
	...
	static void update_smoothing(int bgtilerow, int first, int last)
	{
		...
		UBytePtr[] bgscan=new UBytePtr[2]; // [256]
                
                if (bgscan[0] == null)
                    bgscan[0]=new UBytePtr(256);
                
                if (bgscan[1] == null)
                    bgscan[1]=new UBytePtr(256);
                
		UBytePtr bgcurr = new UBytePtr(bgscan[0]);
                UBytePtr bglast = new UBytePtr (bgscan[1]);
