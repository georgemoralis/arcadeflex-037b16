...
/*TOOD*///    );
 ...
 /* A4 VLM5030 ST pin */
    ...
    /*TOOD*///    public static ReadHandlerPtr hyprolyb_speech_r = new ReadHandlerPtr() {
/*TOOD*///        public int handler(int offset) {
/*TOOD*///            return ADPCM_playing(0) != 0 ? 0x10 : 0x00;
/*TOOD*///        }
/*TOOD*///    };
/*TOOD*///    public static WriteHandlerPtr hyprolyb_ADPCM_data_w = new WriteHandlerPtr() {
/*TOOD*///        public void handler(int offset, int data) {
/*TOOD*///            int cmd, start, end;
/*TOOD*///            UBytePtr RAM = memory_region(REGION_CPU3);

    /* simulate the operation of the 6802 */
 /*TOOD*///            cmd = RAM.read(0xfe01 + data) + 256 * RAM.read(0xfe00 + data);
/*TOOD*///            start = RAM.read(cmd + 1) + 256 * RAM.read(cmd);
/*TOOD*///            end = RAM.read(cmd + 3) + 256 * RAM.read(cmd + 2);
/*TOOD*///            if (end > start) {
/*TOOD*///                ADPCM_play(0, start, (end - start) * 2);
/*TOOD*///            }
/*TOOD*///        }
/*TOOD*///    };
}
