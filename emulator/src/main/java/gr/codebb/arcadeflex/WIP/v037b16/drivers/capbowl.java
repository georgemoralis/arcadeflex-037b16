...
static UBytePtr nvram = new UBytePtr();
	...
	public static Memory_ReadAddress bowlrama_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x001f, bowlrama_turbo_r ),
		new Memory_ReadAddress( 0x5000, 0x57ff, MRA_RAM ),
		new Memory_ReadAddress( 0x5800, 0x5fff, capbowl_tms34061_r ),
		new Memory_ReadAddress( 0x7000, 0x7000, track_0_r ),	/* + other inputs */
		new Memory_ReadAddress( 0x7800, 0x7800, track_1_r ),	/* + other inputs */
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x001f, bowlrama_turbo_w ),	/* Bowl-O-Rama only */
