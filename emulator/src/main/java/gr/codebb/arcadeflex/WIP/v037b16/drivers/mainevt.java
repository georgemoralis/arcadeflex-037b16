...
import static gr.codebb.arcadeflex.v037b16.sound.upd7759.*;
import static gr.codebb.arcadeflex.v037b16.sound.upd7759H.*;
...
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.mainevt.*;
...
/*TODO*///		set_led_status(3,data & 0x08);
	...
	//logerror("CPU #1 PC: %04x bank switch = %02x\n",cpu_get_pc(),data);
		...
		memcpy(new UBytePtr(dest),new UBytePtr(src, ((data >> 4) & 0x03) * 0x20000),0x20000);
	} };
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x1f94, 0x1f94, input_port_0_r ), /* Coins */
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x1f80, 0x1f80, mainevt_bankswitch_w ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_mainevt = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD( "799c02.k11",   0x10000, 0x08000, 0xe2e7dbd5 );	ROM_CONTINUE(             0x08000, 0x08000 );
		...
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "63s141n.bin",  0x0000, 0x0100, 0x61f6c8d1 );/* priority encoder (not used) */
	...
	static RomLoadPtr rom_mainevt2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD( "02",           0x10000, 0x08000, 0xc143596b );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "799c01.f7",    0x00000, 0x08000, 0x447c4c5c );
		ROM_REGION( 0x20000, REGION_GFX1, 0 );/* graphics (addressable by the main CPU) */
		ROM_LOAD16_BYTE( "799c06.f22",   0x00000, 0x08000, 0xf839cb58 );
	...
	static RomLoadPtr rom_ringohja = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD( "799n02.k11",   0x10000, 0x08000, 0xf9305dd0 );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "799c01.f7",    0x00000, 0x08000, 0x447c4c5c );
		ROM_REGION( 0x20000, REGION_GFX1, 0 );/* graphics (addressable by the main CPU) */
		ROM_LOAD16_BYTE( "799c06.f22",   0x00000, 0x08000, 0xf839cb58 );
	...
	static RomLoadPtr rom_devstors = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD( "890-z02.k11",  0x10000, 0x08000, 0xebeb306f );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		...
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "devaprom.bin", 0x0000, 0x0100, 0xd3620106 );/* priority encoder (not used) */
	
		ROM_REGION( 0x80000, REGION_SOUND1, 0 );/* 512k for 007232 samples */
	 	ROM_LOAD( "dev-f03.rom",  0x00000, 0x80000, 0x19065031 );ROM_END(); }}; 
	
	static RomLoadPtr rom_devstor2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD( "dev-x02.rom",  0x10000, 0x08000, 0xe58ebb35 );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "dev-k01.rom",  0x00000, 0x08000, 0xd44b3eb0 );
		ROM_REGION( 0x40000, REGION_GFX1, 0 );/* graphics (addressable by the main CPU) */
		ROM_LOAD16_BYTE( "dev-f06.rom",  0x00000, 0x10000, 0x26592155 );
	...
	static RomLoadPtr rom_devstor3 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD( "890k02.k11",   0x10000, 0x08000, 0x52f4ccdd );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "dev-k01.rom",  0x00000, 0x08000, 0xd44b3eb0 );
		ROM_REGION( 0x40000, REGION_GFX1, 0 );/* graphics (addressable by the main CPU) */
		ROM_LOAD16_BYTE( "dev-f06.rom",  0x00000, 0x10000, 0x26592155 );
	...
	static RomLoadPtr rom_garuka = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD( "890w02.bin",   0x10000, 0x08000, 0xb2f6f538 );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "dev-k01.rom",  0x00000, 0x08000, 0xd44b3eb0 );
		ROM_REGION( 0x40000, REGION_GFX1, 0 );/* graphics (addressable by the main CPU) */
		ROM_LOAD16_BYTE( "dev-f06.rom",  0x00000, 0x10000, 0x26592155 );
