...
/*TODO*///	static void lfkp(int mask)
/*TODO*///	{
/*TODO*///		int A;
/*TODO*///		UBytePtr RAM = memory_region(REGION_CPU1);
/*TODO*///	
/*TODO*///	
/*TODO*///		for (A = 0x0000;A < 0x8000-14;A++)
/*TODO*///		{
/*TODO*///			static char text[] = "INSERT COIN";
/*TODO*///			int i;
/*TODO*///	
/*TODO*///	
/*TODO*///			if (	(RAM[A+0] & mask) == (0x21 & mask) &&	/* LD HL,$xxxx */
/*TODO*///					(RAM[A+3] & mask) == (0x11 & mask) &&	/* LD DE,$xxxx */
/*TODO*///					(RAM[A+6] & mask) == (0x01 & mask))		/* LD BC,$xxxx */
/*TODO*///			{
/*TODO*///				if (	(RAM[A+ 9] & mask) == (0x36 & mask) &&	/* LD (HL),$xx */
/*TODO*///						(RAM[A+11] & mask) == (0xed & mask) &&
/*TODO*///						(RAM[A+12] & mask) == (0xb0 & mask))	/* LDIR */
/*TODO*///					logerror("%04x: hl de bc (hl),xx ldir\n",A);
/*TODO*///	
/*TODO*///				if (	(RAM[A+ 9] & mask) == (0x77 & mask) &&	/* LD (HL),A */
/*TODO*///						(RAM[A+10] & mask) == (0xed & mask) &&
/*TODO*///						(RAM[A+11] & mask) == (0xb0 & mask))	/* LDIR */
/*TODO*///					logerror("%04x: hl de bc (hl),a ldir\n",A);
/*TODO*///	
/*TODO*///				if (	(RAM[A+ 9] & mask) == (0xed & mask) &&
/*TODO*///						(RAM[A+10] & mask) == (0xb0 & mask))	/* LDIR */
/*TODO*///					logerror("%04x: hl de bc ldir\n",A);
/*TODO*///			}
/*TODO*///	
/*TODO*///			/* the following can also be PUSH IX, PUSH IY - need better checking */
/*TODO*///			if (	(RAM[A+0] & mask) == (0xf5 & mask) &&	/* PUSH AF */
/*TODO*///					(RAM[A+1] & mask) == (0xc5 & mask) &&	/* PUSH BC */
/*TODO*///					(RAM[A+2] & mask) == (0xd5 & mask) &&	/* PUSH DE */
/*TODO*///					(RAM[A+3] & mask) == (0xe5 & mask))		/* PUSH HL */
/*TODO*///				logerror("%04x: push af bc de hl\n",A);
/*TODO*///	
/*TODO*///			if (	(RAM[A+0] & mask) == (0xe1 & mask) &&	/* POP HL */
/*TODO*///					(RAM[A+1] & mask) == (0xd1 & mask) &&	/* POP DE */
/*TODO*///					(RAM[A+2] & mask) == (0xc1 & mask) &&	/* POP BC */
/*TODO*///					(RAM[A+3] & mask) == (0xf1 & mask))		/* POP AF */
/*TODO*///				logerror("%04x: pop hl de bc af\n",A);
/*TODO*///	
/*TODO*///			for (i = 0;i < strlen(text);i++)
/*TODO*///				if ((RAM[A+i] & mask) != (text[i] & mask)) break;
/*TODO*///			if (i == strlen(text))
/*TODO*///				logerror("%04x: INSERT COIN\n",A);
/*TODO*///		}
/*TODO*///	}
/*TODO*///	
/*TODO*///	static void look_for_known_plaintext(void)
/*TODO*///	{
/*TODO*///		lfkp(0x57);
/*TODO*///	}
/*TODO*///	
/*TODO*///	static void read_table_from_disk(UBytePtr xortable)
/*TODO*///	{
/*TODO*///		FILE *f;
/*TODO*///	
/*TODO*///	
/*TODO*///		f = fopen("table","rb");
/*TODO*///	
/*TODO*///		if (f != 0) fread(xortable,1,128,f);
/*TODO*///	
/*TODO*///		fclose(f);
/*TODO*///	}
/*TODO*///	#endif
	
	static void sega_decode(char[][] xortable)
	{
		int A;
...
/*TODO*///	void pengo_decode(void)
/*TODO*///	{
/*TODO*///		static const unsigned char xortable[32][4] =
/*TODO*///		{
/*TODO*///			/*       opcode                   data                     address      */
/*TODO*///			/*  A    B    C    D         A    B    C    D                           */
/*TODO*///			{ 0xa0,0x88,0x88,0xa0 }, { 0x28,0xa0,0x28,0xa0 },	/* ...0...0...0...0 */
/*TODO*///			{ 0x28,0xa0,0x28,0xa0 }, { 0xa0,0x88,0x88,0xa0 },	/* ...0...0...0...1 */
/*TODO*///			{ 0xa0,0x88,0x00,0x28 }, { 0xa0,0x88,0x00,0x28 },	/* ...0...0...1...0 */
/*TODO*///			{ 0x08,0x20,0xa8,0x80 }, { 0xa0,0x88,0x88,0xa0 },	/* ...0...0...1...1 */
/*TODO*///			{ 0x08,0x08,0xa8,0xa8 }, { 0x28,0xa0,0x28,0xa0 },	/* ...0...1...0...0 */
/*TODO*///			{ 0xa0,0x88,0x00,0x28 }, { 0x08,0x08,0xa8,0xa8 },	/* ...0...1...0...1 */
/*TODO*///			{ 0xa0,0x88,0x00,0x28 }, { 0xa0,0x88,0x00,0x28 },	/* ...0...1...1...0 */
/*TODO*///			{ 0xa0,0x88,0x00,0x28 }, { 0x00,0x00,0x00,0x00 },	/* ...0...1...1...1 */
/*TODO*///			{ 0x88,0x88,0x28,0x28 }, { 0xa0,0x88,0x00,0x28 },	/* ...1...0...0...0 */
/*TODO*///			{ 0x88,0x88,0x28,0x28 }, { 0x00,0x00,0x00,0x00 },	/* ...1...0...0...1 */
/*TODO*///			{ 0x08,0x20,0xa8,0x80 }, { 0x08,0x20,0xa8,0x80 },	/* ...1...0...1...0 */
/*TODO*///			{ 0xa0,0x88,0x88,0xa0 }, { 0xa0,0x88,0x00,0x28 },	/* ...1...0...1...1 */
/*TODO*///			{ 0x08,0x08,0xa8,0xa8 }, { 0x88,0x88,0x28,0x28 },	/* ...1...1...0...0 */
/*TODO*///			{ 0x00,0x00,0x00,0x00 }, { 0x88,0x88,0x28,0x28 },	/* ...1...1...0...1 */
/*TODO*///			{ 0x08,0x20,0xa8,0x80 }, { 0x08,0x20,0xa8,0x80 },	/* ...1...1...1...0 */
/*TODO*///			{ 0x08,0x08,0xa8,0xa8 }, { 0xa0,0x88,0x00,0x28 }	/* ...1...1...1...1 */
/*TODO*///		};
/*TODO*///	
/*TODO*///	
...
/*TODO*///	}
	...
	******************************************************************************/
	...
	public static void wboy_decode()
	{
