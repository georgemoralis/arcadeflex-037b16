...
public class atetris
{
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x20ff, MRA_RAM ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_atetris = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1101.35a",     0x0000, 0x10000, 0x84a1939f );ROM_END(); }}; 
	...
	static RomLoadPtr rom_atetrisb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "tetris.02",    0x0000, 0x10000, 0x5c4e7258 );
		...
		ROM_REGION( 0x0800, REGION_USER1, 0 );	ROM_LOAD( "tetris.03",    0x0000, 0x0800, 0x26618c0b );ROM_END(); }}; 
	
	static RomLoadPtr rom_atetcktl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x14000, REGION_CPU1, 0 );    /* 80k for code */
		ROM_LOAD( "tetcktl1.rom", 0x0000, 0x10000, 0x9afd1f4a );
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1103.35a",     0x0000, 0x10000, 0xec2a7f93 );ROM_END(); }}; 
	...
	public static InitDriverPtr init_atetris = new InitDriverPtr() { public void handler() 
	{
	    ...
	    memcpy(new UBytePtr(RAM, 0x10000), new UBytePtr(RAM, 0x00000), 0x4000);
	    memset(new UBytePtr(RAM, 0x00000), 0, 0x4000);
	} };
