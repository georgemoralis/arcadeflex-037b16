...
public class s2636
{
	...
	static int s2636_x_offset=0;
	static int s2636_y_offset=0;
	...
	public static int SpriteCheck(int first,int second,UBytePtr workram,int Graphics_Bank, osd_bitmap collision_bitmap)
	{
		int Checksum=0;
		int x,y;
	...
	public static void Update_Bitmap(osd_bitmap bitmap,UBytePtr workram,UBytePtr dirty,int Graphics_Bank, osd_bitmap collision_bitmap)
	{
