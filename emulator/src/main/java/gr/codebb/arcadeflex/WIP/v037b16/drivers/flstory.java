...
import static gr.codebb.arcadeflex.WIP.v037b16.machine.flstory.*;
...
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.flstory.*;
...
public class flstory
{
	...
	PORT_START();       /* D800: DSW0 */
		...
		PORT_DIPSETTING(   0x00, "ENDLESS?" );	
                PORT_DIPSETTING(   0x08, "3" );	PORT_DIPSETTING(   0x10, "4" );	PORT_DIPSETTING(   0x18, "5" );	
