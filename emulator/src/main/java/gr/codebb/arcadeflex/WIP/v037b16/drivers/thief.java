...
//vidhrdw imports
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.thief.*;

public class thief {

    static int/*UINT8*/ thief_input_select;
	...
	**	tracks.
    ...
    public static Memory_WriteAddress thief_writemem[] = {
        new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8), new Memory_WriteAddress(0x0000, 0x0000, thief_blit_w),
    ...
    public static IO_ReadPort readport[] = {
        new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8), new IO_ReadPort(0x31, 0x31, thief_io_r), // 8255
    ...
    static InputPortPtr input_ports_sharkatt = new InputPortPtr() {
        public void handler() {
            ...
            PORT_DIPSETTING(0x02, "5");//	PORT_DIPSETTING(	0x03, "5" );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Unknown") );
    ...
    static RomLoadPtr rom_natodefa = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1, 0);/* Z80 code */
            ROM_LOAD("natodef.cp0", 0x0000, 0x1000, 0x8397c787);
            ROM_LOAD("natodef.cp2", 0x1000, 0x1000, 0x8cfbf26f);
    ...
    public static GameDriver driver_natodefa = new GameDriver("1982", "natodefa", "thief.java", rom_natodefa, driver_natodef, machine_driver_natodef, input_ports_natodef, null, ROT0, "Pacific Novelty", "NATO Defense (alternate mazes)");
}
