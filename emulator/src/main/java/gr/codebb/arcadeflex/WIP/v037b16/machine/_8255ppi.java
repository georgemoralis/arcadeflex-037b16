...
//machine imports
import static gr.codebb.arcadeflex.WIP.v037b16.machine._8255ppiH.*;
//to be organized
...
public class _8255ppi {
        ...
        switch (offset) {
            case 0:
                ...
                if (chip.io[0] == 0) {
                    return chip.latch[0];
                    /* output */
                } else if ((chip.portAread) != null) {
                    return chip.portAread.handler(0);
                    /* input */
                }
                break;
            ...
            case 1:
                ...
                if (chip.io[1] == 0) {
                    return chip.latch[1];
                    /* output */
                } else if ((chip.portBread) != null) {
                    return (chip.portBread).handler(0);
                    /* input */
                }
                break;
            ...
            case 2:
                ...
                if (chip.io[2] == 0) {
                    return chip.latch[2];
                    /* output */
                } else /* return data - combination of input and latched output depending on
				   the input/output status of each half of port C */ if ((chip.portCread) != null) {
    ...
    public static void PPI8255_PORT_A_WRITE(ppi8255 chip, int which) {
        int write_data;
    ...
    public static void PPI8255_PORT_B_WRITE(ppi8255 chip, int which) {
        int write_data;
    ...
    public static void PPI8255_PORT_C_WRITE(ppi8255 chip, int which) {
        int write_data;
    ...
    public static void ppi8255_w(int which, int offset, int data) {
        ...
        switch (offset) {
            case 0:
                /* Port A write */
                chip.latch[0] = data;
                PPI8255_PORT_A_WRITE(chip, which);
                break;

            case 1:
                /* Port B write */
                chip.latch[1] = data;
                PPI8255_PORT_B_WRITE(chip, which);
                break;

            case 2:
                /* Port C write */
                chip.latch[2] = data;
                PPI8255_PORT_C_WRITE(chip, which);
                break;
