...
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.terracre.*;
...
/*TODO*///	WRITE16_HANDLER( terrac_videoram2_w );
/*TODO*///	READ16_HANDLER( terrac_videoram2_r );
	
/*TODO*///	extern data16_t *terrac_videoram2;
/*TODO*///	extern size_t terrac_videoram2_size;
/*TODO*///	extern data16_t *terrac_scrolly;
	
	
	//WRITE16_HANDLER( terracre_soundcmd_w )
        public static WriteHandlerPtr terracre_soundcmd_w = new WriteHandlerPtr() {
            @Override
            public void handler(int offset, int data) {
                soundlatch_w.handler(0,((data & 0x7f) << 1) | 1);
            }
        };
        ...
        static Memory_ReadAddress readmem[] =
	{
		...
		new Memory_ReadAddress( 0x000000, 0x01ffff, /*MRA16_ROM*/ MRA_ROM ),
		new Memory_ReadAddress( 0x020000, 0x0201ff, MRA_RAM/*MRA16_RAM*/ ),
		new Memory_ReadAddress( 0x020200, 0x021fff, MRA_RAM/*MRA16_RAM*/ ),
		new Memory_ReadAddress( 0x022000, 0x022fff, terrac_videoram2_r ),
		new Memory_ReadAddress( 0x023000, 0x023fff, MRA_RAM/*MRA16_RAM*/ ),
		new Memory_ReadAddress( 0x024000, 0x024001, input_port_0_word_r ),
		new Memory_ReadAddress( 0x024002, 0x024003, input_port_1_word_r ),
		new Memory_ReadAddress( 0x024004, 0x024005, input_port_2_word_r ),
		new Memory_ReadAddress( 0x024006, 0x024007, input_port_3_word_r ),
		new Memory_ReadAddress( 0x028000, 0x0287ff, MRA_RAM/*MRA16_RAM*/ ),
	...
	static Memory_WriteAddress writemem[] =
	{
                ...
                new Memory_WriteAddress( 0x000000, 0x01ffff, MWA_ROM /*MWA16_ROM*/ ),
		new Memory_WriteAddress( 0x020000, 0x0201ff, MWA_RAM /*MWA16_RAM*/, spriteram /*spriteram16*/, spriteram_size ),
		new Memory_WriteAddress( 0x020200, 0x021fff, MWA_RAM /*MWA16_RAM*/ ),
		new Memory_WriteAddress( 0x022000, 0x022fff, terrac_videoram2_w, terrac_videoram2, terrac_videoram2_size ),
		new Memory_WriteAddress( 0x023000, 0x023fff, MWA_RAM /*MWA16_RAM*/ ),
		new Memory_WriteAddress( 0x026002, 0x026003, MWA_RAM /*MWA16_RAM*/, terrac_scrolly ),
		new Memory_WriteAddress( 0x02600c, 0x02600d, terracre_soundcmd_w ),
		new Memory_WriteAddress( 0x028000, 0x0287ff, MWA_RAM /*MWA16_RAM*/, videoram /*videoram16*/, videoram_size) ,
	...
	public static IO_ReadPort sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x04, 0x04, soundlatch_clear_r ),
		new IO_ReadPort( 0x06, 0x06, soundlatch_r ),
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	public static IO_WritePort sound_writeport_3526[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, YM3526_control_port_0_w ),
	...
	PORT_START(); 
		...
		PORT_START(); 
		PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_SERVICE( 0x2000, IP_ACTIVE_LOW );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_DIPNAME( 0x0003, 0x0003, DEF_STR( "Lives") );
		PORT_DIPSETTING(      0x0003, "3" );	PORT_DIPSETTING(      0x0002, "4" );	PORT_DIPSETTING(      0x0001, "5" );	PORT_DIPSETTING(      0x0000, "6" );	PORT_DIPNAME( 0x000c, 0x000c, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(      0x000c, "20000 60000" );	PORT_DIPSETTING(      0x0008, "30000 70000" );	PORT_DIPSETTING(      0x0004, "40000 80000" );	PORT_DIPSETTING(      0x0000, "50000 90000" );	PORT_DIPNAME( 0x0010, 0x0010, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPSETTING(      0x1000, "Easy" );	PORT_DIPSETTING(      0x0000, "Hard" );	PORT_DIPNAME( 0x2000, 0x2000, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x2000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_BITX(    0x4000, 0x4000, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Complete Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(      0x4000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_BITX(    0x8000, 0x8000, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Base Ship Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(      0x8000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_terracre = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x02000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "2a_16b.rom",   0x00000, 0x2000, 0x591a3804 );/* tiles */
	
		ROM_REGION( 0x10000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "1a_15f.rom",   0x00000, 0x8000, 0x984a597f );/* Background */
		ROM_LOAD( "1a_17f.rom",   0x08000, 0x8000, 0x30e297ff );
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "2a_6e.rom",    0x00000, 0x4000, 0xbcf7740b );/* Sprites */
		...
		ROM_REGION( 0x0500, REGION_PROMS, 0 );	ROM_LOAD( "tc1a_10f.bin", 0x0000, 0x0100, 0xce07c544 );/* red component */
