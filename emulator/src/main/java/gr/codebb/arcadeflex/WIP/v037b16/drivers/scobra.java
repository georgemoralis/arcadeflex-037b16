...
import static gr.codebb.arcadeflex.WIP.v037b16.machine._8255ppi.*;
//sndhrdw imports
...
import static mame037b5.sound.mixerH.MIXER_PAN_CENTER;
...
public class scobra {
    ...
    static UBytePtr scobra_soundram = new UBytePtr();
    ...
    static InputPortPtr input_ports_scobras = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY | IPF_COCKTAIL);
    ...
    static InputPortPtr input_ports_stratgyx = new InputPortPtr() {
        public void handler() {
            ...
            /* none of these appear to be used */
            ...
            PORT_START();
            /* IN4 - fake coinage DIPs.  read via IN2 and IN3 */
    ...
    static InputPortPtr input_ports_moonwar = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            ...
            PORT_START();
            /* IN3/4 - dummy ports for the dial */
    ...
    static InputPortPtr input_ports_moonwara = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x1f, IP_ACTIVE_LOW, IPT_SPECIAL);/* the spinner */
            ...
            PORT_ANALOG(0xff, 0x00, IPT_DIAL | IPF_CENTER, 25, 10, 0, 0);
            PORT_START();
            /* doesn't actually work due to bug in game code */
            PORT_ANALOG(0xff, 0x00, IPT_DIAL | IPF_CENTER | IPF_COCKTAIL, 25, 10, 0, 0);
            INPUT_PORTS_END();
        }
    };
 ...
 /* routines to set up the graduated color backgound they use */
    ...
    static RomLoadPtr rom_moonwar = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1, 0);/* 64k for code */
    ...
    static RomLoadPtr rom_moonwara = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1, 0);/* 64k for code */
