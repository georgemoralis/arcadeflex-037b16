...
import static gr.codebb.arcadeflex.WIP.v037b16.machine.stactics.*;
...
public class stactics
{
	...
	static UBytePtr dirty_videoram_b = new UBytePtr();
	static UBytePtr dirty_chardata_b = new UBytePtr();
	static UBytePtr dirty_videoram_d = new UBytePtr();
	static UBytePtr dirty_chardata_d = new UBytePtr();
	static UBytePtr dirty_videoram_e = new UBytePtr();
	static UBytePtr dirty_chardata_e = new UBytePtr();
	static UBytePtr dirty_videoram_f = new UBytePtr();
	static UBytePtr dirty_chardata_f = new UBytePtr();
	...
	static UBytePtr beamdata = new UBytePtr();
	static int states_per_frame;
	
	public static final int DIRTY_CHARDATA_SIZE  = 0x100;
	public static final int BEAMDATA_SIZE        = 0x800;
	...
	static int old_firebeam_state;
        ...
        static int TOTAL_COLORS(int gfxn){ return (Machine.gfx[gfxn].total_colors * Machine.gfx[gfxn].color_granularity); }
	static void COLOR(char[] colortable, int gfxn, int offs, int value){ (colortable[Machine.drv.gfxdecodeinfo[gfxn].color_codes_start + offs])=(char) value; }
	...
	***************************************************************************/
	...
	public static VhStartPtr stactics_vh_start = new VhStartPtr() { public int handler() 
	{
		...
		if ((dirty_videoram_b = (UBytePtr )new UBytePtr(videoram_size[0])) == null)       return 1;
		if ((dirty_videoram_d = (UBytePtr )new UBytePtr(videoram_size[0])) == null)       return 1;
		if ((dirty_videoram_e = (UBytePtr )new UBytePtr(videoram_size[0])) == null)       return 1;
		if ((dirty_videoram_f = (UBytePtr )new UBytePtr(videoram_size[0])) == null)       return 1;
		if ((dirty_chardata_b = (UBytePtr )new UBytePtr(DIRTY_CHARDATA_SIZE)) == null) return 1;
		if ((dirty_chardata_d = (UBytePtr )new UBytePtr(DIRTY_CHARDATA_SIZE)) == null) return 1;
		if ((dirty_chardata_e = (UBytePtr )new UBytePtr(DIRTY_CHARDATA_SIZE)) == null) return 1;
		if ((dirty_chardata_f = (UBytePtr )new UBytePtr(DIRTY_CHARDATA_SIZE)) == null) return 1;
		...
		if ((beamdata = (UBytePtr )new UBytePtr(BEAMDATA_SIZE)) == null) return 1;
