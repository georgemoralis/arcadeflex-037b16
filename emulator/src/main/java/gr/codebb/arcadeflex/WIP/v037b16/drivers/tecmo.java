...
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.tecmo.*;
...
public class tecmo
{
	...
	public static Memory_WriteAddress tecmo_sound_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x2000, 0x207f, MWA_RAM ),	/* Silkworm set #2 has a custom CPU which */
	...
	//MACHINE_DRIVER( silkworm, 6000000 /* ? */, 6000000 )
        //#define MACHINE_DRIVER(NAME,CPU1_CLOCK,SOUND)					
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_rygar = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "cpu_8k.bin",   0x00000, 0x08000, 0x4d482fb6 );/* characters */
	
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "vid_6k.bin",   0x00000, 0x08000, 0xaba6db9e );/* sprites */
		...
		ROM_REGION( 0x20000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "vid_6p.bin",   0x00000, 0x08000, 0x9eae5f8e );	ROM_LOAD( "vid_6o.bin",   0x08000, 0x08000, 0x5a10a396 );	ROM_LOAD( "vid_6n.bin",   0x10000, 0x08000, 0x7b12cf3f );	ROM_LOAD( "vid_6l.bin",   0x18000, 0x08000, 0x3cea7eaa );
		ROM_REGION( 0x20000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "vid_6f.bin",   0x00000, 0x08000, 0x9840edd8 );	ROM_LOAD( "vid_6e.bin",   0x08000, 0x08000, 0xff65e074 );	ROM_LOAD( "vid_6c.bin",   0x10000, 0x08000, 0x89868c85 );	ROM_LOAD( "vid_6b.bin",   0x18000, 0x08000, 0x35389a7b );
	...
	static RomLoadPtr rom_rygarj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "cpu_4h.bin",   0x0000, 0x2000, 0xe4a2fa87 );
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "cpuj_8k.bin",  0x00000, 0x08000, 0x45047707 );/* characters */
	...
	static RomLoadPtr rom_silkworm = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "silkworm.2",   0x00000, 0x08000, 0xe80a1cd9 );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "silkworm.6",   0x00000, 0x10000, 0x1138d159 );/* sprites */
		...
		ROM_REGION( 0x40000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "silkworm.10",  0x00000, 0x10000, 0x8c7138bb );/* tiles #1 */
		...
		ROM_REGION( 0x40000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "silkworm.14",  0x00000, 0x10000, 0x409df64b );/* tiles #2 */
	...
	static RomLoadPtr rom_gemini = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "gw02-3h.rom",  0x00000, 0x08000, 0x7acc8d35 );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "gw06-1c.rom",  0x00000, 0x10000, 0x4ea51631 );/* sprites */
		...
		ROM_REGION( 0x40000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "gw10-1n.rom",  0x00000, 0x10000, 0x5e84cd4f );/* tiles #1 */
		...
		ROM_REGION( 0x40000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "gw14-1r.rom",  0x00000, 0x10000, 0x9c10e5b5 );/* tiles #2 */
