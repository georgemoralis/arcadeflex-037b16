...
import static gr.codebb.arcadeflex.WIP.v037b16.machine.starwars.*;
import static gr.codebb.arcadeflex.WIP.v037b16.sndhrdw.starwars.*;
...
import static gr.codebb.arcadeflex.WIP.v037b16.machine.slapstic.*;
import static gr.codebb.arcadeflex.WIP.v037b16.machine.swmathbx.*;
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.avgdvg.*;
...
import static gr.codebb.arcadeflex.v037b16.sound._5220intfH.*;
...
/*TODO*///	void starwars_wdclr(int, int);
...
/*TODO*///	int slapstic_tweak (offs_t offset);
	...
	if (prevpc != 0x8080 && prevpc != 0x8090 && prevpc != 0x80a0 && prevpc !=0x80b0)
	  bank = esb_slapstic_tweak ((prevpc & 0x1fff) != 0 ? 1:0);	/* ASG - switched to ESB version */
	 }
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x2fff, MRA_RAM ),   /* vector_ram */
	...
	public static Memory_ReadAddress readmem2[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0800, 0x0fff, starwars_sin_r ),		/* SIN Read */
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x2fff, MWA_RAM, vectorram, vectorram_size ), /* vector_ram */
	...
	public static Memory_WriteAddress writemem2[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x07ff, starwars_sout_w ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_esb = new RomLoadPtr(){ public void handler(){ 
		...
		/* Sound ROMS */
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "136031.113",   0x4000, 0x2000, 0x24ae3815 );/* Sound ROM 0 */
