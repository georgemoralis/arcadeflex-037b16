...
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw._88games.*;
...
public class _88games
{
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x1fff, MRA_RAM ),	/* banked ROM + palette RAM */
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x0fff, MWA_RAM ),	/* banked ROM */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_88games = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "861.g3",   0x0000, 0x0100, 0x429785db );/* priority encoder (not used) */
	...
	logerror("%04x: bank select %02x\n",cpu_get_pc(),lines);
		...
		memcpy(new UBytePtr(RAM),new UBytePtr(RAM, offs),0x1000);
		if ((lines & 0x08) != 0)
		{
