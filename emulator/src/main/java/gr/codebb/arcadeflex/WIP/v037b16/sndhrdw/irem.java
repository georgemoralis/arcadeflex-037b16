...
//cpu imports
import static gr.codebb.arcadeflex.v037b16.cpu.m6800.m6803.*;
//mame imports
...
public class irem {
 ...
 /* bits 0 and 1 reset the two chips */
    ...
    public static Memory_ReadAddress irem_sound_readmem[] = {
        new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8), new Memory_ReadAddress(0x0000, 0x001f, m6803_internal_registers_r),
    ...
    public static Memory_WriteAddress irem_sound_writemem[] = {
        new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8), new Memory_WriteAddress(0x0000, 0x001f, m6803_internal_registers_w),
    ...
    public static IO_ReadPort irem_sound_readport[] = {
        new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8), new IO_ReadPort(M6803_PORT1, M6803_PORT1, irem_port1_r),
        new IO_ReadPort(M6803_PORT2, M6803_PORT2, irem_port2_r),
        new IO_ReadPort(MEMPORT_MARKER, 0)
    };
    public static IO_WritePort irem_sound_writeport[] = {
        new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8), new IO_WritePort(M6803_PORT1, M6803_PORT1, irem_port1_w),
