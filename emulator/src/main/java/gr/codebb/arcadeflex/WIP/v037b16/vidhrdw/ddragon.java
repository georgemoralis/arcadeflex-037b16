...
public class ddragon
{
	...
	***************************************************************************/
	...
	public static GetTileInfoPtr get_fg_16color_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int attr = ddragon_fgvideoram.read(2*tile_index);
		SET_TILE_INFO(
				0,
	...
	***************************************************************************/
	...
	static void DRAW_SPRITE(osd_bitmap bitmap, GfxElement gfx, int which, 
                int color, int flipx, int flipy, rectangle clip,
                int order, int sx, int sy ) {
            drawgfx( bitmap, gfx,
