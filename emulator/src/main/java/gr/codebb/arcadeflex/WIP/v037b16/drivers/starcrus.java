...
import common.ptr;
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.starcrus.*;
...
public class starcrus
{
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x0fff, MRA_ROM ), /* Program ROM */
		new Memory_ReadAddress( 0x1000, 0x10ff, MRA_RAM ), /* RAM */
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),    new Memory_WriteAddress( 0x0000, 0x0fff, MWA_ROM ), /* Program ROM */
	...
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),    new IO_WritePort( 0x00, 0x00, starcrus_s1_x_w ),
	...
	static VhConvertColorPromPtr init_palette = new VhConvertColorPromPtr() {
            @Override
            public void handler(char[] game_palette, char[] game_colortable, ptr.UBytePtr color_prom) {
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_starcrus = new RomLoadPtr(){ public void handler(){ 
	    ...
	    ROM_REGION( 0x0200, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "starcrus.e6",   0x0000, 0x0200, 0x54887a25 );
	    ROM_REGION( 0x0200, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "starcrus.l2",   0x0000, 0x0200, 0x54887a25 );
	    ROM_REGION( 0x0400, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "starcrus.j4",   0x0000, 0x0200, 0x25f15ae1 );	ROM_LOAD( "starcrus.g5",   0x0200, 0x0200, 0x73b27f6e );ROM_END(); }}; 
