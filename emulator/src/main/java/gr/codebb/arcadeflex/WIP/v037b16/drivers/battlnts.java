...
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.battlnts.*;
...
public class battlnts
{
	...
	public static Memory_ReadAddress battlnts_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x1fff, K007342_r ),			/* Color RAM + Video RAM */
	...
	public static Memory_WriteAddress battlnts_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x1fff, K007342_w ),				/* Color RAM + Video RAM */
	...
	public static Memory_ReadAddress battlnts_readmem_sound[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x7fff, MRA_ROM ),				/* ROM 777c01.rom */
	...
	public static Memory_WriteAddress battlnts_writemem_sound[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x7fff, MWA_ROM ),					/* ROM 777c01.rom */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_battlnts = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "777c04.bin",  0x00000, 0x40000, 0x45d92347 );/* tiles */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "777c05.bin",  0x00000, 0x40000, 0xaeee778c );/* sprites */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_thehustl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "765-e04.13a", 0x00000, 0x40000, 0x08c2b72e );/* tiles */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "765-e05.13e", 0x00000, 0x40000, 0xef044655 );/* sprites */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_rackemup = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the sound CPU */
		ROM_LOAD( "765-j01.10a", 0x00000, 0x08000, 0x77ae753e );
		ROM_REGION( 0x40000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "765l04",      0x00000, 0x40000, 0xacfbeee2 );/* tiles */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "765l05",      0x00000, 0x40000, 0x1bb6855f );/* sprites */
	ROM_END(); }}; 
