...
public class baraduke {
     ...
     **************************************************************************
     */
    public static VhConvertColorPromPtr baraduke_vh_convert_color_prom = new VhConvertColorPromPtr() {
    ...
    public static GetTileInfoPtr get_tile_info0 = new GetTileInfoPtr() {
        public void handler(int tile_index) {
            ...
            SET_TILE_INFO(1 + ((attr & 0x02) >> 1), code | ((attr & 0x01) << 8), attr, 0);
        }
    };
    ...
    public static GetTileInfoPtr get_tile_info1 = new GetTileInfoPtr() {
        public void handler(int tile_index) {
            ...
            SET_TILE_INFO(3 + ((attr & 0x02) >> 1), code | ((attr & 0x01) << 8), attr, 0);
        }
    };
     ...
     **************************************************************************
     */
    public static VhStartPtr baraduke_vh_start = new VhStartPtr() {
        public int handler() {
    ...
    public static VhUpdatePtr baraduke_vh_screenrefresh = new VhUpdatePtr() {
    ...
    public static VhUpdatePtr metrocrs_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int offs;
