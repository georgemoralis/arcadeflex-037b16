...
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.arabian.*;
//to be organized
...
public class arabian {
     ...
     ************************************
     */
    public static InterruptPtr generate_interrupt = new InterruptPtr() {
        public int handler() {
 ...
 /* track the custom CPU reset */
     ...
     ************************************
     */
    public static ReadHandlerPtr custom_cpu_r = new ReadHandlerPtr() {
 ...
 /* initial state is based on the flip screen flag */
    ...
    public static WriteHandlerPtr custom_flip_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr custom_cocktail_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
     ...
     ************************************
     */
    public static InitDriverPtr init_arabian = new InitDriverPtr() {
        public void handler() {
