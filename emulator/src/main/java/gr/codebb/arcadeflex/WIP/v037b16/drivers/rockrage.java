...
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.rockrage.*;
...
public class rockrage
{
	...
	public static Memory_ReadAddress rockrage_readmem_sound[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x3000, 0x3000, rockrage_VLM5030_busy_r ),/* VLM5030 */
	...
	public static Memory_WriteAddress rockrage_writemem_sound[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x2000, 0x2000, VLM5030_data_w ), 			/* VLM5030 */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_rockrage = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x040000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "620k06.15g",	0x000000, 0x20000, BADCRC( 0xc0e2b35c ));	/* tiles */
		ROM_LOAD( "620k05.16g",	0x020000, 0x20000, BADCRC( 0xca9d9346 ));
	
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "rr-k11.rom",	0x000000, 0x20000, 0x70449239 );/* sprites */
		ROM_LOAD( "rr-l10.rom",	0x020000, 0x20000, 0x06d108e0 );
		ROM_REGION( 0x0300, REGION_PROMS, 0 );	ROM_LOAD( "620k09.11g", 0x00000, 0x00100, 0x9f0e0608 );/* layer 0 lookup table */
	...
	static RomLoadPtr rom_rockragj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION(  0x10000 , REGION_CPU2, 0 );/* 64k for the sound CPU */
		ROM_LOAD( "620k03.11c", 0x08000, 0x08000, 0x9fbefe82 );
		ROM_REGION( 0x040000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "620k06.15g",	0x000000, 0x20000, 0xc0e2b35c );/* tiles */
		ROM_LOAD( "620k05.16g",	0x020000, 0x20000, 0xca9d9346 );
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "620k11.7g",	0x000000, 0x20000, 0x7430f6e9 );/* sprites */
