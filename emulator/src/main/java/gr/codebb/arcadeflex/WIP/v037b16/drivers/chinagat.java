...
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.ddragon.*;
...
import static gr.codebb.arcadeflex.WIP.v037b16.cpu.i8039.i8039H.*;
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.generic.*;
import static gr.codebb.arcadeflex.v037b16.cpu.m6809.m6809H.M6809_INT_NONE;
...
import static gr.codebb.arcadeflex.v037b16.sound.okim6295H.*;
...
/*TODO*///	#endif
	...
	public static WriteHandlerPtr saiyugb1_adpcm_control_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		UBytePtr saiyugb1_adpcm_rom = memory_region(REGION_SOUND1);
...
/*TODO*///	#endif
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x1fff, MRA_BANK2 ),
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x1fff, MWA_BANK2 ),
	...
	public static IO_ReadPort i8748_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( I8039_bus, I8039_bus, saiyugb1_mcu_command_r ),
		new IO_ReadPort( I8039_t1,  I8039_t1,  saiyugb1_m5205_irq_r ),
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	public static IO_WritePort i8748_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( I8039_t0,  I8039_t0,  saiyugb1_m5205_clk_w ), 		/* Drives the clock on the m5205 at 1/8 of this frequency */
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 
		...
		PORT_DIPSETTING(	0x01, "Easy" );	PORT_DIPSETTING(	0x03, "Normal" );	PORT_DIPSETTING(	0x02, "Hard" );	PORT_DIPSETTING(	0x00, "Hardest" );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x04, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x30, "Timer" );	PORT_DIPSETTING(    0x00, "50" );	PORT_DIPSETTING(    0x20, "55" );	PORT_DIPSETTING(    0x30, "60" );	PORT_DIPSETTING(    0x10, "70" );	PORT_DIPNAME( 0xc0, 0x80, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0xc0, "2" );	PORT_DIPSETTING(    0x80, "3" );	PORT_DIPSETTING(    0x40, "4" );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 
		...
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START2 );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_chinagat = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "23j1-0.53", 0x00000, 0x20000, 0xf91f1001 );	ROM_LOAD( "23j2-0.52", 0x20000, 0x20000, 0x8b6f26e9 );
	...
	static RomLoadPtr rom_saiyugou = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION(0x40000, REGION_GFX3, ROMREGION_DISPOSE );/* Background */
		ROM_LOAD( "a-13", 0x00000, 0x10000, 0x00000000 );	ROM_LOAD( "a-12", 0x10000, 0x10000, 0x00000000 );	ROM_LOAD( "a-15", 0x20000, 0x10000, 0x00000000 );	ROM_LOAD( "a-14", 0x30000, 0x10000, 0x00000000 );
		ROM_REGION(0x40000, REGION_SOUND1, 0 );/* ADPCM */
		ROM_LOAD( "23j1-0.53", 0x00000, 0x20000, 0xf91f1001 );	ROM_LOAD( "23j2-0.52", 0x20000, 0x20000, 0x8b6f26e9 );
		ROM_REGION(0x300, REGION_USER1, 0 );/* Unknown Bipolar PROMs */
		ROM_LOAD( "23jb-0.16", 0x000, 0x200, 0x46339529 );/* 82S131 on video board */
	...
	static RomLoadPtr rom_saiyugb1 = new RomLoadPtr(){ public void handler(){ 
		...
		*/
		...
		ROM_REGION(0x40000, REGION_GFX3, ROMREGION_DISPOSE );/* Background */
		ROM_LOAD( "a-13", 0x00000, 0x10000, 0xb745cac4 );	ROM_LOAD( "a-12", 0x10000, 0x10000, 0x3c864299 );	ROM_LOAD( "a-15", 0x20000, 0x10000, 0x2f268f37 );	ROM_LOAD( "a-14", 0x30000, 0x10000, 0xaef814c8 );
	...
	public static GameDriver driver_saiyugou	   = new GameDriver("1988"	,"saiyugou"	,"chinagat.java"	,rom_saiyugou,driver_chinagat	,machine_driver_chinagat	,input_ports_chinagat	,null	,	ROT0, "Technos", "Sai Yo Gou Ma Roku (Japan)" );
	public static GameDriver driver_saiyugb1	   = new GameDriver("1988"	,"saiyugb1"	,"chinagat.java"	,rom_saiyugb1,driver_chinagat	,machine_driver_saiyugb1	,input_ports_chinagat	,null	,	ROT0, "bootleg", "Sai Yo Gou Ma Roku (bootleg 1)", GAME_IMPERFECT_SOUND );
	public static GameDriver driver_saiyugb2	   = new GameDriver("1988"	,"saiyugb2"	,"chinagat.java"	,rom_saiyugb2,driver_chinagat	,machine_driver_saiyugb2	,input_ports_chinagat	,null	,	ROT0, "bootleg", "Sai Yo Gou Ma Roku (bootleg 2)" );
}
