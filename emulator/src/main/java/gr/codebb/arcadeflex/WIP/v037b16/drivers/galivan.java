...
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.galivan.*;
...
public class galivan
{
	...
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x40, 0x40, galivan_gfxbank_w ),
	...
	public static IO_ReadPort ninjemak_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x80, 0x80, input_port_0_r ),
	...
	public static IO_WritePort ninjemak_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x80, 0x80, ninjemak_gfxbank_w ),
	...
	public static IO_ReadPort sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),/*	new IO_ReadPort( 0x04, 0x04, IORP_NOP ),    value read and *discarded*    */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_galivan = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "gv4.13d",      0x00000, 0x4000, 0x162490b4 );/* chars */
	
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "gv7.14f",      0x00000, 0x8000, 0xeaa1a0db );/* tiles */
		...
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "gv14.4f",      0x00000, 0x8000, 0x03e2229f );/* sprites */
		...
		ROM_REGION( 0x0500, REGION_PROMS, 0 );	ROM_LOAD( "mb7114e.9f",   0x0000, 0x0100, 0xde782b3e );/* red */
	...
	static RomLoadPtr rom_dangar = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "dangar05.13d", 0x00000, 0x4000, 0x40cb378a );/* chars */
	
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "dangar01.14f", 0x00000, 0x8000, 0xd59ed1f1 ); /* tiles */
		...
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "dangarxx.f4",  0x00000, 0x8000, 0x55711884 ); /* sprites */
		...
		ROM_REGION( 0x0500, REGION_PROMS, 0 );	ROM_LOAD( "82s129.9f",    0x0000, 0x0100, 0xb29f6a07 );/* red */
	...
	static RomLoadPtr rom_dangar2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	/* sound cpu code */
		ROM_LOAD( "dangar13.b14", 0x0000, 0x4000, 0x3e041873 );	ROM_LOAD( "dangar14.b15", 0x4000, 0x8000, 0x488e3463 );
		ROM_REGION( 0x04000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "dangar2.011",  0x00000, 0x4000, 0xe804ffe1 );/* chars */
	...
	static RomLoadPtr rom_ninjemak = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ninjemak.4",   0x00000, 0x8000, 0x83702c37 );/* chars */
	
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "ninjemak.8",   0x00000, 0x8000, 0x655f0a58 );/* tiles */
		...
		ROM_REGION( 0x20000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "ninjemak.16",  0x00000, 0x8000, 0x8df93fed ); /* sprites */
	...
	static RomLoadPtr rom_youma = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* sound cpu code */
		ROM_LOAD( "ninjemak.12",  0x0000, 0x4000, 0x3d1cd329 );	ROM_LOAD( "ninjemak.13",  0x4000, 0x8000, 0xac3a0b81 );
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ync-4.bin",    0x00000, 0x8000, 0xa1954f44 );/* chars */
