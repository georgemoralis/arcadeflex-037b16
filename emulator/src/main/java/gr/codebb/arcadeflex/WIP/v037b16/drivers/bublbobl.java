...
import static gr.codebb.arcadeflex.WIP.v037b16.machine.bublbobl.*;
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.bublbobl.*;
...
public class bublbobl
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_bublbobl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "a78-09.12",    0x00000, 0x8000, 0x20358c22 );   /* 1st plane */
	...
	static RomLoadPtr rom_tokio = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "a71-08.256",   0x00000, 0x8000, 0x0439ab13 );   /* 1st plane */
