...
import static gr.codebb.arcadeflex.WIP.v037b16.cpu.hd6309.hd6309H.HD6309_INT_IRQ;
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.flkatck.*;
import static gr.codebb.arcadeflex.v037b16.cpu.z80.z80H.Z80_IRQ_INT;
...
public class flkatck
{
	...
	public static Memory_ReadAddress flkatck_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0400, 0x041f, flkatck_ls138_r ),			/* inputs + DIPS */
	...
	public static Memory_WriteAddress flkatck_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x0007, flkatck_k007121_regs_w ), 	/* 007121 registers */
