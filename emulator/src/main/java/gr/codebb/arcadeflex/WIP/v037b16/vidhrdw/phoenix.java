...
import static gr.codebb.arcadeflex.WIP.v037b16.sndhrdw.pleiads.pleiads_sound_control_c_w;
...
public class phoenix
{
	...
	static UBytePtr videoram_pg1=new UBytePtr();
	static UBytePtr videoram_pg2=new UBytePtr();
	static UBytePtr current_videoram_pg=new UBytePtr();
	...
	***************************************************************************/
	...
	public static VhConvertColorPromPtr phoenix_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(char []palette, char []colortable, UBytePtr color_prom) 
	{
        ...
        public int TOTAL_COLORS(int gfxn){ return (Machine.gfx[gfxn].total_colors * Machine.gfx[gfxn].color_granularity); }
	...
	***************************************************************************/
	...
	public static GetTileInfoPtr get_fg_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		...
		SET_TILE_INFO(
				...
				(tile_index & 0x1f)!=0 ? 0 : TILE_IGNORE_TRANSPARENCY);	/* first row (column) is opaque */
	} };
