...
import static gr.codebb.arcadeflex.WIP.v037b16.cpu.hd6309.hd6309H.HD6309_INT_FIRQ;
import static gr.codebb.arcadeflex.WIP.v037b16.vidhrdw.bladestl.*;
...
/*TODO*///		set_led_status(1,data & 0x08);
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_bladestl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "797a05",	0x000000, 0x40000, 0x5491ba28 );/* tiles */
		ROM_LOAD( "797a06",	0x040000, 0x40000, 0xd055f5cc );/* sprites */
	
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "797a07", 0x0000, 0x0100, 0x7aecad4e );/* sprites lookup table */
