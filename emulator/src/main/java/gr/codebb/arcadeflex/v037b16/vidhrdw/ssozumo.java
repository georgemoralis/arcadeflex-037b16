...
public class ssozumo {
     ...
     * ***********************************************************************
     */
    public static VhConvertColorPromPtr ssozumo_vh_convert_color_prom = new VhConvertColorPromPtr() {
    ...
    public static WriteHandlerPtr ssozumo_paletteram_w = new WriteHandlerPtr() {
    ...
    public static VhStartPtr ssozumo_vh_start = new VhStartPtr() {
        public int handler() {
    ...
    public static VhStopPtr ssozumo_vh_stop = new VhStopPtr() {
        public void handler() {
            dirtybuffer = null;
    ...
    public static VhUpdatePtr ssozumo_vh_screenrefresh = new VhUpdatePtr() {
