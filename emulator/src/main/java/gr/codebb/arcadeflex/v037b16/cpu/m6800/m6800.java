...
public class m6800 extends cpu_interface {
    ...
    public static class m6800_Regs {
        ...
        public /*const UINT8*/ int[] cycles;
        /* clock cycle of instruction table internal registers */
    ...
    public static void SET_TIMER_EVENT() {
        u32_timer_next = (getOutputReg() - getCounterReg() < getTimeOverReg() - getCounterReg()) ? getOutputReg() : getTimeOverReg();
    }
...
/*TODO*///	return 0;
    ...
    public void set_reg(int regnum, int val) {
        ...
        /*TODO*///	switch( regnum )
/*TODO*///	{
/*TODO*///		case M6800_PC: m6800.pc.w.l = val; break;
/*TODO*///		case M6800_S: m6800.s.w.l = val; break;
/*TODO*///		case M6800_CC: m6800.cc = val; break;
/*TODO*///		case M6800_A: m6800.d.b.h = val; break;
/*TODO*///		case M6800_B: m6800.d.b.l = val; break;
/*TODO*///		case M6800_X: m6800.x.w.l = val; break;
/*TODO*///		case M6800_NMI_STATE: m6800_set_nmi_line(val); break;
/*TODO*///		case M6800_IRQ_STATE: m6800_set_irq_line(M6800_IRQ_LINE,val); break;
/*TODO*///		default:
/*TODO*///			if( regnum <= REG_SP_CONTENTS )
/*TODO*///			{
/*TODO*///				unsigned offset = S + 2 * (REG_SP_CONTENTS - regnum);
...
/*TODO*///	}
    ...
    public void set_nmi_line(int state) {
        ...
        //LOG((errorlog, "M6800#%d set_nmi_line %d\n", cpu_getactivecpu(), state));
...
/*TODO*///		case CPU_INFO_WIN_LAYOUT: case 6800: return (const char *)m6800_win_layout;
    ...
    public void internal_interrupt(int type) {
        //doesn't exist in 6800 cpu
    }

    @Override
    public int internal_read(int offset) {
        return 0; //doesn't exist in 6800 cpu
    }

    @Override
    public void internal_write(int offset, int data) {
        //doesesn't exist in 6800 cpu
    }
