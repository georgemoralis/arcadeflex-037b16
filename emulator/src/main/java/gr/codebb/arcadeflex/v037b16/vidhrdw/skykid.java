...
public class skykid {
     ...
     **************************************************************************
     */
    public static VhConvertColorPromPtr skykid_vh_convert_color_prom = new VhConvertColorPromPtr() {
 ...
 /* tiles lookup table */
     ...
     **************************************************************************
     */
    public static GetTileInfoPtr get_tile_info_bg = new GetTileInfoPtr() {
        public void handler(int tile_index) {
            int code = skykid_videoram.read(tile_index);
            int attr = skykid_videoram.read(tile_index + 0x800);

            SET_TILE_INFO(1, code + 256 * (attr & 0x01), ((attr & 0x7e) >> 1) | ((attr & 0x01) << 6), 0);
        }
    };
     ...
     **************************************************************************
     */
    public static VhStartPtr skykid_vh_start = new VhStartPtr() {
        public int handler() {
    ...
    public static WriteHandlerPtr skykid_flipscreen_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            priority = data;
            flipscreen = offset;
    ...
    public static VhUpdatePtr skykid_vh_screenrefresh = new VhUpdatePtr() {
