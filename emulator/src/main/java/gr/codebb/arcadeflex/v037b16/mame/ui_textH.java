...
public class ui_textH {
    ...
    public static final int UI_watchpoint = 87;
    public static final int UI_disabled = 88;
    public static final int UI_cheats = 89;
    public static final int UI_watchpoints = 90;
    public static final int UI_moreinfo = 91;
    public static final int UI_moreinfoheader = 92;
    public static final int UI_cheatname = 93;
    public static final int UI_cheatdescription = 94;
    public static final int UI_cheatactivationkey = 95;
    public static final int UI_code = 96;
    public static final int UI_max = 97;
    public static final int UI_set = 98;
    public static final int UI_conflict_found = 99;
    public static final int UI_no_help_available = 100;

    /* watchpoint stuff */
    public static final int UI_watchlength = 101;
    public static final int UI_watchlabeltype = 102;
    public static final int UI_watchlabel = 103;
    public static final int UI_watchx = 104;
    public static final int UI_watchy = 105;
    public static final int UI_watch = 106;

    /* search stuff */
    public static final int UI_search_lives = 107;
    public static final int UI_search_timers = 108;
    public static final int UI_search_energy = 109;
    public static final int UI_search_status = 110;
    public static final int UI_search_slow = 111;
    public static final int UI_search_speed = 112;
    public static final int UI_search_speed_fast = 113;
    public static final int UI_search_speed_medium = 114;
    public static final int UI_search_speed_slow = 115;
    public static final int UI_search_speed_veryslow = 116;
    public static final int UI_search_select_memory_areas = 117;
    public static final int UI_search_matches_found = 118;
    public static final int UI_search_noinit = 119;
    public static final int UI_search_nosave = 120;
    public static final int UI_search_done = 121;
    public static final int UI_search_OK = 122;
    public static final int UI_search_select_value = 123;
    public static final int UI_search_all_values_saved = 124;
    public static final int UI_search_one_match_found_added = 125;

    public static final int UI_last_entry = 126;
