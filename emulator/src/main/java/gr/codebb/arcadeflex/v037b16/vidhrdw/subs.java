...
public class subs {
    ...
    public static WriteHandlerPtr subs_invert1_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr subs_invert2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if ((offset & 0x01) == 1) {
     ...
     **************************************************************************
     */
    public static VhUpdatePtr subs_vh_screenrefresh = new VhUpdatePtr() {
