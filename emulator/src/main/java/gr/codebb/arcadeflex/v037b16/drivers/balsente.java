...
import static mame037b5.sound.mixer.mixer_get_name;
import static mame037b5.sound.mixer.mixer_set_volume;
import static mame037b5.sound.mixerH.MIXER_MAX_CHANNELS;
 ...
 /* if we gate on, start a pulsing timer to clock it */
    ...
    static InputPortPtr input_ports_nstocker = new InputPortPtr() {
        public void handler() {
            ...
            /* analog ports */
            UNUSED_ANALOG_X3();
            /* cheese alert -- we have to map this to player 2 so that it doesn't interfere with */ /* the crosshair controls */
            PORT_START();
