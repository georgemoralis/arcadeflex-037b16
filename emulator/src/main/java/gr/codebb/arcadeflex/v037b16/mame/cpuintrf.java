...
import gr.codebb.arcadeflex.v037b16.cpu.m6800.m6800;
import gr.codebb.arcadeflex.v037b16.cpu.m6800.m6801;
import gr.codebb.arcadeflex.v037b16.cpu.m6800.m6802;
import gr.codebb.arcadeflex.v037b16.cpu.m6800.m6803;
...
import gr.codebb.arcadeflex.WIP.v037b16.cpu.i8085.i8080;
import gr.codebb.arcadeflex.WIP.v037b16.cpu.i8085.i8085;
import gr.codebb.arcadeflex.WIP.v037b16.cpu.i8039.i8035;
import gr.codebb.arcadeflex.WIP.v037b16.cpu.i8039.i8039;
...
import gr.codebb.arcadeflex.v037b16.cpu.konami.konami;
import static gr.codebb.arcadeflex.v037b16.cpu.konami.konamiH.*;
...
/*TODO*///
    ...
    static /*UINT8*/ int[] interrupt_enable = new int[MAX_CPU];
    static int[] interrupt_vector = new int[MAX_CPU];

    static /*UINT8*/ int[] irq_line_state = new int[MAX_CPU * MAX_IRQ_LINES];
...
/*TODO*///		NULL, name##_info, name##_dasm, 										   \
...
/*TODO*///		name##_get_sp, name##_set_sp, name##_get_reg, name##_set_reg,			   \
/*TODO*///		name##_set_nmi_line, name##_set_irq_line, name##_set_irq_callback,		   \
/*TODO*///		name##_internal_interrupt, name##_info, name##_dasm,					   \
/*TODO*///		nirq, dirq, &name##_ICount, oc, i0, i1, i2, 							   \
/*TODO*///		datawidth,																   \
/*TODO*///		(mem_read_handler)cpu_readmem##mem, (mem_write_handler)cpu_writemem##mem, NULL, NULL,						   \
/*TODO*///		0, cpu_setopbase##mem,													   \
...
/*TODO*////* warning the ordering must match the one of the enum in driver.h! */
    public static cpu_interface cpuintf[]
            = {new dummy_cpu(),
                ...
                new i8080(),//CPU0(8080,	   i8080,	 4,255,1.00,I8080_NONE, 	   I8080_INTR,	   I8080_TRAP,	   8, 16,	  0,16,LE,1, 3	),
                new i8085(),//CPU0(8085A,    i8085,	 4,255,1.00,I8085_NONE, 	   I8085_INTR,	   I8085_TRAP,	   8, 16,	  0,16,LE,1, 3	),
                new m6502(),//CPU0(M6502,    m6502,	 1,  0,1.00,M6502_INT_NONE,    M6502_INT_IRQ,  M6502_INT_NMI,  8, 16,	  0,16,LE,1, 3	),
                new dummy_cpu(),//CPU0(M65C02,   m65c02,	 1,  0,1.00,M65C02_INT_NONE,   M65C02_INT_IRQ, M65C02_INT_NMI, 8, 16,	  0,16,LE,1, 3	),
                new dummy_cpu(),//CPU0(M65SC02,  m65sc02,  1,  0,1.00,M65SC02_INT_NONE,  M65SC02_INT_IRQ,M65SC02_INT_NMI,8, 16,	  0,16,LE,1, 3	),
                new dummy_cpu(),//CPU0(M65CE02,  m65ce02,  1,  0,1.00,M65CE02_INT_NONE,  M65CE02_INT_IRQ,M65CE02_INT_NMI,8, 16,	  0,16,LE,1, 3	),
                new dummy_cpu(),//CPU0(M6509,    m6509,	 1,  0,1.00,M6509_INT_NONE,    M6509_INT_IRQ,  M6509_INT_NMI,  8, 20,	  0,20,LE,1, 3	),
                new dummy_cpu(),//CPU0(M6510,    m6510,	 1,  0,1.00,M6510_INT_NONE,    M6510_INT_IRQ,  M6510_INT_NMI,  8, 16,	  0,16,LE,1, 3	),
                ...
                new dummy_cpu(),//CPU0(I188,	   i188,	 1,  0,1.00,I188_INT_NONE,	   -1000,		   I188_NMI_INT,   8, 20,	  0,20,LE,1, 5	),
                new dummy_cpu(),//CPU0(I286,	   i286,	 1,  0,1.00,I286_INT_NONE,	   -1000,		   I286_NMI_INT,   8, 24,	  0,24,LE,1, 5	),
                new dummy_cpu(),//CPU0(V20,	   v20, 	 1,  0,1.00,NEC_INT_NONE,	   -1000,		   NEC_NMI_INT,    8, 20,	  0,20,LE,1, 5	),
                new dummy_cpu(),//CPU0(V30,	   v30, 	 1,  0,1.00,NEC_INT_NONE,	   -1000,		   NEC_NMI_INT,    8, 20,	  0,20,LE,1, 5	),
                new dummy_cpu(),//CPU0(V33,	   v33, 	 1,  0,1.00,NEC_INT_NONE,	   -1000,		   NEC_NMI_INT,    8, 20,	  0,20,LE,1, 5	),
                new i8035(),//CPU0(I8035,    i8035,	 1,  0,1.00,I8035_IGNORE_INT,  I8035_EXT_INT,  -1,			   8, 16,	  0,16,LE,1, 2	),
                new i8039(),//CPU0(I8039,    i8039,	 1,  0,1.00,I8039_IGNORE_INT,  I8039_EXT_INT,  -1,			   8, 16,	  0,16,LE,1, 2	),
                new i8048(),//CPU0(I8048,    i8048,	 1,  0,1.00,I8048_IGNORE_INT,  I8048_EXT_INT,  -1,			   8, 16,	  0,16,LE,1, 2	),
                new n7751(),//CPU0(N7751,    n7751,	 1,  0,1.00,N7751_IGNORE_INT,  N7751_EXT_INT,  -1,			   8, 16,	  0,16,LE,1, 2	),
                new dummy_cpu(),//CPU0(I8X41,    i8x41,	 1,  0,1.00,I8X41_INT_NONE,    I8X41_INT_IBF,  -1,			   8, 16,	  0,16,LE,1, 2	),
                new m6800(),//CPU0(M6800,    m6800,	 1,  0,1.00,M6800_INT_NONE,    M6800_INT_IRQ,  M6800_INT_NMI,  8, 16,	  0,16,BE,1, 4	),
                new m6801(),//CPU0(M6801,    m6801,	 1,  0,1.00,M6801_INT_NONE,    M6801_INT_IRQ,  M6801_INT_NMI,  8, 16,	  0,16,BE,1, 4	),
                new m6802(),//CPU0(M6802,    m6802,	 1,  0,1.00,M6802_INT_NONE,    M6802_INT_IRQ,  M6802_INT_NMI,  8, 16,	  0,16,BE,1, 4	),
                new m6803(),//CPU0(M6803,    m6803,	 1,  0,1.00,M6803_INT_NONE,    M6803_INT_IRQ,  M6803_INT_NMI,  8, 16,	  0,16,BE,1, 4	),
                ...
                new hd6309(),//CPU0(HD6309,   hd6309,	 2,  0,1.00,HD6309_INT_NONE,   HD6309_INT_IRQ, HD6309_INT_NMI, 8, 16,	  0,16,BE,1, 4	),
                ...
                new m68kmame(),//CPU0(M68000,   m68000,	 8, -1,1.00,MC68000_INT_NONE,  -1,			   -1,			   16,24bew,  0,24,BE,2,10	),
                ...
                new dummy_cpu(),//CPU0(TMS9940,  tms9940,  1,  0,1.00,TMS9940_NONE,	   -1,			   -1,			   16,16bew,  0,16,BE,2, 6	),
                new dummy_cpu(),//CPU0(TMS9980,  tms9980a, 1,  0,1.00,TMS9980A_NONE,	   -1,			   -1,			   8, 16,	  0,16,BE,1, 6	),
                new dummy_cpu(),//CPU0(TMS9985,  tms9985,  1,  0,1.00,TMS9985_NONE,	   -1,			   -1,			   8, 16,	  0,16,BE,1, 6	),
                new dummy_cpu(),//CPU0(TMS9989,  tms9989,  1,  0,1.00,TMS9989_NONE,	   -1,			   -1,			   8, 16,	  0,16,BE,1, 6	),
                new dummy_cpu(),//CPU0(TMS9995,  tms9995,  1,  0,1.00,TMS9995_NONE,	   -1,			   -1,			   8, 16,	  0,16,BE,1, 6	),
                new dummy_cpu(),//CPU0(TMS99105A,tms99105a,1,  0,1.00,TMS99105A_NONE,    -1,			   -1,			   16,16bew,  0,16,BE,2, 6	),
                new dummy_cpu(),//CPU0(TMS99110A,tms99110a,1,  0,1.00,TMS99110A_NONE,    -1,			   -1,			   16,16bew,  0,16,BE,2, 6	),
                new dummy_cpu(),//CPU0(Z8000,    z8000,	 2,  0,1.00,Z8000_INT_NONE,    Z8000_NVI,	   Z8000_NMI,	   16,16bew,  0,16,BE,2, 6	),
                new dummy_cpu(),//CPU3(TMS320C10,tms320c10,2,  0,1.00,TMS320C10_INT_NONE,-1,			   -1,			   16,16bew, -1,16,BE,2, 4	),
                new dummy_cpu(),//CPU3(CCPU,	   ccpu,	 2,  0,1.00,0,				   -1,			   -1,			   16,16bew,  0,15,BE,2, 3	),
                new dummy_cpu(),//CPU3(ADSP2100, adsp2100, 4,  0,1.00,ADSP2100_INT_NONE, -1,			   -1,			   16,17lew, -1,14,LE,2, 4	),
                new dummy_cpu(),//CPU3(ADSP2105, adsp2105, 4,  0,1.00,ADSP2105_INT_NONE, -1,			   -1,			   16,17lew, -1,14,LE,2, 4	),
                new dummy_cpu(),//CPU0(PSXCPU,   mips,	 8, -1,1.00,MIPS_INT_NONE,	   MIPS_INT_NONE,  MIPS_INT_NONE,  16,32lew,  0,32,LE,4, 4	),
                new dummy_cpu(),//define asap_ICount asap_icount CPU0(ASAP,	   asap,	 1,  0,1.00,ASAP_INT_NONE,	   -1,			   -1,			   32,32ledw, 0,32,LE,4, 12 ),
                new dummy_cpu(),//#define upd7810_ICount upd7810_icount CPU0(UPD7810,  upd7810,  2,  0,1.00,UPD7810_INT_NONE,  UPD7810_INTF1,  UPD7810_INTNMI, 8, 16,	  0,16,LE,1, 4	),
        };
...
/*TODO*///	state_save_register_INT32("cpu", 0, "irq vector",     interrupt_vector,  totalcpu);
/*TODO*///	state_save_register_UINT8("cpu", 0, "irqline state",  irq_line_state,    totalcpu*MAX_IRQ_LINES);
...
/*TODO*///					state_save_set_current_tag(activecpu + 1);
/*TODO*///					state_save_save_continue();
/*TODO*///				}
/*TODO*///
...
/*TODO*///  will be reset.
/*TODO*///
/*TODO*///  The 3 seconds delay is targeted at qzshowby, which otherwise would reset
/*TODO*///  at the start of a game.
/*TODO*///
/*TODO*///***************************************************************************/
/*TODO*///
...
/*TODO*///#endif
				...
				switch (num)
				{
				case KONAMI_INT_IRQ:	irq_line = 0; 
                                /*LOG(("KONAMI IRQ\n"));*/ 
                                break;
				case KONAMI_INT_FIRQ:	irq_line = 1; 
                                /*LOG(("KONAMI FIRQ\n"));*/ 
                                break;
				default:		irq_line = 0; 
                                /*LOG(("KONAMI unknown\n"));*/
...
/*TODO*///
     ...
     * *************************************************************************
     */
    public static int/*unsigned*/ cpu_address_bits() {
        int cpunum = (activecpu < 0) ? 0 : activecpu;
...
/*TODO*///	if ( 1
/*TODO*///#if (HAS_M68000)
/*TODO*///		&& CPU_TYPE(cpunum) != CPU_M68000
/*TODO*///#endif
/*TODO*///#if (HAS_M68010)
/*TODO*///		&& CPU_TYPE(cpunum) != CPU_M68010
/*TODO*///#endif
/*TODO*///#if (HAS_M68020)
/*TODO*///		&& CPU_TYPE(cpunum) != CPU_M68020
/*TODO*///#endif
/*TODO*///#if (HAS_M68EC020)
/*TODO*///		&& CPU_TYPE(cpunum) != CPU_M68EC020
/*TODO*///#endif
/*TODO*///		)
/*TODO*///	{
...
/*TODO*///		if (cpu[cpunum].save_context) SETCONTEXT(cpunum, cpu[cpunum].context);
/*TODO*///	}
/*TODO*///
...
/*TODO*///	{
/*TODO*///		memory_set_context(cpunum);
/*TODO*///		if (cpu[cpunum].save_context) GETCONTEXT(cpunum, cpu[cpunum].context);
/*TODO*///		if(activecpu != -1)
/*TODO*///			if (cpu[activecpu].save_context) SETCONTEXT(activecpu, cpu[activecpu].context);
/*TODO*///	}
/*TODO*///}
