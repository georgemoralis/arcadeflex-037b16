...
public class inptportH {
 ...
 /* the following are special codes for user interface handling - not to be used by drivers_old! */
    ...
    public static final int IPT_UI_TOGGLE_DEBUG = 79;
    public static final int IPT_UI_SAVE_STATE = 80;
    public static final int IPT_UI_LOAD_STATE = 81;
    public static final int IPT_UI_ADD_CHEAT = 82;
    public static final int IPT_UI_DELETE_CHEAT = 83;
    public static final int IPT_UI_SAVE_CHEAT = 84;
    public static final int IPT_UI_WATCH_VALUE = 85;
    public static final int __ipt_max = 86;
