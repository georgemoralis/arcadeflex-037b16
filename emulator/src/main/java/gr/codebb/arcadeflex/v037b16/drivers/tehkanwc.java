 ...
 /* probably waiting to be reset by a watchdog */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_tehkanwc = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "twc-12.bin",   0x00000, 0x4000, 0xa9e274f8 );/* fg tiles */
	
		ROM_REGION( 0x10000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "twc-8.bin",    0x00000, 0x8000, 0x055a5264 );/* sprites */
		ROM_LOAD( "twc-7.bin",    0x08000, 0x8000, 0x59faebe7 );
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "twc-11.bin",   0x00000, 0x8000, 0x669389fc );/* bg tiles */
	...
	static RomLoadPtr rom_gridiron = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "gfight7.bin",  0x00000, 0x4000, 0x04390cca );/* fg tiles */
	
		ROM_REGION( 0x10000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "gfight8.bin",  0x00000, 0x4000, 0x5de6a70f );/* sprites */
		ROM_LOAD( "gfight9.bin",  0x04000, 0x4000, 0xeac9dc16 );	ROM_LOAD( "gfight10.bin", 0x08000, 0x4000, 0x61d0690f );	/* 0c000-0ffff empty */
	
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "gfight11.bin", 0x00000, 0x4000, 0x80b09c03 );/* bg tiles */
	...
	static RomLoadPtr rom_teedoff = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "to-12.bin",    0x00000, 0x4000, 0x4f44622c );/* fg tiles */
	
		ROM_REGION( 0x10000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "to-8.bin",     0x00000, 0x8000, 0x363bd1ba );/* sprites */
		ROM_LOAD( "to-7.bin",     0x08000, 0x8000, 0x6583fa5b );
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "to-11.bin",    0x00000, 0x8000, 0x1ec00cb5 );/* bg tiles */
