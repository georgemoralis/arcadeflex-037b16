...
import static arcadeflex036.video.osd_create_display;
...
import static gr.codebb.arcadeflex.WIP.v037b16.mame.tilemapC.tilemap_close;
import static gr.codebb.arcadeflex.WIP.v037b16.mame.tilemapC.tilemap_init;
import static gr.codebb.arcadeflex.v037b16.mame.cpuintrf.cpu_init;
import static gr.codebb.arcadeflex.v037b16.mame.cpuintrf.cpu_run;
import static gr.codebb.arcadeflex.v037b16.mame.memory.memory_init;
import static gr.codebb.arcadeflex.v037b16.mame.memory.memory_shutdown;
import static gr.codebb.arcadeflex.v037b16.mame.usrintrf.builduifont;
import static gr.codebb.arcadeflex.v037b16.mame.usrintrf.handle_user_interface;
import static gr.codebb.arcadeflex.v037b16.mame.usrintrf.init_user_interface;
import static gr.codebb.arcadeflex.v037b16.mame.usrintrf.showcopyright;
...
public class mame {
    ...
    public static int run_game(int game) {
        ...
        } else if ((Machine.gamedrv.flags & GAME_REQUIRES_16BIT) != 0) {
