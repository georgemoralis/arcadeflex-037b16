...
public class state
{
	...
	static void ss_c2(UBytePtr , unsigned);
	static void ss_c4(UBytePtr , unsigned);
	static void ss_c8(UBytePtr , unsigned);
	
	static void (*ss_conv[])(UBytePtr , unsigned) = {
	...
	static UINT32 ss_get_signature(void)
	{
		...
		signature = crc32(0, (UBytePtr )info, size);
	...
	static void ss_c2(UBytePtr data, unsigned size)
	{
		unsigned i;
		for(i=0; i<size; i++) {
			unsigned char v;
	...
	static void ss_c4(UBytePtr data, unsigned size)
	{
		unsigned i;
		for(i=0; i<size; i++) {
			unsigned char v;
	...
	static void ss_c8(UBytePtr data, unsigned size)
	{
		unsigned i;
		for(i=0; i<size; i++) {
			unsigned char v;
