...
public class leland
{
	...
	public static Memory_WriteAddress leland_i86_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x00000, 0x03fff, MWA_RAM, &ram_base ),
	...
	public static IO_ReadPort leland_i86_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0xff00, 0xffff, i186_internal_port_r ),
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	public static IO_WritePort redline_i86_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x6000, 0x6fff, redline_dac_w ),
		new IO_WritePort( 0xff00, 0xffff, i186_internal_port_w ),
		new IO_WritePort(MEMPORT_MARKER, 0)
	};
	public static IO_WritePort leland_i86_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x0000, 0x000b, dac_w ),
	...
	public static IO_WritePort ataxx_i86_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0xff00, 0xffff, i186_internal_port_w ),
		new IO_WritePort(MEMPORT_MARKER, 0)
	};
