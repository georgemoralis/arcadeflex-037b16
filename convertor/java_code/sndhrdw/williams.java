...
public class williams
{
	...
	****************************************************************************/
	...
	public static Memory_ReadAddress williams_cvsd_readmem[]={
		...
		new Memory_ReadAddress( 0x2000, 0x2001, williams_ym2151_r ),
		new Memory_ReadAddress( 0x4000, 0x4003, williams_cvsd_pia_r ),
	...
	public static Memory_WriteAddress williams_cvsd_writemem[]={
		...
		new Memory_WriteAddress( 0x2000, 0x2001, williams_ym2151_w ),
		new Memory_WriteAddress( 0x4000, 0x4003, williams_cvsd_pia_w ),
		...
		new Memory_WriteAddress( 0x7800, 0x7800, williams_cvsd_bank_select_w ),
	...
	public static Memory_ReadAddress williams_adpcm_readmem[]={
		...
		new Memory_ReadAddress( 0x2401, 0x2401, williams_ym2151_r ),
		new Memory_ReadAddress( 0x2c00, 0x2c00, OKIM6295_status_0_r ),
		new Memory_ReadAddress( 0x3000, 0x3000, williams_adpcm_command_r ),
	...
	public static Memory_WriteAddress williams_adpcm_writemem[]={
		...
		new Memory_WriteAddress( 0x2000, 0x2000, williams_adpcm_bank_select_w ),
		new Memory_WriteAddress( 0x2400, 0x2401, williams_ym2151_w ),
		new Memory_WriteAddress( 0x2800, 0x2800, williams_dac_data_w ),
		new Memory_WriteAddress( 0x2c00, 0x2c00, OKIM6295_data_0_w ),
		new Memory_WriteAddress( 0x3400, 0x3400, williams_adpcm_6295_bank_select_w ),
	...
	public static Memory_ReadAddress williams_narc_master_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x1fff, MRA_RAM ),
		new Memory_ReadAddress( 0x2001, 0x2001, williams_ym2151_r ),
		new Memory_ReadAddress( 0x3000, 0x3000, MRA_NOP ),
		new Memory_ReadAddress( 0x3400, 0x3400, williams_narc_command_r ),
		new Memory_ReadAddress( 0x4000, 0xbfff, MRA_BANK6 ),
		new Memory_ReadAddress( 0xc000, 0xffff, MRA_ROM ),
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	...
	public static Memory_ReadAddress williams_narc_slave_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x1fff, MRA_RAM ),
		new Memory_ReadAddress( 0x3000, 0x3000, MRA_NOP ),
		new Memory_ReadAddress( 0x3400, 0x3400, williams_narc_command2_r ),
	...
	public static Memory_WriteAddress williams_narc_slave_writemem[]={
		...
		new Memory_WriteAddress( 0x3000, 0x3000, williams_dac2_data_w ),
		new Memory_WriteAddress( 0x3800, 0x3800, williams_narc_slave_bank_select_w ),
