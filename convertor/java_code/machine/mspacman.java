...
public class mspacman
{
	...
	*/
	...
	public static ReadHandlerPtr mspacman_deactivate_rom1  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr mspacman_deactivate_rom2  = new ReadHandlerPtr() { public int handler(int offset)
	{
		UBytePtr RAM = memory_region(REGION_CPU1);
	...
	public static ReadHandlerPtr mspacman_deactivate_rom3  = new ReadHandlerPtr() { public int handler(int offset)
	{
		UBytePtr RAM = memory_region(REGION_CPU1);
	...
	public static ReadHandlerPtr mspacman_deactivate_rom4  = new ReadHandlerPtr() { public int handler(int offset)
	{
		UBytePtr RAM = memory_region(REGION_CPU1);
	...
	public static ReadHandlerPtr mspacman_deactivate_rom5  = new ReadHandlerPtr() { public int handler(int offset)
	{
		UBytePtr RAM = memory_region(REGION_CPU1);
	...
	public static ReadHandlerPtr mspacman_deactivate_rom6  = new ReadHandlerPtr() { public int handler(int offset)
	{
		UBytePtr RAM = memory_region(REGION_CPU1);
