...
public class eeprom
{
	...
	*/
	...
	static EEPROM_interface eeprom_interface_93C46 = new EEPROM_interface
	(
		6,				// address bits	6
		16,				// data bits	16
	...
	public static nvramPtr nvram_handler_93C46  = new nvramPtr() { public void handler(Object file, int read_or_write) 
	{
		if (read_or_write != 0)
			EEPROM_save(file);
		else
