...
public class es5506
{
	...
	***********************************************************************************************/
	...
	public static ShStartPtr ES5506_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	***********************************************************************************************/
	...
	public static ShStopPtr ES5506_sh_stop = new ShStopPtr() { public void handler() 
	{
		/* free memory */
		if (accumulator != 0)
			free(accumulator);
	...
	***********************************************************************************************/
	...
	public static ShStartPtr ES5505_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	***********************************************************************************************/
	...
	public static ShStopPtr ES5505_sh_stop = new ShStopPtr() { public void handler() 
	{
		ES5506_sh_stop();
	} };
