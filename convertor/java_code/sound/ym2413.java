...
public class ym2413
{
	...
	*/
	...
	static final int SETTLE = 0, ATTACK = 1, DECAY = 2, SUSHOLD = 3, SUSTINE = 4, RELEASE = 5, FINISH = 6;
	...
	****************************************************/
	...
	void dump2patch(UBytePtr dump, OPLL_PATCH *patch){
	...
	*****************************************************/
	void OPLL_writeReg(OPLL *opll, UINT32 reg, UINT32 data){
	  ...
	  case 0x24:  case 0x25:
	    ...
	    if ((data & 0x10) != 0) keyOn(opll, reg-0x20) ;
	  ...
	  case 0x26:
	    ...
	    if ((data & 0x10) != 0) keyOn(opll, 6) ; else keyOff(opll, 6) ;
	  ...
	  case 0x27:
	    ...
	    if ((data & 0x10) != 0) keyOn(opll, 7) ; else keyOff(opll, 7) ;
	  ...
	  case 0x28:
	    ...
	    if ((data & 0x10) != 0) keyOn(opll, 8) ; else keyOff(opll, 8) ;
