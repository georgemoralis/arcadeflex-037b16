...
public class asteroid
{
	...
	public static Memory_ReadAddress llander_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x01ff, llander_zeropage_r ),
	...
	public static Memory_WriteAddress llander_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x01ff, llander_zeropage_w, &llander_zeropage ),
		new Memory_WriteAddress( 0x3000, 0x3000, avgdvg_go_w ),
