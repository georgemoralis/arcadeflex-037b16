...
public class seicross
{
	...
	public static IO_ReadPort readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x04, 0x04, AY8910_read_port_0_r ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_friskyt = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ftom.11",      0x0000, 0x1000, 0x1ec6ff65 );	ROM_LOAD( "ftom.12",      0x1000, 0x1000, 0x3b8f40b5 );	ROM_LOAD( "ftom.09",      0x2000, 0x1000, 0x60642f25 );	ROM_LOAD( "ftom.10",      0x3000, 0x1000, 0x07b9dcfc );
		ROM_REGION( 0x0040, REGION_PROMS, 0 );	ROM_LOAD( "ft.9c",        0x0000, 0x0020, 0x0032167e );	ROM_LOAD( "ft.9b",        0x0020, 0x0020, 0x6b364e69 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_radrad = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "11.l7",        0x0000, 0x1000, 0x4ace7afb );	ROM_LOAD( "12.n7",        0x1000, 0x1000, 0xb19b8473 );	ROM_LOAD( "9.j7",         0x2000, 0x1000, 0x229939a3 );	ROM_LOAD( "10.j7",        0x3000, 0x1000, 0x79237913 );
		ROM_REGION( 0x0040, REGION_PROMS, 0 );	ROM_LOAD( "clr.9c",       0x0000, 0x0020, 0xc9d88422 );	ROM_LOAD( "clr.9b",       0x0020, 0x0020, 0xee81af16 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_seicross = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "sz11.7k",      0x0000, 0x1000, 0xfbd9b91d );	ROM_LOAD( "smcd",         0x1000, 0x1000, 0xc3c953c4 );	ROM_LOAD( "sz9.7j",       0x2000, 0x1000, 0x4819f0cd );	ROM_LOAD( "sz10.7h",      0x3000, 0x1000, 0x4c268778 );
		ROM_REGION( 0x0040, REGION_PROMS, 0 );	ROM_LOAD( "sz73.10c",     0x0000, 0x0020, 0x4d218a3c );	ROM_LOAD( "sz74.10b",     0x0020, 0x0020, 0xc550531c );ROM_END(); }}; 
	...
	static RomLoadPtr rom_sectrzon = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "sz11.7k",      0x0000, 0x1000, 0xfbd9b91d );	ROM_LOAD( "sz12.7m",      0x1000, 0x1000, 0x2bdef9ad );	ROM_LOAD( "sz9.7j",       0x2000, 0x1000, 0x4819f0cd );	ROM_LOAD( "sz10.7h",      0x3000, 0x1000, 0x4c268778 );
		ROM_REGION( 0x0040, REGION_PROMS, 0 );	ROM_LOAD( "sz73.10c",     0x0000, 0x0020, 0x4d218a3c );	ROM_LOAD( "sz74.10b",     0x0020, 0x0020, 0xc550531c );ROM_END(); }}; 
