...
public class mcr1
{
	...
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x1c, 0x1f, ssio_data_w ),
	...
	static RomLoadPtr rom_solarfox = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x02000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "sfcpu.4g",     0x0000, 0x1000, 0xba019a60 );	ROM_LOAD( "sfcpu.5g",     0x1000, 0x1000, 0x7ff0364e );
		ROM_REGION( 0x08000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "sfvid.1a",     0x0000, 0x2000, 0x9d9b5d7e );	ROM_LOAD( "sfvid.1b",     0x2000, 0x2000, 0x78801e83 );	ROM_LOAD( "sfvid.1d",     0x4000, 0x2000, 0x4d8445cf );	ROM_LOAD( "sfvid.1e",     0x6000, 0x2000, 0x3da25495 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_kick = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x02000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1800g-v2.g4",  0x0000, 0x1000, 0xb4d120f3 );	ROM_LOAD( "1900h-v2.g5",  0x1000, 0x1000, 0xc3ba4893 );
		ROM_REGION( 0x08000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "2600a-v2.1e",  0x0000, 0x2000, 0x2c5d6b55 );	ROM_LOAD( "2700b-v2.1d",  0x2000, 0x2000, 0x565ea97d );	ROM_LOAD( "2800c-v2.1b",  0x4000, 0x2000, 0xf3be56a1 );	ROM_LOAD( "2900d-v2.1a",  0x6000, 0x2000, 0x77da795e );ROM_END(); }}; 
	...
	static RomLoadPtr rom_kicka = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "4200-a.a7",    0x0000, 0x1000, 0x9e35c02e );	ROM_LOAD( "4300-b.a8",    0x1000, 0x1000, 0xca2b7c28 );	ROM_LOAD( "4400-c.a9",    0x2000, 0x1000, 0xd1901551 );	ROM_LOAD( "4500-d.a10",   0x3000, 0x1000, 0xd36ddcdc );
		ROM_REGION( 0x02000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1000-g.g4",    0x0000, 0x1000, 0xacdae4f6 );	ROM_LOAD( "1100-h.g5",    0x1000, 0x1000, 0xdbb18c96 );
		ROM_REGION( 0x08000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "2600-a.1e",    0x0000, 0x2000, 0x74b409d7 );	ROM_LOAD( "2700-b.1d",    0x2000, 0x2000, 0x78eda36c );	ROM_LOAD( "2800-c.1b",    0x4000, 0x2000, 0xc93e0170 );	ROM_LOAD( "2900-d.1a",    0x6000, 0x2000, 0x91e59383 );ROM_END(); }}; 
