...
public class snowbros
{
	...
	public static IO_ReadPort sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x02, 0x02, YM3812_status_port_0_r ),
		new IO_ReadPort( 0x04, 0x04, soundlatch_r ),
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	public static IO_WritePort sound_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x02, 0x02, YM3812_control_port_0_w ),
	...
	/* Better to implement a coin mode 1-2 stuff later */
		...
		PORT_DIPSETTING(    0x00, "2C/3C 4C/1C" );	PORT_DIPSETTING(    0x20, "1C/2C 2C/1C" );	PORT_DIPNAME( 0xc0, 0xc0, "Coin B America/Europe" );	PORT_DIPSETTING(    0x40, "2C/1C 1C/4C" );	PORT_DIPSETTING(    0xc0, "1C/1C 1C/2C" );	PORT_DIPSETTING(    0x00, "2C/3C 1C/6C" );	PORT_DIPSETTING(    0x80, "1C/2C 1C/3C" );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x8000, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* Must be low or game stops! */
	                                               /* probably VBlank */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_snowbros = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ch0",          0x00000, 0x20000, 0x36d84dfe );	ROM_LOAD( "ch1",          0x20000, 0x20000, 0x76347256 );	ROM_LOAD( "ch2",          0x40000, 0x20000, 0xfdaa634c );	ROM_LOAD( "ch3",          0x60000, 0x20000, 0x34024aef );ROM_END(); }}; 
	...
	static RomLoadPtr rom_snowbroj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for z80 sound code */
		ROM_LOAD( "snowbros.4",   0x0000, 0x8000, 0xe6eab4e4 );
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	/* The gfx ROM (snowbros.1) was bad, I'm using the ones from the other sets. */
	...
	static RomLoadPtr rom_wintbob = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	/* probably identical data to Snow Bros, in a different format */
