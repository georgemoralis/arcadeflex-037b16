...
public class _1943
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_1943 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x8000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1943.04",      0x00000, 0x8000, 0x46cb9d3d );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "1943.15",      0x00000, 0x8000, 0x6b1a0443 );/* bg tiles */
		...
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "1943.24",      0x00000, 0x8000, 0x11134036 );/* fg tiles */
		ROM_LOAD( "1943.25",      0x08000, 0x8000, 0x092cf9c1 );
		ROM_REGION( 0x40000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "1943.06",      0x00000, 0x8000, 0x97acc8af );/* sprites */
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "bmprom.01",    0x0000, 0x0100, 0x74421f18 );/* red component */
	...
	static RomLoadPtr rom_1943kai = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x8000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1943kai.04",   0x00000, 0x8000, 0x884a8692 );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "1943kai.15",   0x00000, 0x8000, 0x6b1a0443 );/* bg tiles */
		...
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "1943kai.24",   0x00000, 0x8000, 0xbf186ef2 );/* fg tiles */
		ROM_LOAD( "1943kai.25",   0x08000, 0x8000, 0xa755faf1 );
		ROM_REGION( 0x40000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "1943kai.06",   0x00000, 0x8000, 0x5f7e38b3 );/* sprites */
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "bmk01.bin",    0x0000, 0x0100, 0xe001ea33 );/* red component */
