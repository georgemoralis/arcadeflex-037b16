...
public class wgp
{
	...
	***********************************************************/
	...
	static InputPortPtr input_ports_wgp = new InputPortPtr(){ public void handler() { 	/* Wgp2 has no "lumps" ? */
		...
		PORT_DIPSETTING(    0x03, "Normal" );	PORT_DIPSETTING(    0x02, "Easy" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x04, 0x04, "Shift Pattern Select" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		...
		PORT_BIT( 0x08, IP_ACTIVE_LOW,  IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW,  IPT_UNKNOWN );
		PORT_START();       /* IN1 */
		...
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_4WAY | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_4WAY | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_4WAY | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_4WAY | IPF_PLAYER1 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER1 );/* accel */
	...
	//	PORT_ANALOG( 0xff, 0xff, IPT_AD_STICK_X | IPF_PLAYER2, 10, 5, 0xcf, 0xff);
		PORT_START(); 	/* unknown */
		PORT_ANALOG( 0xff, 0x00, IPT_AD_STICK_Y | IPF_PLAYER2, 20, 10, 0, 0xff);INPUT_PORTS_END(); }}; 
	...
	PORT_START();  /* DSW A */
		...
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW,  IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW,  IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW,  IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW,  IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW,  IPT_UNKNOWN );//	PORT_BIT( 0x01, IP_ACTIVE_LOW,  IPT_BUTTON3 | IPF_PLAYER1 );// freeze
	
		PORT_START();       /* IN1, is it read? */
		PORT_BIT( 0x01, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW,  IPT_UNKNOWN );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
	...
	***********************************************************/
	...
	static MachineDriver machine_driver_wgp = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_M68000,
				12000000,	/* 12 MHz ??? */
				wgp_readmem,wgp_writemem,null,null,
				wgp_interrupt, 1
			),
			new MachineCPU(																			\
			...
			new MachineCPU(
				CPU_M68000,
				12000000,	/* 12 MHz ??? */
				wgp_cpub_readmem,wgp_cpub_writemem,null,null,
	...
	static MachineDriver machine_driver_wgp2 = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_M68000,
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_wgp = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "c32-24.34",   0x00000, 0x04000, 0xe9adb447 );	ROM_CONTINUE(            0x10000, 0x0c000 );/* banked stuff */
	
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "c32-09.16", 0x00000, 0x80000, 0x96495f35 );/* SCR */
	
		ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD32_BYTE( "c32-04.9",  0x000000, 0x80000, 0x473a19c9 )	/* PIV */
		...
		ROM_REGION( 0x200000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "c32-05.71", 0x000000, 0x80000, 0x3698d47a )	/* OBJ */
	...
	//	Pals (not dumped)
	//	ROM_LOAD( "c32-18.64", 0x00000, 0x00???, 0x00000000 );//	ROM_LOAD( "c32-19.27", 0x00000, 0x00???, 0x00000000 );//	ROM_LOAD( "c32-20.67", 0x00000, 0x00???, 0x00000000 );//	ROM_LOAD( "c32-21.85", 0x00000, 0x00???, 0x00000000 );//	ROM_LOAD( "c32-22.24", 0x00000, 0x00???, 0x00000000 );//	ROM_LOAD( "c32-23.13", 0x00000, 0x00???, 0x00000000 );
	//	Pals on lan interface board
	//	ROM_LOAD( "c32-34", 0x00000, 0x00???, 0x00000000 );//	ROM_LOAD( "c32-35", 0x00000, 0x00???, 0x00000000 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_wgpj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "c32-11.8", 0x00000, 0x80000, 0x2b326ff0 );
		ROM_REGION( 0x80000, REGION_SOUND2, 0 );/* Delta-T samples */
		ROM_LOAD( "c32-12.7", 0x00000, 0x80000, 0xdf48a37b );ROM_END(); }}; 
	...
	static RomLoadPtr rom_wgpjoy = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1c000, REGION_CPU2, 0 );/* Z80 sound cpu */
		ROM_LOAD( "c32-61.34",   0x00000, 0x04000, 0x2fcad5a3 );	ROM_CONTINUE(            0x10000, 0x0c000 );/* banked stuff */
	...
	static RomLoadPtr rom_wgp2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1c000, REGION_CPU2, 0 );/* Z80 sound cpu */
		ROM_LOAD( "c73-05.34",   0x00000, 0x04000, 0x7e00a299 );	ROM_CONTINUE(            0x10000, 0x0c000 );/* banked stuff */
	...
	//	ROM_LOAD( "c73-06", 0x00000, 0x00???, 0x00000000 );ROM_END(); }}; 
	...
	public static GameDriver driver_wgp2	   = new GameDriver("1990"	,"wgp2"	,"wgp.java"	,rom_wgp2,driver_wgp	,machine_driver_wgp2	,input_ports_wgp	,init_wgp2	,ROT0	,	"Taito Corporation", "World Grand Prix 2 (Japan)", GAME_NOT_WORKING |GAME_IMPERFECT_GRAPHICS )
