...
public class ajax
{
	...
	public static Memory_ReadAddress ajax_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x01c0, ajax_ls138_f10_r ),			/* inputs + DIPSW */
	...
	public static Memory_WriteAddress ajax_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x01c0, ajax_ls138_f10_w ),			/* bankswitch + sound command + FIRQ command */
	...
	public static Memory_ReadAddress ajax_readmem_2[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x07ff, K051316_0_r ),		/* 051316 zoom/rotation layer */
	...
	public static Memory_WriteAddress ajax_writemem_2[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x07ff, K051316_0_w ),			/* 051316 zoom/rotation layer */
	...
	public static Memory_ReadAddress ajax_readmem_sound[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x7fff, MRA_ROM ),				/* ROM F6 */
	...
	public static Memory_WriteAddress ajax_writemem_sound[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x7fff, MWA_ROM ),					/* ROM F6 */
	...
	*/
	...
	static RomLoadPtr rom_ajax = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	ROM_LOAD( "63s241.j11",	0x0000, 0x0200, 0x9bdd719f );/* priority encoder (not used) */
