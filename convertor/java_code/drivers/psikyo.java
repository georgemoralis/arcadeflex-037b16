...
public class psikyo
{
	...
	***************************************************************************/
	...
	public static IO_ReadPort gunbird_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x04, 0x04, YM2610_status_port_0_A_r		),
	...
	public static IO_WritePort gunbird_sound_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, gunbird_sound_bankswitch_w	),
	...
	***************************************************************************/
	...
	public static Memory_ReadAddress sngkace_sound_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x77ff, MRA_ROM		),	// ROM
	...
	public static Memory_WriteAddress sngkace_sound_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x77ff, MWA_ROM		),	// ROM
	...
	***************************************************************************/
	...
	public static IO_ReadPort s1945_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x08, 0x08, YM2610_status_port_0_A_r		),
	//	new IO_ReadPort( 0x06, 0x06, YM2610_status_port_0_B_r		),
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_btlkrodj = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT( 0x0040, IP_ACTIVE_LOW,  IPT_TILT     );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_SPECIAL  );// From Sound CPU
	
		PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_UNKNOWN               );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON6 | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON5 | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN               );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON6 | IPF_PLAYER1 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON5 | IPF_PLAYER1 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );
		...
		PORT_DIPSETTING(      0x0008, "Easy" );	PORT_DIPSETTING(      0x000c, "Normal" );	PORT_DIPSETTING(      0x0004, "Hard" );	PORT_DIPSETTING(      0x0000, "Hardest" );	PORT_DIPNAME( 0x0010, 0x0010, "Unknown 2-4" );// used
		...
		PORT_DIPSETTING(      0x0000, "Psikyo" );//	PORT_DIPSETTING(      0x000d, "Psikyo" );//	PORT_DIPSETTING(      0x000b, "Psikyo" );//	PORT_DIPSETTING(      0x0009, "Psikyo" );//	PORT_DIPSETTING(      0x0008, "Psikyo" );//	PORT_DIPSETTING(      0x0007, "Psikyo" );//	PORT_DIPSETTING(      0x0005, "Psikyo" );//	PORT_DIPSETTING(      0x0004, "Psikyo" );//	PORT_DIPSETTING(      0x0003, "Psikyo" );//	PORT_DIPSETTING(      0x0002, "Psikyo" );//	PORT_DIPSETTING(      0x0001, "Psikyo" );
		PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_VBLANK  );// vblank
		...
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0400, 0x0400, "Unknown 3-2" );	PORT_DIPSETTING(      0x0400, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0800, 0x0800, "Unknown 3-3" );	PORT_DIPSETTING(      0x0800, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x1000, 0x1000, "Unknown 3-4" );// tested!
		PORT_DIPSETTING(      0x1000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x2000, 0x2000, "Unknown 3-5" );	PORT_DIPSETTING(      0x2000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x4000, 0x4000, "Unknown 3-6" );	PORT_DIPSETTING(      0x4000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_btlkrodj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x030000, REGION_CPU2, 0 );	/* Sound CPU Code */
		ROM_LOAD( "3-u71.bin", 0x00000, 0x20000, 0x22411fab );	ROM_RELOAD(            0x10000, 0x20000             );
		ROM_REGION( 0x700000, REGION_GFX1, ROMREGION_DISPOSE );/* Sprites */
		ROM_LOAD( "u14.bin",  0x000000, 0x200000, 0x282d89c3 );	ROM_LOAD( "u24.bin",  0x200000, 0x200000, 0xbbe9d3d1 );	ROM_LOAD( "u15.bin",  0x400000, 0x200000, 0xd4d1b07c );//	ROM_LOAD( "u25.bin",  0x600000, 0x100000	NOT PRESENT
	
		ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE );/* Layer 0 */
		ROM_LOAD( "u33.bin",  0x000000, 0x200000, 0x4c8577f1 );
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );/* Layer 1 */
		ROM_LOAD( "u33.bin",  0x000000, 0x100000, 0x4c8577f1 );	ROM_CONTINUE(         0x000000, 0x100000             );
		ROM_REGION( 0x080000, REGION_SOUND1, ROMREGION_SOUNDONLY );/* DELTA-T Samples */
	...
	***************************************************************************/
	...
	public static GameDriver driver_btlkrodj	   = new GameDriver("1994"	,"btlkrodj"	,"psikyo.java"	,rom_btlkrodj,null	,machine_driver_gunbird	,input_ports_btlkrodj	,init_gunbird	,ROT0_16BIT	,	"Psikyo", "Battle K-Road (Japan)" )
