...
public class hcastle
{
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x0007, hcastle_pf1_control_w ),
	...
	static RomLoadPtr rom_hcastle = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1, 0 );	ROM_LOAD( "768.k03",      0x08000, 0x08000, 0x40ce4f38 );	ROM_LOAD( "768.g06",      0x10000, 0x20000, 0xcdade920 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "768.e01",      0x00000, 0x08000, 0xb9fff184 );
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "d95.g21",      0x000000, 0x80000, 0xe3be3fdd );	ROM_LOAD( "d94.g19",      0x080000, 0x80000, 0x9633db8b );
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "d91.j5",       0x000000, 0x80000, 0x2960680e );	ROM_LOAD( "d92.j6",       0x080000, 0x80000, 0x65a2f227 );
		ROM_REGION( 0x0500, REGION_PROMS, 0 );	ROM_LOAD( "768c13.j21",   0x0000, 0x0100, 0xf5de80cb );/* 007121 #0 sprite lookup table */
	...
	static RomLoadPtr rom_hcastlea = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1, 0 );	ROM_LOAD( "m03.k12",      0x08000, 0x08000, 0xd85e743d );	ROM_LOAD( "b06.k8",       0x10000, 0x20000, 0xabd07866 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "768.e01",      0x00000, 0x08000, 0xb9fff184 );
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "d95.g21",      0x000000, 0x80000, 0xe3be3fdd );	ROM_LOAD( "d94.g19",      0x080000, 0x80000, 0x9633db8b );
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "d91.j5",       0x000000, 0x80000, 0x2960680e );	ROM_LOAD( "d92.j6",       0x080000, 0x80000, 0x65a2f227 );
	...
	static RomLoadPtr rom_hcastlej = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1, 0 );	ROM_LOAD( "768p03.k12",0x08000, 0x08000, 0xd509e340 );	ROM_LOAD( "768j06.k8", 0x10000, 0x20000, 0x42283c3e );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "768.e01",   0x00000, 0x08000, 0xb9fff184 );
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "d95.g21",      0x000000, 0x80000, 0xe3be3fdd );	ROM_LOAD( "d94.g19",      0x080000, 0x80000, 0x9633db8b );
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "d91.j5",       0x000000, 0x80000, 0x2960680e );	ROM_LOAD( "d92.j6",       0x080000, 0x80000, 0x65a2f227 );
