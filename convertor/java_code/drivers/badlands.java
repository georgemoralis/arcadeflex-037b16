...
public class badlands
{
	...
	static RomLoadPtr rom_badlands = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x60000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1012.4n",  0x000000, 0x10000, 0x5d124c6c );/* playfield */
		...
		ROM_REGION( 0x30000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "1010.14r", 0x000000, 0x10000, 0xc15f629e );/* mo */
