...
public class system16
{
	...
	public static IO_ReadPort readport_7751[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( I8039_t1,  I8039_t1,  sys16_7751_sh_t1_r ),
	...
	public static IO_WritePort writeport_7751[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( I8039_p1, I8039_p1, sys16_7751_sh_dac_w ),
	...
	***************************************************************************/
	...
	//	ROM_RELOAD(             		   0x40000, 0x08000 );	ROM_LOAD16_BYTE( "epr10016.b2",  0x00000, 0x08000, 0xaf5dc72f )
	//	ROM_RELOAD(              		   0x40000, 0x08000 );	ROM_LOAD16_BYTE( "epr10013.c6",  0x10001, 0x08000, 0x9a0919c5 )
	...
	//	ROM_RELOAD(               			0x040000, 0x08000 );	ROM_LOAD16_BYTE( "7719.bin",  	0x000000, 0x08000, 0xfa5c5d6c )
	//	ROM_RELOAD(            		 		0x040000, 0x08000 );	ROM_LOAD16_BYTE( "epr10013.c6",	0x010001, 0x08000, 0x9a0919c5 )	/* 7716 */
...
PORT_START(); 	/* DSW1 */
	...
	static RomLoadPtr rom_shinobi = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x20000, REGION_CPU2, 0 );/* sound CPU */
		ROM_LOAD( "shinobi.a7", 0x00000, 0x8000, 0x2457a7cf );	ROM_LOAD( "shinobi.a8", 0x10000, 0x8000, 0xc8df8460 );	ROM_LOAD( "shinobi.a9", 0x18000, 0x8000, 0xe5a4cf30 );ROM_END(); }}; 
	...
	// Custom cpu 317-0049
		...
		ROM_REGION( 0x20000, REGION_CPU2, 0 );/* sound CPU */
		ROM_LOAD( "shinobi.a7", 0x00000, 0x8000, 0x2457a7cf );	ROM_LOAD( "shinobi.a8", 0x10000, 0x8000, 0xc8df8460 );	ROM_LOAD( "shinobi.a9", 0x18000, 0x8000, 0xe5a4cf30 );
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_tturfu = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x30000, REGION_CPU2, 0 );/* sound CPU */
		ROM_LOAD( "epr12271.bin", 0x00000,  0x8000, 0x99671e52 );	ROM_LOAD( "epr12272.bin", 0x10000, 0x8000, 0x7cf7e69f );	ROM_LOAD( "epr12273.bin", 0x18000, 0x8000, 0x28f0bb8b );	ROM_LOAD( "epr12274.bin", 0x20000, 0x8000, 0x8207f0c4 );	ROM_LOAD( "epr12275.bin", 0x28000, 0x8000, 0x182f3c3d );
	ROM_END(); }}; 
	...
	//	if (ACCESSING_MSB != 0) sound_command_w(offset,data>>8 );
	}
...
INPUT_PORTS_END(); }}; 
	...
	// cpu 317-5023
		...
		ROM_REGION( 0x30000, REGION_CPU2, 0 );/* sound CPU */
		ROM_LOAD( "13349",0x00000,0x08000, 0xb83183f8 );	ROM_LOAD( "13350",0x10000,0x20000, 0x3c59a658 );ROM_END(); }}; 
