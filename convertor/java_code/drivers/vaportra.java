...
public class vaportra
{
	...
	static RomLoadPtr rom_vaportra = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "vtmaa00.bin",   0x000000, 0x80000, 0x0330e13b );/* chars & tiles */
	
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );  	ROM_LOAD( "vtmaa01.bin",   0x000000, 0x80000, 0xc217a31b );/* tiles 2 */
		ROM_LOAD( "vtmaa02.bin",   0x080000, 0x80000, 0x091ff98e );/* tiles 3 */
	
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );  	ROM_LOAD( "vtmaa03.bin",   0x000000, 0x80000, 0x1a30bf81 );/* sprites */
