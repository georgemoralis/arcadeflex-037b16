...
public class xmen
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_xmen = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "065ubb04.10d",  0x00000, 0x20000, 0xf896c93b )
	...
	static RomLoadPtr rom_xmen6p = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "xmenb04.bin",   0x00000, 0x20000, 0x0f09b8e0 )
	...
	static RomLoadPtr rom_xmen2pj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "065jaa04.10d",  0x00000, 0x20000, 0x66746339 )
