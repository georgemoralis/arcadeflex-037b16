...
public class snk
{
	...
	*/
	...
	static RomLoadPtr rom_tnk3 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "7122.2",  0x000, 0x400, 0x34c06bc6 );	ROM_LOAD( "7122.1",  0x400, 0x400, 0x6d0ac66a );	ROM_LOAD( "7122.0",  0x800, 0x400, 0x4662b4c8 );
	...
	static RomLoadPtr rom_athena = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "up02_c2.rom",  0x000, 0x400, 0x294279ae );	ROM_LOAD( "up02_b1.rom",  0x400, 0x400, 0xd25c9099 );	ROM_LOAD( "up02_c1.rom",  0x800, 0x400, 0xa4a4e7dc );
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );/* characters */
	...
	static RomLoadPtr rom_fitegolf = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "82s137.2c",  0x00000, 0x00400, 0x6e4c7836 );	ROM_LOAD( "82s137.1b",  0x00400, 0x00400, 0x29e7986f );	ROM_LOAD( "82s137.1c",  0x00800, 0x00400, 0x27ba9ff9 );
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );/* characters */
	...
	static RomLoadPtr rom_ikari = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "7122er.prm",  0x000, 0x400, 0xb9bf2c2c );	ROM_LOAD( "7122eg.prm",  0x400, 0x400, 0x0703a770 );	ROM_LOAD( "7122eb.prm",  0x800, 0x400, 0x0a11cdde );
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );/* characters */
	...
	static RomLoadPtr rom_victroad = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "mb7122e.1k", 0x000, 0x400, 0x491ab831 );	ROM_LOAD( "mb7122e.2l", 0x400, 0x400, 0x8feca424 );	ROM_LOAD( "mb7122e.1l", 0x800, 0x400, 0x220076ca );
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );/* characters */
		...
		ROM_REGION( 0x20000, REGION_SOUND1, 0 );	ROM_LOAD( "p4",  0x00000, 0x10000, 0xe10fb8cc );	ROM_LOAD( "p5",  0x10000, 0x10000, 0x93e5f110 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_dogosoke = new RomLoadPtr(){ public void handler(){  /* Victory Road Japan */
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "up03_k1.rom",  0x000, 0x400, 0x10a2ce2b );	ROM_LOAD( "up03_l2.rom",  0x400, 0x400, 0x99dc9792 );	ROM_LOAD( "up03_l1.rom",  0x800, 0x400, 0xe7213160 );
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );/* characters */
		...
		ROM_REGION( 0x30000, REGION_GFX4, ROMREGION_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "p11", 0x00000, 0x8000, 0x668b25a4 );	ROM_LOAD( "p14", 0x08000, 0x8000, 0xa7031d4a );	ROM_LOAD( "p12", 0x10000, 0x8000, 0xf44e95fa );	ROM_LOAD( "p15", 0x18000, 0x8000, 0x120d2450 );	ROM_LOAD( "p13", 0x20000, 0x8000, 0x980ca3d8 );	ROM_LOAD( "p16", 0x28000, 0x8000, 0x9f820e8a );
		ROM_REGION( 0x20000, REGION_SOUND1, 0 );	ROM_LOAD( "up03_f5.rom", 0x00000, 0x10000, 0x5b43fe9f );	ROM_LOAD( "up03_g5.rom", 0x10000, 0x10000, 0xaae30cd6 );ROM_END(); }}; 
	
	/***********************************************************************/
	
	static RomLoadPtr rom_gwar = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );	ROM_LOAD( "7g",  0x00000, 0x10000, 0x5bcfa7dc );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "g02",  0x00000, 0x10000, 0x86d931bf );
		ROM_REGION( 0x10000, REGION_CPU3, 0 );	ROM_LOAD( "g03",  0x00000, 0x10000, 0xeb544ab9 );
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "guprom.3", 0x000, 0x400, 0x090236a3 );/* red */
		ROM_LOAD( "guprom.2", 0x400, 0x400, 0x9147de69 );/* green */
		ROM_LOAD( "guprom.1", 0x800, 0x400, 0x7f9c839e );/* blue */
	
		ROM_REGION( 0x8000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "g05",  0x0000, 0x08000, 0x80f73e2e );
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "g06",  0x00000, 0x10000, 0xf1dcdaef );	ROM_LOAD( "g07",  0x10000, 0x10000, 0x326e4e5e );	ROM_LOAD( "g08",  0x20000, 0x10000, 0x0aa70967 );	ROM_LOAD( "g09",  0x30000, 0x10000, 0xb7686336 );
		ROM_REGION( 0x40000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "g10",  0x00000, 0x10000, 0x58600f7d );	ROM_LOAD( "g11",  0x10000, 0x10000, 0xa3f9b463 );	ROM_LOAD( "g12",  0x20000, 0x10000, 0x092501be );	ROM_LOAD( "g13",  0x30000, 0x10000, 0x25801ea6 );
		ROM_REGION( 0x80000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "g20",  0x00000, 0x10000, 0x2b46edff );	ROM_LOAD( "g21",  0x10000, 0x10000, 0xbe19888d );	ROM_LOAD( "g18",  0x20000, 0x10000, 0x2d653f0c );	ROM_LOAD( "g19",  0x30000, 0x10000, 0xebbf3ba2 );	ROM_LOAD( "g16",  0x40000, 0x10000, 0xaeb3707f );	ROM_LOAD( "g17",  0x50000, 0x10000, 0x0808f95f );	ROM_LOAD( "g14",  0x60000, 0x10000, 0x8dfc7b87 );	ROM_LOAD( "g15",  0x70000, 0x10000, 0x06822aac );
		ROM_REGION( 0x10000, REGION_SOUND1, 0 );	ROM_LOAD( "g04",  0x00000, 0x10000, 0x2255f8dd );ROM_END(); }}; 
	
	static RomLoadPtr rom_gwara = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );	ROM_LOAD( "gv3",  0x00000, 0x10000, 0x24936d83 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "gv4",  0x00000, 0x10000, 0x26335a55 );
		ROM_REGION( 0x10000, REGION_CPU3, 0 );	ROM_LOAD( "gv2",  0x00000, 0x10000, 0x896682dd );
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "guprom.3", 0x000, 0x400, 0x090236a3 );/* red */
		ROM_LOAD( "guprom.2", 0x400, 0x400, 0x9147de69 );/* green */
		ROM_LOAD( "guprom.1", 0x800, 0x400, 0x7f9c839e );/* blue */
	...
	static RomLoadPtr rom_gwarj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );	ROM_LOAD( "7y3047",  0x00000, 0x10000, 0x7f8a880c );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "g02",  0x00000, 0x10000, 0x86d931bf );
		ROM_REGION( 0x10000, REGION_CPU3, 0 );	ROM_LOAD( "g03",  0x00000, 0x10000, 0xeb544ab9 );
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "guprom.3", 0x000, 0x400, 0x090236a3 );/* red */
		ROM_LOAD( "guprom.2", 0x400, 0x400, 0x9147de69 );/* green */
		...
		ROM_REGION( 0x8000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "792001",  0x0000, 0x08000, 0x99d7ddf3 );
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "g06",  0x00000, 0x10000, 0xf1dcdaef );	ROM_LOAD( "g07",  0x10000, 0x10000, 0x326e4e5e );	ROM_LOAD( "g08",  0x20000, 0x10000, 0x0aa70967 );	ROM_LOAD( "g09",  0x30000, 0x10000, 0xb7686336 );
		ROM_REGION( 0x40000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "g10",  0x00000, 0x10000, 0x58600f7d );	ROM_LOAD( "g11",  0x10000, 0x10000, 0xa3f9b463 );	ROM_LOAD( "g12",  0x20000, 0x10000, 0x092501be );	ROM_LOAD( "g13",  0x30000, 0x10000, 0x25801ea6 );
		ROM_REGION( 0x80000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "g20",  0x00000, 0x10000, 0x2b46edff );	ROM_LOAD( "g21",  0x10000, 0x10000, 0xbe19888d );	ROM_LOAD( "g18",  0x20000, 0x10000, 0x2d653f0c );	ROM_LOAD( "g19",  0x30000, 0x10000, 0xebbf3ba2 );	ROM_LOAD( "g16",  0x40000, 0x10000, 0xaeb3707f );	ROM_LOAD( "g17",  0x50000, 0x10000, 0x0808f95f );	ROM_LOAD( "g14",  0x60000, 0x10000, 0x8dfc7b87 );	ROM_LOAD( "g15",  0x70000, 0x10000, 0x06822aac );
		ROM_REGION( 0x10000, REGION_SOUND1, 0 );	ROM_LOAD( "g04",  0x00000, 0x10000, 0x2255f8dd );ROM_END(); }}; 
	...
	static RomLoadPtr rom_gwarb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "guprom.3", 0x000, 0x400, 0x090236a3 );/* red */ // up03_k1.rom
	...
	static RomLoadPtr rom_bermudat = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1400, REGION_PROMS, 0 );	ROM_LOAD( "btj_01r.prm", 0x0000, 0x0400, 0xf4b54d06 );/* red */
		...
		ROM_REGION( 0x20000, REGION_SOUND1, 0 );	ROM_LOAD( "bt_p4.rom",  0x00000, 0x10000, 0x4bc83229 );	ROM_LOAD( "bt_p5.rom",  0x10000, 0x10000, 0x817bd62c );ROM_END(); }}; 
	...
	static RomLoadPtr rom_bermudaj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX4, ROMREGION_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "bt_p11.rom",  0x00000, 0x10000, 0xaae7410e );	ROM_LOAD( "bt_p12.rom",  0x10000, 0x10000, 0x18914f70 );	ROM_LOAD( "bt_p13.rom",  0x20000, 0x10000, 0xcd79ce81 );	ROM_LOAD( "bt_p14.rom",  0x30000, 0x10000, 0xedc57117 );	ROM_LOAD( "bt_p15.rom",  0x40000, 0x10000, 0x448bf9f4 );	ROM_LOAD( "bt_p16.rom",  0x50000, 0x10000, 0x119999eb );	ROM_LOAD( "bt_p17.rom",  0x60000, 0x10000, 0xb5462139 );	ROM_LOAD( "bt_p18.rom",  0x70000, 0x10000, 0xcb416227 );
		ROM_REGION( 0x20000, REGION_SOUND1, 0 );	ROM_LOAD( "btj_p04.bin", 0x00000, 0x10000, 0xb2e01129 );	ROM_LOAD( "btj_p05.bin", 0x10000, 0x10000, 0x924c24f7 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_worldwar = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1400, REGION_PROMS, 0 );	ROM_LOAD( "ww_r.bin",    0x0000, 0x0400, 0xb88e95f0 );/* red */
	...
	static RomLoadPtr rom_bermudaa = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1400, REGION_PROMS, 0 );	ROM_LOAD( "mb7122e.1k",  0x0000, 0x0400, 0x1e8fc4c3 );/* red */
	...
	static RomLoadPtr rom_psychos = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1400, REGION_PROMS, 0 );	ROM_LOAD( "up03_k1.rom",  0x00000, 0x00400, 0x27b8ca8c );/* red */
		...
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );	ROM_LOAD( "p1",  0x00000, 0x10000, 0x58f1683f );	ROM_LOAD( "p2",  0x10000, 0x10000, 0xda3abda1 );	ROM_LOAD( "p3",  0x20000, 0x10000, 0xf3683ae8 );	ROM_LOAD( "p4",  0x30000, 0x10000, 0x437d775a );ROM_END(); }}; 
	...
	static RomLoadPtr rom_psychosj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX4, ROMREGION_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "up01_f10.rom",  0x00000, 0x10000, 0x2bac250e );	ROM_LOAD( "up01_h10.rom",  0x10000, 0x10000, 0x5e1ba353 );	ROM_LOAD( "up01_j10.rom",  0x20000, 0x10000, 0x9ff91a97 );	ROM_LOAD( "up01_l10.rom",  0x30000, 0x10000, 0xae1965ef );	ROM_LOAD( "up01_m10.rom",  0x40000, 0x10000, 0xdf283b67 );	ROM_LOAD( "up01_n10.rom",  0x50000, 0x10000, 0x914f051f );	ROM_LOAD( "up01_r10.rom",  0x60000, 0x10000, 0xc4488472 );	ROM_LOAD( "up01_s10.rom",  0x70000, 0x10000, 0x8ec7fe18 );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );	ROM_LOAD( "up03_b5.rom",  0x00000, 0x10000, 0x0f8e8276 );	ROM_LOAD( "up03_c5.rom",  0x10000, 0x10000, 0x34e41dfb );	ROM_LOAD( "up03_d5.rom",  0x20000, 0x10000, 0xaa583c5e );	ROM_LOAD( "up03_f5.rom",  0x30000, 0x10000, 0x7e8bce7a );ROM_END(); }}; 
	...
	static RomLoadPtr rom_chopper = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "up03_k1.rom",  0x0000, 0x0400, 0x7f07a45c );/* red */
		...
		ROM_REGION( 0x10000, REGION_SOUND1, 0 );	ROM_LOAD( "kk_02.rom",  0x00000, 0x10000, 0x06169ae0 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_ftsoccer = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "prom2.bin", 0x000, 0x400, 0xbf4ac706 );/* red */
	...
	//	ROM_REGION( 0x40000, REGION_GFX3, ROMREGION_DISPOSE );/* 16x16 sprites */
		...
		ROM_REGION( 0x10000, REGION_SOUND1, 0 );	ROM_LOAD( "ft-004.bin",  0x00000, 0x10000, 0x435c3716 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_tdfever = new RomLoadPtr(){ public void handler(){  /* USA set */
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "up03_e8.rom",  0x000, 0x00400, 0x67bdf8a0 );	ROM_LOAD( "up03_d8.rom",  0x400, 0x00400, 0x9c4a9198 );	ROM_LOAD( "up03_e9.rom",  0x800, 0x00400, 0xc93c18e8 );
		ROM_REGION( 0x8000, REGION_GFX1, ROMREGION_DISPOSE );/* characters */
		...
		ROM_REGION( 0x20000, REGION_SOUND1, 0 );	ROM_LOAD( "up02_n6.rom",  0x00000, 0x10000, 0x155e472e );	ROM_LOAD( "up02_p6.rom",  0x10000, 0x10000, 0x04794557 );ROM_END(); }}; 
	...
	PORT_START(); 
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, "Bonus Occurrence" );	PORT_DIPSETTING(    0x04, "1st & 2nd only" );	PORT_DIPSETTING(    0x00, "1st & every 2nd" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x08, "3" );	PORT_DIPSETTING(    0x00, "5" );	SNK_COINAGE
		...
		PORT_DIPSETTING(    0x30, "30k 60k" );	PORT_DIPSETTING(    0x20, "40k 80k" );	PORT_DIPSETTING(    0x10, "50k 100k" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x40 ,0x40, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
