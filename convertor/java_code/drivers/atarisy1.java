...
public class atarisy1
{
	...
	static RomLoadPtr rom_marble = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "136032.107",   0x00000, 0x02000, 0x7a29dc07 ); /* alpha font */
	
		ROM_REGION( 0x60000, REGION_GFX2, ROMREGION_DISPOSE | ROMREGION_INVERT );	ROM_LOAD( "136033.137",   0x00000, 0x04000, 0x7a45f5c1 ); /* bank 1, plane 0 */
	...
	static RomLoadPtr rom_peterpak = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x90000, REGION_GFX2, ROMREGION_DISPOSE | ROMREGION_INVERT );	ROM_LOAD( "136028.138",   0x00000, 0x08000, 0x53eaa018 ); /* bank 1, plane 0 */
	...
	static RomLoadPtr rom_indytemp = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0xc0000, REGION_GFX2, ROMREGION_DISPOSE | ROMREGION_INVERT );	ROM_LOAD( "136036.135",   0x00000, 0x08000, 0xffa8749c ); /* bank 1, plane 0 */
	...
	static RomLoadPtr rom_roadrunn = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE | ROMREGION_INVERT );	ROM_LOAD( "136040.101",   0x00000, 0x08000, 0x26d9f29c ); /* bank 1, plane 0 */
	...
	static RomLoadPtr rom_roadblst = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_CONTINUE(                    0x50000, 0x08000 );	ROM_LOAD16_BYTE( "048-1140.rom", 0x10001, 0x08000, 0x6305429b )
		ROM_CONTINUE(                    0x50001, 0x08000 );	ROM_LOAD16_BYTE( "048-1155.rom", 0x20000, 0x08000, 0xe95fc7d2 )
		ROM_CONTINUE(                    0x60000, 0x08000 );	ROM_LOAD16_BYTE( "048-1156.rom", 0x20001, 0x08000, 0x727510f9 )
		ROM_CONTINUE(                    0x60001, 0x08000 );	ROM_LOAD16_BYTE( "048-1167.rom", 0x70000, 0x08000, 0xc6d30d6f )
		...
		ROM_REGION( 0x120000, REGION_GFX2, ROMREGION_DISPOSE | ROMREGION_INVERT );	ROM_LOAD( "048-1101.rom", 0x000000, 0x08000, 0xfe342d27 ); /* bank 1, plane 0 */
