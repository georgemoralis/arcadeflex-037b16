...
public class ninjakid
{
	...
	*******************************************************************************/
	...
	static RomLoadPtr rom_ninjakun = new RomLoadPtr(){ public void handler(){  /* Original Board? */
		...
		ROM_LOAD( "ninja-1.7a",  0x0000, 0x02000, 0x1c1dc141 );	ROM_LOAD( "ninja-2.7b",  0x2000, 0x02000, 0x39cc7d37 );	ROM_LOAD( "ninja-3.7d",  0x4000, 0x02000, 0xd542bfe3 );	ROM_LOAD( "ninja-4.7e",  0x6000, 0x02000, 0xa57385c6 );
	...
	*******************************************************************************/
	...
	PORT_START(); 	/* 0xa000 */
		...
		PORT_BIT( 0x02, IP_ACTIVE_LOW,	IPT_JOYSTICK_RIGHT| IPF_2WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW,	IPT_BUTTON2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW,	IPT_BUTTON1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW,	IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW,	IPT_START1  );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 	/* 0xa001 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW,	IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_COCKTAIL);/* "YPOS1" */
		PORT_BIT( 0x02, IP_ACTIVE_LOW,	IPT_JOYSTICK_RIGHT| IPF_2WAY | IPF_COCKTAIL);	PORT_BIT( 0x04, IP_ACTIVE_LOW,	IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW,	IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW,	IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW,	IPT_START2  );	PORT_SERVICE( 0x40, IP_ACTIVE_HIGH );\
		...
		PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x04, "3" );	PORT_DIPSETTING(    0x06, "4" );	PORT_DIPSETTING(    0x00, "5" );	PORT_DIPNAME( 0x08, 0x08, "First Bonus" );	PORT_DIPSETTING(    0x08, "30000" );	PORT_DIPSETTING(    0x00, "40000" );	PORT_DIPNAME( 0x30, 0x30, "Second Bonus" );	PORT_DIPSETTING(    0x00, "No Bonus" );	PORT_DIPSETTING(    0x10, "Every 30000" );	PORT_DIPSETTING(    0x30, "Every 50000" );	PORT_DIPSETTING(    0x20, "Every 70000" );	PORT_DIPNAME( 0x40, 0x00, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPNAME( 0x08, 0x08, "High Score Names" );	PORT_DIPSETTING(    0x00, "3 Letters" );	PORT_DIPSETTING(    0x08, "8 Letters" );	PORT_DIPNAME( 0x10, 0x10, "Allow Continue" );	PORT_DIPSETTING(    0x10, DEF_STR( "No") );
	...
	*******************************************************************************/
	...
	public static GameDriver driver_ninjakun	   = new GameDriver("1984"	,"ninjakun"	,"ninjakid.java"	,rom_ninjakun,null	,machine_driver_ninjakid	,input_ports_ninjakid	,init_ninjakid	,ROT0_16BIT	,	"[UPL] (Taito license)", "Ninjakun Majou no Bouken" )
}
