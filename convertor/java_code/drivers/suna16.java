...
public class suna16
{
	...
	***************************************************************************/
	...
	public static Memory_ReadAddress uballoon_sound_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0xefff, MRA_ROM					),	// ROM
		new Memory_ReadAddress( 0xf000, 0xf7ff, MRA_RAM					),	// RAM
		new Memory_ReadAddress( 0xf801, 0xf801, YM2151_status_port_0_r	),	// YM2151
		new Memory_ReadAddress( 0xfc00, 0xfc00, soundlatch_r				),	// From Main CPU
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	...
	public static Memory_WriteAddress uballoon_sound_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0xefff, MWA_ROM					),	// ROM
		new Memory_WriteAddress( 0xf000, 0xf7ff, MWA_RAM					),	// RAM
		new Memory_WriteAddress( 0xf800, 0xf800, YM2151_register_port_0_w	),	// YM2151
		new Memory_WriteAddress( 0xf801, 0xf801, YM2151_data_port_0_w		),	//
	...
	***************************************************************************/
	...
	public static Memory_ReadAddress bssoccer_pcm_1_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x0fff, MRA_ROM			),	// ROM
	...
	public static IO_ReadPort bssoccer_pcm_1_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x00, soundlatch2_r 				),	// From The Sound Z80
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};public static IO_WritePort bssoccer_pcm_1_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x01, bssoccer_DAC_1_w				),	// 2 x DAC
		new IO_WritePort( 0x03, 0x03, bssoccer_pcm_1_bankswitch_w	),	// Rom Bank
		new IO_WritePort(MEMPORT_MARKER, 0)
	};
	public static IO_ReadPort bssoccer_pcm_2_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x00, soundlatch3_r 				),	// From The Sound Z80
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};public static IO_WritePort bssoccer_pcm_2_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x01, bssoccer_DAC_2_w				),	// 2 x DAC
	...
	***************************************************************************/
	...
	public static Memory_ReadAddress uballoon_pcm_1_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x03ff, MRA_ROM			),	// ROM
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_uballoon = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP     | IPF_PLAYER1 );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN   | IPF_PLAYER1 );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT   | IPF_PLAYER1 );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT  | IPF_PLAYER1 );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_BUTTON1         | IPF_PLAYER1 );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_BUTTON2         | IPF_PLAYER1 );	PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x1000, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT(  0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x4000, IP_ACTIVE_LOW, IPT_START1   );	PORT_BIT(  0x8000, IP_ACTIVE_LOW, IPT_COIN1    );
		PORT_START(); 	// IN1 - $600002.w - Player 2
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP     | IPF_PLAYER2 );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN   | IPF_PLAYER2 );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT   | IPF_PLAYER2 );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT  | IPF_PLAYER2 );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_BUTTON1         | IPF_PLAYER2 );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_BUTTON2         | IPF_PLAYER2 );	PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_DIPNAME( 0x3000, 0x3000, "Copyright" );// Jumpers
		PORT_DIPSETTING(	  0x3000, "Distributer Unico" );	PORT_DIPSETTING(	  0x2000, "All Rights Reserved" );//	PORT_DIPSETTING(	  0x1000, "Distributer Unico" );//	PORT_DIPSETTING(	  0x0000, "All Rights Reserved" );	PORT_BIT(  0x4000, IP_ACTIVE_LOW, IPT_START2   );	PORT_BIT(  0x8000, IP_ACTIVE_LOW, IPT_COIN2    );
		...
		PORT_DIPSETTING(	  0x0010, "2" );	PORT_DIPSETTING(	  0x0018, "3" );	PORT_DIPSETTING(	  0x0008, "4" );	PORT_DIPSETTING(	  0x0000, "5" );	PORT_DIPNAME( 0x0060, 0x0060, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(	  0x0040, "Easy"    );	PORT_DIPSETTING(	  0x0060, "Normal"  );	PORT_DIPSETTING(	  0x0020, "Hard"    );	PORT_DIPSETTING(	  0x0000, "Hardest" );	PORT_SERVICE( 0x0080, IP_ACTIVE_LOW );
		...
		PORT_DIPSETTING(	  0x001c, "200K" );	PORT_DIPSETTING(	  0x0010, "300K, 1000K" );	PORT_DIPSETTING(	  0x0018, "400K" );	PORT_DIPSETTING(	  0x000c, "500K, 1500K" );	PORT_DIPSETTING(	  0x0008, "500K, 2000K" );	PORT_DIPSETTING(	  0x0004, "500K, 3000K" );	PORT_DIPSETTING(	  0x0014, "600K" );	PORT_DIPSETTING(	  0x0000, "None" );	PORT_DIPNAME( 0x0020, 0x0020, "Unknown 1-5*" );	PORT_DIPSETTING(	  0x0020, DEF_STR( "Off") );
		PORT_DIPSETTING(	  0x0000, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	(
		1,
		3579545,	/* ? */
		new int[] { YM3012_VOL(20,MIXER_PAN_LEFT, 20,MIXER_PAN_RIGHT) },
	...
	***************************************************************************/
	...
	static YM2151interface uballoon_ym2151_interface = new YM2151interface
	(
		1,
		3579545,	/* ? */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_uballoon = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "gfx1.rom", 0x000000, 0x080000, 0xfd2ec297 );	ROM_LOAD( "gfx2.rom", 0x080000, 0x080000, 0x6307aa60 );	ROM_LOAD( "gfx3.rom", 0x100000, 0x080000, 0x718f3150 );	ROM_LOAD( "gfx4.rom", 0x180000, 0x080000, 0xaf7e057e );
	ROM_END(); }}; 
