...
public class mitchell
{
	...
	***************************************************************************/
	...
	public static IO_ReadPort readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x02, input_r ),	/* Super Pang needs a kludge to initialize EEPROM.
	...
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, pang_gfxctrl_w ),    /* Palette bank, layer enable, coin counters, more */
	...
	static RomLoadPtr rom_mgakuen = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "mg-1.13h",     0x000000, 0x80000, 0xfd6a0805 );/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "mg-6.4l",      0x000000, 0x20000, 0x34594e62 );/* sprites */
	...
	static RomLoadPtr rom_mgakuen2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "mg2-a.13h",    0x000000, 0x80000, 0x31a0c55e );/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "mg2-f.4l",     0x000000, 0x20000, 0x3172c9fe );/* sprites */
	...
	static RomLoadPtr rom_pkladies = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "pko-001.8h",   0x000000, 0x80000, 0x1ead5d9b )	/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "pko-chr1.2j",  0x000000, 0x20000, 0x31ce33cd );/* sprites */
	...
	static RomLoadPtr rom_pkladiel = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "pk05.14f",     0x00000, 0x08000, 0xea1740a6 );	ROM_LOAD( "pk06.15f",     0x10000, 0x20000, 0x3078ff5e );/* larger than pkladies - 2nd half unused? */
	...
	static RomLoadPtr rom_dokaben = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "db02.1e",      0x000000, 0x20000, 0x9aa8470c );/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "db10.2k",      0x000000, 0x20000, 0x9e70f7ae );/* sprites */
	...
	static RomLoadPtr rom_pang = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "pang_09.bin",  0x000000, 0x20000, 0x3a5883f5 );/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "bb10.bin",     0x000000, 0x20000, 0xfdba4f6e );/* sprites */
	...
	static RomLoadPtr rom_bbros = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "bb2.bin",      0x000000, 0x20000, 0x62f29992 );/* chars */
		ROM_LOAD( "bb3.bin",      0x020000, 0x20000, 0x79a8ed08 );	/* 40000-7ffff empty */
	...
	static RomLoadPtr rom_pompingw = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "pw_02.1e",     0x000000, 0x20000, 0x4b5992e4 );/* chars */
		ROM_LOAD( "bb3.bin",      0x020000, 0x20000, 0x79a8ed08 );	/* 40000-7ffff empty */
	...
	static RomLoadPtr rom_cworld = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "cw08.bin",     0x000000, 0x20000, 0x6c80da3c );/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "cw16.bin",     0x000000, 0x20000, 0xf90217d1 );/* sprites */
	...
	static RomLoadPtr rom_hatena = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "q2-08.rom",    0x000000, 0x20000, 0x6c80da3c );/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "q2-16.rom",    0x000000, 0x20000, 0xec19b2f0 );/* sprites */
	...
	static RomLoadPtr rom_spang = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "spe_02.rom",   0x000000, 0x20000, 0x63c9dfd2 );/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "spe_10.rom",   0x000000, 0x20000, 0xeedd0ade );/* sprites */
	...
	static RomLoadPtr rom_sbbros = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "02.f1",        0x000000, 0x20000, 0x0c22ffc6 );/* chars */
		ROM_LOAD( "03.f2",        0x020000, 0x20000, 0x3ae28bc1 );	/* 40000-7ffff empty */
		ROM_LOAD( "04.g2",        0x080000, 0x20000, 0xbb3dee5b );	ROM_LOAD( "05.g2",        0x0a0000, 0x20000, 0x4a060884 );	/* c0000-fffff empty */
	
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "10.l2",        0x000000, 0x20000, 0xd6675d8f );/* sprites */
	...
	static RomLoadPtr rom_marukin = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "mg3-a.3k",     0x000000, 0x80000, 0x420f1de7 );/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "mg3-05.2g",    0x000000, 0x20000, 0x7a738d2d );/* sprites */
	...
	static RomLoadPtr rom_qtono1 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "q3-08.rom",    0x000000, 0x20000, 0x1533b978 );/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "q3-16.rom",    0x000000, 0x20000, 0x863d6836 );/* sprites */
	...
	static RomLoadPtr rom_qsangoku = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "q4-08.rom",    0x000000, 0x20000, 0xdc84c6cb );/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "q4-16.rom",    0x000000, 0x20000, 0x77342320 );/* sprites */
	...
	static RomLoadPtr rom_block = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x50000, REGION_CPU1, 0 );/* 320k for code + 320k for decrypted opcodes */
		ROM_LOAD( "ble_05.bin",   0x00000, 0x08000, 0xfa2a4536 );	ROM_LOAD( "ble_06.bin",   0x10000, 0x20000, 0x58a77402 );	ROM_LOAD( "ble_07.rom",   0x30000, 0x20000, 0x1d114f13 );
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "bl_08.rom",    0x000000, 0x20000, 0xaa0f4ff1 );/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "bl_16.rom",    0x000000, 0x20000, 0xfadcaff7 );/* sprites */
	...
	static RomLoadPtr rom_blockbl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "m12.o10",      0x000000, 0x20000, 0x963154d9 );/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "m11.o7",       0x000000, 0x10000, 0x255180a5 );/* sprites */
	...
	public static GameDriver driver_block	   = new GameDriver("1991"	,"block"	,"mitchell.java"	,rom_block,null	,machine_driver_pang	,input_ports_block	,init_block	,ROT270	,	"Capcom", "Block Block (World 911106)" )
