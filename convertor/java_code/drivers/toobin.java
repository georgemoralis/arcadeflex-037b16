...
public class toobin
{
	...
	static RomLoadPtr rom_toobin = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "061-1101.bin", 0x000000, 0x10000, 0x02696f15 ); /* bank 0 (4 bpp)*/
		...
		ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "061-1143.bin", 0x000000, 0x20000, 0x211c1049 ); /* bank 0 (4 bpp)*/
		...
		ROM_REGION( 0x004000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "061-1142.bin", 0x000000, 0x04000, 0xa6ab551f ); /* alpha font */
	ROM_END(); }}; 
