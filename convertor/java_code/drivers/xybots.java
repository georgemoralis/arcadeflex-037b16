...
public class xybots
{
	...
	static RomLoadPtr rom_xybots = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "2102.l13",     0x00000, 0x08000, 0xc1309674 );	ROM_RELOAD(               0x08000, 0x08000 );	ROM_LOAD( "2103.l11",     0x10000, 0x10000, 0x907c024d );	ROM_LOAD( "2117.l7",      0x30000, 0x10000, 0x0cc9b42d );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "1105.de1",     0x00000, 0x10000, 0x315a4274 );	ROM_LOAD( "1106.e1",      0x10000, 0x10000, 0x3d8c1dd2 );	ROM_LOAD( "1107.f1",      0x20000, 0x10000, 0xb7217da5 );	ROM_LOAD( "1108.fj1",     0x30000, 0x10000, 0x77ac65e1 );	ROM_LOAD( "1109.j1",      0x40000, 0x10000, 0x1b482c53 );	ROM_LOAD( "1110.k1",      0x50000, 0x10000, 0x99665ff4 );	ROM_LOAD( "1111.kl1",     0x60000, 0x10000, 0x416107ee );
		ROM_REGION( 0x02000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "1101.c4",      0x00000, 0x02000, 0x59c028a2 );ROM_END(); }}; 
