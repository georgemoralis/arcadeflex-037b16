...
public class wc90
{
	...
	static RomLoadPtr rom_wc90 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x010000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ic85_07v.bin", 0x00000, 0x10000, 0xc5219426 );/* characters */
	
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "ic86_08v.bin", 0x00000, 0x20000, 0x8fa1a1ff );/* tiles #1 */
		ROM_LOAD( "ic90_09v.bin", 0x20000, 0x20000, 0x99f8841c );/* tiles #2 */
	
		ROM_REGION( 0x040000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "ic87_10v.bin", 0x00000, 0x20000, 0x8232093d );/* tiles #3 */
		ROM_LOAD( "ic91_11v.bin", 0x20000, 0x20000, 0x188d3789 );/* tiles #4 */
	
		ROM_REGION( 0x080000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "ic50_12v.bin", 0x00000, 0x20000, 0xda1fe922 );/* sprites  */
