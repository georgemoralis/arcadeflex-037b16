...
public class itech8
{
	...
	public static IO_ReadPort slikz80_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x00, slikz80_port_r ),
	MEMORY_END
	
	
	public static IO_WritePort slikz80_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, slikz80_port_w ),
	MEMORY_END
	...
	PORT_START(); 	/* 40 */
		...
		PORT_START(); 	/* 60 */
		PORT_BIT     ( 0x01, IP_ACTIVE_LOW, IPT_COIN4 );	PORT_BIT     ( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT     ( 0x04, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT_NAME( 0x08, IP_ACTIVE_LOW, IPT_BUTTON1, "Left Hook" )
	...
	PORT_START(); 	/* 40 */
		...
		PORT_START(); 	/* 60 */
		PORT_BIT     ( 0x07, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT_NAME( 0x08, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3, "Blue Player" )
	...
	PORT_START(); 	/* 40 */
		...
		PORT_START(); 	/* 60 */
		PORT_BIT     ( 0x01, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT_NAME( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1, "P1 Face Right" )
		...
		PORT_START(); 	/* 80 */
		PORT_BIT     ( 0x01, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT_NAME( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 | IPF_COCKTAIL, "P2 Face Right" )
	...
	(																				\
		...
		new MachineCPU[] {																			\
			...
			new MachineCPU(																		\
				CPU_M6809,															\
				CLOCK_8MHz/4,														\
				sound##YMTYPE##_readmem,sound##YMTYPE##_writemem,null,null,				\
				ignore_interrupt,1													\
			)																		\
		},																			\
		...
		init_machine,																\
																					\
		/* video hardware */														\
		512, 263, new rectangle( XMIN, XMAX, 0, 239 ),											\
		null,																			\
		256,256,																	\
		null,																			\
																					\
		...
		0,0,0,0,																	\
		new MachineSound[] {																			\
			new MachineSound( SOUND_YM##YMTYPE, ym##YMTYPE##_interface ),							\
			new MachineSound( SOUND_OKIM6295, oki6295_interface_##OKISPEED ),						\
		},																			\
		nvram_handler																\
	)
	...
	static RomLoadPtr rom_stratab = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "sbprogv3.bin", 0x08000, 0x8000, 0xa5ae728f );	ROM_COPY( REGION_CPU1,    0x8000, 0x14000, 0x8000 )
	...
	static RomLoadPtr rom_wfortune = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "wofpgm", 0x04000, 0x4000, 0xbd984654 );	ROM_CONTINUE(       0x10000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x14000, 0x8000, 0x8000 )
	...
	static RomLoadPtr rom_wfortuna = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "wofpgmr1.bin", 0x04000, 0x4000, 0xc3d3eb21 );	ROM_CONTINUE(             0x10000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x14000, 0x8000, 0x8000 )
	...
	static RomLoadPtr rom_gtg = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "u5.bin", 0x04000, 0x4000, 0x61984272 );	ROM_CONTINUE(       0x10000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x14000, 0x8000, 0x8000 )
	...
	static RomLoadPtr rom_slikshot = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "pgm20.u5",  0x04000, 0x4000, 0x370a00eb );	ROM_CONTINUE(          0x10000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x14000, 0x8000, 0x8000 )
	...
	static RomLoadPtr rom_sliksh17 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "u5.bin", 0x04000, 0x4000, 0x09d70554 );	ROM_CONTINUE(       0x10000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x14000, 0x8000, 0x8000 )
	...
	static RomLoadPtr rom_sstrike = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "sstrku5.bin", 0x08000, 0x8000, 0xaf00cddf );	ROM_COPY( REGION_CPU1,    0x8000, 0x14000, 0x8000 )
	...
	static RomLoadPtr rom_gtg2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "u5.2",   0x10000, 0x4000, 0x4a61580f );	ROM_CONTINUE(       0x04000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x8000, 0x14000, 0x8000 )
	...
	static RomLoadPtr rom_gtg2t = new RomLoadPtr(){ public void handler(){ 
		/* banks are loaded in the opposite order from the others, */
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "u5",     0x10000, 0x4000, 0xc7b3a9f3 );	ROM_CONTINUE(       0x04000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x8000, 0x14000, 0x8000 )
	...
	static RomLoadPtr rom_gtg2j = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "u5.bin", 0x04000, 0x4000, 0x9c95ceaa );	ROM_CONTINUE(       0x10000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x14000, 0x8000, 0x8000 )
	...
	static RomLoadPtr rom_arlingtn = new RomLoadPtr(){ public void handler(){ 
		/* banks are loaded in the opposite order from the others, */
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "ahrd121.bin", 0x10000, 0x4000, 0x00aae02e );	ROM_CONTINUE(            0x04000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x8000, 0x14000, 0x8000 )
	...
	static RomLoadPtr rom_neckneck = new RomLoadPtr(){ public void handler(){ 
		/* banks are loaded in the opposite order from the others, */
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "nn_prg12.u5", 0x04000, 0x4000, 0x8e51734a );	ROM_CONTINUE(            0x10000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x14000, 0x8000, 0x8000 )
	...
	static RomLoadPtr rom_peggle = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "j-stick.u5", 0x04000, 0x4000, 0x140d5a9c );	ROM_CONTINUE(           0x10000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x14000, 0x8000, 0x8000 )
	...
	static RomLoadPtr rom_pegglet = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "trakball.u5", 0x04000, 0x4000, 0xd2694868 );	ROM_CONTINUE(            0x10000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x14000, 0x8000, 0x8000 )
	...
	static RomLoadPtr rom_hstennis = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x1c000, REGION_CPU1, 0 );	ROM_LOAD( "ten_v1_1.bin", 0x04000, 0x4000, 0xfaffab5c );	ROM_CONTINUE(             0x10000, 0xc000 );	ROM_COPY( REGION_CPU1, 0x14000, 0x8000, 0x8000 )
	...
	static RomLoadPtr rom_rimrockn = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x34000, REGION_CPU1, 0 );	ROM_LOAD( "u5-2_2",    0x04000, 0x4000, 0x97777683 );	ROM_CONTINUE(          0x10000, 0x4000 );	ROM_CONTINUE(          0x1c000, 0x4000 );	ROM_CONTINUE(          0x28000, 0xc000 );	ROM_CONTINUE(          0x2c000, 0x8000 );	ROM_COPY( REGION_CPU1, 0x2c000, 0x08000, 0x8000 )
	...
	static RomLoadPtr rom_rimrck20 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x34000, REGION_CPU1, 0 );	ROM_LOAD( "rrb.bin",   0x04000, 0x4000, 0x7e9d5545 );	ROM_CONTINUE(          0x10000, 0x4000 );	ROM_CONTINUE(          0x1c000, 0x4000 );	ROM_CONTINUE(          0x28000, 0xc000 );	ROM_CONTINUE(          0x2c000, 0x8000 );	ROM_COPY( REGION_CPU1, 0x2c000, 0x08000, 0x8000 )
		ROM_COPY( REGION_CPU1, 0x2c000, 0x14000, 0x8000 )
		ROM_COPY( REGION_CPU1, 0x2c000, 0x20000, 0x8000 )
	...
	static RomLoadPtr rom_rimrck16 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x34000, REGION_CPU1, 0 );	ROM_LOAD( "rrbbv16.u5",0x04000, 0x4000, 0x999cd502 );	ROM_CONTINUE(          0x10000, 0x4000 );	ROM_CONTINUE(          0x1c000, 0x4000 );	ROM_CONTINUE(          0x28000, 0xc000 );	ROM_CONTINUE(          0x2c000, 0x8000 );	ROM_COPY( REGION_CPU1, 0x2c000, 0x08000, 0x8000 )
		ROM_COPY( REGION_CPU1, 0x2c000, 0x14000, 0x8000 )
		ROM_COPY( REGION_CPU1, 0x2c000, 0x20000, 0x8000 )
	...
	static RomLoadPtr rom_rimrck12 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x34000, REGION_CPU1, 0 );	ROM_LOAD( "rrbbv12.u5",0x04000, 0x4000, 0x661761a6 );	ROM_CONTINUE(          0x10000, 0x4000 );	ROM_CONTINUE(          0x1c000, 0x4000 );	ROM_CONTINUE(          0x28000, 0xc000 );	ROM_CONTINUE(          0x2c000, 0x8000 );	ROM_COPY( REGION_CPU1, 0x2c000, 0x08000, 0x8000 )
		ROM_COPY( REGION_CPU1, 0x2c000, 0x14000, 0x8000 )
		ROM_COPY( REGION_CPU1, 0x2c000, 0x20000, 0x8000 )
	...
	static RomLoadPtr rom_ninclown = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "prog1", 0x00000, 0x20000, 0xfabfdcd2 )
