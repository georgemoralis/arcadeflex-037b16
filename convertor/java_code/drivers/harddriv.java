...
public class harddriv
{
	...
	PORT_START(); 		/* 600000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_SERVICE( 0x0020, IP_ACTIVE_LOW );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0xff00, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 		/* a80000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0xfffc, IP_ACTIVE_LOW, IPT_UNUSED );
	...
	PORT_START(); 		/* 60c000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_SERVICE( 0x0020, IP_ACTIVE_LOW );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0xff00, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 		/* a80000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0xfff8, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 		/* b00000 - 8 bit ADC 0 */
	...
	PORT_START(); 		/* 60c000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_SERVICE( 0x0020, IP_ACTIVE_LOW );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 		/* a80000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0xfff8, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 		/* b00000 - 8 bit ADC 0 */
		PORT_ANALOG( 0xff, 0x80, IPT_AD_STICK_X, 25, 10, 0x00, 0xff );
		PORT_START(); 		/* b00000 - 8 bit ADC 1 */
		PORT_BIT( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );
	...
	*/
	...
	static RomLoadPtr rom_stunrun = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "sr_snd.10c", 0x10000, 0x4000, 0x121ab09a );	ROM_CONTINUE(           0x04000, 0xc000 );
		ROM_REGION16_BE( 0x60000, REGION_USER1, 0 )		/* 384k for object ROM */
		...
		ROM_LOAD( "sr_snd.1fh",  0x00000, 0x10000, 0x4dc14fe8 );	ROM_LOAD( "sr_snd.1ef",  0x10000, 0x10000, 0xcbdabbcc );	ROM_LOAD( "sr_snd.1de",  0x20000, 0x10000, 0xb973d9d1 );	ROM_LOAD( "sr_snd.1cd",  0x30000, 0x10000, 0x3e419f4e );ROM_END(); }}; 
	...
	static RomLoadPtr rom_steeltal = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "stsnd.1f", 0x10000, 0x4000, 0xc52d8218 );	ROM_CONTINUE(         0x04000, 0xc000 );
		...
		ROM_LOAD( "stsnd.1m",  0x80000, 0x20000, 0xc904db9c );	ROM_LOAD( "stsnd.1n",  0xa0000, 0x20000, 0x164580b3 );	ROM_LOAD( "stsnd.1p",  0xc0000, 0x20000, 0x296290a0 );	ROM_LOAD( "stsnd.1r",  0xe0000, 0x20000, 0xc029d037 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_hdrivair = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD     ( "sboot.bin",   0x00000, 0x10000, 0xcde4d010 );	ROM_LOAD     ( "xboot.bin",   0x00000, 0x10000, 0x054b46a0 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_hdrivaip = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD     ( "sboota.bin",  0x00000, 0x10000, 0x3ef819cd );	ROM_LOAD     ( "xboota.bin",  0x00000, 0x10000, 0xd9c49901 );ROM_END(); }}; 
	...
	public static GameDriver driver_harddrvc	   = new GameDriver("1990"	,"harddrvc"	,"harddriv.java"	,rom_harddrvc,driver_harddriv	,machine_driver_racedriv	,input_ports_racedriv	,init_harddrvc	,ROT0_16BIT	,	"Atari Games", "Hard Drivin' (compact)", GAME_NO_SOUND | GAME_NOT_WORKING )
