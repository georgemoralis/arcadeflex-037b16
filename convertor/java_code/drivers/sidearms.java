...
public class sidearms
{
	...
	static RomLoadPtr rom_sidearms = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "a_10j.rom",    0x00000, 0x4000, 0x651fef75 );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "b_13d.rom",    0x00000, 0x8000, 0x3c59afe1 );/* tiles */
		...
		ROM_REGION( 0x40000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "b_11b.rom",    0x00000, 0x8000, 0xeb6f278c );/* sprites */
		...
		ROM_REGION( 0x0320, REGION_PROMS, 0 );	ROM_LOAD( "63s141.16h",   0x0000, 0x0100, 0x75af3553 );/* unknown */
	...
	static RomLoadPtr rom_turtship = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "turtship.005",    0x00000, 0x04000, 0x651fef75 );/* characters */
	
		ROM_REGION( 0x60000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "turtship.008",    0x00000, 0x10000, 0xe0658469 );/* tiles */
		...
		ROM_REGION( 0x40000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "turtship.013",    0x00000, 0x10000, 0x599f5246 );/* sprites */
	...
	static RomLoadPtr rom_dyger = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "dyger.005",    0x00000, 0x04000, 0xc4bc72a5 );/* characters */
		ROM_CONTINUE(             0x00000, 0x04000 );/* is the first half used? */
	
		ROM_REGION( 0x60000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "dyger.010",    0x00000, 0x10000, 0x9715880d );/* tiles */
		...
		ROM_REGION( 0x40000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "dyger.014",    0x00000, 0x10000, 0x99c60b26 );/* sprites */
