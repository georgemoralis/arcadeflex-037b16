...
public class aburner
{
	...
	*/
	...
	static RomLoadPtr rom_aburner = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "epr10926.bin",0x00000,0x10000, 0xed8bd632 );	ROM_LOAD( "epr10925.bin",0x10000,0x10000, 0x4ef048cc );	ROM_LOAD( "epr10924.bin",0x20000,0x10000, 0x50c15a6d );
		ROM_REGION( 0x200000, REGION_GFX2, 0 );/* sprites */
		ROM_LOAD( "10932.125",   0x20000*0x0, 0x20000, 0xcc0821d6 );	ROM_LOAD( "10934.129",   0x20000*0x4, 0x20000, 0x4a51b1fa );	ROM_LOAD( "10936.133",   0x20000*0x8, 0x20000, 0xada70d64 );	ROM_LOAD( "10938.102",   0x20000*0xc, 0x20000, 0xe7675baf );	ROM_LOAD( "10933.126",   0x20000*0x1, 0x20000, 0xc8efb2c3 );	ROM_LOAD( "10935.130",   0x20000*0x5, 0x20000, 0xc1e23521 );	ROM_LOAD( "10937.134",   0x20000*0x9, 0x20000, 0xf0199658 );	ROM_LOAD( "10939.103",   0x20000*0xd, 0x20000, 0xa0d49480 );	ROM_LOAD( "epr10942.bin",0x20000*0x2,0x20000, 0x5ce10b8c );	ROM_LOAD( "epr10943.bin",0x20000*0x6,0x20000, 0xb98294dc );	ROM_LOAD( "epr10944.bin",0x20000*0xa,0x20000, 0x17be8f67 );	ROM_LOAD( "epr10945.bin",0x20000*0xe,0x20000, 0xdf4d4c4f );	ROM_LOAD( "epr10946.bin",0x20000*0x3,0x20000, 0xd7d485f4 );	ROM_LOAD( "epr10947.bin",0x20000*0x7,0x20000, 0x08838392 );	ROM_LOAD( "epr10948.bin",0x20000*0xb,0x20000, 0x64284761 );	ROM_LOAD( "epr10949.bin",0x20000*0xf,0x20000, 0xd8437d92 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* sound CPU */
		ROM_LOAD( "epr10923.bin",0x00000, 0x10000, 0x6888eb8f );
		ROM_REGION( 0x60000, REGION_SOUND1, 0 );/* Sega PCM sound data */
		ROM_LOAD( "10931.11",    0x00000, 0x20000, 0x9209068f );	ROM_LOAD( "10930.12",    0x20000, 0x20000, 0x6493368b );	ROM_LOAD( "11102.13",    0x40000, 0x20000, 0x6c07c78d );
		...
		ROM_LOAD( "10922.40", 0x000000, 0x10000, 0xb49183d4 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_aburner2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX2, 0 );/* sprites */
		ROM_LOAD( "10932.125", 0x20000*0x0, 0x20000, 0xcc0821d6 );	ROM_LOAD( "10933.126", 0x20000*0x1, 0x20000, 0xc8efb2c3 );	ROM_LOAD( "11103.127", 0x20000*0x2, 0x20000, 0xbdd60da2 );	ROM_LOAD( "11116.128", 0x20000*0x3, 0x20000, 0x49b4c1ba );	ROM_LOAD( "10934.129", 0x20000*0x4, 0x20000, 0x4a51b1fa );	ROM_LOAD( "10935.130", 0x20000*0x5, 0x20000, 0xc1e23521 );	ROM_LOAD( "11104.131", 0x20000*0x6, 0x20000, 0x06a35fce );	ROM_LOAD( "11117.132", 0x20000*0x7, 0x20000, 0x821fbb71 );	ROM_LOAD( "10936.133", 0x20000*0x8, 0x20000, 0xada70d64 );	ROM_LOAD( "10937.134", 0x20000*0x9, 0x20000, 0xf0199658 );	ROM_LOAD( "11105.135", 0x20000*0xa, 0x20000, 0x027b0689 );	ROM_LOAD( "11118.136", 0x20000*0xb, 0x20000, 0x8f38540b );	ROM_LOAD( "10938.102", 0x20000*0xc, 0x20000, 0xe7675baf );	ROM_LOAD( "10939.103", 0x20000*0xd, 0x20000, 0xa0d49480 );	ROM_LOAD( "11106.104", 0x20000*0xe, 0x20000, 0x9e1fec09 );	ROM_LOAD( "11119.105", 0x20000*0xf, 0x20000, 0xd0343a8e );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* sound CPU */
	...
	//	ROM_LOAD16_BYTE( "11321.epr", 0x180000, 0x20000, 0x8e738f58 )
		...
		ROM_REGION( 0x60000, REGION_SOUND1, 0 );/* Sega PCM sound data */
		ROM_LOAD( "11317.epr",   0x00000, 0x20000, 0xd4e7ac1f );	ROM_LOAD( "11318.epr",   0x20000, 0x20000, 0x70d3f02c );	ROM_LOAD( "11319.epr",   0x40000, 0x20000, 0x50d9242e );
		ROM_REGION( 0x100000, REGION_CPU3, 0 );/* 2nd 68000 code */
	...
	static RomLoadPtr rom_thndrbdj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x30000, REGION_GFX1, ROMREGION_DISPOSE );/* tiles */
		ROM_LOAD( "11314.epr", 0x00000, 0x10000, 0xd4f954a9 );	ROM_LOAD( "11315.epr", 0x10000, 0x10000, 0x35813088 );	ROM_LOAD( "11316.epr", 0x20000, 0x10000, 0x84290dff );
		ROM_REGION( 0x200000, REGION_GFX2, 0 );/* sprites */
		ROM_LOAD( "11323.epr", 0x20000*0x0, 0x20000, 0x27e40735 );	ROM_LOAD( "11322.epr", 0x20000*0x4, 0x20000, 0x10364d74 );	ROM_LOAD( "11321.epr", 0x20000*0x8, 0x20000, 0x8e738f58 );	ROM_LOAD( "11320.epr", 0x20000*0xc, 0x20000, 0xa95c76b8 );	ROM_LOAD( "11327.epr", 0x20000*0x1, 0x20000, 0xdeae90f1 );	ROM_LOAD( "11326.epr", 0x20000*0x5, 0x20000, 0x29198403 );	ROM_LOAD( "11325.epr", 0x20000*0x9, 0x20000, 0xb9e98ae9 );	ROM_LOAD( "11324.epr", 0x20000*0xd, 0x20000, 0x9742b552 );	ROM_LOAD( "11331.epr", 0x20000*0x2, 0x20000, 0x3a2c042e );	ROM_LOAD( "11330.epr", 0x20000*0x6, 0x20000, 0xaa7c70c5 );	ROM_LOAD( "11329.epr", 0x20000*0xa, 0x20000, 0x31b20257 );	ROM_LOAD( "11328.epr", 0x20000*0xe, 0x20000, 0xda39e89c );	ROM_LOAD( "11335.epr", 0x20000*0x3, 0x20000, 0xf19b3e86 );	ROM_LOAD( "11334.epr", 0x20000*0x7, 0x20000, 0x348f91c7 );	ROM_LOAD( "11333.epr", 0x20000*0xb, 0x20000, 0x05a2333f );	ROM_LOAD( "11332.epr", 0x20000*0xf, 0x20000, 0xdc089ec6 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* sound CPU */
	...
	PORT_START();  /* player 1 */
		...
		PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );/* vulcan */
		...
		PORT_START();  /* DSWB */
		PORT_DIPNAME( 0x03, 0x01, "Cabinet Type" );	PORT_DIPSETTING(    0x01, "Upright 1" );	PORT_DIPSETTING(    0x00, "N/A" );	PORT_DIPSETTING(    0x02, "Moving Standard" );	PORT_DIPSETTING(    0x03, "Moving Deluxe" );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x04, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x10, 0x00, "Ship Increase" );	PORT_DIPSETTING(    0x10, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x20, 0x00, "Allow Continue" );	PORT_DIPSETTING(    0x20, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		...
		PORT_ANALOG( 0xff, 0x80, IPT_AD_STICK_Y | IPF_CENTER | IPF_PLAYER2, 100, 79, 0x00, 0xff );INPUT_PORTS_END(); }}; 
	...
	PORT_START();  /* player 1 */
		...
		PORT_START();  /* DSWB */
		PORT_DIPNAME( 0x03, 0x01, "Cabinet Type" );	PORT_DIPSETTING(    0x01, "Upright 1" );	PORT_DIPSETTING(    0x00, "Upright 2" );	PORT_DIPSETTING(    0x02, "Moving Standard" );	PORT_DIPSETTING(    0x03, "Moving Deluxe" );	PORT_DIPNAME( 0x04, 0x04, "Throttle Lever" );	PORT_DIPSETTING(    0x00, DEF_STR( "No") );
		PORT_DIPSETTING(    0x04, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x08, "3" );	PORT_DIPSETTING(    0x00, "4" );	PORT_DIPNAME( 0x10, 0x00, "Ship Increase" );	PORT_DIPSETTING(    0x10, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x20, 0x00, "Allow Continue" );	PORT_DIPSETTING(    0x20, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0xc0, 0xc0, DEF_STR( "Difficulty") );
	...
	PORT_START();  /* player 1 */
		...
		PORT_BITX(0x02, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );/* service */
		PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );/* gun */
		PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 );/* missle */
		PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN2 );
		SYS16_COINAGE /* DSWA */ /* wrong! */
	
		PORT_START();  /* DSWB */
		PORT_DIPNAME( 0x01, 0x01, "Cabinet Type" );	PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x01, "Deluxe" );	PORT_DIPNAME( 0x02, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, "Time" );	PORT_DIPSETTING(    0x00, "0 Seconds" );	PORT_DIPSETTING(    0x04, "30 Seconds" );	PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x08, "2" );	PORT_DIPSETTING(    0x18, "3" );	PORT_DIPSETTING(    0x10, "4" );	PORT_DIPSETTING(    0x00, "5" );	PORT_DIPNAME( 0x20, 0x00, "Allow Continue" );	PORT_DIPSETTING(    0x00, DEF_STR( "No") );
		...
		PORT_START(); 
		PORT_ANALOG( 0xff, 0x7f, IPT_AD_STICK_Y | IPF_CENTER, 100, 4, 0x00, 0xff );INPUT_PORTS_END(); }}; 
	...
	*/
	...
	public static GameDriver driver_aburner	   = new GameDriver("1987"	,"aburner"	,"aburner.java"	,rom_aburner,driver_aburner2	,machine_driver_aburner	,input_ports_aburner	,init_aburner	,ROT0_16BIT	,	"Sega", "After Burner (Japan)" )
	public static GameDriver driver_aburner2	   = new GameDriver("1987"	,"aburner2"	,"aburner.java"	,rom_aburner2,null	,machine_driver_aburner	,input_ports_aburner2	,init_aburner2	,ROT0_16BIT	,	"Sega", "After Burner II" )
	...
	public static GameDriver driver_thndrbdj	   = new GameDriver("19??"	,"thndrbdj"	,"aburner.java"	,rom_thndrbdj,driver_thndrbld	,machine_driver_aburner	,input_ports_thndrbld	,init_thndrbdj	,ROT0_16BIT	,	"Sega", "Thunder Blade (Japan)" )
}
