...
public class outrun
{
	...
	static RomLoadPtr rom_outrun = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "10371", 0x00000, 0x20000, 0x0a1c98de );	ROM_LOAD( "10372", 0x20000, 0x20000, 0x1640ad1f );	ROM_LOAD( "10373", 0x40000, 0x20000, 0x339f8e64 );	ROM_LOAD( "10374", 0x60000, 0x20000, 0x22744340 );	ROM_LOAD( "10375", 0x80000, 0x20000, 0x62a472bd );	ROM_LOAD( "10376", 0xa0000, 0x20000, 0x8337ace7 );	ROM_LOAD( "10377", 0xc0000, 0x20000, 0xc86daecb );	ROM_LOAD( "10378", 0xe0000, 0x20000, 0x544068fd );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* sound CPU */
		ROM_LOAD( "10187",       0x00000, 0x8000, 0xa10abaa9 );
		ROM_REGION( 0x38000, REGION_SOUND1, 0 );/* Sega PCM sound data */
		ROM_LOAD( "10193",       0x00000, 0x8000, 0xbcd10dde );	ROM_RELOAD(              0x30000, 0x8000 );// twice??
		ROM_LOAD( "10192",       0x08000, 0x8000, 0x770f1270 );	ROM_LOAD( "10191",       0x10000, 0x8000, 0x20a284ab );	ROM_LOAD( "10190",       0x18000, 0x8000, 0x7cab70e2 );	ROM_LOAD( "10189",       0x20000, 0x8000, 0x01366b54 );	ROM_LOAD( "10188",       0x28000, 0x8000, 0xbad30ad9 );
		ROM_REGION( 0x40000, REGION_CPU3, 0 );/* second 68000 CPU */
	...
	static RomLoadPtr rom_outrunb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "10268", 0x00000, 0x08000, 0x95344b04 );	ROM_LOAD( "10232", 0x08000, 0x08000, 0x776ba1eb );	ROM_LOAD( "10267", 0x10000, 0x08000, 0xa85bb823 );	ROM_LOAD( "10231", 0x18000, 0x08000, 0x8908bcbf );	ROM_LOAD( "10266", 0x20000, 0x08000, 0x9f6f1a74 );	ROM_LOAD( "10230", 0x28000, 0x08000, 0x686f5e50 );
		ROM_REGION( 0x100000, REGION_GFX2, 0 );/* sprites */
		ROM_LOAD( "orun_1.rom", 	0x00000, 0x10000, 0x77377e00 );	ROM_LOAD( "orun_17.rom", 	0x10000, 0x10000, 0x4f784236 );	ROM_LOAD( "orun_2.rom", 	0x20000, 0x10000, 0x2c0e7277 );	ROM_LOAD( "orun_18.rom", 	0x30000, 0x10000, 0x8d459356 );	ROM_LOAD( "orun_3.rom", 	0x40000, 0x10000, 0x69ecc975 );	ROM_LOAD( "orun_19.rom", 	0x50000, 0x10000, 0xee4f7154 );	ROM_LOAD( "orun_4.rom", 	0x60000, 0x10000, 0x54761e57 );	ROM_LOAD( "orun_20.rom",	0x70000, 0x10000, 0xc2825654 );	ROM_LOAD( "orun_5.rom", 	0x80000, 0x10000, 0xb6a8d0e2 );	ROM_LOAD( "orun_21.rom", 	0x90000, 0x10000, 0xe9880aa3 );	ROM_LOAD( "orun_6.rom", 	0xa0000, 0x10000, 0xa00d0676 );	ROM_LOAD( "orun_22.rom",	0xb0000, 0x10000, 0xef7d06fe );	ROM_LOAD( "orun_7.rom", 	0xc0000, 0x10000, 0xd632d8a2 );	ROM_LOAD( "orun_23.rom", 	0xd0000, 0x10000, 0xdc286dc2 );	ROM_LOAD( "orun_8.rom", 	0xe0000, 0x10000, 0xda398368 );	ROM_LOAD( "orun_24.rom",	0xf0000, 0x10000, 0x1222af9f );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* sound CPU */
	...
	// custom cpu 317-0106
		...
		ROM_LOAD( "epr12298.11", 0x0, 0x08000, 0xfc9bc41b );ROM_END(); }}; 
