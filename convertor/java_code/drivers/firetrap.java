...
public class firetrap
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_firetrap = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	ROM_LOAD( "firetrap.3b",  0x0000,  0x0100, 0x8bb45337 );/* palette red and green component */
