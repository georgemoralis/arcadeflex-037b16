...
public class balsente
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BIT( 0x7e, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x1c, 0x00, "Bonus Coins" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPSETTING(    0x04, "2 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x08, "3 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x0c, "4 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x10, "4 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x14, "5 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x18, "5 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x1c, "5 Coins = 3 Bonus" );	PORT_DIPNAME( 0x20, 0x00, "Left Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x20, "x2" );	PORT_DIPNAME( 0xc0, 0x00, "Right Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x40, "x4" );	PORT_DIPSETTING(    0x80, "x5" );	PORT_DIPSETTING(    0xc0, "x6" );
		PORT_START(); 	/* IN1 */
		PORT_DIPNAME( 0x80, 0x00, "Bug Generation" );	PORT_DIPSETTING(    0x00, "Regular" );	PORT_DIPSETTING(    0x80, "None" );	PORT_DIPNAME( 0x40, 0x00, "Bee In Game?" );	PORT_DIPSETTING(    0x40, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x20, DEF_STR( "On") );
		PORT_BIT( 0x18, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x04, 0x04, "Kid on Left Located?" );	PORT_DIPSETTING(    0x04, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x02, 0x02, "Kid on Right Located?" );	PORT_DIPSETTING(    0x02, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x01, 0x01, "Display Kids?" );	PORT_DIPSETTING(    0x00, DEF_STR( "No") );
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x00, "4" );	PORT_DIPSETTING(    0x01, "5" );	PORT_DIPNAME( 0x0c, 0x04, "Minimum Game Time" );	PORT_DIPSETTING(    0x08, "45" );	PORT_DIPSETTING(    0x04, "60" );	PORT_DIPSETTING(    0x00, "90" );	PORT_DIPSETTING(    0x0c, "120" );	PORT_BIT( 0x30, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x40, 0x40, "Keep High Scores" );	PORT_DIPSETTING(    0x40, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
