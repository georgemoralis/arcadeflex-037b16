...
public class liberatr
{
	...
	public static Memory_ReadAddress liberatr_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0002, 0x0002, liberatr_bitmap_xy_r ),
	...
	public static Memory_WriteAddress liberatr_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0002, 0x0002, liberatr_bitmap_xy_w ),
