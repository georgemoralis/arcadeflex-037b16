...
public class blstroid
{
	...
	static RomLoadPtr rom_blstroid = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x040000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "blstroid.1l",  0x000000, 0x10000, 0x3c2daa5b );/* playfield */
		...
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "blstroid.5m",  0x000000, 0x10000, 0x50e0823f );/* mo */
