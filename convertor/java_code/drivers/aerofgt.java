...
public class aerofgt
{
	...
	public static IO_ReadPort turbofrc_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x14, 0x14, soundlatch_r ),
	...
	public static IO_WritePort turbofrc_sound_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, aerofgt_sh_bankswitch_w ),
	...
	public static IO_ReadPort aerofgt_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x00, YM2610_status_port_0_A_r ),
	...
	public static IO_WritePort aerofgt_sound_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, YM2610_control_port_0_A_w ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_pspikes = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "g7h",          0x000000, 0x80000, 0x74c23c3d );
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "g7j",          0x000000, 0x80000, 0x0b9e4739 );	ROM_LOAD( "g7l",          0x080000, 0x80000, 0x943139ff );
	...
	static RomLoadPtr rom_spinlbrk = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ic15",         0x000000, 0x80000, 0xe318cf3a );	ROM_LOAD( "ic9",          0x080000, 0x80000, 0xe071f674 );
		ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "ic17",         0x000000, 0x80000, 0xa63d5a55 );	ROM_LOAD( "ic11",         0x080000, 0x80000, 0x7dcc913d );	ROM_LOAD( "ic16",         0x100000, 0x80000, 0x0d84af7f );//FIRST AND SECOND HALF IDENTICAL
	
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "ic12",         0x000000, 0x80000, 0xd63fac4e );	ROM_LOAD( "ic18",         0x080000, 0x80000, 0x5a60444b );
		ROM_REGION( 0x200000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "ic14",         0x000000, 0x80000, 0x1befd0f3 );	ROM_LOAD( "ic20",         0x080000, 0x80000, 0xc2f84a61 );	ROM_LOAD( "ic35",         0x100000, 0x80000, 0xeba8e1a3 );	ROM_LOAD( "ic40",         0x180000, 0x80000, 0x5ef5aa7e );
	...
	static RomLoadPtr rom_karatblz = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "gha.u55",      0x00000, 0x80000, 0x3e0cea91 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "gh9.u61",      0x00000, 0x80000, 0x5d1676bd );
		ROM_REGION( 0x400000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "u42",          0x000000, 0x100000, 0x65f0da84 );	ROM_LOAD( "3.u44",        0x100000, 0x020000, 0x34bdead2 );	ROM_LOAD( "u43",          0x200000, 0x100000, 0x7b349e5d );	ROM_LOAD( "4.u45",        0x300000, 0x020000, 0xbe4d487d );
		ROM_REGION( 0x100000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "u59.ghb",      0x000000, 0x80000, 0x158c9cde );	ROM_LOAD( "ghd.u60",      0x080000, 0x80000, 0x73180ae3 );
	...
	static RomLoadPtr rom_turbofrc = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0a0000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "tfrcu94.bin",  0x000000, 0x80000, 0xbaa53978 );	ROM_LOAD( "tfrcu95.bin",  0x080000, 0x20000, 0x71a6c573 );
		ROM_REGION( 0x0a0000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "tfrcu105.bin", 0x000000, 0x80000, 0x4de4e59e );	ROM_LOAD( "tfrcu106.bin", 0x080000, 0x20000, 0xc6479eb5 );
		ROM_REGION( 0x200000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "tfrcu116.bin", 0x000000, 0x80000, 0xdf210f3b );	ROM_LOAD( "tfrcu118.bin", 0x080000, 0x40000, 0xf61d1d79 );	ROM_LOAD( "tfrcu117.bin", 0x100000, 0x80000, 0xf70812fd );	ROM_LOAD( "tfrcu119.bin", 0x180000, 0x40000, 0x474ea716 );
		ROM_REGION( 0x100000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "tfrcu134.bin", 0x000000, 0x80000, 0x487330a2 );	ROM_LOAD( "tfrcu135.bin", 0x080000, 0x80000, 0x3a7e5b6d );
	...
	static RomLoadPtr rom_aerofgt = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "538a54.124",   0x000000, 0x80000, 0x4d2c4df2 );	ROM_LOAD( "1538a54.124",  0x080000, 0x80000, 0x286d109e );
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "538a53.u9",    0x000000, 0x100000, 0x630d8e0b );
		ROM_REGION( 0x080000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "534g8f.u18",   0x000000, 0x80000, 0x76ce0926 );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );/* sound samples */
	...
	static RomLoadPtr rom_aerofgtb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "it-19-03",     0x000000, 0x80000, 0x85eba1a4 );
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "it-19-02",     0x000000, 0x80000, 0x4f57f8ba );
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "it-19-04",     0x000000, 0x80000, 0x3b329c1f );	ROM_LOAD( "it-19-05",     0x080000, 0x80000, 0x02b525af );
		ROM_REGION( 0x080000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "g27",          0x000000, 0x40000, 0x4d89cbc8 );	ROM_LOAD( "g26",          0x040000, 0x40000, 0x8072c1d2 );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );/* sound samples */
		ROM_LOAD( "it-19-01",     0x00000, 0x40000, 0x6d42723d );
		ROM_REGION( 0x100000, REGION_SOUND2, 0 );/* sound samples */
		ROM_LOAD( "it-19-06",     0x000000, 0x100000, 0xcdbbdb1d );ROM_END(); }}; 
