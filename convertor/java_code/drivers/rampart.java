...
public class rampart
{
	...
	static RomLoadPtr rom_rampart = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x148000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "082-1033.13l", 0x00000, 0x80000, 0x5c36795f )
		...
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "082-1009.2n",   0x000000, 0x20000, 0x23b95f59 );
	...
	static RomLoadPtr rom_ramprt2p = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "10192n.rom",   0x000000, 0x20000, 0xefa38bef );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );/* ADPCM data */
		ROM_LOAD( "082-1007.2d", 0x00000, 0x20000, 0xc96a0fc3 );	ROM_LOAD( "082-1008.1d", 0x20000, 0x20000, 0x518218d9 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_rampartj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x148000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "3451.bin",  0x00000, 0x20000, 0xc6596d32 )
		...
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "2419.bin",   0x000000, 0x20000, 0x456a8aae );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );/* ADPCM data */
		ROM_LOAD( "082-1007.2d", 0x00000, 0x20000, 0xc96a0fc3 );	ROM_LOAD( "082-1008.1d", 0x20000, 0x20000, 0x518218d9 );ROM_END(); }}; 
