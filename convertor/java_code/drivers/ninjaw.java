...
public class ninjaw
{
	...
	***********************************************************/
	...
	PORT_START();  /* DSW A */
		...
		PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_DIPSETTING(    0x00, "6" );	PORT_BITX(    0x40, 0x40, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	*************************************************************/
	...
	static MachineDriver machine_driver_ninjaw = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_M68000,
				16000000/2,	/* 8 MHz ? */
				ninjaw_readmem,ninjaw_writemem,null,null,
				ninjaw_interrupt, 1
			),
			new MachineCPU(
			...
			new MachineCPU(
				CPU_M68000,
				16000000/2,	/* 8 MHz ? */
				ninjaw_cpub_readmem,ninjaw_cpub_writemem,null,null,
				ninjaw_interrupt, 1
			),
		},
		...
		/* video hardware */
		110*8, 32*8, new rectangle( 0*8, 108*8-1, 3*8, 31*8-1 ),
	...
	static MachineDriver machine_driver_darius2 = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_M68000,
				16000000/2,	/* 8 MHz ? */
				darius2_readmem,darius2_writemem,null,null,
				ninjaw_interrupt, 1
			),
			new MachineCPU(
				CPU_Z80 | CPU_AUDIO_CPU,
			...
			new MachineCPU(
				CPU_M68000,
				16000000/2,	/* 8 MHz ? */
				darius2_cpub_readmem,darius2_cpub_writemem,null,null,
				ninjaw_interrupt, 1
			),
		},
		60, DEFAULT_60HZ_VBLANK_DURATION,	/* frames per second, vblank duration */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_ninjaw = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "b31_37.11",  0x00000, 0x04000, 0x0ca5799d );	ROM_CONTINUE(           0x10000, 0x1c000 ); /* banked stuff */
	
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "b31-01.23", 0x00000, 0x80000, 0x8e8237a7 );/* SCR (screen 1) */
		ROM_LOAD( "b31-02.24", 0x80000, 0x80000, 0x4c3b4e33 );
		ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "b31-07.176", 0x000000, 0x80000, 0x33568cdb );/* OBJ */
		ROM_LOAD( "b31-06.175", 0x080000, 0x80000, 0x0d59439e );	ROM_LOAD( "b31-05.174", 0x100000, 0x80000, 0x0a1fc9fb );	ROM_LOAD( "b31-04.173", 0x180000, 0x80000, 0x2e1e4cb5 );
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_COPY( REGION_GFX1, 0x000000, 0x000000, 0x100000 )	/* SCR (screens 2+) */
	...
	//	ROM_LOAD( "b31-02.27", 0x80000, 0x80000, 0x4c3b4e33 );//	ROM_LOAD( "b31-01.28", 0x00000, 0x80000, 0x8e8237a7 );/* SCR (screen 3) */
	//	ROM_LOAD( "b31-02.29", 0x80000, 0x80000, 0x4c3b4e33 );
		ROM_REGION( 0x180000, REGION_SOUND1, 0 );/* ADPCM samples */
		ROM_LOAD( "b31-09.18", 0x000000, 0x80000, 0x60a73382 );	ROM_LOAD( "b31-10.17", 0x080000, 0x80000, 0xc6434aef );	ROM_LOAD( "b31-11.16", 0x100000, 0x80000, 0x8da531d4 );
		...
		ROM_LOAD( "b31-25.38", 0x00000, 0x200, 0xa0b4ba48 );	ROM_LOAD( "b31-26.58", 0x00000, 0x200, 0x13e5fe15 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_darius2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2c000, REGION_CPU2, 0 );/* sound cpu */
		ROM_LOAD( "c07-28",  0x00000, 0x04000, 0xda304bc5 );	ROM_CONTINUE(            0x10000, 0x1c000 ); /* banked stuff */
		...
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "c07-01", 0x00000, 0x80000, 0x3cf0f050 );/* OBJ */
		...
		ROM_REGION( 0x80000, REGION_SOUND2, 0 );/* Delta-T samples */
		ROM_LOAD( "c07-12.107", 0x00000, 0x80000, 0xe0b71258 );ROM_END(); }}; 
