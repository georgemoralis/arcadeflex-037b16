...
public class tunhunt
{
	...
	void tunhunt_vh_convert_color_prom(
			UBytePtr palette, unsigned short *colortable, const UBytePtr color_prom )
	{
	...
	*/
	...
	{
	//	const UBytePtr color_prom = memory_region( REGION_PROMS );
	/*
	...
	*/
	...
	public static VhUpdatePtr tunhunt_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		const UINT8 *pMem = memory_region( REGION_CPU1 );
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x03ff, MRA_RAM ), /* Work RAM */
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x03ff, MWA_RAM ), /* Work RAM */
	...
	PORT_START(); 
		PORT_BIT ( 0x01, IP_ACTIVE_HIGH, IPT_TILT );	PORT_BIT ( 0x02, IP_ACTIVE_HIGH, IPT_BUTTON1 );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Service_Mode") );
		PORT_DIPSETTING (	0x00, DEF_STR( "Off") );
		PORT_DIPSETTING (	0x04, DEF_STR( "On") );
		PORT_BIT ( 0x08, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT ( 0x10, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT ( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 );	PORT_BIT ( 0x40, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT ( 0x80, IP_ACTIVE_LOW, IPT_VBLANK );
		PORT_START(); 
		...
		PORT_DIPSETTING (     0x0000, "*1" );	PORT_DIPSETTING (     0x0004, "*4" );	PORT_DIPSETTING (     0x0008, "*5" );	PORT_DIPSETTING (     0x000c, "*6" );	PORT_DIPNAME (0x0010, 0x0000, DEF_STR( "Coin_A") );
		PORT_DIPSETTING (     0x0000, "*1" );	PORT_DIPSETTING (     0x0010, "*2" );	PORT_DIPNAME (0x0060, 0x0000, "Bonus Credits" );	PORT_DIPSETTING (     0x0000, "None" );	PORT_DIPSETTING (     0x0060, "5 credits, 1 bonus" );	PORT_DIPSETTING (     0x0040, "4 credits, 1 bonus" );	PORT_DIPSETTING (     0x0020, "2 credits, 1 bonus" );	PORT_DIPNAME (0x0880, 0x0000, "Language" );	PORT_DIPSETTING (     0x0000, "English" );	PORT_DIPSETTING (     0x0080, "German" );	PORT_DIPSETTING (     0x0800, "French" );	PORT_DIPSETTING (     0x0880, "Spanish" );	PORT_DIPNAME (0x0100, 0x0000, DEF_STR( "Unknown") );
		PORT_DIPSETTING (     0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING (     0x0100, DEF_STR( "On") );
		PORT_DIPNAME (0x0600, 0x0200, DEF_STR( "Lives") );
		PORT_DIPSETTING (     0x0000, "2" );	PORT_DIPSETTING (     0x0200, "3" );	PORT_DIPSETTING (     0x0400, "4" );	PORT_DIPSETTING (     0x0600, "5" );	PORT_DIPNAME (0x1000, 0x1000, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING (     0x1000, "30000" );	PORT_DIPSETTING (     0x0000, "None" );INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_tunhunt = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );	ROM_LOAD( "001.lm1",	0x5000, 0x800, 0x2601a3a4 );	ROM_LOAD( "002.k1",		0x5800, 0x800, 0x29bbf3df );	ROM_LOAD( "003.j1",		0x6000, 0x800, 0x360c0f47 );/* bad crc? fails self-test */
						/* 0xcaa6bb2a: alternate prom (re)dumped by Al also fails */
		ROM_LOAD( "004.fh1",	0x6800, 0x800, 0x4d6c920e );	ROM_LOAD( "005.ef1",	0x7000, 0x800, 0xe17badf0 );	ROM_LOAD( "006.d1",		0x7800, 0x800, 0xc3ae8519 );	ROM_RELOAD( 		  	0xf800, 0x800 );/* 6502 vectors  */
		...
		ROM_LOAD( "016.a8",		0x000, 0x200, 0x830e6c34 );	ROM_LOAD( "017.b8",		0x200, 0x200, 0x5bef8b5a );
		ROM_REGION( 0x540, REGION_PROMS, 0 );	ROM_LOAD( "013.d11",	0x000, 0x020, 0x66f1f5eb );/* hue: BBBBGGGG? */
