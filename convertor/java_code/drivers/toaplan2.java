...
public class toaplan2
{
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr toaplan2_coin_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		if ((data & 0x0f) != 0)
		{
			coin_lockout_w.handler( 0, ((data & 4) ? 0 : 1) );
			coin_lockout_w.handler( 1, ((data & 8) ? 0 : 1) );
			coin_counter_w.handler( 0, (data & 1) ); coin_counter_w.handler( 0, 0 );
			coin_counter_w.handler( 1, (data & 2) ); coin_counter_w.handler( 1, 0 );
		}
		else
		{
	...
	***************************************************************************/
	...
	public static IO_ReadPort batrider_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x48, 0x4a, batrider_sound_data_z80_r ),
	...
	public static IO_WritePort batrider_sound_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x40, 0x46, batrider_sound_data_z80_w ),
	...
	public static Memory_ReadAddress Zx80_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x00000, 0x03fff, MRA_ROM ),
	...
	public static Memory_WriteAddress Zx80_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x00000, 0x03fff, MWA_ROM, ),
	...
	public static IO_ReadPort Zx80_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x0060, 0x0060, input_port_4_r ),		/* Directly mapped I/O ports */
	...
	*****************************************************************************/
	...
	//	NONEUROPEAN_COINAGE_8
		...
		PORT_DIPSETTING(	0x00, "100k and every 200k" );	PORT_DIPSETTING(	0x04, "100k and every 300k" );	PORT_DIPSETTING(	0x08, "100k only" );	PORT_DIPSETTING(	0x0c, "None" );	LIVES_8
		PORT_BITX(	  0x40,	0x00, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(	0x00, DEF_STR( "Off") );
	...
	//	NONEUROPEAN_COINAGE_16
		...
		PORT_DIPSETTING(		0x0004, "200k, 400k and 600k" );	PORT_DIPSETTING(		0x0000, "200k only" );	PORT_DIPSETTING(		0x0008, "400k only" );	PORT_DIPSETTING(		0x000c, "None" );	LIVES_16
		PORT_BITX(	  0x0040,	0x0000, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
	...
	*/
	...
	//	NONEUROPEAN_COINAGE_16
		...
		DIFFICULTY_16
		PORT_DIPNAME( 0x000c,	0x0000, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(		0x0000, "100k and every 400k" );	PORT_DIPSETTING(		0x0004, "100k only" );	PORT_DIPSETTING(		0x0008, "200k only" );	PORT_DIPSETTING(		0x000c, "None" );	/* Lives are different in this game */
		PORT_DIPNAME( 0x0030,	0x0000, DEF_STR( "Lives") );
	...
	//	NONEUROPEAN_COINAGE_16
		...
		DIFFICULTY_16
		PORT_DIPNAME( 0x000c,	0x0000, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(		0x0000, "70k and 200k" );	PORT_DIPSETTING(		0x0004, "100k and 250k" );	PORT_DIPSETTING(		0x0008, "100k only" );	PORT_DIPSETTING(		0x000c, "200k only" );	LIVES_16
		PORT_BITX(	  0x0040,	0x0000, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0040, DEF_STR( "On") );
		PORT_DIPNAME( 0x0080,	0x0000, "Allow Continue" );	PORT_DIPSETTING(		0x0080, DEF_STR( "No") );
		PORT_DIPSETTING(		0x0000, DEF_STR( "Yes") );
	...
	//	NONEUROPEAN_COINAGE_8
		...
		DIFFICULTY_8
		PORT_DIPNAME( 0x0c,	0x00, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(	0x04, "150k and every 200k" );	PORT_DIPSETTING(	0x00, "200k and every 300k" );	PORT_DIPSETTING(	0x08, "200k only" );	PORT_DIPSETTING(	0x0c, "None" );	LIVES_8
		PORT_BITX(	  0x40,	0x00, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(	0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(	0x40, DEF_STR( "On") );
		PORT_DIPNAME( 0x80,	0x00, DEF_STR( "Unused") );
		PORT_DIPSETTING(	0x00, DEF_STR( "Off") );
		...
		PORT_DIPNAME( 0x08,	0x00, "Nudity" );	PORT_DIPSETTING(	0x08, "Low" );	PORT_DIPSETTING(	0x00, "High, but censored" );	PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	//	EUROPEAN_COINAGE_8
		...
		PORT_START(); 		/* (6) Territory Jumper block */
		PORT_DIPNAME( 0x07,	0x00, "Territory" );	PORT_DIPSETTING(	0x06, "Europe" );	PORT_DIPSETTING(	0x04, "USA" );	PORT_DIPSETTING(	0x00, "Japan" );	PORT_DIPSETTING(	0x02, "Hong Kong" );	PORT_DIPSETTING(	0x03, "Taiwan" );	PORT_DIPSETTING(	0x01, "Asia" );	PORT_DIPSETTING(	0x07, "Europe (Nova Apparate GMBH & Co); )
		PORT_DIPSETTING(	0x05, "USA (Romstar); )
		PORT_DIPNAME( 0x08,	0x08, "Nudity" );	PORT_DIPSETTING(	0x08, "Low" );	PORT_DIPSETTING(	0x00, "High, but censored" );	PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* bit 0x10 sound ready */
	INPUT_PORTS_END(); }}; 
	...
	//	PORT_DIPSETTING(	0x03, "World" );	PORT_DIPNAME( 0x08,	0x00, "Nudity" );	PORT_DIPSETTING(	0x08, "Low" );	PORT_DIPSETTING(	0x00, "High, but censored" );	PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 		/* (0) VBlank */
		...
		PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x0002, IP_ACTIVE_HIGH, IPT_TILT );	PORT_BITX(0x0004, IP_ACTIVE_HIGH, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x0040, IP_ACTIVE_HIGH, IPT_START2 );	PORT_BIT( 0xff80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
	#if 0
		PORT_START(); 		/* Fake input, to display message */
		PORT_DIPNAME( 0x00,	0x00, "    Press service button" );	PORT_DIPSETTING(	0x00, "" );	PORT_DIPNAME( 0x00,	0x00, "  for game keeping options" );	PORT_DIPSETTING(	0x00, "" );	PORT_DIPNAME( 0x00,	0x00, "" );	PORT_DIPSETTING(	0x00, "" );#endif
	
		PORT_START(); 		/* (4) DSWA */
		PORT_DIPNAME( 0x0001,	0x0000, "Maximum Players" );	PORT_DIPSETTING(		0x0000, "2" );	PORT_DIPSETTING(		0x0001, "3" );	PORT_DIPNAME( 0x0002,	0x0000, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0002, DEF_STR( "On") );
		PORT_DIPNAME( 0x0004,	0x0004, "Shooting style" );	PORT_DIPSETTING(		0x0004, "Semi-auto" );	PORT_DIPSETTING(		0x0000, "Fully-auto" );	PORT_DIPNAME( 0x0008,	0x0000, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(		0x0008, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0000, DEF_STR( "On") );
		EUROPEAN_COINAGE_16
	//	NONEUROPEAN_COINAGE_16
		...
		DIFFICULTY_16
		PORT_DIPNAME( 0x000c,	0x0000, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(		0x0004, "300k and every 300k" );	PORT_DIPSETTING(		0x0008, "300k only" );	PORT_DIPSETTING(		0x0000, "500k and every 500k" );	PORT_DIPSETTING(		0x000c, "None" );	LIVES_16
		PORT_BITX(	  0x0040,	0x0000, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0040, DEF_STR( "On") );
		PORT_DIPNAME( 0x0080,	0x0000, "Allow Continue" );	PORT_DIPSETTING(		0x0080, DEF_STR( "No") );
		PORT_DIPSETTING(		0x0000, DEF_STR( "Yes") );
		...
		PORT_START(); 		/* (6) Territory Jumper block */
		PORT_DIPNAME( 0x0f,	0x09, "Territory" );	PORT_DIPSETTING(	0x09, "Europe" );	PORT_DIPSETTING(	0x08, "Europe (Taito Corp); )
		PORT_DIPSETTING(	0x0b, "USA" );	PORT_DIPSETTING(	0x0a, "USA (Taito America Corp); )
		PORT_DIPSETTING(	0x0e, "Japan" );	PORT_DIPSETTING(	0x0f, "Japan (Taito corp); )
		PORT_DIPSETTING(	0x01, "Korea" );	PORT_DIPSETTING(	0x00, "Korea (Taito Corp); )
		PORT_DIPSETTING(	0x03, "Hong Kong" );	PORT_DIPSETTING(	0x02, "Hong Kong (Taito Corp); )
		PORT_DIPSETTING(	0x05, "Taiwan" );	PORT_DIPSETTING(	0x04, "Taiwan (Taito corp); )
		PORT_DIPSETTING(	0x07, "South East Asia" );	PORT_DIPSETTING(	0x06, "South East Asia (Taito corp); )
		PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	//	NONEUROPEAN_COINAGE_16
		...
		DIFFICULTY_16
		PORT_DIPNAME( 0x000c,	0x0000, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(		0x0008, "200k only" );	PORT_DIPSETTING(		0x0004, "300k and every 800k" );	PORT_DIPSETTING(		0x0000, "300k and 800k" );	PORT_DIPSETTING(		0x000c, "None" );	LIVES_16
		PORT_BITX(	  0x0040,	0x0000, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0040, DEF_STR( "On") );
		PORT_DIPNAME( 0x0080,	0x0000, "Allow Continue" );	PORT_DIPSETTING(		0x0080, DEF_STR( "No") );
		PORT_DIPSETTING(		0x0000, DEF_STR( "Yes") );
	...
	*/
	...
	//	NONEUROPEAN_COINAGE_16
		...
		DIFFICULTY_16
		PORT_DIPNAME( 0x000c,	0x0000, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(		0x0004, "500k and every 600k" );	PORT_DIPSETTING(		0x0000, "1000k only" );	PORT_DIPSETTING(		0x0008, "1500k only" );	PORT_DIPSETTING(		0x000c, "None" );	LIVES_16
		PORT_BITX(	  0x0040,	0x0000, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0040, DEF_STR( "On") );
		PORT_DIPNAME( 0x0080,	0x0000, "Allow Continue" );	PORT_DIPSETTING(		0x0080, DEF_STR( "No") );
		PORT_DIPSETTING(		0x0000, DEF_STR( "Yes") );
	...
	//	EUROPEAN_COINAGE_16
		...
		DIFFICULTY_16
		PORT_DIPNAME( 0x000c,	0x0000, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(		0x0004, "100k and every 500k" );	PORT_DIPSETTING(		0x0000, "100k only" );	PORT_DIPSETTING(		0x0008, "200k only" );	PORT_DIPSETTING(		0x000c, "None" );	/* Lives have one different value */
		PORT_DIPNAME( 0x0030,	0x0000, DEF_STR( "Lives") );
	...
	PORT_START(); 		/* (0) VBlank */
		...
		DIFFICULTY_16
		PORT_DIPNAME( 0x000c,	0x0000, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(		0x0004, "200k and 500k" );	PORT_DIPSETTING(		0x0000, "Every 300k" );	PORT_DIPSETTING(		0x0008, "200k only" );	PORT_DIPSETTING(		0x000c, "None" );	LIVES_16
		PORT_BITX(	  0x0040,	0x0000, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0040, DEF_STR( "On") );
		PORT_DIPNAME( 0x0080,	0x0000, "Allow Continue" );	PORT_DIPSETTING(		0x0080, DEF_STR( "No") );
		PORT_DIPSETTING(		0x0000, DEF_STR( "Yes") );
	...
	PORT_START(); 		/* (0) VBlank */
		...
		PORT_DIPNAME( 0x0002,	0x0000, "Credits to Start" );	PORT_DIPSETTING(		0x0000, "1" );	PORT_DIPSETTING(		0x0002, "2" );	PORT_DIPNAME( 0x001c,	0x0000, DEF_STR( "Coin_A") );
	...
	//	PORT_DIPNAME( 0x0020,	0x0000, "Stick Mode" );//	PORT_DIPSETTING(		0x0000, "Special" );//	PORT_DIPSETTING(		0x0020, "Normal" );//	PORT_DIPNAME( 0x0040,	0x0000, "Effect" );//	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
	//	PORT_DIPSETTING(		0x0040, DEF_STR( "On") );
	//	PORT_DIPNAME( 0x0080,	0x0000, "Music" );//	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
	//	PORT_DIPSETTING(		0x0080, DEF_STR( "On") );
		...
		PORT_DIPSETTING(		0x0030, "1" );	PORT_DIPSETTING(		0x0020, "2" );	PORT_DIPSETTING(		0x0000, "3" );	PORT_DIPSETTING(		0x0010, "4" );	PORT_DIPSETTING(		0x0040, "5" );	PORT_DIPSETTING(		0x0050, "6" );	PORT_BITX( 0,			0x0060, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite", 0, 0 );//	PORT_BITX( 0,			0x0070, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Invulnerability", 0, 0 );	PORT_DIPNAME( 0x0080,	0x0000, DEF_STR( "Bonus_Life") );
		/* Bonus_Life for Non European territories */
	//	PORT_DIPSETTING(		0x0000, "Every 1000k" );//	PORT_DIPSETTING(		0x0080, "1000k and 2000k" );	/* Bonus_Life values for European territories */
		PORT_DIPSETTING(		0x0080, "Every 2000k" );	PORT_DIPSETTING(		0x0000, "None" );	PORT_BIT( 0xff00, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 		/* (6) DSWC / Territory Jumper block */
		PORT_DIPNAME( 0x0004,	0x0000, "Allow Continue" );	PORT_DIPSETTING(		0x0004, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0008,	0x0000, "Stage Edit" );	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0008, DEF_STR( "On") );
		PORT_DIPNAME( 0x0003,	0x0001, "Territory" );	PORT_DIPSETTING(		0x0001, "Europe (German Tuning license); )
		PORT_DIPSETTING(		0x0002, "USA (Fabtek license); )
		PORT_DIPSETTING(		0x0000, "Japan" );	PORT_DIPSETTING(		0x0003, "Asia" );	PORT_BIT( 0xffe0, IP_ACTIVE_HIGH, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	
	static InputPortPtr input_ports_batrider = new InputPortPtr(){ public void handler() { 
	PORT_START(); 		/* (0) VBlank */
		PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_BIT( 0xfffe, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 		/* (1) Player Inputs */
		PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0100, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x8080, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 		/* (2) Coin/System and DSWC */
		PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x0002, IP_ACTIVE_HIGH, IPT_TILT );	PORT_BIT( 0x0004, IP_ACTIVE_HIGH, IPT_SERVICE1 );	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x0040, IP_ACTIVE_HIGH, IPT_START2 );	PORT_DIPNAME( 0x0100,	0x0000, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0100, DEF_STR( "On") );
		PORT_DIPNAME( 0x0200,	0x0000, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(		0x0200, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0400,	0x0000, "Stage Edit" );	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0400, DEF_STR( "On") );
		PORT_DIPNAME( 0x0800,	0x0000, "Allow Continue" );	PORT_DIPSETTING(		0x0800, DEF_STR( "Off") );
		PORT_DIPSETTING(		0x0000, DEF_STR( "On") );
		PORT_BITX(	  0x1000,	0x0000, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
	...
	//	PORT_DIPNAME( 0x2000,	0x0000, "Guest Player" );//	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
	//	PORT_DIPSETTING(		0x2000, DEF_STR( "On") );
	//	PORT_DIPNAME( 0x4000,	0x0000, "Player Select" );//	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
	//	PORT_DIPSETTING(		0x4000, DEF_STR( "On") );
	//	PORT_DIPNAME( 0x8000,	0x0000, "Special Course" );//	PORT_DIPSETTING(		0x0000, DEF_STR( "Off") );
	//	PORT_DIPSETTING(		0x8000, DEF_STR( "On") );
		...
		PORT_SERVICE( 0x0001,	IP_ACTIVE_HIGH );	/* Service Mode */
		PORT_DIPNAME( 0x0002,	0x0000, "Credits to Start" );	PORT_DIPSETTING(		0x0000, "1" );	PORT_DIPSETTING(		0x0002, "2" );	/* When Coin_A is set to Free_Play, dip 0x0002 becomes: */
	//	PORT_DIPNAME( 0x0002,	0x0000, "Stick Mode" );//	PORT_DIPSETTING(		0x0000, "Normal" );//	PORT_DIPSETTING(		0x0002, "Special" );	PORT_DIPNAME( 0x001c,	0x0000, DEF_STR( "Coin_A") );
		PORT_DIPSETTING(		0x0018, DEF_STR( "4C_1C") );
		PORT_DIPSETTING(		0x0014, DEF_STR( "3C_1C") );
		PORT_DIPSETTING(		0x0010, DEF_STR( "2C_1C") );
		PORT_DIPSETTING(		0x0000, DEF_STR( "1C_1C") );
	...
	//	PORT_DIPNAME( 0x0020,	0x0000, "Hit Score" );//	PORT_DIPSETTING(		0x0020, DEF_STR( "Off") );
	//	PORT_DIPSETTING(		0x0000, DEF_STR( "On") );
	//	PORT_DIPNAME( 0x0040,	0x0000, "Sound Effect" );//	PORT_DIPSETTING(		0x0040, DEF_STR( "Off") );
	//	PORT_DIPSETTING(		0x0000, DEF_STR( "On") );
	//	PORT_DIPNAME( 0x0080,	0x0000, "Music" );//	PORT_DIPSETTING(		0x0080, DEF_STR( "Off") );
	//	PORT_DIPSETTING(		0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0300,	0x0000, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(		0x0100, "Easy" );	PORT_DIPSETTING(		0x0000, "Medium" );	PORT_DIPSETTING(		0x0200, "Hard" );	PORT_DIPSETTING(		0x0300, "Hardest" );	PORT_DIPNAME( 0x0c00,	0x0000, "Timer" );	PORT_DIPSETTING(		0x0400, "Easy" );	PORT_DIPSETTING(		0x0000, "Medium" );	PORT_DIPSETTING(		0x0800, "Hard" );	PORT_DIPSETTING(		0x0c00, "Hardest" );	PORT_DIPNAME( 0x3000,	0x0000, DEF_STR( "Lives") );
		PORT_DIPSETTING(		0x3000, "1" );	PORT_DIPSETTING(		0x2000, "2" );	PORT_DIPSETTING(		0x0000, "3" );	PORT_DIPSETTING(		0x1000, "4" );	PORT_DIPNAME( 0xc000,	0x0000, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(		0x4000, "Every 1000k" );	PORT_DIPSETTING(		0x0000, "Every 1500k" );	PORT_DIPSETTING(		0x8000, "Every 2000k" );	PORT_DIPSETTING(		0xc000, "None" );INPUT_PORTS_END(); }}; 
	...
	static YM2151interface raizing_ym2151_interface = new YM2151interface
	(
		1,				/* 1 chip */
	...
	(
		1,						/* 1 chip */
		new int[] { 27000000/10/132 },	/* frequency (Hz). 2.7MHz to 6295 (using B mode) */
		new int[] { REGION_SOUND1 },		/* memory region */
		new int[] { 47 }
	);
	
	static OKIM6295interface raizing_okim6295_interface = new OKIM6295interface
	(
		1,						/* 1 chip */
		new int[] { 32000000/32/132 },	/* frequency (Hz) 1MHz to 6295 (using B mode) */
		new int[] { REGION_SOUND1 },		/* memory region */
		new int[] { 47 }
	);
	
	static OKIM6295interface battleg_okim6295_interface = new OKIM6295interface
	(
		1,						/* 1 chip */
		new int[] { 32000000/16/132 },	/* frequency (Hz). 2MHz to 6295 (using B mode) */
		new int[] { REGION_SOUND1 },		/* memory region */
		new int[] { 47 }
	);
	
	static OKIM6295interface batrider_okim6295_interface = new OKIM6295interface
	(
		2,										/* 2 chips */
		new int[] { 32000000/10/132, 32000000/10/165 },	/* frequency (Hz). 3.2MHz to two 6295 (using B mode / A mode) */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_tekipaki = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "tp020-4.bin", 0x000000, 0x080000, 0x3ebbe41e );	ROM_LOAD( "tp020-3.bin", 0x080000, 0x080000, 0x2d5e2201 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_ghox = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "tp021-03.u36", 0x000000, 0x080000, 0xa15d8e9d );	ROM_LOAD( "tp021-04.u37", 0x080000, 0x080000, 0x26ed1c9a );ROM_END(); }}; 
	...
	//	ROM_LOAD( "tp022.mcu", 0x00000, 0x08000, 0x00000000 );#endif
		...
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD16_WORD_SWAP( "tp022_3.r16", 0x000000, 0x100000, 0x191b595f )
		ROM_LOAD16_WORD_SWAP( "tp022_4.r16", 0x100000, 0x100000, 0xd58d29ca )
	
		ROM_REGION( 0x400000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD16_WORD_SWAP( "tp022_5.r16", 0x000000, 0x200000, 0xd4c1db45 )
	...
	static RomLoadPtr rom_kbash = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "kbash02.bin", 0x80000, 0x08000, 0x4cd882a1 );#else
		ROM_REGION( 0x08000, REGION_USER1, 0 );	ROM_LOAD( "kbash02.bin", 0x00200, 0x07e00, 0x4cd882a1 );	ROM_CONTINUE(			 0x00000, 0x00200 );#endif
	
		ROM_REGION( 0x800000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "kbash03.bin", 0x000000, 0x200000, 0x32ad508b );	ROM_LOAD( "kbash05.bin", 0x200000, 0x200000, 0xb84c90eb );	ROM_LOAD( "kbash04.bin", 0x400000, 0x200000, 0xe493c077 );	ROM_LOAD( "kbash06.bin", 0x600000, 0x200000, 0x9084b50a );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );	/* ADPCM Samples */
	...
	static RomLoadPtr rom_truxton2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "tp024_4.bin", 0x000000, 0x100000, 0x805c449e );	ROM_LOAD( "tp024_3.bin", 0x100000, 0x100000, 0x47587164 );
		ROM_REGION( 0x80000, REGION_SOUND1, 0 );		/* ADPCM Samples */
		ROM_LOAD( "tp024_2.bin", 0x00000, 0x80000, 0xf2f6cae4 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_pipibibs = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "tp025-4.bin", 0x000000, 0x100000, 0xab97f744 );	ROM_LOAD( "tp025-3.bin", 0x100000, 0x100000, 0x7b16101e );ROM_END(); }}; 
	...
	static RomLoadPtr rom_pipibibi = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );	/* GFX data differs slightly from Toaplan boards ??? */
	...
	//	ROM_LOAD( "tp-026.mcu", 0x0000, 0x8000, 0x00000000 );#endif
		...
		ROM_REGION( 0x400000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "tp-026-3", 0x000000, 0x200000, 0xe5578d98 );	ROM_LOAD( "tp-026-4", 0x200000, 0x200000, 0xb760cb53 );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );		/* ADPCM Samples */
		ROM_LOAD( "tp-026-2", 0x00000, 0x40000, 0x85063f1f );
		ROM_REGION( 0x80, REGION_USER1, 0 );	/* Serial EEPROM (93C45) connected to Secondary CPU */
	...
	//	ROM_LOAD( "tp027.mcu", 0x8000, 0x8000, 0x00000000 );#endif
		...
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "tp027_02.bin", 0x000000, 0x100000, 0x877b45e8 );	ROM_LOAD( "tp027_03.bin", 0x100000, 0x100000, 0xb1fc6362 );ROM_END(); }}; 
	...
	//	ROM_LOAD( "tp030.mcu", 0x8000, 0x8000, 0x00000000 );#endif
		...
		ROM_REGION( 0x400000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "tp030_3l.bin", 0x000000, 0x100000, 0x3024b793 );	ROM_LOAD( "tp030_3h.bin", 0x100000, 0x100000, 0xed75730b );	ROM_LOAD( "tp030_4l.bin", 0x200000, 0x100000, 0xfedb9861 );	ROM_LOAD( "tp030_4h.bin", 0x300000, 0x100000, 0xd482948b );
		ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "tp030_5.bin",  0x000000, 0x100000, 0xbcf5ba05 );	ROM_LOAD( "tp030_6.bin",  0x100000, 0x100000, 0x0666fecd );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );		/* ADPCM Samples */
	...
	static RomLoadPtr rom_snowbro2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x300000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "rom2-l", 0x000000, 0x100000, 0xe9d366a9 );	ROM_LOAD( "rom2-h", 0x100000, 0x080000, 0x9aab7a62 );	ROM_LOAD( "rom3-l", 0x180000, 0x100000, 0xeb06e332 );	ROM_LOAD( "rom3-h", 0x280000, 0x080000, 0xdf4a952a );
		ROM_REGION( 0x80000, REGION_SOUND1, 0 );		/* ADPCM Samples */
	...
	static RomLoadPtr rom_mahoudai = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ra_ma_01.03",  0x000000, 0x100000, 0x54e2bd95 );	ROM_LOAD( "ra_ma_01.04",  0x100000, 0x100000, 0x21cd378f );
		ROM_REGION( 0x008000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "ra_ma_01.05",  0x000000, 0x008000, 0xc00d1e80 );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );		/* ADPCM Samples */
	...
	static RomLoadPtr rom_shippumd = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ma02rom3.bin",  0x000000, 0x200000, 0x0e797142 );	ROM_LOAD( "ma02rom4.bin",  0x200000, 0x200000, 0x72a6fa53 );
		ROM_REGION( 0x008000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "ma02rom5.bin",  0x000000, 0x008000, 0x116ae559 );
		ROM_REGION( 0x80000, REGION_SOUND1, 0 );		/* ADPCM Samples */
	...
	static RomLoadPtr rom_battleg = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "snd.bin", 0x00000, 0x08000, 0x68632952 );	ROM_CONTINUE(        0x10000, 0x18000 );
		ROM_REGION( 0x800000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "rom4.bin",  0x000000, 0x200000, 0xb333d81f );	ROM_LOAD( "rom3.bin",  0x200000, 0x200000, 0x51b9ebfb );	ROM_LOAD( "rom2.bin",  0x400000, 0x200000, 0xb330e5e2 );	ROM_LOAD( "rom1.bin",  0x600000, 0x200000, 0x7eafdd70 );
		ROM_REGION( 0x010000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "text.bin", 0x000000, 0x010000, 0xb239cd05 );
		ROM_REGION( 0x140000, REGION_SOUND1, 0 );	/* ADPCM Samples */
		ROM_LOAD( "rom5.bin", 0x040000, 0x100000, 0xf6d49863 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_batrider = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "snd.u77", 0x00000, 0x08000, 0x56682696 );	ROM_CONTINUE(        0x10000, 0x38000 );
		ROM_REGION( 0x1000000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "rom-1.bin", 0x000000, 0x400000, 0x0df69ca2 );	ROM_LOAD( "rom-3.bin", 0x400000, 0x400000, 0x60167d38 );	ROM_LOAD( "rom-2.bin", 0x800000, 0x400000, 0x1bfea593 );	ROM_LOAD( "rom-4.bin", 0xc00000, 0x400000, 0xbee03c94 );
		...
		ROM_LOAD( "rom-6.bin", 0x040000, 0x100000, 0x2a1c2426 );ROM_END(); }}; 
	...
	public static GameDriver driver_mahoudai	   = new GameDriver("1993"	,"mahoudai"	,"toaplan2.java"	,rom_mahoudai,null	,machine_driver_mahoudai	,input_ports_mahoudai	,init_raizing	,ROT270_16BIT	,	"Raizing (Able license)", "Mahou Daisakusen (Japan)" )
	public static GameDriver driver_shippumd	   = new GameDriver("1994"	,"shippumd"	,"toaplan2.java"	,rom_shippumd,null	,machine_driver_shippumd	,input_ports_shippumd	,init_raizing	,ROT270_16BIT	,	"Raizing/8ing", "Shippu Mahou Daisakusen (Japan)" )
	public static GameDriver driver_battleg	   = new GameDriver("1996"	,"battleg"	,"toaplan2.java"	,rom_battleg,null	,machine_driver_battleg	,input_ports_battleg	,init_battleg	,ROT270_16BIT	,	"Raizing/8ing", "Battle Garegga" )
	public static GameDriver driver_batrider	   = new GameDriver("1998"	,"batrider"	,"toaplan2.java"	,rom_batrider,null	,machine_driver_batrider	,input_ports_batrider	,init_battleg	,ROT270_16BIT	,	"Raizing/8ing", "Armed Police Batrider (Japan, version B)" )
	public static GameDriver driver_batridra	   = new GameDriver("1998"	,"batridra"	,"toaplan2.java"	,rom_batridra,driver_batrider	,machine_driver_batrider	,input_ports_batrider	,init_battleg	,ROT270_16BIT	,	"Raizing/8ing", "Armed Police Batrider (Japan, version A)" )
}
