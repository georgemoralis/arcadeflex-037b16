...
public class quantum
{
	...
	static RomLoadPtr rom_quantum = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x014000, REGION_CPU1, 0 );    ROM_LOAD16_BYTE( "136016.201",   0x000000, 0x002000, 0x7e7be63a )
	...
	static RomLoadPtr rom_quantum1 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x014000, REGION_CPU1, 0 );    ROM_LOAD16_BYTE( "136016.101",   0x000000, 0x002000, 0x5af0bd5b )
	...
	static RomLoadPtr rom_quantump = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x014000, REGION_CPU1, 0 );    ROM_LOAD16_BYTE( "quantump.2e",  0x000000, 0x002000, 0x176d73d3 )
