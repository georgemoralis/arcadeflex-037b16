...
public class atarisy2
{
	...
	static RomLoadPtr rom_paperboy = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "vid_a06.bin",  0x000000, 0x08000, 0xb32ffddf );	/* playfield, planes 0/1 */
		...
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "vid_l06.bin",  0x000000, 0x08000, 0x067ef202 );/* motion objects, planes 0/1 */
		...
		ROM_REGION( 0x2000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "vid_t06.bin",  0x000000, 0x02000, 0x60d7aebb );/* alphanumerics */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_720 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1121.rom",     0x000000, 0x08000, 0x7adb5f9a );	/* playfield, planes 0/1 */
		...
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "1109.rom",     0x020000, 0x08000, 0x0a46b693 );/* motion objects, planes 0/1 */
		...
		ROM_REGION( 0x4000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "1125.rom",     0x000000, 0x04000, 0x6b7e2328 );/* alphanumerics */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_ssprint = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "136042.105",   0x020000, 0x08000, 0x911499fe );	/* playfield, planes 0/1 */
		...
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "136042.113",   0x000000, 0x08000, 0xf869b0fc );/* motion objects, planes 0/1 */
		...
		ROM_REGION( 0x4000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "136042.218",   0x000000, 0x04000, 0x8e500be1 ); /* alphanumerics */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_csprint = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "045-1105.6a",  0x000000, 0x08000, 0x3773bfbb );	/* playfield, planes 0/1 */
		...
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "045-1112.6t",  0x000000, 0x08000, 0xf869b0fc );/* motion objects, planes 0/1 */
		...
		ROM_REGION( 0x4000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "045-1117.4t",  0x000000, 0x04000, 0x82da786d ); /* alphanumerics */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_apb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1118",         0x000000, 0x08000, 0x93752c49 );	/* playfield, planes 0/1 */
		...
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "1105",         0x020000, 0x08000, 0x9b78a88e );/* motion objects, planes 0/1 */
		...
		ROM_REGION( 0x4000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "1125",         0x000000, 0x04000, 0x05a0341c );/* alphanumerics */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_apb2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1118",         0x000000, 0x08000, 0x93752c49 );	/* playfield, planes 0/1 */
		ROM_LOAD( "1120",         0x028000, 0x08000, 0x043086f8 );	ROM_CONTINUE(             0x008000, 0x08000 );	ROM_LOAD( "1122",         0x030000, 0x08000, 0x5ee79481 );	ROM_CONTINUE(             0x010000, 0x08000 );	ROM_LOAD( "1124",         0x038000, 0x08000, 0x27760395 );	ROM_CONTINUE(             0x018000, 0x08000 );	ROM_LOAD( "1117",         0x040000, 0x08000, 0xcfc3f8a3 );	/* playfield, planes 2/3 */
		ROM_LOAD( "1119",         0x068000, 0x08000, 0x68850612 );	ROM_CONTINUE(             0x048000, 0x08000 );	ROM_LOAD( "1121",         0x070000, 0x08000, 0xc7977062 );	ROM_CONTINUE(             0x050000, 0x08000 );	ROM_LOAD( "1123",         0x078000, 0x08000, 0x3c96c848 );	ROM_CONTINUE(             0x058000, 0x08000 );
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "1105",         0x020000, 0x08000, 0x9b78a88e );/* motion objects, planes 0/1 */
		ROM_CONTINUE(             0x000000, 0x08000 );	ROM_LOAD( "1106",         0x028000, 0x08000, 0x4787ff58 );	ROM_CONTINUE(             0x008000, 0x08000 );	ROM_LOAD( "1107",         0x030000, 0x08000, 0x0e85f2ac );	ROM_CONTINUE(             0x010000, 0x08000 );	ROM_LOAD( "1108",         0x038000, 0x08000, 0x70ff9308 );	ROM_CONTINUE(             0x018000, 0x08000 );	ROM_LOAD( "1113",         0x060000, 0x08000, 0x4a445356 );	ROM_CONTINUE(             0x040000, 0x08000 );	ROM_LOAD( "1114",         0x068000, 0x08000, 0xb9b27f3c );	ROM_CONTINUE(             0x048000, 0x08000 );	ROM_LOAD( "1115",         0x070000, 0x08000, 0xa7671dd8 );	ROM_CONTINUE(             0x050000, 0x08000 );	ROM_LOAD( "1116",         0x078000, 0x08000, 0x879fc7de );	ROM_CONTINUE(             0x058000, 0x08000 );	ROM_LOAD( "1101",         0x0a0000, 0x08000, 0x0ef13513 );/* motion objects, planes 2/3 */
