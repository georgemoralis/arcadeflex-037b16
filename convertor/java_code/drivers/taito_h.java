...
public class taito_h
{
	...
	***************************************************************************/
	...
	static YM2610interface syvalion_ym2610_interface = new YM2610interface
	(
		1,	/* 1 chip */
		8000000,	/* 4 MHz */
		new int[] { 30 },
	...
	static YM2610interface dleague_ym2610_interface = new YM2610interface
	(
		1,	/* 1 chip */
		8000000,	/* 4 MHz */
		new int[] { 30 },
	...
	***************************************************************************/
	...
	PORT_START();   /* DSW1 (0) */
		...
		PORT_DIPSETTING(    0x08, "1000k only" );	PORT_DIPSETTING(    0x0c, "1500k only" );	PORT_DIPSETTING(    0x04, "2000k only" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unused") );
		...
		PORT_START(); 	/* IN0 (2) */
		PORT_BIT( 0x01, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW,  IPT_SERVICE1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW,  IPT_TILT );	PORT_BIT( 0x40, IP_ACTIVE_LOW,  IPT_START1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW,  IPT_START2 );
		PORT_START(); 	/* IN1 (3) */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0e, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0xe0, IP_ACTIVE_LOW, IPT_UNKNOWN );
		...
		PORT_ANALOG( 0xff, 0x00, IPT_TRACKBALL_Y | IPF_PLAYER2 | IPF_CENTER | IPF_REVERSE, 30, 30, 0, 0 );INPUT_PORTS_END(); }}; 
	...
	PORT_START();   /* DSW1 (0) */
		...
		PORT_START(); 	/* IN1 (3) */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START3 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START4 );	PORT_BIT( 0xf0, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* IN2 (4) */
	...
	PORT_START();   /* DSW1 (0) */
		...
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x0c, 0x0c, "Innings per credit" );	PORT_DIPSETTING(    0x0c, "3-3-3" );	PORT_DIPSETTING(    0x08, "6-3" );	PORT_DIPSETTING(    0x04, "3-2-2-2" );	PORT_DIPSETTING(    0x00, "5-2-2" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unused") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_START(); 	/* IN1 (3) */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );
		PORT_START(); 	/* IN2 (4) */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_syvalion = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "b51-23.bin", 0x00000, 0x04000, 0x734662de );	ROM_CONTINUE(           0x10000, 0x0c000 );
		ROM_REGION( 0x400000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "b51-16.bin", 0x000000, 0x20000, 0xc0fcf7a5 )
		...
		ROM_LOAD( "b51-17.bin", 0x00000, 0x80000, 0xd85096aa );ROM_END(); }}; 
	...
	static RomLoadPtr rom_recordbr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1c000, REGION_CPU2, 0 );	/* sound cpu */
		ROM_LOAD( "b56-19.rom", 0x00000, 0x04000, 0xc68085ee );	ROM_CONTINUE(           0x10000, 0x0c000 );
		ROM_REGION( 0x400000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "b56-04",     0x000000, 0x20000, 0xf7afdff0 )
		...
		ROM_REGION( 0x80000, REGION_SOUND2, 0 );/* samples */
		ROM_LOAD( "b56-10.bin", 0x00000, 0x80000, 0xde1bce59 );ROM_END(); }}; 
	
	static RomLoadPtr rom_dleague = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "c02-19a.33", 0x00000, 0x20000, 0x7e904e45 )
		...
		ROM_REGION( 0x1c000, REGION_CPU2, 0 );	ROM_LOAD( "c02-23.40", 0x00000, 0x04000, 0x5632ee49 );	ROM_CONTINUE(          0x10000, 0x0c000 );
		ROM_REGION( 0x400000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD       ( "c02-02.15", 0x000000, 0x80000, 0xb273f854 );	ROM_LOAD16_BYTE( "c02-06.6",  0x080000, 0x20000, 0xb8473c7b )
		ROM_LOAD16_BYTE( "c02-10.14", 0x080001, 0x20000, 0x50c02f0f )
		ROM_LOAD       ( "c02-03.17", 0x100000, 0x80000, 0xc3fd0dcd );	ROM_LOAD16_BYTE( "c02-07.7",  0x180000, 0x20000, 0x8c1e3296 )
		ROM_LOAD16_BYTE( "c02-11.16", 0x180001, 0x20000, 0xfbe548b8 )
		ROM_LOAD       ( "c02-24.19", 0x200000, 0x80000, 0x18ef740a );	ROM_LOAD16_BYTE( "c02-08.8",  0x280000, 0x20000, 0x1a3c2f93 )
		ROM_LOAD16_BYTE( "c02-12.18", 0x280001, 0x20000, 0xb1c151c5 )
		ROM_LOAD       ( "c02-05.21", 0x300000, 0x80000, 0xfe3a5179 );	ROM_LOAD16_BYTE( "c02-09.9",  0x380000, 0x20000, 0xa614d234 )
		ROM_LOAD16_BYTE( "c02-13.20", 0x380001, 0x20000, 0x8eb3194d )
	
		ROM_REGION( 0x02000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "c02-18.22", 0x00000, 0x02000, 0xc88f0bbe );
		ROM_REGION( 0x80000, REGION_SOUND1, 0 );/* samples */
		ROM_LOAD( "c02-01.31", 0x00000, 0x80000, 0xd5a3d1aa );ROM_END(); }}; 
