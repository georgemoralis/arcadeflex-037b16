...
public class atarigx2
{
	...
	PORT_START(); 		/* 68.SW (A1=0) */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );					/* BLUE button */
		...
		PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	/* Throttle button */
		PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 );
		PORT_START(); 		/* 68.SW (A1=1) */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START2 );					/* RED button */
		...
		PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );
		...
		PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		...
		PORT_ANALOG ( 0x00ff, 0x0080, IPT_AD_STICK_X | IPF_PLAYER1, 100, 10, 0x10, 0xf0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		...
		PORT_ANALOG ( 0x00ff, 0x0080, IPT_AD_STICK_X | IPF_PLAYER2, 100, 10, 0x10, 0xf0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 		/* A2D @ 0xD00008 */
		PORT_ANALOG ( 0x00ff, 0x0080, IPT_AD_STICK_Y | IPF_PLAYER2, 100, 10, 0x10, 0xf0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	static MachineDriver machine_driver_atarigx2 = new MachineDriver
	(
	...
	static RomLoadPtr rom_spclords = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "136095.80a", 0x10000, 0x4000, 0x33bc0ede );	ROM_CONTINUE(           0x04000, 0xc000 );
		ROM_REGION( 0x60000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "136095.30a", 0x00000, 0x20000, 0x27e0cfec );/* playfield, planes 0-1 */
		ROM_LOAD( "136095.31a", 0x20000, 0x20000, 0x5529cdc7 );/* playfield, planes 2-3 */
		ROM_FILL(               0x40000, 0x20000, 0 )		   /* playfield, planes 4-5 */
	
		ROM_REGION( 0x020000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "136095.25a", 0x000000, 0x20000, 0x1669496e );/* alphanumerics */
		...
		ROM_LOAD( "136095.81a",  0x80000, 0x80000, 0x212560dd );ROM_END(); }}; 
	...
	static RomLoadPtr rom_motofren = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x14000, REGION_CPU2, 0 );/* 64k for 6502 code */
		ROM_LOAD( "mfs6502.bin", 0x10000, 0x4000, 0x0b1e565c );	ROM_CONTINUE(            0x04000, 0xc000 );
		ROM_REGION( 0x180000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "motof2d.bin", 0x000000, 0x80000, 0x1b63b493 );/* playfield, planes 0-1 */
		...
		ROM_REGION( 0x020000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "motof13n.bin", 0x000000, 0x20000, 0x6ab762ad );/* alphanumerics */
		...
		ROM_REGION( 0x100000, REGION_SOUND1, 0 );/* 1MB for ADPCM samples */
		ROM_LOAD( "mfadpcm.bin",  0x80000, 0x80000, 0xfde543c4 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_revrally = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x14000, REGION_CPU2, 0 );/* 64k for 6502 code */
		ROM_LOAD( "rr65snd.bin", 0x10000, 0x4000, 0xd78429da );	ROM_CONTINUE(            0x04000, 0xc000 );
		ROM_REGION( 0x180000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "rralpl.bin", 0x000000, 0x80000, 0x00488dad );/* playfield, planes 0-1 */
		...
		ROM_REGION( 0x020000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "rralalph.bin", 0x000000, 0x20000, 0x7ca93790 );/* alphanumerics */
		...
		ROM_REGION( 0x100000, REGION_SOUND1, 0 );/* 1MB for ADPCM samples */
		ROM_LOAD( "rralpc0.bin",  0x80000, 0x80000, 0x1f7b6ecf );	ROM_LOAD( "rralpc1.bin",  0x80000, 0x80000, 0x7ccd26d7 );ROM_END(); }}; 
	...
	public static GameDriver driver_spclords	   = new GameDriver("1992"	,"spclords"	,"atarigx2.java"	,rom_spclords,null	,machine_driver_atarigx2	,input_ports_spclords	,init_spclords	,ROT0_16BIT	,	"Atari Games", "Space Lords", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_spclorda	   = new GameDriver("1992"	,"spclorda"	,"atarigx2.java"	,rom_spclorda,driver_spclords	,machine_driver_atarigx2	,input_ports_spclords	,init_spclords	,ROT0_16BIT	,	"Atari Games", "Space Lords (alternate)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_motofren	   = new GameDriver("1992"	,"motofren"	,"atarigx2.java"	,rom_motofren,null	,machine_driver_atarigx2	,input_ports_spclords	,init_motofren	,ROT0_16BIT	,	"Atari Games", "Moto Frenzy", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_revrally	   = new GameDriver("1993"	,"revrally"	,"atarigx2.java"	,rom_revrally,null	,machine_driver_atarigx2	,input_ports_spclords	,init_revrally	,ROT0_16BIT	,	"Atari Games", "Road Riot Revenge Rally (Prototype)", GAME_UNEMULATED_PROTECTION )
}
