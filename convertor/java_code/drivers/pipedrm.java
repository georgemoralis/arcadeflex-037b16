...
public class pipedrm
{
	...
	public static IO_ReadPort readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x20, 0x20, input_port_0_r ),
	...
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x20, 0x20, sound_command_w ),
	...
	public static IO_ReadPort sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x16, 0x16, sound_command_r ),
	...
	public static IO_WritePort sound_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x04, 0x04, sound_bankswitch_w ),
	...
	public static IO_ReadPort hatris_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x04, 0x04, sound_command_r ),
	...
	public static IO_WritePort hatris_sound_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x02, 0x02, YM2608_control_port_0_B_w ),
	...
	static RomLoadPtr rom_pipedrm = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x20000, REGION_CPU1, 0 );	ROM_LOAD( "01.u12",	0x00000, 0x08000, 0x9fe261fb );	ROM_LOAD( "02.u11",	0x10000, 0x10000, 0xc8209b67 );
		ROM_REGION( 0x20000, REGION_CPU2, 0 );	ROM_LOAD( "4",	0x00000, 0x08000, 0x497fad4c );	ROM_LOAD( "3",	0x10000, 0x10000, 0x4800322a );
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "s73",    0x000000, 0x80000, 0x63f4e10c );	ROM_LOAD( "s72",    0x080000, 0x80000, 0x4e669e97 );
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "s71",    0x000000, 0x80000, 0x431485ee );	/* s72 will be copied here */
	
		ROM_REGION( 0x080000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "a30", 0x00000, 0x40000, 0x50bc5e98 )
		ROM_LOAD16_BYTE( "a29", 0x00001, 0x40000, 0xa240a448 )
	
		ROM_REGION( 0x80000, REGION_SOUND1, 0 );	ROM_LOAD( "g72",     0x00000, 0x80000, 0xdc3d14be );
		ROM_REGION( 0x80000, REGION_SOUND2, 0 );	ROM_LOAD( "g71",     0x00000, 0x80000, 0x488e2fd1 );ROM_END(); }}; 
	
	static RomLoadPtr rom_pipedrmj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x20000, REGION_CPU1, 0 );	ROM_LOAD( "1",	0x00000, 0x08000, 0xdbfac46b );	ROM_LOAD( "2",	0x10000, 0x10000, 0xb7adb99a );
		ROM_REGION( 0x20000, REGION_CPU2, 0 );	ROM_LOAD( "4",	0x00000, 0x08000, 0x497fad4c );	ROM_LOAD( "3",	0x10000, 0x10000, 0x4800322a );
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "s73",    0x000000, 0x80000, 0x63f4e10c );	ROM_LOAD( "s72",    0x080000, 0x80000, 0x4e669e97 );
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "s71",    0x000000, 0x80000, 0x431485ee );	/* s72 will be copied here */
	...
	static RomLoadPtr rom_hatris = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );	ROM_LOAD( "2-ic79.bin",	0x00000, 0x08000, 0xbbcaddbf );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "1-ic81.bin",	0x00000, 0x08000, 0xdb25e166 );
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "b0-ic56.bin", 0x00000, 0x20000, 0x34f337a4 );	ROM_FILL(                0x20000, 0x20000, 0 )
		ROM_LOAD( "b1-ic73.bin", 0x40000, 0x08000, 0x6351d0ba );	ROM_FILL(                0x48000, 0x18000, 0 )
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "a0-ic55.bin", 0x00000, 0x20000, 0x7b7bc619 );	ROM_LOAD( "a1-ic60.bin", 0x20000, 0x20000, 0xf74d4168 );
		ROM_REGION( 0x20000, REGION_SOUND1, 0 );	ROM_LOAD( "pc-ic53.bin", 0x00000, 0x20000, 0x07147712 );ROM_END(); }}; 
