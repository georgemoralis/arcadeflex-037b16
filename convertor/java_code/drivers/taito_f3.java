...
public class taito_f3
{
	...
	PORT_START(); 
		...
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_TILT );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_SERVICE1 );/* Service */
		...
		PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_START3 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_START4 );
		PORT_START(); 
		...
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNUSED );/* Another service mode */
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN4 );
		PORT_START(); 
		...
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER3 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER3 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER4 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER4 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER4 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER4 );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 
		...
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_TILT );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_SERVICE1 );/* Service */
		PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_SERVICE2 );/* Only on some games */
		PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_SERVICE3 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_START3 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_START4 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_SPECIAL );/* Eprom data bit */
		PORT_BITX(0x02, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNUSED );/* Another service mode */
		...
		PORT_ANALOGX( 0xfff, 0x000, IPT_DIAL | IPF_PLAYER2, 25, 25, 0, 0, KEYCODE_N, KEYCODE_M, 0, 0 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON5 | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON6 | IPF_PLAYER2 );	PORT_BIT( 0xf8, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON5 | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON6 | IPF_PLAYER1 );	PORT_BIT( 0xf8, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	static EEPROM_interface f3_eeprom_interface = new EEPROM_interface
	(
		6,				/* address bits */
		16,				/* data bits */
		"0110",			/* read command */
	...
	static MachineDriver machine_driver_f3 = new MachineDriver
	(
		...
		new MachineCPU[] {
		 	new MachineCPU(
				CPU_M68EC020,
				16000000,
				f3_readmem,f3_writemem,null,null,
				f3_interrupt,2
			),
			new MachineCPU(
		...
		f3_machine_reset,
	 	...
	 	/* video hardware */
		40*8+48*2, 32*8, new rectangle( 46, 40*8-1+46, 3*8, 32*8-1 ),
	...
	static RomLoadPtr rom_ringrage = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("d21-04.68", 0x600000, 0x200000, 0x9dcdceca );	ROM_FILL       (             0x400000, 0x200000, 0 )
		...
		ROM_LOAD       ("d21-08.51", 0x180000, 0x080000, 0xa0d95be9 );	ROM_FILL       (             0x100000, 0x080000, 0 )
	...
	static RomLoadPtr rom_arabianm = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("d29-05.rom", 0x300000, 0x100000, 0x9b5f7a17 );	ROM_FILL       (              0x200000, 0x100000, 0 )
	
		ROM_REGION(0x200000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("d29-06.rom", 0x000000, 0x080000, 0xeea07bf3 )
	  	ROM_LOAD16_BYTE("d29-07.rom", 0x000001, 0x080000, 0xdb3c094d )
		ROM_LOAD       ("d29-08.rom", 0x180000, 0x080000, 0xd7562851 );	ROM_FILL       (              0x100000, 0x080000, 0 )
	...
	static RomLoadPtr rom_gseeker = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_CONTINUE(0,0x80000);	ROM_LOAD16_BYTE("d40_15.rom", 0x000000, 0x080000, 0x50555125 )
	...
	static RomLoadPtr rom_cupfinal = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("d49-03", 0x900000, 0x200000, 0xcf9a8727 );	ROM_LOAD       ("d49-08", 0xb00000, 0x100000, 0x7d3c6536 );	ROM_FILL       (          0x600000, 0x300000, 0 )
	
		ROM_REGION(0x200000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("d49-09", 0x000000, 0x080000, 0x257ede01 )
		ROM_LOAD16_BYTE("d49-10", 0x000001, 0x080000, 0xf587b787 )
		ROM_LOAD       ("d49-11", 0x180000, 0x080000, 0x11318b26 );	ROM_FILL       (          0x100000, 0x080000, 0 )
	...
	static RomLoadPtr rom_trstar = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("d53-05.47", 0x900000, 0x200000, 0xb9b68b15 );	ROM_LOAD       ("d53-08.66", 0xb00000, 0x100000, 0xad13a1ee );	ROM_FILL       (             0x600000, 0x300000, 0 )
	
		ROM_REGION(0x400000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("d53-09.48", 0x000000, 0x100000, 0x690554d3 )
		ROM_LOAD16_BYTE("d53-10.49", 0x000001, 0x100000, 0x0ec05dc5 )
		ROM_LOAD       ("d53-11.50", 0x300000, 0x100000, 0x39c0a546 );	ROM_FILL       (             0x200000, 0x100000, 0 )
	...
	static RomLoadPtr rom_gunlock = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("d66-05.rom", 0x300000, 0x100000, 0xa3cefe04 );	ROM_FILL       (              0x200000, 0x100000, 0 )
	
		ROM_REGION(0x400000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("d66-06.rom", 0x000000, 0x100000, 0xb3d8126d )
	  	ROM_LOAD16_BYTE("d66-07.rom", 0x000001, 0x100000, 0xa6da9be7 )
		ROM_LOAD       ("d66-08.rom", 0x300000, 0x100000, 0x9959f30b );	ROM_FILL       (              0x200000, 0x100000, 0 )
	...
	static RomLoadPtr rom_lightbr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("d69-08.bin", 0x900000, 0x200000, 0x5b68d7d8 );	ROM_LOAD       ("d69-11.bin", 0xb00000, 0x100000, 0xc11adf92 );	ROM_FILL       (              0x600000, 0x300000, 0 )
		...
		ROM_LOAD       ("d69-05.bin", 0x600000, 0x200000, 0xf9f5433c );	ROM_FILL       (              0x400000, 0x200000, 0 )
	...
	static RomLoadPtr rom_kaiserkn = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("d84-05.rom", 0x1200000, 0x200000, 0x31a3c75d );	ROM_LOAD       ("d84-08.rom", 0x1400000, 0x200000, 0x07347bf1 );	ROM_LOAD       ("d84-11.rom", 0x1600000, 0x200000, 0xa062c1d4 );	ROM_FILL       (              0xc00000, 0x600000, 0 )
		...
		ROM_LOAD       ("d84-14.rom", 0x900000, 0x200000, 0x2b2e693e );	ROM_LOAD       ("d84-18.rom", 0xb00000, 0x100000, 0xe812bcc5 );	ROM_FILL       (              0x600000, 0x300000, 0 )
	...
	static RomLoadPtr rom_dariusg = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("d87-05.bin", 0x600000, 0x200000, 0x4e5891a9 );	ROM_FILL       (              0x400000, 0x200000, 0 )
	
		ROM_REGION(0x800000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("d87-06.bin", 0x000000, 0x200000, 0x3b97a07c )
		ROM_LOAD16_BYTE("d87-17.bin", 0x000001, 0x200000, 0xe601d63e )
		ROM_LOAD       ("d87-08.bin", 0x600000, 0x200000, 0x76d23602 );	ROM_FILL       (              0x400000, 0x200000, 0 )
	...
	static RomLoadPtr rom_bublbob2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("d90.01", 0x300000, 0x100000, 0x8aedb9e5 );	ROM_FILL       (          0x200000, 0x100000, 0 )
	
		ROM_REGION(0x400000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("d90.08", 0x000000, 0x100000, 0x25a4fb2c )
		ROM_LOAD16_BYTE("d90.07", 0x000001, 0x100000, 0xb436b42d )
		ROM_LOAD       ("d90.06", 0x300000, 0x100000, 0x166a72b8 );	ROM_FILL       (          0x200000, 0x100000, 0 )
	...
	static RomLoadPtr rom_pwrgoal = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("d94-03.bin", 0x1200000, 0x200000, 0x95e32072 );	ROM_LOAD       ("d94-02.bin", 0x1400000, 0x200000, 0xf460b9ac );	ROM_LOAD       ("d94-01.bin", 0x1600000, 0x200000, 0x410ffccd );	ROM_FILL       (              0xc00000, 0x600000,0 )
	
		ROM_REGION(0x400000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("d94-14.bin", 0x000000, 0x100000, 0xb8ba5761 )
		ROM_LOAD16_BYTE("d94-13.bin", 0x000001, 0x100000, 0xcafc68ce )
		ROM_LOAD       ("d94-12.bin", 0x300000, 0x100000, 0x47064189 );	ROM_FILL       (              0x200000, 0x100000,0 )
	...
	static RomLoadPtr rom_akkanvdr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e06.01", 0x300000, 0x100000, 0x51721b15 );	ROM_FILL       (          0x200000, 0x100000, 0 )
	
		ROM_REGION(0x400000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("e06.08", 0x000000, 0x100000, 0x72ae2fbf )
		ROM_LOAD16_BYTE("e06.07", 0x000001, 0x100000, 0x4b02e8f5 )
		ROM_LOAD       ("e06.06", 0x300000, 0x100000, 0x9380db3c );	ROM_FILL       (          0x200000, 0x100000, 0 )
	...
	static RomLoadPtr rom_elvactr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e02-01.4",  0x600000, 0x200000, 0x2ba94726 );	ROM_FILL       (             0x400000, 0x200000, 0 )
	
		ROM_REGION(0x800000, REGION_GFX2, ROMREGION_DISPOSE );/* Tiles */
		ROM_LOAD16_BYTE("e02-08.47", 0x000000, 0x200000, 0x29c9bd02 )
		ROM_LOAD16_BYTE("e02-07.45", 0x000001, 0x200000, 0x5eeee925 )
		ROM_LOAD       ("e02-06.43", 0x600000, 0x200000, 0x4c8726e9 );	ROM_FILL       (             0x400000, 0x200000, 0 )
	...
	static RomLoadPtr rom_quizhuhu = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e08-02.4",  0x900000, 0x200000, 0xd89eb067 );	ROM_LOAD       ("e08-01.3",  0xb00000, 0x100000, 0x90223c06 );	ROM_FILL       (             0x600000, 0x300000, 0 )
	
		ROM_REGION(0x400000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("e08-12.47", 0x000000, 0x100000, 0x6c711d36 )
		ROM_LOAD16_BYTE("e08-11.45", 0x000001, 0x100000, 0x56775a60 )
		ROM_LOAD       ("e08-10.43", 0x300000, 0x100000, 0x60abc71b );	ROM_FILL       (             0x200000, 0x100000, 0 )
	...
	static RomLoadPtr rom_pbobble2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e10-05.rom", 0x300000, 0x100000, 0x81266151 );	ROM_FILL       (              0x200000, 0x100000, 0 )
	...
	static RomLoadPtr rom_gekirido = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e11-01.bin", 0x600000, 0x200000, 0xc2cd1069 ); 	ROM_FILL       (              0x400000, 0x200000, 0 )
	
		ROM_REGION(0x800000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("e11-08.bin", 0x000000, 0x200000, 0x907f69d3 )
		ROM_LOAD16_BYTE("e11-07.bin", 0x000001, 0x200000, 0xef018607 )
		ROM_LOAD       ("e11-06.bin", 0x600000, 0x200000, 0x200ce305 ); 	ROM_FILL       (              0x400000, 0x200000, 0 )
	...
	static RomLoadPtr rom_bubblem = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e21-05.rom", 0x300000, 0x100000, 0x07eab58f );	ROM_FILL       (              0x200000, 0x100000, 0 )
	...
	static RomLoadPtr rom_cleopatr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e28-04.bin", 0x300000, 0x100000, 0x57aef029 );	ROM_FILL       (              0x200000, 0x100000, 0 )
	...
	static RomLoadPtr rom_pbobble3 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("pb3_06.rom", 0x300000, 0x100000, 0xc16184f8 );	ROM_FILL       (              0x200000, 0x100000, 0 )
	...
	static RomLoadPtr rom_arkretrn = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e36.01", 0x0c0000, 0x040000, 0x54b9b2cd );	ROM_FILL       (          0x080000, 0x040000, 0 )
	
		ROM_REGION(0x200000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("e36.07", 0x000000, 0x080000, 0x266bf1c1 )
		ROM_LOAD16_BYTE("e36.06", 0x000001, 0x080000, 0x110ab729 )
		ROM_LOAD       ("e36.05", 0x180000, 0x080000, 0xdb18bce2 );	ROM_FILL       (          0x100000, 0x080000, 0 )
	...
	static RomLoadPtr rom_kirameki = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e44-02.4",  0x1200000, 0x400000, 0x5481efde );	ROM_LOAD       ("e44-01.3",  0x1600000, 0x200000, 0xc4bdf727 );	ROM_FILL       (             0x0c00000, 0x600000, 0 )
		...
		ROM_LOAD       ("e44-10.43", 0x900000, 0x200000, 0x326f738e );	ROM_LOAD       ("e44-09.42", 0xb00000, 0x100000, 0xa8e68eb7 );	ROM_FILL       (             0x600000, 0x300000, 0 )
		...
		ROM_REGION(0xa00000, REGION_SOUND1 , ROMREGION_SOUNDONLY | ROMREGION_ERASE00 );	ROM_LOAD("e44-07.38", 0x000000, 0x400000, 0xa9e28544 );	ROM_LOAD("e44-08.39", 0x400000, 0x400000, 0x33ba3037 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_puchicar = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e46.02", 0xc00000, 0x200000, 0xfb046018 );	ROM_LOAD       ("e46.01", 0xe00000, 0x200000, 0x34fc2103 );	ROM_FILL       (          0x800000, 0x400000, 0 )
	
		ROM_REGION(0x400000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("e46.12", 0x000000, 0x100000, 0x1f3a9851 )
		ROM_LOAD16_BYTE("e46.11", 0x000001, 0x100000, 0xe9f10bf1 )
		ROM_LOAD       ("e46.10", 0x300000, 0x100000, 0x1999b76a );	ROM_FILL       (          0x200000, 0x100000, 0 )
	...
	static RomLoadPtr rom_pbobble4 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e49.06", 0x300000, 0x100000, 0xec85f7ce );	ROM_FILL       (          0x200000, 0x100000, 0 )
	...
	static RomLoadPtr rom_popnpop = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e51-01.4", 0x300000, 0x100000, 0x70347e24 );	ROM_FILL       (            0x200000, 0x100000, 0 )
	
		ROM_REGION(0x800000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("e51-08.47", 0x000000, 0x200000, 0x3ad41f02 )
		ROM_LOAD16_BYTE("e51-07.45", 0x000001, 0x200000, 0x95873e46 )
		ROM_LOAD       ("e51-06.43", 0x600000, 0x200000, 0xc240d6c8 );	ROM_FILL       (             0x400000, 0x200000, 0 )
	...
	static RomLoadPtr rom_landmakr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD       ("e61-01.04",0x600000, 0x200000, 0x6cdd8311 );	ROM_FILL       (            0x400000, 0x200000, 0 )
	
		ROM_REGION(0x800000, REGION_GFX2 , ROMREGION_DISPOSE);/* Tiles */
		ROM_LOAD16_BYTE("e61-09.47", 0x000000, 0x200000, 0x6ba29987 )
		ROM_LOAD16_BYTE("e61-08.45", 0x000001, 0x200000, 0x76c98e14 )
		ROM_LOAD       ("e61-07.43", 0x600000, 0x200000, 0x4a57965d );	ROM_FILL       (             0x400000, 0x200000, 0 )
	...
	public static GameDriver driver_ringrage	   = new GameDriver("1992"	,"ringrage"	,"taito_f3.java"	,rom_ringrage,null	,machine_driver_	,input_ports_f3	,init_f3	,ringrage	,	ROT0_16BIT,   "Taito Corporation Japan",   "Ring Rage (World)" )
	public static GameDriver driver_ringragj	   = new GameDriver("1992"	,"ringragj"	,"taito_f3.java"	,rom_ringragj,driver_ringrage	,machine_driver_f3	,input_ports_f3	,init_ringrage	,ROT0_16BIT	,	"Taito Corporation",         "Ring Rage (Japan)" )
	public static GameDriver driver_ringragu	   = new GameDriver("1992"	,"ringragu"	,"taito_f3.java"	,rom_ringragu,driver_ringrage	,machine_driver_f3	,input_ports_f3	,init_ringrage	,ROT0_16BIT	,	"Taito America Corporation", "Ring Rage (US)" )
	public static GameDriver driver_arabianm	   = new GameDriver("1992"	,"arabianm"	,"taito_f3.java"	,rom_arabianm,null	,machine_driver_	,input_ports_f3	,init_f3	,arabianm	,	ROT0_16BIT,   "Taito Corporation Japan",   "Arabian Magic (World)" )
	public static GameDriver driver_arabiamj	   = new GameDriver("1992"	,"arabiamj"	,"taito_f3.java"	,rom_arabiamj,driver_arabianm	,machine_driver_f3	,input_ports_f3	,init_arabianm	,ROT0_16BIT	,	"Taito Corporation",         "Arabian Magic (Japan)" )
	public static GameDriver driver_arabiamu	   = new GameDriver("1992"	,"arabiamu"	,"taito_f3.java"	,rom_arabiamu,driver_arabianm	,machine_driver_f3	,input_ports_f3	,init_arabianm	,ROT0_16BIT	,	"Taito America Corporation", "Arabian Magic (US)" )
	public static GameDriver driver_ridingf	   = new GameDriver("1992"	,"ridingf"	,"taito_f3.java"	,rom_ridingf,null	,machine_driver_	,input_ports_f3	,init_f3	,ridingf	,	ROT0_16BIT,   "Taito Corporation Japan",   "Riding Fight (World)" )
	public static GameDriver driver_ridefgtj	   = new GameDriver("1992"	,"ridefgtj"	,"taito_f3.java"	,rom_ridefgtj,driver_ridingf	,machine_driver_	,input_ports_f3	,init_f3	,ridingf	,	ROT0_16BIT,   "Taito Corporation",         "Riding Fight (Japan)" )
	public static GameDriver driver_ridefgtu	   = new GameDriver("1992"	,"ridefgtu"	,"taito_f3.java"	,rom_ridefgtu,driver_ridingf	,machine_driver_	,input_ports_f3	,init_f3	,ridingf	,	ROT0_16BIT,   "Taito America Corporation", "Riding Fight (US)" )
	public static GameDriver driver_gseeker	   = new GameDriver("1992"	,"gseeker"	,"taito_f3.java"	,rom_gseeker,null	,machine_driver_	,input_ports_f3	,init_f3	,gseeker	,	ROT270_16BIT, "Taito Corporation Japan",   "Grid Seeker: Project Stormhammer (World)" )
	public static GameDriver driver_gseekerj	   = new GameDriver("1992"	,"gseekerj"	,"taito_f3.java"	,rom_gseekerj,driver_gseeker	,machine_driver_f3	,input_ports_f3	,init_gseeker	,ROT270_16BIT	,	"Taito Corporation",         "Grid Seeker: Project Stormhammer (Japan)" )
	public static GameDriver driver_gseekeru	   = new GameDriver("1992"	,"gseekeru"	,"taito_f3.java"	,rom_gseekeru,driver_gseeker	,machine_driver_f3	,input_ports_f3	,init_gseeker	,ROT270_16BIT	,	"Taito America Corporation", "Grid Seeker: Project Stormhammer (US)" )
	public static GameDriver driver_gunlock	   = new GameDriver("1993"	,"gunlock"	,"taito_f3.java"	,rom_gunlock,null	,machine_driver_	,input_ports_f3	,init_f3	,gunlock	,	ROT270_16BIT, "Taito Corporation Japan",   "Gunlock (World)" )
	public static GameDriver driver_rayforcj	   = new GameDriver("1993"	,"rayforcj"	,"taito_f3.java"	,rom_rayforcj,driver_gunlock	,machine_driver_	,input_ports_f3	,init_f3	,gunlock	,	ROT270_16BIT, "Taito Corporation",         "Rayforce (Japan)" )
	public static GameDriver driver_rayforce	   = new GameDriver("1993"	,"rayforce"	,"taito_f3.java"	,rom_rayforce,driver_gunlock	,machine_driver_	,input_ports_f3	,init_f3	,gunlock	,	ROT270_16BIT, "Taito America Corporation", "Rayforce (US)" )
	public static GameDriver driver_scfinals	   = new GameDriver("1993"	,"scfinals"	,"taito_f3.java"	,rom_scfinals,null	,machine_driver_	,input_ports_f3	,init_f3	,scfinals	,	ROT0_16BIT,   "Taito Corporation Japan",   "Super Cup Finals (World)" )
	...
	public static GameDriver driver_hthero93	   = new GameDriver("1992"	,"hthero93"	,"taito_f3.java"	,rom_hthero93,driver_scfinals	,machine_driver_f3	,input_ports_f3	,init_cupfinal	,ROT0_16BIT	,	"Taito Corporation",         "Hat Trick Hero '93 (Japan)" )
	public static GameDriver driver_cupfinal	   = new GameDriver("1993"	,"cupfinal"	,"taito_f3.java"	,rom_cupfinal,driver_scfinals	,machine_driver_f3	,input_ports_f3	,init_cupfinal	,ROT0_16BIT	,	"Taito Corporation Japan",   "Taito Cup Finals (World)" )
	public static GameDriver driver_trstar	   = new GameDriver("1993"	,"trstar"	,"taito_f3.java"	,rom_trstar,null	,machine_driver_	,input_ports_f3	,init_f3	,trstaroj	,	ROT0_16BIT,   "Taito Corporation Japan",   "Top Ranking Stars (World new version)" )
	public static GameDriver driver_trstarj	   = new GameDriver("1993"	,"trstarj"	,"taito_f3.java"	,rom_trstarj,driver_trstar	,machine_driver_	,input_ports_f3	,init_f3	,trstaroj	,	ROT0_16BIT,   "Taito Corporation",         "Top Ranking Stars (Japan new version)" )
	public static GameDriver driver_prmtmfgt	   = new GameDriver("1993"	,"prmtmfgt"	,"taito_f3.java"	,rom_prmtmfgt,driver_trstar	,machine_driver_	,input_ports_f3	,init_f3	,trstaroj	,	ROT0_16BIT,   "Taito America Corporation", "Prime Time Fighter (US new version)" )
	public static GameDriver driver_trstaro	   = new GameDriver("1993"	,"trstaro"	,"taito_f3.java"	,rom_trstaro,driver_trstar	,machine_driver_	,input_ports_f3	,init_f3	,trstaroj	,	ROT0_16BIT,   "Taito Corporation Japan",   "Top Ranking Stars (World old version)" )
	public static GameDriver driver_trstaroj	   = new GameDriver("1993"	,"trstaroj"	,"taito_f3.java"	,rom_trstaroj,driver_trstar	,machine_driver_	,input_ports_f3	,init_f3	,trstaroj	,	ROT0_16BIT,   "Taito Corporation",         "Top Ranking Stars (Japan old version)" )
	public static GameDriver driver_prmtmfgo	   = new GameDriver("1993"	,"prmtmfgo"	,"taito_f3.java"	,rom_prmtmfgo,driver_trstar	,machine_driver_	,input_ports_f3	,init_f3	,trstaroj	,	ROT0_16BIT,   "Taito America Corporation", "Prime Time Fighter (US old version)" )
	public static GameDriver driver_lightbr	   = new GameDriver("1993"	,"lightbr"	,"taito_f3.java"	,rom_lightbr,null	,machine_driver_	,input_ports_f3	,init_f3	,lightbr	,	ROT0_16BIT,   "Taito Corporation",         "Lightbringer (Japan)" )
	/* Hacking the Lightbringer rom enables American & World versions called 'Dungeon Magic' - were they ever officially released? */
	public static GameDriver driver_kaiserkn	   = new GameDriver("1994"	,"kaiserkn"	,"taito_f3.java"	,rom_kaiserkn,null	,machine_driver_	,input_ports_f3	,init_kn	,kaiserkn	,	ROT0_16BIT,   "Taito Corporation Japan",   "Kaiser Knuckle (World)" )
	public static GameDriver driver_kaiserkj	   = new GameDriver("1994"	,"kaiserkj"	,"taito_f3.java"	,rom_kaiserkj,driver_kaiserkn	,machine_driver_f3	,input_ports_kn	,init_kaiserkn	,ROT0_16BIT	,	"Taito Corporation",         "Kaiser Knuckle (Japan)" )
	public static GameDriver driver_gblchmp	   = new GameDriver("1994"	,"gblchmp"	,"taito_f3.java"	,rom_gblchmp,driver_kaiserkn	,machine_driver_f3	,input_ports_kn	,init_kaiserkn	,ROT0_16BIT	,	"Taito America Corporation", "Global Champion (US)" )
	public static GameDriver driver_dankuga	   = new GameDriver("1994"	,"dankuga"	,"taito_f3.java"	,rom_dankuga,driver_kaiserkn	,machine_driver_f3	,input_ports_kn	,init_kaiserkn	,ROT0_16BIT	,	"Taito Corporation",         "Dan-Ku-Ga (Japan)" )
	public static GameDriver driver_dariusg	   = new GameDriver("1994"	,"dariusg"	,"taito_f3.java"	,rom_dariusg,null	,machine_driver_	,input_ports_f3	,init_f3	,dariusg	,	ROT0_16BIT,   "Taito Corporation",         "Darius Gaiden - Silver Hawk" )
	public static GameDriver driver_dariusgx	   = new GameDriver("1994"	,"dariusgx"	,"taito_f3.java"	,rom_dariusgx,driver_dariusg	,machine_driver_	,input_ports_f3	,init_f3	,dariusg	,	ROT0_16BIT,   "Taito Corporation",         "Darius Gaiden - Silver Hawk (Extra Version)" )
	public static GameDriver driver_bublbob2	   = new GameDriver("1994"	,"bublbob2"	,"taito_f3.java"	,rom_bublbob2,null	,machine_driver_	,input_ports_f3	,init_f3	,bubsymph	,	ROT0_16BIT,   "Taito Corporation Japan",   "Bubble Bobble 2 (World)" )
	public static GameDriver driver_bubsymph	   = new GameDriver("1994"	,"bubsymph"	,"taito_f3.java"	,rom_bubsymph,driver_bublbob2	,machine_driver_f3	,input_ports_f3	,init_bubsymph	,ROT0_16BIT	,	"Taito Corporation",         "Bubble Symphony (Japan)" )
	public static GameDriver driver_bubsympu	   = new GameDriver("1994"	,"bubsympu"	,"taito_f3.java"	,rom_bubsympu,driver_bublbob2	,machine_driver_f3	,input_ports_f3	,init_bubsymph	,ROT0_16BIT	,	"Taito America Corporation", "Bubble Symphony (US)" )
	public static GameDriver driver_spcinvdj	   = new GameDriver("1994"	,"spcinvdj"	,"taito_f3.java"	,rom_spcinvdj,driver_spacedx	,machine_driver_	,input_ports_f3	,init_f3	,spcinvdj	,	ROT0_16BIT,   "Taito Corporation",         "Space Invaders DX (Japan F3 version)" )
	public static GameDriver driver_pwrgoal	   = new GameDriver("1994"	,"pwrgoal"	,"taito_f3.java"	,rom_pwrgoal,null	,machine_driver_	,input_ports_f3	,init_f3	,hthero95	,	ROT0_16BIT,   "Taito Corporation Japan",   "Power Goal (World)" )
	public static GameDriver driver_hthero95	   = new GameDriver("1994"	,"hthero95"	,"taito_f3.java"	,rom_hthero95,driver_pwrgoal	,machine_driver_	,input_ports_f3	,init_f3	,hthero95	,	ROT0_16BIT,   "Taito Corporation",         "Hat Trick Hero '95 (Japan)" )
	public static GameDriver driver_hthro95u	   = new GameDriver("1994"	,"hthro95u"	,"taito_f3.java"	,rom_hthro95u,driver_pwrgoal	,machine_driver_	,input_ports_f3	,init_f3	,hthero95	,	ROT0_16BIT,   "Taito America Corporation", "Hat Trick Hero '95 (US)" )
	public static GameDriver driver_qtheater	   = new GameDriver("1994"	,"qtheater"	,"taito_f3.java"	,rom_qtheater,null	,machine_driver_	,input_ports_f3	,init_f3	,qtheater	,	ROT0_16BIT,   "Taito Corporation",         "Quiz Theater - 3tsu no Monogatari (Japan)" )
	public static GameDriver driver_elvactr	   = new GameDriver("1994"	,"elvactr"	,"taito_f3.java"	,rom_elvactr,null	,machine_driver_	,input_ports_f3	,init_f3	,elvactr	,	ROT0_16BIT,   "Taito Corporation Japan",   "Elevator Action Returns (World)" )
	public static GameDriver driver_elvactrj	   = new GameDriver("1994"	,"elvactrj"	,"taito_f3.java"	,rom_elvactrj,driver_elvactr	,machine_driver_	,input_ports_f3	,init_f3	,elvactr	,	ROT0_16BIT,   "Taito Corporation",         "Elevator Action Returns (Japan)" )
	public static GameDriver driver_elvact2u	   = new GameDriver("1994"	,"elvact2u"	,"taito_f3.java"	,rom_elvact2u,driver_elvactr	,machine_driver_	,input_ports_f3	,init_f3	,elvactr	,	ROT0_16BIT,   "Taito America Corporation", "Elevator Action 2 (US)" )
	/* There is also a prototype Elevator Action 2 (US) pcb with the graphics in a different rom format (same program code) */
	public static GameDriver driver_akkanvdr	   = new GameDriver("1995"	,"akkanvdr"	,"taito_f3.java"	,rom_akkanvdr,null	,machine_driver_	,input_ports_f3	,init_f3	,spcinv95	,	ROT270_16BIT, "Taito Corporation",         "Akkanvader (Japan)" )
	/* Space Invaders '95 - Attack Of The Lunar Loonies */
	public static GameDriver driver_twinqix	   = new GameDriver("1995"	,"twinqix"	,"taito_f3.java"	,rom_twinqix,null	,machine_driver_	,input_ports_f3	,init_f3	,twinqix	,	ROT0_16BIT,   "Taito America Corporation", "Twin Qix (US Prototype)" )
	public static GameDriver driver_gekirido	   = new GameDriver("1995"	,"gekirido"	,"taito_f3.java"	,rom_gekirido,null	,machine_driver_	,input_ports_f3	,init_f3	,gekirido	,	ROT270_16BIT, "Taito Corporation",         "Gekirindan (Japan)" )
	public static GameDriver driver_quizhuhu	   = new GameDriver("1995"	,"quizhuhu"	,"taito_f3.java"	,rom_quizhuhu,null	,machine_driver_	,input_ports_f3	,init_f3	,quizhuhu	,	ROT0_16BIT,   "Taito Corporation",         "Moriguchi Hiroko no Quiz de Hyuuhyuu (Japan)" )
	public static GameDriver driver_pbobble2	   = new GameDriver("1995"	,"pbobble2"	,"taito_f3.java"	,rom_pbobble2,null	,machine_driver_	,input_ports_f3	,init_f3	,pbobble2	,	ROT0_16BIT,   "Taito Corporation Japan",	 "Puzzle Bobble 2 (World)" )
	public static GameDriver driver_pbobbl2j	   = new GameDriver("1995"	,"pbobbl2j"	,"taito_f3.java"	,rom_pbobbl2j,driver_pbobble2	,machine_driver_f3	,input_ports_f3	,init_pbobble2	,ROT0_16BIT	,	"Taito Corporation", 		 "Puzzle Bobble 2 (Japan)" )
	public static GameDriver driver_pbobbl2u	   = new GameDriver("1995"	,"pbobbl2u"	,"taito_f3.java"	,rom_pbobbl2u,driver_pbobble2	,machine_driver_f3	,input_ports_f3	,init_pbobble2	,ROT0_16BIT	,	"Taito America Corporation", "Bust-A-Move Again (US)" )
	public static GameDriver driver_pbobbl2x	   = new GameDriver("1995"	,"pbobbl2x"	,"taito_f3.java"	,rom_pbobbl2x,driver_pbobble2	,machine_driver_f3	,input_ports_f3	,init_pbobbl2x	,ROT0_16BIT	,	"Taito Corporation", 		 "Puzzle Bobble 2X (Japan)" )
	public static GameDriver driver_ktiger2	   = new GameDriver("1995"	,"ktiger2"	,"taito_f3.java"	,rom_ktiger2,null	,machine_driver_	,input_ports_f3	,init_f3	,ktiger2	,	ROT270_16BIT, "Taito Corporation",         "Kyukyoku Tiger 2 (Japan)" )
	/* Twin Cobra 2 (US & World) is known to exist */
	public static GameDriver driver_bubblem	   = new GameDriver("1995"	,"bubblem"	,"taito_f3.java"	,rom_bubblem,null	,machine_driver_	,input_ports_f3	,init_f3	,bubblem	,	ROT0_16BIT,   "Taito Corporation Japan",   "Bubble Memories - The Story Of Bubble Bobble 3 (World)" )
	public static GameDriver driver_bubblemj	   = new GameDriver("1995"	,"bubblemj"	,"taito_f3.java"	,rom_bubblemj,driver_bubblem	,machine_driver_f3	,input_ports_f3	,init_bubblem	,ROT0_16BIT	,	"Taito Corporation", "Bubble Memories - The Story Of Bubble Bobble 3 (Japan)" )
	public static GameDriver driver_cleopatr	   = new GameDriver("1996"	,"cleopatr"	,"taito_f3.java"	,rom_cleopatr,null	,machine_driver_	,input_ports_f3	,init_f3	,cleopatr	,	ROT0_16BIT,   "Taito Corporation", "Cleopatra Fortune (Japan)" )
	public static GameDriver driver_pbobble3	   = new GameDriver("1996"	,"pbobble3"	,"taito_f3.java"	,rom_pbobble3,null	,machine_driver_	,input_ports_f3	,init_f3	,pbobble3	,	ROT0_16BIT,   "Taito Corporation", "Puzzle Bobble 3 (World)" )
	public static GameDriver driver_pbobbl3u	   = new GameDriver("1996"	,"pbobbl3u"	,"taito_f3.java"	,rom_pbobbl3u,driver_pbobble3	,machine_driver_f3	,input_ports_f3	,init_pbobble3	,ROT0_16BIT	,	"Taito Corporation", "Puzzle Bobble 3 (US)" )
	public static GameDriver driver_pbobbl3j	   = new GameDriver("1996"	,"pbobbl3j"	,"taito_f3.java"	,rom_pbobbl3j,driver_pbobble3	,machine_driver_f3	,input_ports_f3	,init_pbobble3	,ROT0_16BIT	,	"Taito Corporation", "Puzzle Bobble 3 (Japan)" )
	public static GameDriver driver_arkretrn	   = new GameDriver("1997"	,"arkretrn"	,"taito_f3.java"	,rom_arkretrn,null	,machine_driver_	,input_ports_f3	,init_f3	,arkretrn	,	ROT0_16BIT,   "Taito Corporation", "Arkanoid Returns (Japan)" )
	public static GameDriver driver_kirameki	   = new GameDriver("1997"	,"kirameki"	,"taito_f3.java"	,rom_kirameki,null	,machine_driver_	,input_ports_f3	,init_f3	,kirameki	,	ROT0_16BIT,   "Taito Corporation", "Kirameki Star Road (Japan)" )
	public static GameDriver driver_puchicar	   = new GameDriver("1997"	,"puchicar"	,"taito_f3.java"	,rom_puchicar,null	,machine_driver_	,input_ports_f3	,init_f3	,puchicar	,	ROT0_16BIT,   "Taito Corporation", "Puchi Carat (Japan)" )
	public static GameDriver driver_pbobble4	   = new GameDriver("1997"	,"pbobble4"	,"taito_f3.java"	,rom_pbobble4,null	,machine_driver_	,input_ports_f3	,init_f3	,pbobble4	,	ROT0_16BIT,   "Taito Corporation", "Puzzle Bobble 4 (World)" )
	public static GameDriver driver_pbobbl4j	   = new GameDriver("1997"	,"pbobbl4j"	,"taito_f3.java"	,rom_pbobbl4j,driver_pbobble4	,machine_driver_f3	,input_ports_f3	,init_pbobble4	,ROT0_16BIT	,	"Taito Corporation", "Puzzle Bobble 4 (Japan)" )
	public static GameDriver driver_pbobbl4u	   = new GameDriver("1997"	,"pbobbl4u"	,"taito_f3.java"	,rom_pbobbl4u,driver_pbobble4	,machine_driver_f3	,input_ports_f3	,init_pbobble4	,ROT0_16BIT	,	"Taito Corporation", "Puzzle Bobble 4 (US)" )
	public static GameDriver driver_popnpop	   = new GameDriver("1997"	,"popnpop"	,"taito_f3.java"	,rom_popnpop,null	,machine_driver_	,input_ports_f3	,init_f3	,popnpop	,	ROT0_16BIT,   "Taito Corporation", "Pop 'N Pop (Japan)" )
	public static GameDriver driver_landmakr	   = new GameDriver("1998"	,"landmakr"	,"taito_f3.java"	,rom_landmakr,null	,machine_driver_	,input_ports_f3	,init_f3	,landmakr	,	ROT0_16BIT,   "Taito Corporation", "Landmaker (Japan)" )
}
