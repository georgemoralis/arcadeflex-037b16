...
public class tetrisp2
{
	...
	***************************************************************************/
	...
	public static nvramPtr tetrisp2_nvram_handler  = new nvramPtr() { public void handler(Object file, int read_or_write) 
	{
		if (read_or_write != 0)
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_tetrisp2 = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER1 );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER1 );	PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_BUTTON3        | IPF_PLAYER1 );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );// unused button
	
		PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER2 );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER2 );	PORT_BIT(  0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT(  0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT(  0x1000, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER2 );	PORT_BIT(  0x2000, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER2 );	PORT_BIT(  0x4000, IP_ACTIVE_LOW, IPT_BUTTON3        | IPF_PLAYER2 );	PORT_BIT(  0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );// unused button
	
		PORT_START(); 	// IN1 - $be0004.w
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_START1   );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_START2   );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_COIN1    );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_COIN2    );
		...
		PORT_DIPSETTING(      0x0000, "Easy" );	PORT_DIPSETTING(      0x0300, "Normal" );	PORT_DIPSETTING(      0x0100, "Hard" );	PORT_DIPSETTING(      0x0200, "Hardest" );	PORT_DIPNAME( 0x0400, 0x0400, "Vs Mode Rounds" );	PORT_DIPSETTING(      0x0000, "1" );	PORT_DIPSETTING(      0x0400, "3" );	PORT_DIPNAME( 0x0800, 0x0000, "Language" );	PORT_DIPSETTING(      0x0800, "Japanese" );	PORT_DIPSETTING(      0x0000, "English" );	PORT_DIPNAME( 0x1000, 0x1000, "Unknown 2-4" );// F.B.I. Logo (in the USA set?)
		PORT_DIPSETTING(      0x1000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x2000, 0x2000, "Voice" );	PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_teplus2j = new InputPortPtr(){ public void handler() { 
		...
		PORT_START(); 	// IN1 - $be0004.w
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_START1   );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_START2   );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN  );// no service coin?
		PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_COIN1    );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_COIN2    );
		PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_SPECIAL  );// ?
		PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_SPECIAL  );// ?
		PORT_BIT(  0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN  );
	/*
	...
	*/
		...
		PORT_DIPNAME( 0x0300, 0x0300, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x0000, "Easy" );	PORT_DIPSETTING(      0x0300, "Normal" );	PORT_DIPSETTING(      0x0100, "Hard" );	PORT_DIPSETTING(      0x0200, "Hardest" );	PORT_DIPNAME( 0x0400, 0x0400, "Vs Mode Rounds" );	PORT_DIPSETTING(      0x0000, "1" );	PORT_DIPSETTING(      0x0400, "3" );	PORT_DIPNAME( 0x0800, 0x0800, "Language" );	PORT_DIPSETTING(      0x0800, "Japanese" );//	PORT_DIPSETTING(      0x0000, "English" );// it does not work properly with "english"
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_tetrisp2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "96019-06.13", 0x000000, 0x400000, 0x16f7093c );	ROM_LOAD( "96019-04.6",  0x400000, 0x100000, 0xb849dec9 );
	...
	***************************************************************************/
	...
	public static GameDriver driver_tetrisp2	   = new GameDriver("1997"	,"tetrisp2"	,"tetrisp2.java"	,rom_tetrisp2,null	,machine_driver_tetrisp2	,input_ports_tetrisp2	,null	,ROT0_16BIT	,	"Jaleco / The Tetris Company", "Tetris Plus 2 (World?)", GAME_NOT_WORKING | GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_teplus2j	   = new GameDriver("1997"	,"teplus2j"	,"tetrisp2.java"	,rom_teplus2j,driver_tetrisp2	,machine_driver_tetrisp2	,input_ports_teplus2j	,null	,ROT0_16BIT	,	"Jaleco / The Tetris Company", "Tetris Plus 2 (Japan)", GAME_IMPERFECT_GRAPHICS )
}
