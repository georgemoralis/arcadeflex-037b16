...
public class ginganin
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_ginganin = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "gn_15.bin", 0x000000, 0x10000, 0x1b8ac9fb ); /* bg */
		ROM_LOAD( "gn_14.bin", 0x010000, 0x10000, 0xe73fe668 );
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "gn_12.bin", 0x000000, 0x10000, 0xc134a1e9 ); /* fg */
		ROM_LOAD( "gn_13.bin", 0x010000, 0x10000, 0x1d3bec21 );
		ROM_REGION( 0x04000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "gn_10.bin", 0x000000, 0x04000, 0xae371b2d ); /* txt */
	
		ROM_REGION( 0x50000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "gn_06.bin", 0x000000, 0x10000, 0xbdc65835 ); /* sprites */
