...
public class omegaf
{
	...
	**************************************************************************/
	...
	extern UBytePtr omegaf_fg_videoram;
	extern size_t omegaf_fgvideoram_size;
	
	extern UBytePtr omegaf_bg0_scroll_x;
	extern UBytePtr omegaf_bg1_scroll_x;
	extern UBytePtr omegaf_bg2_scroll_x;
	extern UBytePtr omegaf_bg0_scroll_y;
	extern UBytePtr omegaf_bg1_scroll_y;
	extern UBytePtr omegaf_bg2_scroll_y;
	...
	**************************************************************************/
	...
	PORT_START(); 			/* Player 1 inputs */
		...
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_SERVICE );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_START(); 			/* DSW 0 */
		PORT_DIPNAME( 0x01, 0x01, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x06, 0x06, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x00, "Easy" );	PORT_DIPSETTING(    0x06, "Normal" );	PORT_DIPSETTING(    0x02, "Hard" );	PORT_DIPSETTING(    0x04, "Hardest" );	PORT_SERVICE( 0x08, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x10, 0x00, DEF_STR( "Cabinet"));
		...
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0xc0, "3" );	PORT_DIPSETTING(    0x40, "4" );	PORT_DIPSETTING(    0x80, "5" );
		PORT_START();  			/* DSW 1 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x00, "20k" );	PORT_DIPSETTING(    0x03, "30k" );	PORT_DIPSETTING(    0x01, "50k" );	PORT_DIPSETTING(    0x02, "100k" );	PORT_DIPNAME( 0x1c, 0x1c, DEF_STR( "Coin_B") );
	...
	PORT_START(); 			/* Player 1 inputs */
		...
		PORT_DIPSETTING(    0x02, "50k, then every 100k" );	PORT_DIPSETTING(	0x00, "None" );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x04, "Normal" );	PORT_DIPSETTING(    0x00, "Difficult" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Free_Play") );
		...
		PORT_START();  			/* DSW 1 */
		PORT_SERVICE( 0x01, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x02, 0x02, DEF_STR( "Unused") );
	...
	PORT_START(); 			/* Player 1 inputs */
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x02, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x02, "30k, then every 50k" );	PORT_DIPSETTING(	0x00, "50k, then every 80k" );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x04, "Normal" );	PORT_DIPSETTING(    0x00, "Difficult" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Free_Play") );
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x10, 0x00, DEF_STR( "Cabinet") );
	...
	**************************************************************************/
	...
	public static IO_ReadPort sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x0000, 0x0000, YM2203_status_port_0_r ),
	...
	**************************************************************************/
	...
	static RomLoadPtr rom_omegaf = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "1.5",          0x00000, 0x08000, 0x57a7fd96 );	ROM_CONTINUE(             0x10000, 0x18000 );	ROM_LOAD( "6.4l",         0x28000, 0x20000, 0x6277735c );
		...
		ROM_LOAD( "4.18h",        0x00000, 0x08000, 0x9e2d8152 );ROM_END(); }}; 
	
	static RomLoadPtr rom_omegafs = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x48000, REGION_CPU1, 0 );					/* main CPU */
		ROM_LOAD( "5.3l",         0x00000, 0x08000, 0x503a3e63 );	ROM_CONTINUE(             0x10000, 0x18000 );	ROM_LOAD( "6.4l",         0x28000, 0x20000, 0x6277735c );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );					/* sound CPU */
		ROM_LOAD( "7.7m",         0x00000, 0x10000, 0xd40fc8d5 );
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	/* BG0 */
		ROM_LOAD( "2back1.27b",   0x00000, 0x80000, 0x21f8a32e );
	...
	static RomLoadPtr rom_robokid = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x48000, REGION_CPU1, 0 );					/* main CPU */
		ROM_LOAD( "robokid1.18j", 0x00000, 0x08000, 0x378c21fc );	ROM_CONTINUE(             0x10000, 0x08000 );	ROM_LOAD( "robokid2.18k", 0x18000, 0x10000, 0xddef8c5a );	ROM_LOAD( "robokid3.15k", 0x28000, 0x10000, 0x05295ec3 );	ROM_LOAD( "robokid4.12k", 0x38000, 0x10000, 0x3bc3977f );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );					/* sound CPU */
		ROM_LOAD( "robokid.k7",   0x00000, 0x10000, 0xf490a2e9 );
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	/* BG0 */
		ROM_LOAD( "robokid.19c",  0x00000, 0x10000, 0x02220421 );	ROM_LOAD( "robokid.20c",  0x10000, 0x10000, 0x02d59bc2 );	ROM_LOAD( "robokid.17d",  0x20000, 0x10000, 0x2fa29b99 );	ROM_LOAD( "robokid.18d",  0x30000, 0x10000, 0xae15ce02 );	ROM_LOAD( "robokid.19d",  0x40000, 0x10000, 0x784b089e );	ROM_LOAD( "robokid.20d",  0x50000, 0x10000, 0xb0b395ed );	ROM_LOAD( "robokid.19f",  0x60000, 0x10000, 0x0f9071c6 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	/* BG1 */
		ROM_LOAD( "robokid.12c",  0x00000, 0x10000, 0x0ab45f94 );	ROM_LOAD( "robokid.14c",  0x10000, 0x10000, 0x029bbd4a );	ROM_LOAD( "robokid.15c",  0x20000, 0x10000, 0x7de67ebb );	ROM_LOAD( "robokid.16c",  0x30000, 0x10000, 0x53c0e582 );	ROM_LOAD( "robokid.17c",  0x40000, 0x10000, 0x0cae5a1e );	ROM_LOAD( "robokid.18c",  0x50000, 0x10000, 0x56ac7c8a );	ROM_LOAD( "robokid.15d",  0x60000, 0x10000, 0xcd632a4d );	ROM_LOAD( "robokid.16d",  0x70000, 0x10000, 0x18d92b2b );
		ROM_REGION( 0x80000, REGION_GFX3, ROMREGION_DISPOSE );	/* BG2 */
		ROM_LOAD( "robokid.12a",  0x00000, 0x10000, 0xe64d1c10 );	ROM_LOAD( "robokid.14a",  0x10000, 0x10000, 0x8f9371e4 );	ROM_LOAD( "robokid.15a",  0x20000, 0x10000, 0x469204e7 );	ROM_LOAD( "robokid.16a",  0x30000, 0x10000, 0x4e340815 );	ROM_LOAD( "robokid.17a",  0x40000, 0x10000, 0xf0863106 );	ROM_LOAD( "robokid.18a",  0x50000, 0x10000, 0xfdff7441 );
		ROM_REGION( 0x40000, REGION_GFX4, ROMREGION_DISPOSE );	/* sprite */
		ROM_LOAD( "robokid.15f",  0x00000, 0x10000, 0xba61f5ab );	ROM_LOAD( "robokid.16f",  0x10000, 0x10000, 0xd9b399ce );	ROM_LOAD( "robokid.17f",  0x20000, 0x10000, 0xafe432b9 );	ROM_LOAD( "robokid.18f",  0x30000, 0x10000, 0xa0aa2a84 );
		ROM_REGION( 0x08000, REGION_GFX5, ROMREGION_DISPOSE );	/* FG */
		ROM_LOAD( "robokid.b9",   0x00000, 0x08000, 0xfac59c3f );ROM_END(); }}; 
	
	static RomLoadPtr rom_robokidj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x48000, REGION_CPU1, 0 );					/* main CPU */
		ROM_LOAD( "1.29",         0x00000, 0x08000, 0x59a1e2ec );	ROM_CONTINUE(             0x10000, 0x08000 );	ROM_LOAD( "2.30",         0x18000, 0x10000, 0xe3f73476 );	ROM_LOAD( "robokid3.15k", 0x28000, 0x10000, 0x05295ec3 );	ROM_LOAD( "robokid4.12k", 0x38000, 0x10000, 0x3bc3977f );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );					/* sound CPU */
		ROM_LOAD( "robokid.k7",   0x00000, 0x10000, 0xf490a2e9 );
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	/* BG0 */
		ROM_LOAD( "robokid.19c",  0x00000, 0x10000, 0x02220421 );	ROM_LOAD( "robokid.20c",  0x10000, 0x10000, 0x02d59bc2 );	ROM_LOAD( "robokid.17d",  0x20000, 0x10000, 0x2fa29b99 );	ROM_LOAD( "robokid.18d",  0x30000, 0x10000, 0xae15ce02 );	ROM_LOAD( "robokid.19d",  0x40000, 0x10000, 0x784b089e );	ROM_LOAD( "robokid.20d",  0x50000, 0x10000, 0xb0b395ed );	ROM_LOAD( "robokid.19f",  0x60000, 0x10000, 0x0f9071c6 );
