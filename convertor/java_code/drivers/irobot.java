...
public class irobot
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_irobot = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x800, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "136029.124",     0x0000,  0x0800, 0x848948b6 );
		ROM_REGION( 0x3420, REGION_PROMS, 0 );	ROM_LOAD( "ir125.bin",      0x0000,  0x0020, 0x446335ba );	ROM_LOAD( "ir111.bin",      0x0020,  0x0400, 0x9fbc9bf3 );/* program ROMs from c000-f3ff */
		ROM_LOAD( "ir112.bin",      0x0420,  0x0400, 0xb2713214 );	ROM_LOAD( "ir113.bin",      0x0820,  0x0400, 0x7875930a );	ROM_LOAD( "ir114.bin",      0x0c20,  0x0400, 0x51d29666 );	ROM_LOAD( "ir115.bin",      0x1020,  0x0400, 0x00f9b304 );	ROM_LOAD( "ir116.bin",      0x1420,  0x0400, 0x326aba54 );	ROM_LOAD( "ir117.bin",      0x1820,  0x0400, 0x98efe8d0 );	ROM_LOAD( "ir118.bin",      0x1c20,  0x0400, 0x4a6aa7f9 );	ROM_LOAD( "ir119.bin",      0x2020,  0x0400, 0xa5a13ad8 );	ROM_LOAD( "ir120.bin",      0x2420,  0x0400, 0x2a083465 );	ROM_LOAD( "ir121.bin",      0x2820,  0x0400, 0xadebcb99 );	ROM_LOAD( "ir122.bin",      0x2c20,  0x0400, 0xda7b6f79 );	ROM_LOAD( "ir123.bin",      0x3020,  0x0400, 0x39fff18f );ROM_END(); }}; 
