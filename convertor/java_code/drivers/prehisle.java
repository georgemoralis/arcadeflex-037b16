...
public class prehisle
{
	...
	static RomLoadPtr rom_prehisle = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "gt.2", 0x00000, 0x20000, 0x7083245a )
		ROM_LOAD16_BYTE( "gt.3", 0x00001, 0x20000, 0x6d8cdf58 )
	
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* Sound CPU */
		ROM_LOAD( "gt.1",  0x000000, 0x10000, 0x80a4c093 );
		ROM_REGION( 0x008000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "gt15.b15",   0x000000, 0x08000, 0xac652412 );
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "pi8914.b14", 0x000000, 0x40000, 0x207d6187 );
		ROM_REGION( 0x040000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "pi8916.h16", 0x000000, 0x40000, 0x7cffe0f6 );
		ROM_REGION( 0x0a0000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "pi8910.k14", 0x000000, 0x80000, 0x5a101b0b );	ROM_LOAD( "gt.5",       0x080000, 0x20000, 0x3d3ab273 );
	...
	static RomLoadPtr rom_prehislu = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "gt-u2.2h", 0x00000, 0x20000, 0xa14f49bb )
	...
	static RomLoadPtr rom_gensitou = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "gt2j.bin", 0x00000, 0x20000, 0xa2da0b6b )
