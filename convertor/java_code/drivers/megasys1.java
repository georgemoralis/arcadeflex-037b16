...
public class megasys1
{
	...
	***************************************************************************/
	...
	(
		2,
		new int[] { 4000000/132, 4000000/132 },	/* seems appropriate */
	...
	***************************************************************************/
	...
	static OKIM6295interface okim6295_interface_D = new OKIM6295interface
	(
		1,
		new int[] { 12000 },
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_64street = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "64th_05.rom", 0x000000, 0x080000, 0xa89a7020 );	ROM_LOAD( "64th_04.rom", 0x080000, 0x080000, 0x98f83ef6 );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_astyanax = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );/* Scroll 0 */
		ROM_LOAD( "astyan11.bin", 0x000000, 0x020000, 0x5593fec9 );	ROM_LOAD( "astyan12.bin", 0x020000, 0x020000, 0xe8b313ec );	ROM_LOAD( "astyan13.bin", 0x040000, 0x020000, 0x5f3496c6 );	ROM_LOAD( "astyan14.bin", 0x060000, 0x020000, 0x29a09ec2 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );/* Scroll 1 */
		ROM_LOAD( "astyan15.bin", 0x000000, 0x020000, 0x0d316615 );	ROM_LOAD( "astyan16.bin", 0x020000, 0x020000, 0xba96e8d9 );	ROM_LOAD( "astyan17.bin", 0x040000, 0x020000, 0xbe60ba06 );	ROM_LOAD( "astyan18.bin", 0x060000, 0x020000, 0x3668da3d );
		ROM_REGION( 0x20000, REGION_GFX3, ROMREGION_DISPOSE );/* Scroll 2 */
		ROM_LOAD( "astyan19.bin", 0x000000, 0x020000, 0x98158623 );
		ROM_REGION( 0x80000, REGION_GFX4, ROMREGION_DISPOSE );/* Sprites */
		ROM_LOAD( "astyan20.bin", 0x000000, 0x020000, 0xc1ad9aa0 );	ROM_LOAD( "astyan21.bin", 0x020000, 0x020000, 0x0bf498ee );	ROM_LOAD( "astyan22.bin", 0x040000, 0x020000, 0x5f04d9b1 );	ROM_LOAD( "astyan23.bin", 0x060000, 0x020000, 0x7bd4d1e7 );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );	/* Samples */
		ROM_LOAD( "astyan9.bin",  0x000000, 0x020000, 0xa10b3f17 );	ROM_LOAD( "astyan10.bin", 0x020000, 0x020000, 0x4f704e7a );
		ROM_REGION( 0x40000, REGION_SOUND2, 0 );	/* Samples */
		ROM_LOAD( "astyan7.bin",  0x000000, 0x020000, 0x319418cc );	ROM_LOAD( "astyan8.bin",  0x020000, 0x020000, 0x5e5d2a22 );
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	/* Priority PROM */
		ROM_LOAD( "prom",         0x0000, 0x0200, 0x00000000 );ROM_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_avspirit = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_CONTINUE (                    0x080000, 0x020000 );	ROM_LOAD16_BYTE(  "spirit06.rom", 0x000001, 0x020000, 0x609f71fe )
	...
	COINS
		...
		PORT_DIPSETTING(    0x04, DEF_STR( "On") );
		PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x08, "Easy" );	PORT_DIPSETTING(    0x18, "Normal" );	PORT_DIPSETTING(    0x10, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Cabinet") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_cybattlr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	/* Priority PROM */
		ROM_LOAD( "pr-91028.12",  0x0000, 0x0200, 0xcfe90082 );ROM_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_edf = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_CONTINUE (                  0x080000, 0x020000 );	ROM_LOAD16_BYTE( "edf_06.rom",  0x000001, 0x020000, 0x94da2f0c )
		ROM_CONTINUE (                  0x080001, 0x020000 );
		ROM_REGION( 0x40000, REGION_CPU2, 0 );	/* Sound CPU Code */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_hachoo = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );/* Scroll 1 */
		ROM_LOAD( "hacho15.rom", 0x000000, 0x020000, 0xe559347e );	ROM_LOAD( "hacho16.rom", 0x020000, 0x020000, 0x105fd8b5 );	ROM_LOAD( "hacho17.rom", 0x040000, 0x020000, 0x77f46174 );	ROM_LOAD( "hacho18.rom", 0x060000, 0x020000, 0x0be21111 );
		ROM_REGION( 0x020000, REGION_GFX3, ROMREGION_DISPOSE );/* Scroll 2 */
		ROM_LOAD( "hacho19.rom", 0x000000, 0x020000, 0x33bc9de3 );
		ROM_REGION( 0x080000, REGION_GFX4, ROMREGION_DISPOSE );/* Sprites */
		ROM_LOAD( "hacho20.rom", 0x000000, 0x020000, 0x2ae2011e );	ROM_LOAD( "hacho21.rom", 0x020000, 0x020000, 0x6dcfb8d5 );	ROM_LOAD( "hacho22.rom", 0x040000, 0x020000, 0xccabf0e0 );	ROM_LOAD( "hacho23.rom", 0x060000, 0x020000, 0xff5f77aa );
		ROM_REGION( 0x040000, REGION_SOUND1, 0 );	/* Samples */
		ROM_LOAD( "hacho09.rom", 0x000000, 0x020000, 0xe9f35c90 );	ROM_LOAD( "hacho10.rom", 0x020000, 0x020000, 0x1aeaa188 );
		ROM_REGION( 0x040000, REGION_SOUND2, 0 );	/* Samples */
		ROM_LOAD( "hacho07.rom", 0x000000, 0x020000, 0x06e6ca7f );	ROM_LOAD( "hacho08.rom", 0x020000, 0x020000, 0x888a6df1 );
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	/* Priority PROM */
		ROM_LOAD( "prom",         0x0000, 0x0200, 0x00000000 );ROM_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_jitsupro = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_CONTINUE(          0x000000, 0x040000             );
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	/* Priority PROM */
		ROM_LOAD( "bs.bpr",    0x0000, 0x0200, 0x85b30ac4 );ROM_END(); }}; 
	...
	static InputPortPtr input_ports_jitsupro = new InputPortPtr(){ public void handler() { 
		...
		PORT_DIPNAME( 0x01, 0x01, "Unknown 2-0*" );	PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x02, "Unknown 2-1*" );	PORT_DIPSETTING(    0x02, DEF_STR( "Off") );	// $200-140
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );	// $400-140
		PORT_DIPNAME( 0x3c, 0x3c, "Unknown 2-2345*" );	PORT_DIPSETTING(    0x3c, "0"  );	PORT_DIPSETTING(    0x38, "1"  );	PORT_DIPSETTING(    0x34, "2"  );	PORT_DIPSETTING(    0x30, "3"  );	PORT_DIPSETTING(    0x2c, "4"  );	PORT_DIPSETTING(    0x28, "5"  );	PORT_DIPSETTING(    0x24, "6"  );	PORT_DIPSETTING(    0x20, "7"  );	PORT_DIPSETTING(    0x1c, "8"  );	PORT_DIPSETTING(    0x18, "9"  );	PORT_DIPSETTING(    0x14, "10" );	PORT_DIPSETTING(    0x10, "11" );	PORT_DIPSETTING(    0x0c, "12" );	PORT_DIPSETTING(    0x08, "13" );	PORT_DIPSETTING(    0x04, "14" );	PORT_DIPSETTING(    0x00, "15" );	PORT_DIPNAME( 0x40, 0x40, "Unknown 2-6*" );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_peekaboo = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	/* Priority PROM */
		ROM_LOAD( "priority.69",    0x000000, 0x200, 0xb40bff56 );ROM_END(); }}; 
	...
	static WRITE16_HANDLER( protection_peekaboo_w )
	{
		...
		{
			UBytePtr RAM = memory_region(okim6295_interface_D.region[0]);
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_soldamj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	/* Priority PROM */
		ROM_LOAD( "soldam.m14",   0x0000, 0x0200, 0x8914e72d );ROM_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_tshingen = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x040000, REGION_SOUND2, 0 );	/* Samples */
		ROM_LOAD( "shing_07.rom",  0x000000, 0x020000, 0xc37ecbdc );	ROM_LOAD( "shing_08.rom",  0x020000, 0x020000, 0x36d56c8c );
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	/* Priority PROM */
		ROM_LOAD( "prom",    0x0000, 0x0200, 0x00000000 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_tshingna = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );/* Scroll 0 */
		ROM_LOAD( "takeda11.bin", 0x000000, 0x020000, 0xbf0b40a6 );	ROM_LOAD( "shing_12.rom", 0x020000, 0x020000, 0x5e4adedb );
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );/* Scroll 1 */
		ROM_LOAD( "shing_15.rom", 0x000000, 0x020000, 0x9db18233 );	ROM_LOAD( "takeda16.bin", 0x020000, 0x020000, 0xceda9dd6 );	ROM_LOAD( "takeda17.bin", 0x040000, 0x020000, 0x3d4371dc );
		ROM_REGION( 0x020000, REGION_GFX3, ROMREGION_DISPOSE );/* Scroll 2 */
		ROM_LOAD( "shing_19.rom", 0x000000, 0x010000, 0x97282d9d );
		ROM_REGION( 0x080000, REGION_GFX4, ROMREGION_DISPOSE );/* Sprites */
		ROM_LOAD( "shing_20.rom", 0x000000, 0x020000, 0x7f6f8384 );	ROM_LOAD( "takeda21.bin", 0x020000, 0x020000, 0x12fb006b );	ROM_LOAD( "takeda22.bin", 0x040000, 0x020000, 0xb165b6ae );	ROM_LOAD( "takeda23.bin", 0x060000, 0x020000, 0x37cb9214 );
		ROM_REGION( 0x040000, REGION_SOUND1, 0 );	/* Samples */
		ROM_LOAD( "takeda9.bin",  0x000000, 0x020000, 0xdb7f3f4f );	ROM_LOAD( "takeda10.bin", 0x020000, 0x020000, 0xc9959d71 );
		ROM_REGION( 0x040000, REGION_SOUND2, 0 );	/* Samples */
		ROM_LOAD( "shing_07.rom",  0x000000, 0x020000, 0xc37ecbdc );	ROM_LOAD( "shing_08.rom",  0x020000, 0x020000, 0x36d56c8c );
	...
	***************************************************************************/
	...
	public static GameDriver driver_astyanax	   = new GameDriver("1989"	,"astyanax"	,"megasys1.java"	,rom_astyanax,null	,machine_driver_system_A	,input_ports_astyanax	,init_astyanax	,ROT0_16BIT	,	"Jaleco", "The Astyanax" )
	public static GameDriver driver_lordofk	   = new GameDriver("1989"	,"lordofk"	,"megasys1.java"	,rom_lordofk,driver_astyanax	,machine_driver_system_A	,input_ports_astyanax	,init_astyanax	,ROT0_16BIT	,	"Jaleco", "The Lord of King (Japan)" )
