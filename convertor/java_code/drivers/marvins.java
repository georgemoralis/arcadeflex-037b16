...
public class marvins
{
	...
	***************************************************************************/
	...
	public static Memory_WriteAddress writemem_sound[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x3fff, MWA_ROM, &namco_wavedata ),	/* silly hack - this shouldn't be here */
	...
	***************************************************************************/
	...
	public static Memory_WriteAddress writemem_CPUA[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x6000, 0x6000, marvins_palette_bank_w ), // Marvin's Maze only
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_marvins = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "s1",    0x0000, 0x2000, 0x327f70f3 );/* characters */
	
		ROM_REGION( 0x2000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "b1",    0x0000, 0x2000, 0xe528bc60 );/* background tiles */
	
		ROM_REGION( 0x2000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "b2",    0x0000, 0x2000, 0xe528bc60 );/* foreground tiles */
	
		ROM_REGION( 0x6000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "f3",    0x0000, 0x2000, 0xe55c9b83 );/* sprites */
		ROM_LOAD( "f2",    0x2000, 0x2000, 0x8fc2b081 );	ROM_LOAD( "f1",    0x4000, 0x2000, 0x0bd6b4e5 );
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "marvmaze.j1",  0x000, 0x400, 0x92f5b06d );	ROM_LOAD( "marvmaze.j2",  0x400, 0x400, 0xd2b25665 );	ROM_LOAD( "marvmaze.j3",  0x800, 0x400, 0xdf9e6005 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_madcrash = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "p13",    0x0000, 0x2000, 0x48c4ade0 );/* characters */
	
		ROM_REGION( 0x2000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "p11",    0x0000, 0x2000, 0x67174956 );/* background tiles */
	
		ROM_REGION( 0x2000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "p12",    0x0000, 0x2000, 0x085094c1 );/* foreground tiles */
	
		ROM_REGION( 0x6000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "p14",    0x0000, 0x2000, 0x07e807bc );/* sprites */
		ROM_LOAD( "p15",    0x2000, 0x2000, 0xa74149d4 );	ROM_LOAD( "p16",    0x4000, 0x2000, 0x6153611a );
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "m3-prom.j3",  0x000, 0x400, 0xd19e8a91 );	ROM_LOAD( "m2-prom.j4",  0x400, 0x400, 0x9fc325af );	ROM_LOAD( "m1-prom.j5",  0x800, 0x400, 0x07678443 );ROM_END(); }}; 
	
	static RomLoadPtr rom_vangrd2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );	ROM_LOAD( "p1.9a",  0x0000, 0x2000, 0xbc9eeca5 );	ROM_LOAD( "p3.11a", 0x2000, 0x2000, 0x3970f69d );	ROM_LOAD( "p2.12a", 0x4000, 0x2000, 0x58b08b58 );	ROM_LOAD( "p4.14a", 0x6000, 0x2000, 0xa95f11ea );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "p5.4a", 0x0000, 0x2000, 0xe4dfd0ba );	ROM_LOAD( "p6.6a", 0x2000, 0x2000, 0x894ff00d );	ROM_LOAD( "p7.7a", 0x4000, 0x2000, 0x40b4d069 );
		ROM_REGION( 0x10000, REGION_CPU3, 0 );/* 64k for sound code */
		ROM_LOAD( "p8.6a", 0x0000, 0x2000, 0xa3daa438 );	ROM_LOAD( "p9.8a", 0x2000, 0x2000, 0x9345101a );
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "p15.1e", 0x0000, 0x2000, 0x85718a41 );/* characters */
	
		ROM_REGION( 0x2000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "p13.1a", 0x0000, 0x2000, 0x912f22c6 );/* background tiles */
	
		ROM_REGION( 0x2000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "p9",     0x0000, 0x2000, 0x7aa0b684 );/* foreground tiles */
	
		ROM_REGION( 0x6000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "p12.1kl", 0x0000, 0x2000, 0x8658ea6c );/* sprites */
		ROM_LOAD( "p11.3kl", 0x2000, 0x2000, 0x620cd4ec );	ROM_LOAD( "p10.4kl", 0x4000, 0x2000, 0x5bfc04c0 );
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "mb7054.3j", 0x000, 0x400, 0x506f659a );	ROM_LOAD( "mb7054.4j", 0x400, 0x400, 0x222133ce );	ROM_LOAD( "mb7054.5j", 0x800, 0x400, 0x2e21a79b );ROM_END(); }}; 
