...
public class itech32
{
	...
	static public static nvramPtr nvram_handler_itech020  = new nvramPtr() { public void handler(Object file, int read_or_write) 
	{
		int i;
	...
	public static Memory_ReadAddress sound_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0400, 0x0400, sound_data_r ),
	...
	public static Memory_WriteAddress sound_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0800, 0x083f, ES5506_data_0_w ),
	...
	public static Memory_ReadAddress sound_020_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x0000, sound_data_r ),
	...
	PORT_START(); 	/* 40000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON3        | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON4        | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 );
		PORT_START(); 	/* 48000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON3        | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON4        | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER2 );
		PORT_START(); 	/* 50000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON5        | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON5        | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 58000 */
		PORT_SERVICE_NO_TOGGLE( 0x0001, IP_ACTIVE_LOW )
		PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_SPECIAL );	PORT_DIPNAME( 0x0010, 0x0000, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0010, DEF_STR( "On") );
		PORT_DIPNAME( 0x0020, 0x0000, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0020, DEF_STR( "On") );
		PORT_DIPNAME( 0x0040, 0x0000, "Violence" );	PORT_DIPSETTING(      0x0040, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0080, 0x0000, "Force Test Mode" );	PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
	...
	PORT_START(); 	/* 080000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON3        | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 );
		PORT_START(); 	/* 100000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON3        | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER2 );
		PORT_START(); 	/* 180000 */
		...
		PORT_START(); 	/* 780000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON4        | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON4        | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON5        | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON5        | IPF_PLAYER2 );	PORT_BIT( 0x00c0, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	
	
	static InputPortPtr input_ports_hardyard = new InputPortPtr(){ public void handler() { 
	PORT_START(); 	/* 080000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 );
		PORT_START(); 	/* 100000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER2 );
		PORT_START(); 	/* 180000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START3 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER3 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER3 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER3 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER3 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER3 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER3 );
		PORT_START(); 	/* 200000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START4 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER4 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER4 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER4 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER4 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER4 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER4 );
		PORT_START(); 	/* 280000 */
		PORT_SERVICE_NO_TOGGLE( 0x0001, IP_ACTIVE_LOW )
		PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_SPECIAL );	PORT_DIPNAME( 0x0010, 0x0000, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		...
		PORT_START(); 	/* 780000 */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	
	
	static InputPortPtr input_ports_pairs = new InputPortPtr(){ public void handler() { 
	PORT_START(); 	/* 080000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 );
		PORT_START(); 	/* 100000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER2 );
		PORT_START(); 	/* 180000 */
		PORT_BIT( 0x00ff, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* 200000 */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );
		...
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0020, DEF_STR( "On") );
		PORT_DIPNAME( 0x0040, 0x0000, "Modesty" );	PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0040, DEF_STR( "On") );
		PORT_DIPNAME( 0x0080, 0x0000, "Force Test Mode" );	PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0080, DEF_STR( "On") );
	...
	PORT_START(); 	/* 080000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER1 );	PORT_BIT( 0x00f0, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 100000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER2 | IPF_COCKTAIL );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER2 | IPF_COCKTAIL );	PORT_BIT( 0x00f0, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 180000 */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 200000 */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 280000 */
		PORT_SERVICE_NO_TOGGLE( 0x0001, IP_ACTIVE_LOW )
		PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x0010, 0x0000, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0010, DEF_STR( "On") );
		...
		PORT_START(); 	/* analog */
	    PORT_ANALOG( 0xff, 0x00, IPT_TRACKBALL_Y | IPF_PLAYER2 | IPF_COCKTAIL, 25, 32, 0, 255 );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* 080000 */
		...
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER2 );
		PORT_START(); 	/* 180000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON3        | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON3        | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON4        | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON4        | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON5        | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON5        | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON6        | IPF_PLAYER1 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON6        | IPF_PLAYER2 );
		PORT_START(); 	/* 200000 */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 280000 */
		PORT_SERVICE_NO_TOGGLE( 0x0001, IP_ACTIVE_LOW )
	...
	(																				\
		...
		new MachineCPU[] {																			\
			...
			new MachineCPU(																		\
				CPU_M6809,															\
				CLOCK_8MHz/4,														\
				SOUNDMEM##_readmem,SOUNDMEM##_writemem,null,null,							\
				SOUNDINT,4															\
			)																		\
		},																			\
		...
		init_machine,																\
																					\
		/* video hardware */														\
		384, 240, new rectangle( 0, 383, 0, YMAX ),												\
		null,																			\
		COLORS,COLORS,																\
		null,																			\
																					\
		...
		0,0,0,0,																	\
		new MachineSound[] {																			\
			new MachineSound( SOUND_ES5506, es5506_interface )										\
		},																			\
		NVRAM																		\
	);
	...
	static RomLoadPtr rom_timekill = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x28000, REGION_CPU2, 0 );	ROM_LOAD( "tksndv41.u17", 0x10000, 0x18000, 0xc699af7b );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x880000, REGION_GFX1, 0 );	ROM_LOAD32_BYTE( "tk0_rom.1", 0x000000, 0x200000, 0x94cbf6f8 )
	...
	static RomLoadPtr rom_timek131 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x28000, REGION_CPU2, 0 );	ROM_LOAD( "tksnd.u17", 0x10000, 0x18000, 0xab1684c3 );	ROM_CONTINUE(          0x08000, 0x08000 );
		ROM_REGION( 0x880000, REGION_GFX1, 0 );	ROM_LOAD32_BYTE( "tk0_rom.1", 0x000000, 0x200000, 0x94cbf6f8 )
		ROM_LOAD32_BYTE( "tk1_rom.2", 0x000001, 0x200000, 0xc07dea98 )
		ROM_LOAD32_BYTE( "tk2_rom.3", 0x000002, 0x200000, 0x183eed2a )
		ROM_LOAD32_BYTE( "tk3_rom.4", 0x000003, 0x200000, 0xb1da1058 )
	...
	static RomLoadPtr rom_bloodstm = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x28000, REGION_CPU2, 0 );	ROM_LOAD( "bldsnd.u17", 0x10000, 0x18000, 0xdddeedbb );	ROM_CONTINUE(           0x08000, 0x08000 );
		ROM_REGION( 0x880000, REGION_GFX1, 0 );	ROM_LOAD32_BYTE( "bsgrom0.bin",  0x000000, 0x080000, 0x4e10b8c1 )
	...
	static RomLoadPtr rom_hardyard = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x28000, REGION_CPU2, 0 );	ROM_LOAD( "fbsndv11.u17", 0x10000, 0x18000, 0xd221b121 );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x880000, REGION_GFX1, 0 );	ROM_LOAD32_BYTE( "itfb0.bin",  0x000000, 0x100000, 0x0b7781af )
	...
	static RomLoadPtr rom_hardyd10 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x28000, REGION_CPU2, 0 );	ROM_LOAD( "hy_fbsnd.u17", 0x10000, 0x18000, 0x6c6db5b8 );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x880000, REGION_GFX1, 0 );	ROM_LOAD32_BYTE( "itfb0.bin",  0x000000, 0x100000, 0x0b7781af )
		ROM_LOAD32_BYTE( "itfb1.bin",  0x000001, 0x100000, 0x178d0f9b )
		ROM_LOAD32_BYTE( "itfb2.bin",  0x000002, 0x100000, 0x0a17231e )
		ROM_LOAD32_BYTE( "itfb3.bin",  0x000003, 0x100000, 0x104456af )
	...
	static RomLoadPtr rom_pairs = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x28000, REGION_CPU2, 0 );	ROM_LOAD( "pairsnd", 0x10000, 0x18000, 0x7a514cfd );	ROM_CONTINUE(        0x08000, 0x08000 );
		ROM_REGION( 0x880000, REGION_GFX1, 0 );	ROM_LOAD32_BYTE( "grom0",  0x000000, 0x80000, 0xbaf1c2dd )
	...
	static RomLoadPtr rom_shufshot = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x28000, REGION_CPU2, 0 );	ROM_LOAD( "sndv1.1", 0x10000, 0x18000, 0xe37d599d );	ROM_CONTINUE(        0x08000, 0x08000 );
		ROM_REGION( 0x800000, REGION_GFX1, 0 );	ROM_LOAD32_BYTE( "grom0_0", 0x000000, 0x80000, 0x832a3d6a )
	...
	static RomLoadPtr rom_sftm = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x48000, REGION_CPU2, 0 );	ROM_LOAD( "snd-v10.bin", 0x10000, 0x38000, 0x10d85366 );	ROM_CONTINUE(            0x08000, 0x08000 );
		ROM_REGION( 0x2080000, REGION_GFX1, 0 );	ROM_LOAD32_BYTE( "rm0-0.bin",  0x0000000, 0x400000, 0x09ef29cb )
	...
	static RomLoadPtr rom_sftmj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x48000, REGION_CPU2, 0 );	ROM_LOAD( "snd_v111.u23", 0x10000, 0x38000, 0x004854ed );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x2080000, REGION_GFX1, 0 );	ROM_LOAD32_BYTE( "rm0-0.bin",  0x0000000, 0x400000, 0x09ef29cb )
		ROM_LOAD32_BYTE( "rm0-1.bin",  0x0000001, 0x400000, 0x6f5910fa )
		ROM_LOAD32_BYTE( "rm0-2.bin",  0x0000002, 0x400000, 0xb8a2add5 )
		ROM_LOAD32_BYTE( "rm0-3.bin",  0x0000003, 0x400000, 0x6b6ff867 )
	...
	public static GameDriver driver_timekill	   = new GameDriver("1992"	,"timekill"	,"itech32.java"	,rom_timekill,null	,machine_driver_timekill	,input_ports_timekill	,init_timekill	,ROT0_16BIT	,	"Strata/Incredible Technologies", "Time Killers (v1.32)" )
	public static GameDriver driver_timek131	   = new GameDriver("1992"	,"timek131"	,"itech32.java"	,rom_timek131,driver_timekill	,machine_driver_timekill	,input_ports_timekill	,init_timekill	,ROT0_16BIT	,	"Strata/Incredible Technologies", "Time Killers (v1.31)" )
	public static GameDriver driver_hardyard	   = new GameDriver("1993"	,"hardyard"	,"itech32.java"	,rom_hardyard,null	,machine_driver_bloodstm	,input_ports_hardyard	,init_hardyard	,ROT0_16BIT	,	"Strata/Incredible Technologies", "Hard Yardage (v1.20)" )
	public static GameDriver driver_hardyd10	   = new GameDriver("1993"	,"hardyd10"	,"itech32.java"	,rom_hardyd10,driver_hardyard	,machine_driver_bloodstm	,input_ports_hardyard	,init_hardyard	,ROT0_16BIT	,	"Strata/Incredible Technologies", "Hard Yardage (v1.00)" )
	public static GameDriver driver_bloodstm	   = new GameDriver("1994"	,"bloodstm"	,"itech32.java"	,rom_bloodstm,null	,machine_driver_bloodstm	,input_ports_bloodstm	,init_bloodstm	,ROT0_16BIT	,	"Strata/Incredible Technologies", "Blood Storm (v2.22)" )
	public static GameDriver driver_bloods22	   = new GameDriver("1994"	,"bloods22"	,"itech32.java"	,rom_bloods22,driver_bloodstm	,machine_driver_bloodstm	,input_ports_bloodstm	,init_bloodstm	,ROT0_16BIT	,	"Strata/Incredible Technologies", "Blood Storm (v2.20)" )
	public static GameDriver driver_bloods21	   = new GameDriver("1994"	,"bloods21"	,"itech32.java"	,rom_bloods21,driver_bloodstm	,machine_driver_bloodstm	,input_ports_bloodstm	,init_bloodstm	,ROT0_16BIT	,	"Strata/Incredible Technologies", "Blood Storm (v2.10)" )
	public static GameDriver driver_pairs	   = new GameDriver("1994"	,"pairs"	,"itech32.java"	,rom_pairs,null	,machine_driver_pairs	,input_ports_pairs	,init_bloodstm	,ROT0_16BIT	,	"Strata/Incredible Technologies", "Pairs" )
	public static GameDriver driver_sftm	   = new GameDriver("1995"	,"sftm"	,"itech32.java"	,rom_sftm,null	,machine_driver_sftm	,input_ports_sftm	,init_sftm	,ROT0_16BIT	,	"Capcom/Incredible Technologies", "Street Fighter: The Movie (v1.12)" )
	public static GameDriver driver_sftm110	   = new GameDriver("1995"	,"sftm110"	,"itech32.java"	,rom_sftm110,driver_sftm	,machine_driver_sftm	,input_ports_sftm	,init_sftm110	,ROT0_16BIT	,	"Capcom/Incredible Technologies", "Street Fighter: The Movie (v1.10)" )
	public static GameDriver driver_sftmj	   = new GameDriver("1995"	,"sftmj"	,"itech32.java"	,rom_sftmj,driver_sftm	,machine_driver_sftm	,input_ports_sftm	,init_sftm	,ROT0_16BIT	,	"Capcom/Incredible Technologies", "Street Fighter: The Movie (v1.12N, Japan)" )
	public static GameDriver driver_shufshot	   = new GameDriver("1997"	,"shufshot"	,"itech32.java"	,rom_shufshot,null	,machine_driver_sftm	,input_ports_shufshot	,init_shufshot	,ROT0_16BIT	,	"Strata/Incredible Technologies", "Shuffleshot" )
}
