...
public class pandoras
{
	...
	public static Memory_ReadAddress pandoras_readmem_a[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x0fff, pandoras_sharedram_r ),	/* Work RAM (Shared with CPU B) */
	...
	public static Memory_WriteAddress pandoras_writemem_a[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x0fff, pandoras_sharedram_w, &pandoras_sharedram ),	/* Work RAM (Shared with CPU B) */
	...
	public static Memory_ReadAddress pandoras_readmem_b[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x0fff, pandoras_sharedram_r ),	/* Work RAM (Shared with CPU A) */
	...
	public static Memory_WriteAddress pandoras_writemem_b[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x0fff, pandoras_sharedram_w ),	/* Work RAM (Shared with CPU A) */
	...
	***************************************************************************/
	...
	//	PORT_DIPSETTING(    0x00, "Invalid" );
		...
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0xe0, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_pandoras = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "pand_a18.cpu",	0x00000, 0x02000, 0x23706d4a );/* tiles */
		ROM_LOAD( "pand_a19.cpu",	0x02000, 0x02000, 0xa463b3f9 );
		ROM_REGION( 0x6000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "pand_j18.cpu",	0x00000, 0x02000, 0x99a696c5 );/* sprites */
		ROM_LOAD( "pand_j17.cpu",	0x02000, 0x02000, 0x38a03c21 );	ROM_LOAD( "pand_j16.cpu",	0x04000, 0x02000, 0xe0708a78 );
		ROM_REGION( 0x0220, REGION_PROMS, 0 );	ROM_LOAD( "pandora.2a",		0x0000, 0x020, 0x4d56f939 );/* palette */
