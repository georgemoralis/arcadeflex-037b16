...
public class hexion
{
	...
	PORT_START(); 
		...
		PORT_DIPSETTING(    0x70, "Easiest" );	PORT_DIPSETTING(    0x60, "Very Easy" );	PORT_DIPSETTING(    0x50, "Easy" );	PORT_DIPSETTING(    0x40, "Medium" );	PORT_DIPSETTING(    0x30, "Medium Hard" );	PORT_DIPSETTING(    0x20, "Hard" );	PORT_DIPSETTING(    0x10, "Very Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		...
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_SPECIAL );/* 052591? game waits for it to be 0 */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_hexion = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "122jab01.bin", 0x00000, 0x20000, 0xeabc6dd1 );	ROM_RELOAD(               0x10000, 0x20000 );/* banked at 8000-9fff */
	
		ROM_REGION( 0x80000, REGION_GFX1, 0 );/* addressable by the main CPU */
		ROM_LOAD( "122a07.bin",   0x00000, 0x40000, 0x22ae55e3 );	ROM_LOAD( "122a06.bin",   0x40000, 0x40000, 0x438f4388 );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );/* OKIM6295 samples */
		ROM_LOAD( "122a05.bin",   0x0000, 0x40000, 0xbcc831bf );
		ROM_REGION( 0x0300, REGION_PROMS, 0 );	ROM_LOAD( "proms",        0x0000, 0x0300, 0x00000000 );ROM_END(); }}; 
