...
public class route16
{
	...
	public static IO_WritePort cpu1_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x6800, 0x6800, AY8910_write_port_0_w ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_route16 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	/* The upper 128 bytes are 0's, used by the hardware to blank the display */
	...
	public static GameDriver driver_speakres	   = new GameDriver("19??"	,"speakres"	,"route16.java"	,rom_speakres,driver_stratvox	,machine_driver_stratvox	,input_ports_stratvox	,init_stratvox	,ROT270	,	"<unknown>", "Speak & Rescue" )
}
