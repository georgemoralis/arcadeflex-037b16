...
public class tmnt
{
	...
	***************************************************************************/
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON5 | IPF_PLAYER1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START1 );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON5 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START2 );
		PORT_START(); 	/* COIN */
	...
	PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BITX(0x0200, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x1000, 0x0000, "Sound" );	PORT_DIPSETTING(      0x1000, "Mono" );	PORT_DIPSETTING(      0x0000, "Stereo" );	PORT_DIPNAME( 0x2000, 0x2000, DEF_STR( "Unused") );
		PORT_DIPSETTING(      0x2000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		...
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0100, IP_ACTIVE_HIGH, IPT_SPECIAL );/* EEPROM data */
		PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_SPECIAL );/* EEPROM status? - always 1 */
		PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_mia = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "808a18.f16",   0x0000, 0x0100, 0xeb95aede );/* priority encoder (not used) */
	...
	static RomLoadPtr rom_tmnt = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	ROM_LOAD( "963-a30",      0x0000, 0x0100, 0xabd82680 );/* sprite address decoder */
	...
	static RomLoadPtr rom_blswhstl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "e09.bin",     0x000000, 0x20000, 0xe8b7b234 )
	...
	static RomLoadPtr rom_detatwin = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "060_j02.rom", 0x000000, 0x20000, 0x11b761ac )
	...
	static RomLoadPtr rom_glfgreat = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "061l02.1h",   0x000000, 0x20000, 0xac7399f4 )
		...
		ROM_LOAD( "061b08.14g",   0x000000, 0x080000, 0x6ab739c3 );	ROM_LOAD( "061b09.15g",   0x080000, 0x080000, 0x42c7a603 );	ROM_LOAD( "061b10.17g",   0x100000, 0x080000, 0x10f89ce7 );
		ROM_REGION( 0x120000, REGION_USER1, 0 );/* unknown (further data for the 053936?) */
		ROM_LOAD( "061b07.18d",   0x000000, 0x080000, 0x517887e2 );	ROM_LOAD( "061b06.16d",   0x080000, 0x080000, 0x41ada2ad );	ROM_LOAD( "061b05.15d",   0x100000, 0x020000, 0x2456fb11 );
		ROM_REGION( 0x100000, REGION_SOUND1, 0 );/* samples for the 053260 */
		ROM_LOAD( "061e04.1d",    0x0000, 0x100000, 0x7921d8df );ROM_END(); }}; 
	
	static RomLoadPtr rom_glfgretj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "061j02.1h",   0x000000, 0x20000, 0x7f0d95f4 )
	...
	static RomLoadPtr rom_tmnt2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "uaa02", 0x000000, 0x20000, 0x58d5c93d )
	...
	static RomLoadPtr rom_tmnt22p = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "a02",   0x000000, 0x20000, 0xaadffe3a )
	...
	static RomLoadPtr rom_tmnt2a = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "ada02", 0x000000, 0x20000, 0x4f11b587 )
	...
	static RomLoadPtr rom_qgakumon = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "248jaa02.8e",  0x000000, 0x40000, 0xfab79410 )
		...
		ROM_REGION( 0x200000, REGION_SOUND1, 0 );/* samples for the 053260 */
		ROM_LOAD( "248a06.1d",       0x0000, 0x200000, 0x0fba1def );ROM_END(); }}; 
	
	static RomLoadPtr rom_ssriders = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "064eac02",    0x000000, 0x40000, 0x5a5425f4 )
	...
	static RomLoadPtr rom_ssrdrebd = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "064ebd02",    0x000000, 0x40000, 0x8deef9ac )
	...
	static RomLoadPtr rom_ssrdrebc = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "sr_c02.rom",  0x000000, 0x40000, 0x9bd7d164 )
	...
	static RomLoadPtr rom_ssrdruda = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "064uda02",    0x000000, 0x40000, 0x5129a6b7 )
	...
	static RomLoadPtr rom_ssrdruac = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "064uac02",    0x000000, 0x40000, 0x870473b6 )
	...
	static RomLoadPtr rom_ssrdrubc = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "2pl.8e",      0x000000, 0x40000, 0xaca7fda5 )
	...
	static RomLoadPtr rom_ssrdrabd = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "064abd02.8e", 0x000000, 0x40000, 0x713406cb )
	...
	static RomLoadPtr rom_ssrdrjbd = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "064jbd02.8e", 0x000000, 0x40000, 0x7acdc1e3 )
	...
	static RomLoadPtr rom_thndrx2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "073-k02.11c", 0x000000, 0x20000, 0x0c8b2d3f )
		...
		ROM_REGION( 0x80000, REGION_SOUND1, 0 );/* samples for the 053260 */
		ROM_LOAD( "073-b04.2d",   0x0000, 0x80000, 0x05287a0b );ROM_END(); }}; 
	
	static RomLoadPtr rom_prmrsocr = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "101jab08.1h", 0x000000, 0x40000, 0xc22b528c )
		ROM_LOAD16_BYTE( "101jab07.4h", 0x000001, 0x40000, 0x06e7acaf )
	
		ROM_REGION( 0x30000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "101_c05.5e",   0x00000, 0x20000, 0x02c3679f );	ROM_RELOAD(               0x10000, 0x20000 );
		...
		ROM_LOAD( "101a01.18d",   0x000000, 0x020000, 0x716f910f );	ROM_LOAD( "101a02.16d",   0x020000, 0x020000, 0x222869c7 );
		ROM_REGION( 0x200000, REGION_SOUND1, 0 );/* samples for the 054539 */
		ROM_LOAD( "101a06.1d",    0x0000, 0x200000, 0x4f48e043 );ROM_END(); }}; 
	...
	public static GameDriver driver_ssriders	   = new GameDriver("1991"	,"ssriders"	,"tmnt.java"	,rom_ssriders,null	,machine_driver_ssriders	,input_ports_ssridr4p	,init_gfx	,ROT0	,	"Konami", "Sunset Riders (World 4 Players ver. EAC)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_ssrdrebd	   = new GameDriver("1991"	,"ssrdrebd"	,"tmnt.java"	,rom_ssrdrebd,driver_ssriders	,machine_driver_ssriders	,input_ports_ssriders	,init_gfx	,ROT0	,	"Konami", "Sunset Riders (World 2 Players ver. EBD)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_ssrdrebc	   = new GameDriver("1991"	,"ssrdrebc"	,"tmnt.java"	,rom_ssrdrebc,driver_ssriders	,machine_driver_ssriders	,input_ports_ssriders	,init_gfx	,ROT0	,	"Konami", "Sunset Riders (World 2 Players ver. EBC)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_ssrdruda	   = new GameDriver("1991"	,"ssrdruda"	,"tmnt.java"	,rom_ssrdruda,driver_ssriders	,machine_driver_ssriders	,input_ports_ssriders	,init_gfx	,ROT0	,	"Konami", "Sunset Riders (US 4 Players ver. UDA)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_ssrdruac	   = new GameDriver("1991"	,"ssrdruac"	,"tmnt.java"	,rom_ssrdruac,driver_ssriders	,machine_driver_ssriders	,input_ports_ssriders	,init_gfx	,ROT0	,	"Konami", "Sunset Riders (US 4 Players ver. UAC)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_ssrdrubc	   = new GameDriver("1991"	,"ssrdrubc"	,"tmnt.java"	,rom_ssrdrubc,driver_ssriders	,machine_driver_ssriders	,input_ports_ssriders	,init_gfx	,ROT0	,	"Konami", "Sunset Riders (US 2 Players ver. UBC)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_ssrdrabd	   = new GameDriver("1991"	,"ssrdrabd"	,"tmnt.java"	,rom_ssrdrabd,driver_ssriders	,machine_driver_ssriders	,input_ports_ssriders	,init_gfx	,ROT0	,	"Konami", "Sunset Riders (Asia 2 Players ver. ABD)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_ssrdrjbd	   = new GameDriver("1991"	,"ssrdrjbd"	,"tmnt.java"	,rom_ssrdrjbd,driver_ssriders	,machine_driver_ssriders	,input_ports_ssriders	,init_gfx	,ROT0	,	"Konami", "Sunset Riders (Japan 2 Players ver. JBD)", GAME_UNEMULATED_PROTECTION )
