...
public class atarigt
{
	...
	logerror("%06X:Palette lo W=%04X\n", cpu_getpreviouspc(), data);
		{
			...
			r = newword >> 8;
			g = newword & 0xff;
			b = READ_WORD(&paletteram_2.read(offset)) & 0xff;
	...
	*/
	...
	#if 0
	static MemoryReadAddress readmem_cage[] =
	{
		new MemoryReadAddress( 0x000000, 0x680000, MRA_ROM ),
		new MemoryReadAddress( -1 )  /* end of table */
	};
	
	
	static MemoryWriteAddress writemem_cage[] =
	{
		new MemoryWriteAddress( 0x000000, 0x680000, MWA_ROM ),
	...
	static MachineDriver machine_driver_atarigt = new MachineDriver
	(
		...
		new MachineCPU[] {
			...
			new MachineCPU(
				CPU_TMS320C31,
				33868800/8,
				readmem_cage,writemem_cage,null,null,
				ignore_interrupt,0
			)*/
		},
	...
	static RomLoadPtr rom_tmek = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "0078c", 0x000000, 0x080000, 0xff5b979a );	ROM_LOAD( "0074",  0x080000, 0x200000, 0x8dfc6ce0 );	ROM_LOAD( "0076",  0x280000, 0x200000, 0x74dffe2d );	ROM_LOAD( "0077",  0x480000, 0x200000, 0x8f650f8b );
		ROM_REGION( 0x300000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "0250",  0x000000, 0x80000, 0x56bd9f25 );/* playfield, planes 0-1 */
		ROM_LOAD( "0253a", 0x080000, 0x80000, 0x23e2f83d );	ROM_LOAD( "0251",  0x100000, 0x80000, 0x0d3b08f7 );/* playfield, planes 2-3 */
		ROM_LOAD( "0254a", 0x180000, 0x80000, 0x448aea87 );	ROM_LOAD( "0252",  0x200000, 0x80000, 0x95a1c23b );/* playfield, planes 4-5 */
		ROM_LOAD( "0255a", 0x280000, 0x80000, 0xf0fbb700 );
		ROM_REGION( 0x020000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "0045a", 0x000000, 0x20000, 0x057a5304 );/* alphanumerics */
	...
	static RomLoadPtr rom_tmekprot = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "0254a", 0x180000, 0x80000, 0x448aea87 );	ROM_LOAD( "0252",  0x200000, 0x80000, 0x95a1c23b );/* playfield, planes 4-5 */
		ROM_LOAD( "0255a", 0x280000, 0x80000, 0xf0fbb700 );
		ROM_REGION( 0x020000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "alpha", 0x000000, 0x20000, 0x8f57a604 );/* alphanumerics */
	...
	static RomLoadPtr rom_primrage = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x680000, REGION_CPU2, 0 );/* 6.5MB for TMS320C31 code */
		ROM_LOAD( "1078a", 0x000000, 0x080000, 0x0656435f );	ROM_LOAD( "0075",  0x080000, 0x200000, 0xb685a88e );	ROM_LOAD( "0077",  0x480000, 0x200000, 0x3283cea8 );
		ROM_REGION( 0x300000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "0050a",  0x000000, 0x80000, 0x66896e8f );/* playfield, planes 0-1 */
		...
		ROM_REGION( 0x020000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "1045b", 0x000000, 0x20000, 0x1d3260bf );/* alphanumerics */
	...
	static RomLoadPtr rom_primrag2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x680000, REGION_CPU2, 0 );/* 6.5MB for TMS320C31 code */
		ROM_LOAD( "0078a", 0x000000, 0x080000, 0x91df8d8f );	ROM_LOAD( "0075",  0x080000, 0x200000, 0xb685a88e );	ROM_LOAD( "0077",  0x480000, 0x200000, 0x3283cea8 );
		ROM_REGION( 0x300000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "0050a",  0x000000, 0x80000, 0x66896e8f );/* playfield, planes 0-1 */
		ROM_LOAD( "0051a",  0x100000, 0x80000, 0xfb5b3e7b );/* playfield, planes 2-3 */
		ROM_LOAD( "0052a",  0x200000, 0x80000, 0xcbe38670 );/* playfield, planes 4-5 */
	
		ROM_REGION( 0x020000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "0045a", 0x000000, 0x20000, 0xc8b39b1c );/* alphanumerics */
	...
	public static GameDriver driver_tmek	   = new GameDriver("1994"	,"tmek"	,"atarigt.java"	,rom_tmek,null	,machine_driver_atarigt	,input_ports_tmek	,init_tmek	,ROT0_16BIT	,	"Atari Games", "T-MEK", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_tmekprot	   = new GameDriver("1994"	,"tmekprot"	,"atarigt.java"	,rom_tmekprot,driver_tmek	,machine_driver_atarigt	,input_ports_tmek	,init_tmek	,ROT0_16BIT	,	"Atari Games", "T-MEK (prototype)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_primrage	   = new GameDriver("1994"	,"primrage"	,"atarigt.java"	,rom_primrage,null	,machine_driver_atarigt	,input_ports_tmek	,init_primrage	,ROT0_16BIT	,	"Atari Games", "Primal Rage (version 2.3)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_primrag2	   = new GameDriver("1994"	,"primrag2"	,"atarigt.java"	,rom_primrag2,driver_primrage	,machine_driver_atarigt	,input_ports_tmek	,init_primrage	,ROT0_16BIT	,	"Atari Games", "Primal Rage (version 2.0)", GAME_UNEMULATED_PROTECTION )
}
