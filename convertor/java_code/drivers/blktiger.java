...
public class blktiger
{
	...
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, soundlatch_w ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_blktiger = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "blktiger.2n",  0x00000, 0x08000, 0x70175d78 );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "blktiger.5b",  0x00000, 0x10000, 0xc4524993 );/* tiles */
		...
		ROM_REGION( 0x40000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "blktiger.5a",  0x00000, 0x10000, 0xe2f17438 );/* sprites */
	...
	static RomLoadPtr rom_blkdrgon = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "blktiger.1l",  0x0000, 0x8000, 0x2cf54274 );
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "blkdrgon.2n",  0x00000, 0x08000, 0x3821ab29 );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "blkdrgon.5b",  0x00000, 0x10000, 0x22d0a4b0 );/* tiles */
	...
	static RomLoadPtr rom_blkdrgnb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the audio CPU */
		ROM_LOAD( "blktiger.1l",  0x0000, 0x8000, 0x2cf54274 );
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "j15-2n",       0x00000, 0x08000, 0x852ad2b7 );/* characters */
