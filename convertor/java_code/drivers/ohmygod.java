...
public class ohmygod
{
	...
	//	PORT_DIPSETTING(      0x6000, DEF_STR( "2C_3C") );
		...
		PORT_DIPNAME( 0x4000, 0x4000, "Balls Have Eyes" );	PORT_DIPSETTING(      0x4000, DEF_STR( "No") );
	...
	//	PORT_DIPSETTING(      0x6000, DEF_STR( "2C_3C") );
		...
		PORT_START(); 
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x0300, 0x0300, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x0200, "Easy" );	PORT_DIPSETTING(      0x0300, "Normal" );	PORT_DIPSETTING(      0x0100, "Hard" );	PORT_DIPSETTING(      0x0000, "Hardest" );	PORT_DIPNAME( 0x0c00, 0x0c00, "Time Difficulty" );	PORT_DIPSETTING(      0x0800, "Easy" );	PORT_DIPSETTING(      0x0c00, "Normal" );	PORT_DIPSETTING(      0x0400, "Hard" );	PORT_DIPSETTING(      0x0000, "Hardest" );	PORT_DIPNAME( 0x1000, 0x1000, "Vs Matches/Credit" );	PORT_DIPSETTING(      0x1000, "1" );	PORT_DIPSETTING(      0x0000, "3" );	PORT_DIPNAME( 0x2000, 0x2000, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x2000, DEF_STR( "On") );
		PORT_DIPNAME( 0x4000, 0x4000, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(      0x4000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x8000, 0x8000, "Freeze" );	PORT_DIPSETTING(      0x8000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	(
		1,          /* 1 chip */
		new int[] { 14000000/8/132 },	/* 13.257 kHz ??? COMPLETE GUESS!! (not even sure about the xtal) */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_ohmygod = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 );	ROM_LOAD16_WORD_SWAP( "omg-p.114", 0x00000, 0x80000, 0x48fa40ca )
	
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "omg-b.117",    0x00000, 0x80000, 0x73621fa6 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "omg-s.120",    0x00000, 0x80000, 0x6413bd36 );
		ROM_REGION( 0x240000, REGION_SOUND1, 0 );	ROM_LOAD( "omg-g.107",    0x00000, 0x200000, 0x7405573c );	/* 00000-1ffff is fixed, 20000-3ffff is banked */
		ROM_RELOAD(               0x40000, 0x200000 );ROM_END(); }}; 
	
	static RomLoadPtr rom_naname = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 );	ROM_LOAD16_WORD_SWAP( "036-prg.114", 0x00000, 0x80000, 0x3b7362f7 )
	
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "036-bg.117",    0x00000, 0x80000, 0xf53e8da5 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "036-spr.120",   0x00000, 0x80000, 0xe36d8731 );
		ROM_REGION( 0x240000, REGION_SOUND1, 0 );	ROM_LOAD( "036-snd.107",  0x00000, 0x200000, 0xa3e0caf4 );	/* 00000-1ffff is fixed, 20000-3ffff is banked */
		ROM_RELOAD(               0x40000, 0x200000 );ROM_END(); }}; 
