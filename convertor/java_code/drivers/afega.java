...
public class afega
{
	...
	***************************************************************************/
	...
	PORT_START(); 	// IN0 - $800000.w
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_COIN1    );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_COIN2    );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_START1   );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_START2   );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0xff00, IP_ACTIVE_LOW, IPT_UNKNOWN  );
		PORT_START(); 	// IN1 - $800002.w
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER1 );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER1 );	PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );
		...
		PORT_DIPNAME( 0x0008, 0x0008, "Bombs" );	PORT_DIPSETTING(      0x0008, "2" );	PORT_DIPSETTING(      0x0000, "3" );	PORT_DIPNAME( 0x0010, 0x0010, "Unknown 1-4" );	PORT_DIPSETTING(      0x0010, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0020, 0x0020, "Unknown 1-5" );	PORT_DIPSETTING(      0x0020, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x00c0, 0x00c0, DEF_STR( "Lives") );
		PORT_DIPSETTING(      0x0000, "1" );	PORT_DIPSETTING(      0x0080, "2" );	PORT_DIPSETTING(      0x00c0, "3" );	PORT_DIPSETTING(      0x0040, "5" );
		PORT_DIPNAME( 0x0300, 0x0300, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(      0x0300, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPSETTING(      0x0200, "Horizontally" );	PORT_DIPSETTING(      0x0100, "Vertically" );	PORT_DIPNAME( 0x0400, 0x0400, "Unknown 2-2" );	PORT_DIPSETTING(      0x0400, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x1800, 0x1800, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x0800, "Easy" );	PORT_DIPSETTING(      0x1800, "Normal" );	PORT_DIPSETTING(      0x1000, "Hard" );	PORT_DIPSETTING(      0x0000, "Hardest" );	PORT_DIPNAME( 0xe000, 0xe000, DEF_STR( "Coinage") );
	...
	***************************************************************************/
	...
	static YM2151interface afega_ym2151_intf = new YM2151interface
	(
		1,
		4000000,	/* ? */
	...
	static OKIM6295interface afega_m6295_intf = new OKIM6295interface
	(
		1,
		new int[] { 8000 },	/* ? */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_stagger1 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_CONTINUE(      0x00000, 0x40000             );ROM_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_grdnstrm = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "gst-07.c08", 0x000000, 0x200000, 0xd68588c2 );	ROM_LOAD( "gst-08.c03", 0x200000, 0x200000, 0xf8b200a8 );
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );/* Layer 1, 8x8x4 */
		ROM_LOAD( "gst-03.u4",  0x00000, 0x10000, 0xa1347297 );
		ROM_REGION( 0x40000, REGION_SOUND1, ROMREGION_SOUNDONLY );/* Samples */
		ROM_LOAD( "gst-02.u95", 0x00000, 0x40000, 0xe911ce33 );ROM_END(); }}; 
	...
	***************************************************************************/
	...
	public static GameDriver driver_stagger1	   = new GameDriver("1998"	,"stagger1"	,"afega.java"	,rom_stagger1,null	,machine_driver_stagger1	,input_ports_stagger1	,init_stagger1	,ROT270_16BIT	,	"Afega", "Stagger I (Japan)",                GAME_NOT_WORKING )
	public static GameDriver driver_grdnstrm	   = new GameDriver("1998"	,"grdnstrm"	,"afega.java"	,rom_grdnstrm,null	,machine_driver_grdnstrm	,input_ports_grdnstrm	,init_grdnstrm	,ROT270_16BIT	,	"Afega", "Sen Jin - Guardian Storm (Korea)", GAME_NOT_WORKING )
}
