...
public class hexa
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_hexa = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x18000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "hexa.17",      0x00000, 0x8000, 0xf6911dd6 );	ROM_LOAD( "hexa.18",      0x08000, 0x8000, 0x6e3d95d2 );	ROM_LOAD( "hexa.19",      0x10000, 0x8000, 0xffe97a31 );
		ROM_REGION( 0x0300, REGION_PROMS, 0 );	ROM_LOAD( "hexa.001",     0x0000, 0x0100, 0x88a055b4 );	ROM_LOAD( "hexa.003",     0x0100, 0x0100, 0x3e9d4932 );	ROM_LOAD( "hexa.002",     0x0200, 0x0100, 0xff15366c );ROM_END(); }}; 
