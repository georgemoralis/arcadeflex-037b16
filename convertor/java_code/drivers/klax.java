...
public class klax
{
	...
	static RomLoadPtr rom_klax = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "136075-2.010", 0x00000, 0x10000, 0x15290a0d );	ROM_LOAD( "136075-2.012", 0x10000, 0x10000, 0xc0d9eb0f );	ROM_LOAD( "136075-2.009", 0x20000, 0x10000, 0x6368dbaf );	ROM_LOAD( "136075-2.011", 0x30000, 0x10000, 0xe83cca91 );
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "136075-2.014", 0x00000, 0x10000, 0x5c551e92 );	ROM_LOAD( "136075-2.013", 0x10000, 0x10000, 0x36764bbc );
