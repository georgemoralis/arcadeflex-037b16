...
public class cbasebal
{
	...
	***************************************************************************/
	...
	public static IO_ReadPort cbasebal_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x10, 0x10, input_port_0_r ),
	...
	public static IO_WritePort cbasebal_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, cbasebal_bankswitch_w ),
	...
	static RomLoadPtr rom_cbasebal = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "cbj13.16m",    0x00000, 0x10000, 0x2359fa0a );/* text */
	
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "cbj02.1f",     0x00000, 0x20000, 0xd6740535 );/* tiles */
		...
		ROM_REGION( 0x80000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "cbj11.1m",     0x00000, 0x20000, 0xbdc1507d );/* sprites */
