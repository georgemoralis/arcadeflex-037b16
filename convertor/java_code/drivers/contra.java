...
public class contra
{
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0010, 0x0010, input_port_0_r ),		/* IN0 */
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x0007, contra_K007121_ctrl_0_w ),
	...
	public static Memory_ReadAddress readmem_sound[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x0000, soundlatch_r ),
	...
	static RomLoadPtr rom_contra = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "633e04.7d",    0x00000, 0x40000, 0x14ddc542 )
		ROM_LOAD16_BYTE( "633e05.7f",    0x00001, 0x40000, 0x42185044 )
	
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "633e06.16d",   0x00000, 0x40000, 0x9cf6faae )
		ROM_LOAD16_BYTE( "633e07.16f",   0x00001, 0x40000, 0xf2d06638 )
	
		ROM_REGION( 0x0400, REGION_PROMS, 0 );	ROM_LOAD( "633e08.10g",   0x0000, 0x0100, 0x9f0949fa );/* 007121 #0 sprite lookup table */
