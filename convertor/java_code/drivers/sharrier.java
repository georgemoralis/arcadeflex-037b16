...
public class sharrier
{
	...
	public static IO_ReadPort hangon_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x40, 0x40, soundlatch_r ),
	...
	static RomLoadPtr rom_enduror = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "7678.rom", 0x00000, 0x8000, 0x9fb5e656 );	ROM_LOAD( "7677.rom", 0x08000, 0x8000, 0x7764765b );	ROM_LOAD( "7676.rom", 0x10000, 0x8000, 0x2e42e0d4 );	ROM_LOAD( "7675.rom", 0x18000, 0x8000, 0x5cd2d61 );	ROM_LOAD( "7674.rom", 0x20000, 0x8000, 0x1a129acf );	ROM_LOAD( "7673.rom", 0x28000, 0x8000, 0x82602394 );	ROM_LOAD( "7672.rom", 0x30000, 0x8000, 0xd11452f7 );	ROM_LOAD( "7671.rom", 0x38000, 0x8000, 0xb0c7fdc6 );	ROM_LOAD( "7670.rom", 0x40000, 0x8000, 0xdbbe2f6e );	ROM_LOAD( "7669.rom", 0x48000, 0x8000, 0xf9525faa );	ROM_LOAD( "7668.rom", 0x50000, 0x8000, 0xe115ce33 );	ROM_LOAD( "7667.rom", 0x58000, 0x8000, 0x923bde9d );	ROM_LOAD( "7666.rom", 0x60000, 0x8000, 0x23697257 );	ROM_LOAD( "7665.rom", 0x68000, 0x8000, 0x12d77607 );	ROM_LOAD( "7664.rom", 0x70000, 0x8000, 0x0df2cfad );	ROM_LOAD( "7663.rom", 0x78000, 0x8000, 0x2b0b8f08 );	ROM_LOAD( "7662.rom", 0x80000, 0x8000, 0xcb0c13c5 );	ROM_LOAD( "7661.rom", 0x88000, 0x8000, 0xfe93a79b );	ROM_LOAD( "7660.rom", 0x90000, 0x8000, 0x86dfbb68 );	ROM_LOAD( "7659.rom", 0x98000, 0x8000, 0x629dc8ce );	ROM_LOAD( "7658.rom", 0xa0000, 0x8000, 0x1677f24f );	ROM_LOAD( "7657.rom", 0xa8000, 0x8000, 0x8158839c );	ROM_LOAD( "7656.rom", 0xb0000, 0x8000, 0x6c741272 );	ROM_LOAD( "7655.rom", 0xb8000, 0x8000, 0x3433fe7b );	ROM_LOAD( "7654.rom", 0xc0000, 0x8000, 0x2db6520d );	ROM_LOAD( "7653.rom", 0xc8000, 0x8000, 0x46a52114 );	ROM_LOAD( "7652.rom", 0xd0000, 0x8000, 0x2880cfdb );	ROM_LOAD( "7651.rom", 0xd8000, 0x8000, 0xd7902bad );	ROM_LOAD( "7650.rom", 0xe0000, 0x8000, 0x642635ec );	ROM_LOAD( "7649.rom", 0xe8000, 0x8000, 0x4edba14c );	ROM_LOAD( "7648.rom", 0xf0000, 0x8000, 0x983ea830 );	ROM_LOAD( "7647.rom", 0xf8000, 0x8000, 0x2e7fbec0 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* sound CPU */
		ROM_LOAD( "7682.rom", 0x00000, 0x8000, 0xc4efbf48 );
		ROM_REGION( 0x10000, REGION_SOUND1, 0 );/* Sega PCM sound data */
		ROM_LOAD( "7681.rom", 0x00000, 0x8000, 0xbc0c4d12 );	ROM_LOAD( "7680.rom", 0x08000, 0x8000, 0x627b3c8c );
		ROM_REGION( 0x10000, REGION_CPU3, 0 );/* second 68000 CPU */
	...
	static RomLoadPtr rom_endurobl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_CONTINUE (            0x000000, 0x08000 );	ROM_LOAD16_BYTE( "4.13h", 0x030001, 0x08000, 0x43bff873 )				// rom de-coded
	...
	static RomLoadPtr rom_endurob2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "7644.rom", 0x00000, 0x08000, 0xe7a4ff90 );	ROM_LOAD( "7645.rom", 0x08000, 0x08000, 0x4caa0095 );	ROM_LOAD( "7646.rom", 0x10000, 0x08000, 0x7e432683 );
		ROM_REGION( 0x100000, REGION_GFX2, 0 );/* sprites */
		ROM_LOAD( "7678.rom",		0x00000, 0x8000, 0x9fb5e656 );	ROM_LOAD( "7677.rom", 		0x08000, 0x8000, 0x7764765b );	ROM_LOAD( "7676.rom", 		0x10000, 0x8000, 0x2e42e0d4 );	ROM_LOAD( "enduro.a20", 	0x18000, 0x8000, 0x7c280bc8 );	ROM_LOAD( "7674.rom", 		0x20000, 0x8000, 0x1a129acf );	ROM_LOAD( "7673.rom",		0x28000, 0x8000, 0x82602394 );	ROM_LOAD( "7672.rom", 		0x30000, 0x8000, 0xd11452f7 );	ROM_LOAD( "7671.rom", 		0x38000, 0x8000, 0xb0c7fdc6 );	ROM_LOAD( "7670.rom", 		0x40000, 0x8000, 0xdbbe2f6e );	ROM_LOAD( "7669.rom", 		0x48000, 0x8000, 0xf9525faa );	ROM_LOAD( "7668.rom", 		0x50000, 0x8000, 0xe115ce33 );	ROM_LOAD( "enduro.a28", 	0x58000, 0x8000, 0x321f034b );	ROM_LOAD( "7666.rom", 		0x60000, 0x8000, 0x23697257 );	ROM_LOAD( "7665.rom", 		0x68000, 0x8000, 0x12d77607 );	ROM_LOAD( "7664.rom", 		0x70000, 0x8000, 0x0df2cfad );	ROM_LOAD( "7663.rom", 		0x78000, 0x8000, 0x2b0b8f08 );	ROM_LOAD( "7662.rom", 		0x80000, 0x8000, 0xcb0c13c5 );	ROM_LOAD( "enduro.a34", 	0x88000, 0x8000, 0x296454d8 );	ROM_LOAD( "enduro.a35", 	0x90000, 0x8000, 0x1ebe76df );	ROM_LOAD( "enduro.a36",		0x98000, 0x8000, 0x243e34e5 );	ROM_LOAD( "7658.rom", 		0xa0000, 0x8000, 0x1677f24f );	ROM_LOAD( "7657.rom", 		0xa8000, 0x8000, 0x8158839c );	ROM_LOAD( "enduro.a39",		0xb0000, 0x8000, 0x1ff3a5e2 );	ROM_LOAD( "7655.rom", 		0xb8000, 0x8000, 0x3433fe7b );	ROM_LOAD( "7654.rom", 		0xc0000, 0x8000, 0x2db6520d );	ROM_LOAD( "7653.rom", 		0xc8000, 0x8000, 0x46a52114 );	ROM_LOAD( "7652.rom", 		0xd0000, 0x8000, 0x2880cfdb );	ROM_LOAD( "enduro.a44", 	0xd8000, 0x8000, 0x84bb12a1 );	ROM_LOAD( "7650.rom", 		0xe0000, 0x8000, 0x642635ec );	ROM_LOAD( "7649.rom", 		0xe8000, 0x8000, 0x4edba14c );	ROM_LOAD( "7648.rom", 		0xf0000, 0x8000, 0x983ea830 );	ROM_LOAD( "7647.rom", 		0xf8000, 0x8000, 0x2e7fbec0 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* sound CPU */
	...
	static RomLoadPtr rom_sharrier = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX2, 0 );/* sprites */
		ROM_LOAD( "ic36.bin", 0x00000, 0x8000, 0x93e2d264 );	ROM_LOAD( "ic35.bin", 0x08000, 0x8000, 0xcd6e7500 );	ROM_LOAD( "ic34.bin", 0x10000, 0x8000, 0xd5e15e66 );	ROM_LOAD( "ic33.bin", 0x18000, 0x8000, 0x60d7c1bb );	ROM_LOAD( "ic32.bin", 0x20000, 0x8000, 0x6d7b5c97 );	ROM_LOAD( "ic31.bin", 0x28000, 0x8000, 0x5e784271 );	ROM_LOAD( "ic30.bin", 0x30000, 0x8000, 0xec42c9ef );	ROM_LOAD( "ic29.bin", 0x38000, 0x8000, 0xed51fdc4 );	ROM_LOAD( "ic28.bin", 0x40000, 0x8000, 0xedbf5fc3 );	ROM_LOAD( "ic27.bin", 0x48000, 0x8000, 0x41f25a9c );	ROM_LOAD( "ic26.bin", 0x50000, 0x8000, 0xac62ae2e );	ROM_LOAD( "ic25.bin", 0x58000, 0x8000, 0xf6330038 );	ROM_LOAD( "ic24.bin", 0x60000, 0x8000, 0xcebf797c );	ROM_LOAD( "ic23.bin", 0x68000, 0x8000, 0x510e5e10 );	ROM_LOAD( "ic22.bin", 0x70000, 0x8000, 0x6d4a7d7a );	ROM_LOAD( "ic21.bin", 0x78000, 0x8000, 0xdfe75f3d );	ROM_LOAD( "ic118.bin",0x80000, 0x8000, 0xe8c537d8 );	ROM_LOAD( "ic17.bin", 0x88000, 0x8000, 0x5bb09a67 );	ROM_LOAD( "ic16.bin", 0x90000, 0x8000, 0x9c782295 );	ROM_LOAD( "ic15.bin", 0x98000, 0x8000, 0x60737b98 );	ROM_LOAD( "ic14.bin", 0xa0000, 0x8000, 0x24596a8b );	ROM_LOAD( "ic13.bin", 0xa8000, 0x8000, 0x7a2dad15 );	ROM_LOAD( "ic12.bin", 0xb0000, 0x8000, 0x0f732717 );	ROM_LOAD( "ic11.bin", 0xb8000, 0x8000, 0xa2c07741 );	ROM_LOAD( "ic8.bin",  0xc0000, 0x8000, 0x22844fa4 );	ROM_LOAD( "ic7.bin",  0xc8000, 0x8000, 0xdcaa2ebf );	ROM_LOAD( "ic6.bin",  0xd0000, 0x8000, 0x3711105c );	ROM_LOAD( "ic5.bin",  0xd8000, 0x8000, 0x70fb5ebb );	ROM_LOAD( "ic4.bin",  0xe0000, 0x8000, 0xb537d082 );	ROM_LOAD( "ic3.bin",  0xe8000, 0x8000, 0xf5ba4e08 );	ROM_LOAD( "ic2.bin",  0xf0000, 0x8000, 0xfc3bf8f3 );	ROM_LOAD( "ic1.bin",  0xf8000, 0x8000, 0xb191e22f );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* sound CPU */
		ROM_LOAD( "ic73.bin", 0x00000, 0x004000, 0xd6397933 );	ROM_LOAD( "ic72.bin", 0x04000, 0x004000, 0x504e76d9 );
		ROM_REGION( 0x10000, REGION_SOUND1, 0 );/* Sega PCM sound data */
		ROM_LOAD( "snd7231.256", 0x00000, 0x8000, 0x871c6b14 );	ROM_LOAD( "snd7232.256", 0x08000, 0x8000, 0x4b59340c );
		ROM_REGION( 0x10000, REGION_CPU3, 0 );/* second 68000 CPU */
	...
	PORT_START(); 	/* Steering */
			PORT_ANALOG( 0xff, 0x7f, IPT_AD_STICK_X | IPF_REVERSE | IPF_CENTER , 100, 3, 0x48, 0xb7 );	PORT_START(); 	/* Accel / Decel */
			PORT_ANALOG( 0xff, 0x1, IPT_AD_STICK_Y | IPF_CENTER | IPF_REVERSE, 100, 16, 0, 0xa2 );	SYS16_SERVICE
		SYS16_COINAGE
		PORT_START(); 	/* DSW1 */
		...
		PORT_START(); 	/* Brake */
			PORT_ANALOG( 0xff, 0x1, IPT_AD_STICK_Y | IPF_PLAYER2 | IPF_CENTER | IPF_REVERSE, 100, 16, 0, 0xa2 );INPUT_PORTS_END(); }}; 
	
	static InputPortPtr input_ports_enduror = new InputPortPtr(){ public void handler() { 
	PORT_START(); 	/* handle right left */
			PORT_ANALOG( 0xff, 0x7f, IPT_AD_STICK_X | IPF_REVERSE | IPF_CENTER, 100, 4, 0x0, 0xff );	PORT_START(); 	/* Fake Buttons */
		...
		PORT_START(); 
			...
			PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_SERVICE1 );		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );		PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );		PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START1 );		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );	SYS16_COINAGE
		PORT_START(); 	/* DSW1 */
			...
			PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		//PORT_START(); 	/* Y */
		//PORT_ANALOG( 0xff, 0x0, IPT_AD_STICK_Y | IPF_CENTER , 100, 8, 0x0, 0xff );INPUT_PORTS_END(); }}; 
	...
	SYS16_JOY1
		...
		PORT_START(); 
			PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );		PORT_BITX(0x04, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
			PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_SERVICE1 );		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START1 );		PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 );		PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );	SYS16_COINAGE
		PORT_START(); 	/* DSW1 */
			PORT_DIPNAME( 0x01, 0x00, DEF_STR( "Cabinet") );
			PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
			...
			PORT_DIPSETTING(    0x80, "Easy" );		PORT_DIPSETTING(    0xc0, "Normal" );		PORT_DIPSETTING(    0x40, "Hard" );		PORT_DIPSETTING(    0x00, "Hardest" );	PORT_START(); 	/* X */
			PORT_ANALOG( 0xff, 0x7f, IPT_AD_STICK_X |  IPF_REVERSE, 100, 4, 0x20, 0xdf );	PORT_START(); 	/* Y */
			PORT_ANALOG( 0xff, 0x7f, IPT_AD_STICK_Y |  IPF_REVERSE, 100, 4, 0x60, 0x9f );INPUT_PORTS_END(); }}; 
	...
	public static GameDriver driver_sharrier	   = new GameDriver("1985"	,"sharrier"	,"sharrier.java"	,rom_sharrier,null	,machine_driver_sharrier	,input_ports_sharrier	,init_sharrier	,ROT0_16BIT	,	"Sega",    "Space Harrier" )
