...
public class gradius3
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_gradius3 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "945s13.f15",   0x00000, 0x20000, 0x70c240a2 )
		ROM_LOAD16_BYTE( "945s12.e15",   0x00001, 0x20000, 0xbbc300d4 )
	
		ROM_REGION( 0x100000, REGION_CPU2, 0 );	ROM_LOAD16_BYTE( "g3_r17.rom",   0x000000, 0x20000, 0xb4a6df25 )
		...
		ROM_LOAD( "945a02.l3",             0x000000, 0x80000, 0x4dfffd74 );	ROM_LOAD16_BYTE( "g3_k6.rom",    0x080000, 0x20000, 0x884e21ee )
		...
		ROM_LOAD( "945a01.h3",             0x100000, 0x80000, 0x339d6dd2 );	ROM_LOAD16_BYTE( "g3_e6.rom",    0x180000, 0x20000, 0xa67ef087 )
		...
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "945l14.j28",  0x0000, 0x0100, 0xc778c189 );/* priority encoder (not used) */
	...
	static RomLoadPtr rom_grdius3a = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "g3_f15.rom",   0x00000, 0x20000, 0x9974fe6b )
