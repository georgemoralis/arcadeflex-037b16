...
public class circusc
{
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x1000, 0x1000, input_port_0_r ), /* IO Coin */
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x0000, circusc_flipscreen_w ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_circusc = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "a04_j12.bin",  0x0000, 0x2000, 0x56e5b408 );	ROM_LOAD( "a05_k13.bin",  0x2000, 0x2000, 0x5aca0193 );
		ROM_REGION( 0x0c000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "e11_j06.bin",  0x0000, 0x2000, 0xdf0405c6 );	ROM_LOAD( "e12_j07.bin",  0x2000, 0x2000, 0x23dfe3a6 );	ROM_LOAD( "e13_j08.bin",  0x4000, 0x2000, 0x3ba95390 );	ROM_LOAD( "e14_j09.bin",  0x6000, 0x2000, 0xa9fba85a );	ROM_LOAD( "e15_j10.bin",  0x8000, 0x2000, 0x0532347e );	ROM_LOAD( "e16_j11.bin",  0xa000, 0x2000, 0xe1725d24 );
		ROM_REGION( 0x0220, REGION_PROMS, 0 );	ROM_LOAD( "a02_j18.bin",  0x0000, 0x020, 0x10dd4eaa );/* palette */
