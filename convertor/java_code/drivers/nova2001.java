...
public class nova2001
{
	...
	static RomLoadPtr rom_nova2001 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );	ROM_LOAD( "1.6c",         0x0000, 0x2000, 0x368cffc0 );	ROM_LOAD( "2.6d",         0x2000, 0x2000, 0xbc4e442b );	ROM_LOAD( "3.6f",         0x4000, 0x2000, 0xb2849038 );	ROM_LOAD( "4.6g",         0x6000, 0x1000, 0x6b5bb12d );	ROM_RELOAD(               0x7000, 0x1000 );
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "5.12s",        0x0000, 0x2000, 0x54198941 );	ROM_LOAD( "6.12p",        0x2000, 0x2000, 0xcbd90dca );
		ROM_REGION( 0x4000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "7.12n",        0x0000, 0x2000, 0x9ebd8806 );	ROM_LOAD( "8.12l",        0x2000, 0x2000, 0xd1b18389 );
		ROM_REGION( 0x0020, REGION_PROMS, 0 );	ROM_LOAD( "nova2001.clr", 0x0000, 0x0020, 0xa2fac5cd );ROM_END(); }}; 
	
	static RomLoadPtr rom_nov2001u = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );	ROM_LOAD( "nova2001.1",   0x0000, 0x2000, 0xb79461bd );	ROM_LOAD( "nova2001.2",   0x2000, 0x2000, 0xfab87144 );	ROM_LOAD( "3.6f",         0x4000, 0x2000, 0xb2849038 );	ROM_LOAD( "4.6g",         0x6000, 0x1000, 0x6b5bb12d );	ROM_RELOAD(               0x7000, 0x1000 );
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "nova2001.5",   0x0000, 0x2000, 0x8ea576e8 );	ROM_LOAD( "nova2001.6",   0x2000, 0x2000, 0x0c61656c );
		ROM_REGION( 0x4000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "7.12n",        0x0000, 0x2000, 0x9ebd8806 );	ROM_LOAD( "8.12l",        0x2000, 0x2000, 0xd1b18389 );
		ROM_REGION( 0x0020, REGION_PROMS, 0 );	ROM_LOAD( "nova2001.clr", 0x0000, 0x0020, 0xa2fac5cd );ROM_END(); }}; 
