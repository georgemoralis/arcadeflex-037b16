...
public class rastan
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_rastan = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ic40_01.bin",  0x00000, 0x20000, 0xcd30de19 );       /* 8x8 0 */
		...
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "ic15_05.bin",  0x00000, 0x20000, 0xc22d94ac );       /* sprites 1a */
