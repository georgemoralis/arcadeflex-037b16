...
public class skullxbo
{
	...
	static RomLoadPtr rom_skullxbo = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x190000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1102",     0x000000, 0x10000, 0x90becdfa );/* MO */
		...
		ROM_REGION( 0x0a0000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "2129",     0x000000, 0x10000, 0x36b1a578 );/* playfield */
		...
		ROM_REGION( 0x008000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "2141",     0x000000, 0x08000, 0x60d6d6df );/* alphanumerics */
