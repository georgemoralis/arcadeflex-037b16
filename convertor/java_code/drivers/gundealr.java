...
public class gundealr
{
	...
	public static IO_ReadPort readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x01, 0x01, YM2203_read_port_0_r ),
	...
	/*	PORT_DIPSETTING(    0x08, DEF_STR( "1C_1C") ); */
		...
		PORT_START(); 	/* COIN */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_TILT );/* "TEST" */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_gundealr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "3.6p",         0x00000, 0x10000, 0x01f99de2 );
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "gundealr.2",   0x00000, 0x20000, 0x7874ec41 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_gundeala = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "gundeala.3",   0x00000, 0x10000, 0x836cf1a3 );
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "gundeala.2",   0x00000, 0x20000, 0x4b5fb53c );ROM_END(); }}; 
	
	static RomLoadPtr rom_gundealt = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1, 0 );/* 64k for code + 128k for banks */
		ROM_LOAD( "1.3j",         0x00000, 0x10000, 0x1d951292 );	ROM_RELOAD(               0x10000, 0x10000 );/* banked at 0x8000-0xbfff */
	
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "3.6p",         0x00000, 0x10000, 0x01f99de2 );
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "2.6b",         0x00000, 0x20000, 0x508ed0d0 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_yamyam = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "b2.d16",       0x00000, 0x10000, 0xcb4f84ee );
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "b1.a16",       0x00000, 0x20000, 0xb122828d );ROM_END(); }}; 
	...
	static RomLoadPtr rom_wiseguy = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "wguyb2.bin",   0x00000, 0x10000, 0x1c684c46 );
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "b1.a16",       0x00000, 0x20000, 0xb122828d );ROM_END(); }}; 
