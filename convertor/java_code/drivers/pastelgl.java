...
public class pastelgl
{
	...
	public static IO_ReadPort readport_pastelgl[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x0000, 0xffff, io_pastelgl_r ),
	...
	public static IO_WritePort writeport_pastelgl[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x0000, 0xffff, io_pastelgl_w ),
	...
	PORT_START(); 	/* (0) DIPSW-A */
		...
		PORT_DIPNAME( 0x03, 0x00, "Number of last chance" );	PORT_DIPSETTING(    0x03, "0" );	PORT_DIPSETTING(    0x02, "1" );	PORT_DIPSETTING(    0x01, "3" );	PORT_DIPSETTING(    0x00, "10" );	PORT_DIPNAME( 0x04, 0x04, "No. of tiles on final match" );	PORT_DIPSETTING(    0x04, "20" );	PORT_DIPSETTING(    0x00, "10" );	PORT_BIT( 0x18, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x60, 0x00, "SANGEN Rush" );	PORT_DIPSETTING(    0x06, "0" );	PORT_DIPSETTING(    0x04, "1" );	PORT_DIPSETTING(    0x02, "5" );	PORT_DIPSETTING(    0x00, "infinite" );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* (2) DIPSW-C */
		PORT_DIPNAME( 0x03, 0x03, "Change Rate" );	PORT_DIPSETTING(    0x03, "Type-A" );	PORT_DIPSETTING(    0x02, "Type-B" );	PORT_DIPSETTING(    0x01, "Type-C" );	PORT_DIPSETTING(    0x00, "Type-D" );	PORT_DIPNAME( 0x04, 0x00, "Open CPU's hand on Player's Reach" );	PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BIT( 0x18, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x60, 0x60, "YAKUMAN cut" );	PORT_DIPSETTING(    0x60, "10%" );	PORT_DIPSETTING(    0x40, "30%" );	PORT_DIPSETTING(    0x20, "50%" );	PORT_DIPSETTING(    0x00, "90%" );	PORT_DIPNAME( 0x80, 0x00, "Nudity" );	PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	static RomLoadPtr rom_pastelgl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "pgal_09.bin",  0x00000, 0x04000, 0x1e494af3 );	ROM_LOAD( "pgal_10.bin",  0x04000, 0x04000, 0x677cccea );	ROM_LOAD( "pgal_11.bin",  0x08000, 0x04000, 0xc2ccea38 );
		...
		ROM_LOAD( "pgal_01.bin",  0x00000, 0x08000, 0x1bb14d52 );	ROM_LOAD( "pgal_02.bin",  0x08000, 0x08000, 0xea85673a );	ROM_LOAD( "pgal_03.bin",  0x10000, 0x08000, 0x40011248 );	ROM_LOAD( "pgal_04.bin",  0x18000, 0x08000, 0x10613a66 );	ROM_LOAD( "pgal_05.bin",  0x20000, 0x08000, 0x6a152703 );	ROM_LOAD( "pgal_06.bin",  0x28000, 0x08000, 0xf56acfe8 );	ROM_LOAD( "pgal_07.bin",  0x30000, 0x08000, 0xfa4226dc );
		ROM_REGION( 0x0040, REGION_PROMS, 0 );/* color */
		ROM_LOAD( "pgal_bp1.bin", 0x0000, 0x0020, 0x2b7fc61a );	ROM_LOAD( "pgal_bp2.bin", 0x0020, 0x0020, 0x4433021e );ROM_END(); }}; 
	
	
	//     YEAR,     NAME,   PARENT,  MACHINE,    INPUT,     INIT,    MONITOR, COMPANY, FULLNAME, FLAGS
	public static GameDriver driver_pastelgl	   = new GameDriver("1985"	,"pastelgl"	,"pastelgl.java"	,rom_pastelgl,null	,machine_driver_pastelgl	,input_ports_pastelgl	,init_pastelgl	,ROT0	,	"Nichibutsu", "Pastel Gal (Japan)", 0 )
}
