...
public class docastle
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_docastle = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "03a_a5.bin",   0x0000, 0x4000, 0x0636b8f4 );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "04m_a6.bin",   0x0000, 0x2000, 0x3bbc9b26 );	ROM_LOAD( "04l_a7.bin",   0x2000, 0x2000, 0x3dfaa9d1 );	ROM_LOAD( "04j_a8.bin",   0x4000, 0x2000, 0x9afb16e9 );	ROM_LOAD( "04h_a9.bin",   0x6000, 0x2000, 0xaf24bce0 );
		ROM_REGION( 0x0400, REGION_PROMS, 0 );	ROM_LOAD( "09c.bin",      0x0000, 0x0200, 0x066f52bc );/* color prom */
	...
	static RomLoadPtr rom_douni = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "03a_a5.bin",   0x0000, 0x4000, 0x0636b8f4 );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "dorev6.bin",   0x0000, 0x2000, 0x9e335bf8 );	ROM_LOAD( "dorev7.bin",   0x2000, 0x2000, 0xf5d5701d );	ROM_LOAD( "dorev8.bin",   0x4000, 0x2000, 0x7143ca68 );	ROM_LOAD( "dorev9.bin",   0x6000, 0x2000, 0x893fc004 );
		ROM_REGION( 0x0400, REGION_PROMS, 0 );	ROM_LOAD( "dorevc9.bin",  0x0000, 0x0200, 0x96624ebe );/* color prom */
		ROM_LOAD( "01d.bin",      0x0200, 0x0200, 0x2747ca77 );/* ??? */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_dorunruc = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "rev-0-5.a3",   0x0000, 0x4000, 0xe20795b7 );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "2764.m4",      0x0000, 0x2000, 0x4bb231a0 );	ROM_LOAD( "2764.l4",      0x2000, 0x2000, 0x0c08508a );	ROM_LOAD( "2764.j4",      0x4000, 0x2000, 0x79287039 );	ROM_LOAD( "2764.h4",      0x6000, 0x2000, 0x523aa999 );
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "dorunrun.clr", 0x0000, 0x0100, 0xd5bab5d5 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_dorunrun = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "27128.a3",     0x0000, 0x4000, 0x4be96dcf );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "2764.m4",      0x0000, 0x2000, 0x4bb231a0 );	ROM_LOAD( "2764.l4",      0x2000, 0x2000, 0x0c08508a );	ROM_LOAD( "2764.j4",      0x4000, 0x2000, 0x79287039 );	ROM_LOAD( "2764.h4",      0x6000, 0x2000, 0x523aa999 );
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "dorunrun.clr", 0x0000, 0x0100, 0xd5bab5d5 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_spiero = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* 64k for the second CPU */
		ROM_LOAD( "27128.p7",     0x0000, 0x4000, 0x8b06d461 );
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "sp5.bin",      0x0000, 0x4000, 0x1b704bb0 );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "sp6.bin",      0x0000, 0x2000, 0x00f893a7 );	ROM_LOAD( "sp7.bin",      0x2000, 0x2000, 0x173e5c6a );	ROM_LOAD( "sp8.bin",      0x4000, 0x2000, 0x2e66525a );	ROM_LOAD( "sp9.bin",      0x6000, 0x2000, 0x9c571525 );
		ROM_REGION( 0x0400, REGION_PROMS, 0 );	ROM_LOAD( "bprom1.bin",   0x0000, 0x0200, 0xfc1b66ff );/* color prom */
	...
	static RomLoadPtr rom_dowild = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "w5",           0x0000, 0x4000, 0xb294b151 );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "w6",           0x0000, 0x2000, 0x57e0208b );	ROM_LOAD( "w7",           0x2000, 0x2000, 0x5001a6f7 );	ROM_LOAD( "w8",           0x4000, 0x2000, 0xec503251 );	ROM_LOAD( "w9",           0x6000, 0x2000, 0xaf7bd7eb );
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "dowild.clr",   0x0000, 0x0100, 0xa703dea5 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_jjack = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "j5.bin",       0x0000, 0x4000, 0x75038ff9 );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "j6.bin",       0x0000, 0x2000, 0x5937bd7b );	ROM_LOAD( "j7.bin",       0x2000, 0x2000, 0xcf8ae8e7 );	ROM_LOAD( "j8.bin",       0x4000, 0x2000, 0x84f6fc8c );	ROM_LOAD( "j9.bin",       0x6000, 0x2000, 0x3f9bb09f );
		ROM_REGION( 0x0400, REGION_PROMS, 0 );	ROM_LOAD( "bprom1.bin",   0x0000, 0x0200, 0x2f0955f2 );/* color prom */
		ROM_LOAD( "bprom2.bin",   0x0200, 0x0200, 0x2747ca77 );/* ??? */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_kickridr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "k5",           0x0000, 0x4000, 0x3f7d7e49 );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "k6",           0x0000, 0x2000, 0x94252ed3 );	ROM_LOAD( "k7",           0x2000, 0x2000, 0x7ef2420e );	ROM_LOAD( "k8",           0x4000, 0x2000, 0x29bed201 );	ROM_LOAD( "k9",           0x6000, 0x2000, 0x847584d3 );
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "kickridr.clr", 0x0000, 0x0100, 0x73ec281c );ROM_END(); }}; 
