...
public class segasyse
{
	...
	static public static WriteHandlerPtr segae_mem_8000_w = new WriteHandlerPtr() {public void handler(int offset, int data);
	
	static public static WriteHandlerPtr segae_port_f7_w = new WriteHandlerPtr() {public void handler(int offset, int data);
	static public static ReadHandlerPtr segae_port_7e_7f_r  = new ReadHandlerPtr() { public int handler(int offset);
	
	static public static ReadHandlerPtr segae_port_ba_bb_r  = new ReadHandlerPtr() { public int handler(int offset);
	static public static ReadHandlerPtr segae_port_be_bf_r  = new ReadHandlerPtr() { public int handler(int offset);
	
	static public static WriteHandlerPtr segae_port_ba_bb_w = new WriteHandlerPtr() {public void handler(int offset, int data);
	static public static WriteHandlerPtr segae_port_be_bf_w = new WriteHandlerPtr() {public void handler(int offset, int data);
	...
	*******************************************************************************/
	...
	static public static Memory_ReadAddress segae_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x7fff, MRA_ROM ),				/* Fixed ROM */
	...
	public static Memory_WriteAddress segae_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x7fff, MWA_ROM ),				/* Fixed ROM */
	...
	public static IO_ReadPort segae_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x7e, 0x7f, segae_port_7e_7f_r ),			/* Vertical / Horizontal Beam Position Read */
	...
	public static IO_WritePort segae_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x7b, 0x7b, SN76496_0_w ), /* Not sure which chip each is on */
	...
	***************************************/
	...
	static public static ReadHandlerPtr segae_hangonjr_port_f8_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		UINT8 temp;
	...
	static public static WriteHandlerPtr segae_hangonjr_port_fa_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	static public static ReadHandlerPtr segae_ridleofp_port_f8_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch (port_to_read)
		{
			default:
	...
	static public static WriteHandlerPtr segae_ridleofp_port_fa_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	*******************************************************************************/
	...
	static InputPortPtr input_ports_transfrm = new InputPortPtr(){ public void handler() {  /* Used By Transformer */
		...
		PORT_DIPNAME( 0x01, 0x00, "1 Player Only" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x01, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x0c, "3" );	PORT_DIPSETTING(    0x08, "4" );	PORT_DIPSETTING(    0x04, "5" );	PORT_BITX( 0,       0x00, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite", 0, 0 );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x20, "10k, 30k, 50k and 70k" );	PORT_DIPSETTING(    0x30, "20k, 60k, 100k and 140k"  );	PORT_DIPSETTING(    0x10, "30k, 80k, 130k and 180k" );	PORT_DIPSETTING(    0x00, "50k, 150k, 250k and 350k" );	PORT_DIPNAME( 0xc0, 0xc0, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x40, "Easy" );	PORT_DIPSETTING(    0xc0, "Medium" );	PORT_DIPSETTING(    0x80, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );
		...
		PORT_BIT( 0x08, IP_ACTIVE_LOW,  IPT_SERVICE1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW,  IPT_START1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW,  IPT_START2 );
	...
	static InputPortPtr input_ports_hangonjr = new InputPortPtr(){ public void handler() {  /* Used By Hang On Jr */
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, "Extended Time" );	PORT_DIPSETTING(    0x00, "53 seconds" );	PORT_DIPSETTING(    0x08, "56 seconds" );	PORT_DIPNAME( 0x10, 0x10, "Time" );	PORT_DIPSETTING(    0x00, "60 seconds" );	PORT_DIPSETTING(    0x10, "65 seconds" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Unknown") );
		...
		PORT_START(); 	/* Read from Port 0xe0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW,  IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW,  IPT_COIN2 );	PORT_BITX(0x04, IP_ACTIVE_LOW,  IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		PORT_BIT( 0x08, IP_ACTIVE_LOW,  IPT_SERVICE1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW,  IPT_START1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW,  IPT_UNKNOWN );
		PORT_START(); 	/* Read from Port 0xe1 */
		...
		PORT_START();   /* Read from Port 0xf8 */
		PORT_ANALOG( 0xff, 0x00, IPT_AD_STICK_Y | IPF_REVERSE | IPF_PLAYER1, 20, 10, 0, 0xff);INPUT_PORTS_END(); }}; 
	...
	static InputPortPtr input_ports_ridleofp = new InputPortPtr(){ public void handler() {  /* Used By Riddle Of Pythagoras */
		...
		PORT_DIPSETTING(    0x03, "2" );	PORT_DIPSETTING(    0x02, "3" );	PORT_DIPSETTING(    0x01, "4" );	PORT_BITX( 0,       0x00, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "98", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Unknown") );  // Unknown
		PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, "Difficulty?" );// To be tested ! I don't see what else it could do
		PORT_DIPSETTING(    0x08, "Easy" );	PORT_DIPSETTING(    0x00, "Hard" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unknown") );  // Unknown
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x60, "50K 100K 200K 500K 1M 2M 5M 10M" );	PORT_DIPSETTING(    0x40, "100K 200K 500K 1M 2M 5M 10M" );	PORT_DIPSETTING(    0x20, "200K 500K 1M 2M 5M 10M" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Unknown") );  // Unknown
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	
		PORT_START(); 	/* Read from Port 0xe0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW,  IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW,  IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW,  IPT_SERVICE1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW,  IPT_START1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW,  IPT_UNKNOWN );// Would Be IPT_START2 but the code doesn't use it
	
		PORT_START(); 	/* Port 0xe1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW,  IPT_UNKNOWN );
		PORT_START(); 	/* Read from Port 0xf8 */
		PORT_ANALOG( 0x0fff, 0x0000, IPT_DIAL, 50, 20, 0, 0 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW,  IPT_BUTTON2 );/* is this used in the game? */
		PORT_BIT( 0x2000, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW,  IPT_BUTTON1 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW,  IPT_UNKNOWN );
		PORT_START(); 	/* Read from Port 0xf8 */
		PORT_ANALOG( 0x0fff, 0x0000, IPT_DIAL | IPF_COCKTAIL, 50, 20, 0, 0 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW,  IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x2000, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW,  IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x8000, IP_ACTIVE_LOW,  IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	*******************************************************************************/
	...
	static RomLoadPtr rom_hangonjr = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1, 0 );	ROM_LOAD( "rom5.ic7",	0x00000, 0x08000, 0xd63925a7 );/* Fixed Code */
	
		/* The following are 8 0x4000 banks that get mapped to reads from 0x8000 - 0xbfff */
		ROM_LOAD( "rom4.ic5",	0x10000, 0x08000, 0xee3caab3 );	ROM_LOAD( "rom3.ic4",	0x18000, 0x08000, 0xd2ba9bc9 );	ROM_LOAD( "rom2.ic3",	0x20000, 0x08000, 0xe14da070 );	ROM_LOAD( "rom1.ic2",	0x28000, 0x08000, 0x3810cbf5 );ROM_END(); }}; 
	
	static RomLoadPtr rom_ridleofp = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1, 0 );	ROM_LOAD( "epr10426.bin",	0x00000, 0x08000, 0x4404c7e7 );/* Fixed Code */
	
		/* The following are 8 0x4000 banks that get mapped to reads from 0x8000 - 0xbfff */
		ROM_LOAD( "epr10425.bin",	0x10000, 0x08000, 0x35964109 );	ROM_LOAD( "epr10424.bin",	0x18000, 0x08000, 0xfcda1dfa );	ROM_LOAD( "epr10423.bin",	0x20000, 0x08000, 0x0b87244f );	ROM_LOAD( "epr10422.bin",	0x28000, 0x08000, 0x14781e56 );ROM_END(); }}; 
	
	static RomLoadPtr rom_transfrm = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1, 0 );	ROM_LOAD( "ic7.top",	0x00000, 0x08000, 0xccf1d123 );/* Fixed Code */
	
		/* The following are 8 0x4000 banks that get mapped to reads from 0x8000 - 0xbfff */
		ROM_LOAD( "epr-7347.ic5",	0x10000, 0x08000, 0xdf0f639f );	ROM_LOAD( "epr-7348.ic4",	0x18000, 0x08000, 0x0f38ea96 );	ROM_LOAD( "ic3.top",		0x20000, 0x08000, 0x9d485df6 );	ROM_LOAD( "epr-7350.ic2",	0x28000, 0x08000, 0x0052165d );ROM_END(); }}; 
	
	static RomLoadPtr rom_astrofl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1, 0 );	ROM_LOAD( "epr-7723.ic7",	0x00000, 0x08000, 0x66061137 );/* Fixed Code */
	
		/* The following are 8 0x4000 banks that get mapped to reads from 0x8000 - 0xbfff */
		ROM_LOAD( "epr-7347.ic5",	0x10000, 0x08000, 0xdf0f639f );	ROM_LOAD( "epr-7348.ic4",	0x18000, 0x08000, 0x0f38ea96 );	ROM_LOAD( "epr-7349.ic3",	0x20000, 0x08000, 0xf8c352d5 );	ROM_LOAD( "epr-7350.ic2",	0x28000, 0x08000, 0x0052165d );ROM_END(); }}; 
	
	static RomLoadPtr rom_fantzn2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x50000, REGION_CPU1, 0 );	ROM_LOAD( "fz2_ic7.rom",	0x00000, 0x08000, 0x76db7b7b );	ROM_LOAD( "fz2_ic5.rom",	0x10000, 0x10000, 0x57b45681 );	ROM_LOAD( "fz2_ic4.rom",	0x20000, 0x10000, 0x6f7a9f5f );	ROM_LOAD( "fz2_ic3.rom",	0x30000, 0x10000, 0xa231dc85 );	ROM_LOAD( "fz2_ic2.rom",	0x40000, 0x10000, 0xb14db5af );ROM_END(); }}; 
	
	static RomLoadPtr rom_opaopa = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_USER1, 0 );	ROM_LOAD( "epr11224.ic7",	0x00000, 0x08000, 0x024b1244 );/* Fixed Code */
	
		/* The following are 8 0x4000 banks that get mapped to reads from 0x8000 - 0xbfff */
		ROM_LOAD( "epr11223.ic5",	0x10000, 0x08000, 0x6bc41d6e );	ROM_LOAD( "epr11222.ic4",	0x18000, 0x08000, 0x395c1d0a );	ROM_LOAD( "epr11221.ic3",	0x20000, 0x08000, 0x4ca132a2 );	ROM_LOAD( "epr11220.ic2",	0x28000, 0x08000, 0xa165e2ef );ROM_END(); }}; 
	...
	public static GameDriver driver_astrofl	   = new GameDriver("1986"	,"astrofl"	,"segasyse.java"	,rom_astrofl,driver_transfrm	,machine_driver_segae	,input_ports_dummy	,init_segasyse	,ROT0	,	"Sega", "Astro Flash (Japan)", GAME_NOT_WORKING ) /* encrypted */
