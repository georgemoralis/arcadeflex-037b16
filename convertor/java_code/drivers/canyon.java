...
public class canyon
{
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x01ff, MRA_RAM ), /* WRAM */
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x01ff, MWA_RAM ), /* WRAM */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_canyon = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0400, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "9492-01.n8", 0x0000, 0x0400, 0x7449f754 );
		ROM_REGION( 0x0200, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "9505-01.n5", 0x0000, 0x0100, 0x60507c07 );	ROM_LOAD( "9506-01.m5", 0x0100, 0x0100, 0x0d63396a );
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "9491-01.j6", 0x0000, 0x0100, 0xb8094b4c );/* sync (not used) */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_canbprot = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );/* 64k for code */
		ROM_LOAD_NIB_LOW ( "cbp3000l.j1", 0x3000, 0x0800, 0x49cf29a0 );	ROM_LOAD_NIB_HIGH( "cbp3000m.p1", 0x3000, 0x0800, 0xb4385c23 );	ROM_LOAD_NIB_LOW ( "cbp3800l.h1", 0x3800, 0x0800, 0xc7ee4431 );	ROM_RELOAD(                       0xf800, 0x0800 );/* for 6502 vectors */
		ROM_LOAD_NIB_HIGH( "cbp3800m.r1", 0x3800, 0x0800, 0x94246a9a );	ROM_RELOAD(                       0xf800, 0x0800 );/* for 6502 vectors */
