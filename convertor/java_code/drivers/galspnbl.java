...
public class galspnbl
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_galspnbl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "17.rom",       0x00000, 0x40000, 0x7d435701 );	ROM_LOAD( "18.rom",       0x40000, 0x40000, 0x136adaac );
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "15.rom",       0x00000, 0x20000, 0x4beb840d );	ROM_LOAD( "16.rom",       0x20000, 0x20000, 0x93d3c610 );
	...
	static RomLoadPtr rom_hotpinbl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "hp_13.bin",    0x00000, 0x40000, 0xd53b64b9 );	ROM_LOAD( "hp_14.bin",    0x40000, 0x40000, 0x2fe3fcee );
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "hp_11.bin",    0x00000, 0x20000, 0xdeecd7f1 );	ROM_LOAD( "hp_12.bin",    0x20000, 0x20000, 0x5fd603c2 );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );/* OKIM6295 samples */
