...
public class vendetta
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_vendetta = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "081t01", 0x10000, 0x38000, 0xe76267f5 );	ROM_CONTINUE(		0x08000, 0x08000 );
	...
	***************************************************************************/
	...
	public static GameDriver driver_vendetta	   = new GameDriver("1991"	,"vendetta"	,"vendetta.java"	,rom_vendetta,null	,machine_driver_vendetta	,input_ports_vendet4p	,init_vendetta	,ROT0	,	"Konami", "Vendetta (US)" )
	public static GameDriver driver_vendetas	   = new GameDriver("1991"	,"vendetas"	,"vendetta.java"	,rom_vendetas,driver_vendetta	,machine_driver_vendetta	,input_ports_vendetta	,init_vendetta	,ROT0	,	"Konami", "Vendetta (Asia set 1)" )
	public static GameDriver driver_vendeta2	   = new GameDriver("1991"	,"vendeta2"	,"vendetta.java"	,rom_vendeta2,driver_vendetta	,machine_driver_vendetta	,input_ports_vendetta	,init_vendetta	,ROT0	,	"Konami", "Vendetta (Asia set 2)" )
