...
public class cyberbal
{
	...
	PORT_START();       /* fe0000 */
		...
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_COIN4 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_SPECIAL );/* output buffer full */
	...
	static RomLoadPtr rom_cyberbal = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x140000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1150.15a",  0x000000, 0x10000, 0xe770eb3e );/* MO */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "1146.9l",   0x000000, 0x10000, 0xa64b4da8 );/* playfield */
		...
		ROM_REGION( 0x020000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "1166.14n",  0x000000, 0x10000, 0x0ca1e3b3 );/* alphanumerics */
	...
	static RomLoadPtr rom_cyberbt = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_CPU3, 0 );	ROM_LOAD16_BYTE( "cyb1011.bin", 0x00000, 0x10000, 0x22d3e09c )
		...
		ROM_REGION( 0x140000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1001.bin",  0x000000, 0x20000, 0x586ba107 );/* MO */
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "cyb1015.bin",  0x000000, 0x10000, 0xdbbad153 );/* playfield */
		...
		ROM_REGION( 0x020000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "cyb1019.bin",  0x000000, 0x10000, 0x833b4768 );/* alphanumerics */
	...
	static RomLoadPtr rom_cyberb2p = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "1036.bin",  0x000000, 0x10000, 0xcdf6e3d6 );/* playfield */
		...
		ROM_REGION( 0x020000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "1040.bin",  0x000000, 0x10000, 0xa4c116f9 );/* alphanumerics */
