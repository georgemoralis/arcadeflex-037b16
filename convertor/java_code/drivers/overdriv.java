...
public class overdriv
{
	...
	***************************************************************************/
	...
	public static Memory_ReadAddress overdriv_s_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0201, 0x0201, YM2151_status_port_0_r ),
	...
	public static Memory_WriteAddress overdriv_s_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0200, 0x0200, YM2151_register_port_0_w ),
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_TOGGLE );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_SPECIAL );/* EEPROM data */
		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BITX(0x10, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_SPECIAL );// ?
	
		PORT_START(); 
		PORT_ANALOG( 0xff, 0x80, IPT_DIAL | IPF_CENTER, 100, 50, 0, 0 );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_overdriv = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "789.2",        0x00000, 0x20000, 0x77f18f3f )
		ROM_LOAD16_BYTE( "789.1",        0x00001, 0x20000, 0x4f44e6ad )
	
		ROM_REGION( 0x40000, REGION_CPU2, 0 );	ROM_LOAD16_BYTE( "789.4",        0x00000, 0x20000, 0x46fb7e88 )
		...
		ROM_LOAD( "e13.r4",       0x100000, 0x100000, 0x6314a628 );	ROM_LOAD( "e14.r10",      0x200000, 0x100000, 0xb5eca14b );	ROM_LOAD( "e15.r15",      0x300000, 0x100000, 0x5d93e0c3 );
		...
		ROM_LOAD( "e19.r22",      0x040000, 0x040000, 0x15c54ea2 );	ROM_LOAD( "e20.s22",      0x080000, 0x040000, 0xea204acd );
		...
		ROM_LOAD( "e03.j1",       0x000000, 0x100000, 0x51ebfebe );	ROM_LOAD( "e02.f1",       0x100000, 0x100000, 0xbdd3b5c6 );ROM_END(); }}; 
	...
	public static GameDriver driver_overdriv	   = new GameDriver("1990"	,"overdriv"	,"overdriv.java"	,rom_overdriv,null	,machine_driver_overdriv	,input_ports_overdriv	,init_overdriv	,ROT90_16BIT	,	"Konami", "Over Drive", GAME_IMPERFECT_GRAPHICS )
}
