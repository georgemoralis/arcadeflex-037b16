...
public class suna8
{
	...
	*/
	public static WriteHandlerPtr hardhead_flipscreen_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		coin_lockout_w.handler ( 1,	data & 0x10);
	} };
	...
	public static IO_ReadPort hardhead_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x00, IORP_NOP	),	// ? IRQ Ack
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	public static IO_WritePort hardhead_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort(MEMPORT_MARKER, 0)
	};
	...
	*/
	public static WriteHandlerPtr rranger_bankswitch_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		coin_lockout_w.handler ( 0,	data & 0x40);
		coin_lockout_w.handler ( 1,	data & 0x80);
	} };
	...
	*/
	...
	public static IO_ReadPort brickzn_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	...
	***************************************************************************/
	...
	public static IO_ReadPort hardhead_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x01, 0x01, IORP_NOP	),	// ? IRQ Ack
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	...
	***************************************************************************/
	...
	public static Memory_ReadAddress brickzn_sound_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0xbfff, MRA_ROM					),	// ROM
	...
	public static Memory_WriteAddress brickzn_sound_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0xbfff, MWA_ROM					),	// ROM
	...
	public static Memory_ReadAddress brickzn_pcm_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0xffff, MRA_ROM	),	// ROM
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};public static Memory_WriteAddress brickzn_pcm_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0xffff, MWA_ROM	),	// ROM
		new Memory_WriteAddress(MEMPORT_MARKER, 0)
	};
	...
	public static IO_ReadPort brickzn_pcm_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x00, soundlatch2_r		),	// From Sound CPU
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};public static IO_WritePort brickzn_pcm_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x03, brickzn_pcm_w			),	// 4 x DAC
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_hardhead = new InputPortPtr(){ public void handler() { 
		...
		PORT_DIPSETTING(    0x0e, "No Bonus" );	PORT_DIPSETTING(    0x0c, "10K" );	PORT_DIPSETTING(    0x0a, "20K" );	PORT_DIPSETTING(    0x08, "50K" );	PORT_DIPSETTING(    0x06, "50K, Every 50K" );	PORT_DIPSETTING(    0x04, "100K, Every 50K" );	PORT_DIPSETTING(    0x02, "100K, Every 100K" );	PORT_DIPSETTING(    0x00, "200K, Every 100K" );	PORT_DIPNAME( 0x70, 0x70, DEF_STR( "Coinage") );
		...
		PORT_DIPNAME( 0x04, 0x04, "Play Together" );	PORT_DIPSETTING(    0x00, DEF_STR( "No") );
		PORT_DIPSETTING(    0x04, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x18, "2" );	PORT_DIPSETTING(    0x10, "3" );	PORT_DIPSETTING(    0x08, "4" );	PORT_DIPSETTING(    0x00, "5" );	PORT_DIPNAME( 0xe0, 0xe0, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0xe0, "Easiest" );	PORT_DIPSETTING(    0xc0, "Very Easy" );	PORT_DIPSETTING(    0xa0, "Easy" );	PORT_DIPSETTING(    0x80, "Moderate" );	PORT_DIPSETTING(    0x60, "Normal" );	PORT_DIPSETTING(    0x40, "Harder" );	PORT_DIPSETTING(    0x20, "Very Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_rranger = new InputPortPtr(){ public void handler() { 
		...
		PORT_DIPSETTING(    0x30, "10K" );	PORT_DIPSETTING(    0x28, "30K" );	PORT_DIPSETTING(    0x20, "50K" );	PORT_DIPSETTING(    0x18, "50K, Every 50K" );	PORT_DIPSETTING(    0x10, "100K, Every 50K" );	PORT_DIPSETTING(    0x08, "100K, Every 100K" );	PORT_DIPSETTING(    0x00, "100K, Every 200K" );	PORT_DIPSETTING(    0x38, "None" );	PORT_DIPNAME( 0xc0, 0xc0, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0xc0, "Normal" );	PORT_DIPSETTING(    0x80, "Hard" );	PORT_DIPSETTING(    0x40, "Harder" );	PORT_DIPSETTING(    0x00, "Hardest" );
		...
		PORT_DIPSETTING(    0x30, "2" );	PORT_DIPSETTING(    0x20, "3" );	PORT_DIPSETTING(    0x10, "4" );	PORT_DIPSETTING(    0x00, "5" );	PORT_DIPNAME( 0x40, 0x00, DEF_STR( "Demo_Sounds") );
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_brickzn = new InputPortPtr(){ public void handler() { 
		...
		PORT_DIPSETTING(    0x38, "Easiest" );	PORT_DIPSETTING(    0x30, "Very Easy" );	PORT_DIPSETTING(    0x28, "Easy" );	PORT_DIPSETTING(    0x20, "Moderate" );	PORT_DIPSETTING(    0x18, "Normal" );	PORT_DIPSETTING(    0x10, "Harder" );	PORT_DIPSETTING(    0x08, "Very Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );//	PORT_BITX(    0x40, 0x40, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );//	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
	//	PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_DIPSETTING(    0x04, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x38, 0x38, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x30, "10K" );	PORT_DIPSETTING(    0x28, "30K" );	PORT_DIPSETTING(    0x18, "50K, Every 50K" );	PORT_DIPSETTING(    0x20, "50K" );	PORT_DIPSETTING(    0x10, "100K, Every 50K" );	PORT_DIPSETTING(    0x08, "100K, Every 100K" );	PORT_DIPSETTING(    0x00, "200K, Every 100K" );	PORT_DIPSETTING(    0x38, "None" );	PORT_DIPNAME( 0xc0, 0xc0, DEF_STR( "Lives") );
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_hardhea2 = new InputPortPtr(){ public void handler() { 
		...
		PORT_DIPSETTING(    0x04, DEF_STR( "1C_4C") );
		PORT_DIPNAME( 0x38, 0x38, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x38, "Easiest" );	PORT_DIPSETTING(    0x30, "Very Easy" );	PORT_DIPSETTING(    0x28, "Easy" );	PORT_DIPSETTING(    0x20, "Moderate" );	PORT_DIPSETTING(    0x18, "Normal" );	PORT_DIPSETTING(    0x10, "Harder" );	PORT_DIPSETTING(    0x08, "Very Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_SERVICE(       0x40, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	(
		...
		new WriteYmHandlerPtr[] { 0,0 }		/* IRQ handler  */
	);
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_hardhead = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "p2",  0x10000, 0x8000, 0xfaa2cf9a );	ROM_LOAD( "p3",  0x18000, 0x8000, 0x3d24755e );	ROM_LOAD( "p4",  0x20000, 0x8000, 0x0241ac79 );	ROM_LOAD( "p7",  0x28000, 0x8000, 0xbeba8313 );	ROM_LOAD( "p8",  0x30000, 0x8000, 0x211a9342 );	ROM_LOAD( "p9",  0x38000, 0x8000, 0x2ad430c4 );	ROM_LOAD( "p10", 0x40000, 0x8000, 0xb6894517 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	/* Sound Z80 Code */
		ROM_LOAD( "p13", 0x0000, 0x8000, 0x493c0b41 );
		ROM_REGION( 0x40000, REGION_GFX1, ROMREGION_DISPOSE | ROMREGION_INVERT );/* Sprites */
		ROM_LOAD( "p5",  0x00000, 0x8000, 0xe9aa6fba );	ROM_RELOAD(      0x08000, 0x8000             );	ROM_LOAD( "p6",  0x10000, 0x8000, 0x15d5f5dd );	ROM_RELOAD(      0x18000, 0x8000             );	ROM_LOAD( "p11", 0x20000, 0x8000, 0x055f4c29 );	ROM_RELOAD(      0x28000, 0x8000             );	ROM_LOAD( "p12", 0x30000, 0x8000, 0x9582e6db );	ROM_RELOAD(      0x38000, 0x8000             );
		ROM_REGION( 0x8000, REGION_SOUND1, ROMREGION_SOUNDONLY );/* Samples */
		ROM_LOAD( "p14", 0x0000, 0x8000, 0x41314ac1 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_hardhedb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "p2",  0x10000, 0x8000, 0xfaa2cf9a );	ROM_LOAD( "p3",  0x18000, 0x8000, 0x3d24755e );	ROM_LOAD( "p4",  0x20000, 0x8000, 0x0241ac79 );	ROM_LOAD( "p7",  0x28000, 0x8000, 0xbeba8313 );	ROM_LOAD( "p8",  0x30000, 0x8000, 0x211a9342 );	ROM_LOAD( "p9",  0x38000, 0x8000, 0x2ad430c4 );	ROM_LOAD( "p10", 0x40000, 0x8000, 0xb6894517 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	/* Sound Z80 Code */
		ROM_LOAD( "p13", 0x0000, 0x8000, 0x493c0b41 );//	ROM_LOAD( "2_13_9h.rom", 0x00000, 0x8000, 0x1b20e5ec );
		ROM_REGION( 0x40000, REGION_GFX1, ROMREGION_DISPOSE | ROMREGION_INVERT );/* Sprites */
		ROM_LOAD( "p5",  0x00000, 0x8000, 0xe9aa6fba );	ROM_RELOAD(      0x08000, 0x8000             );	ROM_LOAD( "p6",  0x10000, 0x8000, 0x15d5f5dd );	ROM_RELOAD(      0x18000, 0x8000             );	ROM_LOAD( "p11", 0x20000, 0x8000, 0x055f4c29 );	ROM_RELOAD(      0x28000, 0x8000             );	ROM_LOAD( "p12", 0x30000, 0x8000, 0x9582e6db );	ROM_RELOAD(      0x38000, 0x8000             );
		ROM_REGION( 0x8000, REGION_SOUND1, ROMREGION_SOUNDONLY );/* Samples */
		ROM_LOAD( "p14", 0x0000, 0x8000, 0x41314ac1 );ROM_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_rranger = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "2",  0x10000, 0x8000, 0xff65af29 );	ROM_LOAD( "3",  0x18000, 0x8000, 0x64e09436 );	ROM_LOAD( "r4", 0x30000, 0x8000, 0x4346fae6 );	ROM_CONTINUE(   0x20000, 0x8000             );	ROM_LOAD( "r5", 0x38000, 0x8000, 0x6a7ca1c3 );	ROM_CONTINUE(   0x28000, 0x8000             );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	/* Sound Z80 Code */
		ROM_LOAD( "14", 0x0000, 0x8000, 0x11c83aa1 );
		ROM_REGION( 0x8000, REGION_SOUND1, ROMREGION_SOUNDONLY );/* Samples */
		ROM_LOAD( "15", 0x0000, 0x8000, 0x28c2c87e );
		ROM_REGION( 0x40000, REGION_GFX1, ROMREGION_DISPOSE | ROMREGION_INVERT );/* Sprites */
		ROM_LOAD( "6",  0x00000, 0x8000, 0x57543643 );	ROM_LOAD( "7",  0x08000, 0x8000, 0x9f35dbfa );	ROM_LOAD( "8",  0x10000, 0x8000, 0xf400db89 );	ROM_LOAD( "9",  0x18000, 0x8000, 0xfa2a11ea );	ROM_LOAD( "10", 0x20000, 0x8000, 0x42c4fdbf );	ROM_LOAD( "11", 0x28000, 0x8000, 0x19037a7b );	ROM_LOAD( "12", 0x30000, 0x8000, 0xc59c0ec7 );	ROM_LOAD( "13", 0x38000, 0x8000, 0x9809fee8 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_sranger = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "15", 0x0000, 0x8000, 0x28c2c87e );
		ROM_REGION( 0x40000, REGION_GFX1, ROMREGION_DISPOSE | ROMREGION_INVERT );/* Sprites */
		ROM_LOAD( "r6",  0x00000, 0x8000, 0x4f11fef3 );	ROM_LOAD( "7",   0x08000, 0x8000, 0x9f35dbfa );	ROM_LOAD( "8",   0x10000, 0x8000, 0xf400db89 );	ROM_LOAD( "9",   0x18000, 0x8000, 0xfa2a11ea );	ROM_LOAD( "r10", 0x20000, 0x8000, 0x1b204d6b );	ROM_LOAD( "11",  0x28000, 0x8000, 0x19037a7b );	ROM_LOAD( "12",  0x30000, 0x8000, 0xc59c0ec7 );	ROM_LOAD( "13",  0x38000, 0x8000, 0x9809fee8 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_srangerb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "2",    0x10000, 0x8000, 0xff65af29 );	ROM_LOAD( "3",    0x18000, 0x8000, 0x64e09436 );	ROM_LOAD( "r4",   0x30000, 0x8000, 0x4346fae6 );	ROM_CONTINUE(     0x20000, 0x8000             );	ROM_LOAD( "r5",   0x38000, 0x8000, 0x6a7ca1c3 );	ROM_CONTINUE(     0x28000, 0x8000             );	ROM_LOAD( "r5bt", 0x28000, 0x8000, BADCRC(0xf7f391b5));	// wrong length
	...
	static RomLoadPtr rom_srangerw = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "15", 0x0000, 0x8000, 0x28c2c87e );
		ROM_REGION( 0x40000, REGION_GFX1, ROMREGION_DISPOSE | ROMREGION_INVERT );/* Sprites */
		ROM_LOAD( "6",  0x00000, 0x8000, 0x312ecda6 );	ROM_LOAD( "7",  0x08000, 0x8000, 0x9f35dbfa );	ROM_LOAD( "8",  0x10000, 0x8000, 0xf400db89 );	ROM_LOAD( "9",  0x18000, 0x8000, 0xfa2a11ea );	ROM_LOAD( "10", 0x20000, 0x8000, 0x8731abc6 );	ROM_LOAD( "11", 0x28000, 0x8000, 0x19037a7b );	ROM_LOAD( "12", 0x30000, 0x8000, 0xc59c0ec7 );	ROM_LOAD( "13", 0x38000, 0x8000, 0x9809fee8 );ROM_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_brickzn = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_RELOAD(               0x50000, 0x08000             );	ROM_LOAD( "brickzon.008", 0x10000, 0x20000, 0xc61540ba );	ROM_RELOAD(               0x60000, 0x20000             );	ROM_LOAD( "brickzon.007", 0x30000, 0x20000, 0xceed12f1 );	ROM_RELOAD(               0x80000, 0x20000             );
		...
		ROM_LOAD( "brickzon.002", 0x00000, 0x20000, 0x241f0659 );	ROM_LOAD( "brickzon.001", 0x20000, 0x20000, 0x6970ada9 );	ROM_LOAD( "brickzon.003", 0x40000, 0x20000, 0x2e4f194b );	ROM_LOAD( "brickzon.005", 0x60000, 0x20000, 0x118f8392 );	ROM_LOAD( "brickzon.004", 0x80000, 0x20000, 0x2be5f335 );	ROM_LOAD( "brickzon.006", 0xa0000, 0x20000, 0xbbf31081 );
	...
	static RomLoadPtr rom_brickzn3 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_RELOAD(               0x50000, 0x08000             );	ROM_LOAD( "38",           0x10000, 0x20000, 0xe16216e8 );	ROM_RELOAD(               0x60000, 0x20000             );	ROM_LOAD( "brickzon.007", 0x30000, 0x20000, 0xceed12f1 );	ROM_RELOAD(               0x80000, 0x20000             );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	/* Music Z80 Code */
		ROM_LOAD( "brickzon.010", 0x00000, 0x10000, 0x4eba8178 );
		ROM_REGION( 0x10000, REGION_CPU3, 0 );	/* PCM Z80 Code */
		ROM_LOAD( "brickzon.011", 0x00000, 0x10000, 0x6c54161a );
		ROM_REGION( 0xc0000, REGION_GFX1, ROMREGION_DISPOSE | ROMREGION_INVERT );/* Sprites */
		ROM_LOAD( "35",           0x00000, 0x20000, 0xb463dfcf );	ROM_LOAD( "brickzon.004", 0x20000, 0x20000, 0x2be5f335 );	ROM_LOAD( "brickzon.006", 0x40000, 0x20000, 0xbbf31081 );	ROM_LOAD( "32",           0x60000, 0x20000, 0x32dbf2dd );	ROM_LOAD( "brickzon.001", 0x80000, 0x20000, 0x6970ada9 );	ROM_LOAD( "brickzon.003", 0xa0000, 0x20000, 0x2e4f194b );
		ROM_REGION( 0x0200 * 2, REGION_USER1, 0 );/* Palette RAM Banks */
		ROM_REGION( 0x2000 * 2, REGION_USER2, 0 );/* Sprite  RAM Banks */
	ROM_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_hardhea2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_RELOAD(           0x50000, 0x08000             );	ROM_LOAD( "hrd-hd10", 0x10000, 0x10000, 0x77ec5b0a );	ROM_RELOAD(           0x60000, 0x10000             );	ROM_LOAD( "hrd-hd11", 0x20000, 0x10000, 0x12af8f8e );	ROM_RELOAD(           0x70000, 0x10000             );	ROM_LOAD( "hrd-hd12", 0x30000, 0x10000, 0x35d13212 );	ROM_RELOAD(           0x80000, 0x10000             );	ROM_LOAD( "hrd-hd13", 0x40000, 0x10000, 0x3225e7d7 );	ROM_RELOAD(           0x90000, 0x10000             );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	/* Music Z80 Code */
		...
		ROM_LOAD( "hrd-hd1",  0x00000, 0x10000, 0x7e7b7a58 );	ROM_LOAD( "hrd-hd2",  0x10000, 0x10000, 0x303ec802 );	ROM_LOAD( "hrd-hd3",  0x20000, 0x10000, 0x3353b2c7 );	ROM_LOAD( "hrd-hd4",  0x30000, 0x10000, 0xdbc1f9c1 );	ROM_LOAD( "hrd-hd5",  0x40000, 0x10000, 0xf738c0af );	ROM_LOAD( "hrd-hd6",  0x50000, 0x10000, 0xbf90d3ca );	ROM_LOAD( "hrd-hd7",  0x60000, 0x10000, 0x992ce8cb );	ROM_LOAD( "hrd-hd8",  0x70000, 0x10000, 0x359597a4 );
		ROM_REGION( 0x0200 * 2, REGION_USER1, 0 );/* Palette RAM Banks */
		ROM_REGION( 0x2000 * 2, REGION_USER2, 0 );/* Sprite  RAM Banks */
	ROM_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_starfigh = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_RELOAD(            0x50000, 0x08000             );	ROM_LOAD( "suna2.bin", 0x10000, 0x10000, 0xfcfcf08a );	ROM_RELOAD(            0x60000, 0x10000             );	ROM_LOAD( "suna1.bin", 0x20000, 0x10000, 0x6935fcdb );	ROM_RELOAD(            0x70000, 0x10000             );	ROM_LOAD( "suna5.bin", 0x30000, 0x10000, 0x50c072a4 );// 0xxxxxxxxxxxxxxx = 0xFF (ROM Test: OK)
		ROM_RELOAD(            0x80000, 0x10000             );	ROM_LOAD( "suna4.bin", 0x40000, 0x10000, 0x3fe3c714 );// clear text here
		...
		ROM_LOAD( "suna9.bin",  0x00000, 0x10000, 0x54c0ca3d );	ROM_RELOAD(             0x20000, 0x10000             );	ROM_LOAD( "suna8.bin",  0x10000, 0x10000, 0x4313ba40 );	ROM_RELOAD(             0x30000, 0x10000             );	ROM_LOAD( "suna7.bin",  0x40000, 0x10000, 0xad8d0f21 );	ROM_RELOAD(             0x60000, 0x10000             );	ROM_LOAD( "suna6.bin",  0x50000, 0x10000, 0x6d8f74c8 );	ROM_RELOAD(             0x70000, 0x10000             );	ROM_LOAD( "suna13.bin", 0x80000, 0x10000, 0xceff00ff );	ROM_RELOAD(             0xa0000, 0x10000             );	ROM_LOAD( "suna12.bin", 0x90000, 0x10000, 0x7aaa358a );	ROM_RELOAD(             0xb0000, 0x10000             );	ROM_LOAD( "suna11.bin", 0xc0000, 0x10000, 0x47d6049c );	ROM_RELOAD(             0xe0000, 0x10000             );	ROM_LOAD( "suna10.bin", 0xd0000, 0x10000, 0x4a33f6f3 );	ROM_RELOAD(             0xf0000, 0x10000             );
		ROM_REGION( 0x0200 * 2, REGION_USER1, 0 );/* Palette RAM Banks */
		ROM_REGION( 0x2000 * 2, REGION_USER2, 0 );/* Sprite  RAM Banks */
	ROM_END(); }}; 
	...
	***************************************************************************/
	...
	/* Working Games */
	public static GameDriver driver_rranger	   = new GameDriver("1988"	,"rranger"	,"suna8.java"	,rom_rranger,null	,machine_driver_rranger	,input_ports_rranger	,null	,ROT0_16BIT	,	"SunA", "Rough Ranger (v2.0, Sharp Image license)", GAME_IMPERFECT_SOUND )
	public static GameDriver driver_hardhead	   = new GameDriver("1988"	,"hardhead"	,"suna8.java"	,rom_hardhead,null	,machine_driver_hardhead	,input_ports_hardhead	,init_hardhead	,ROT0_16BIT	,	"SunA", "Hard Head",           GAME_IMPERFECT_SOUND )
	public static GameDriver driver_hardhedb	   = new GameDriver("1988"	,"hardhedb"	,"suna8.java"	,rom_hardhedb,driver_hardhead	,machine_driver_hardhead	,input_ports_hardhead	,init_hardhedb	,ROT0_16BIT	,	"SunA", "Hard Head (Bootleg)", GAME_IMPERFECT_SOUND )
	
	/* Non Working Games */
	public static GameDriver driver_sranger	   = new GameDriver("1988"	,"sranger"	,"suna8.java"	,rom_sranger,driver_rranger	,machine_driver_rranger	,input_ports_rranger	,null	,ROT0_16BIT	,	"SunA", "Super Ranger (v2.0)",         GAME_NOT_WORKING )
	public static GameDriver driver_srangerb	   = new GameDriver("1988"	,"srangerb"	,"suna8.java"	,rom_srangerb,driver_rranger	,machine_driver_rranger	,input_ports_rranger	,null	,ROT0_16BIT	,	"SunA", "Super Ranger (NIWA Bootleg)", GAME_NOT_WORKING )
	public static GameDriver driver_srangerw	   = new GameDriver("1988"	,"srangerw"	,"suna8.java"	,rom_srangerw,driver_rranger	,machine_driver_rranger	,input_ports_rranger	,null	,ROT0_16BIT	,	"SunA", "Super Ranger (WDK License)",  GAME_NOT_WORKING )
	public static GameDriver driver_starfigh	   = new GameDriver("1990"	,"starfigh"	,"suna8.java"	,rom_starfigh,null	,machine_driver_starfigh	,input_ports_hardhea2	,init_starfigh	,ROT90_16BIT	,	"SunA", "Star Fighter (v1)",   GAME_NOT_WORKING )
	public static GameDriver driver_hardhea2	   = new GameDriver("1991"	,"hardhea2"	,"suna8.java"	,rom_hardhea2,null	,machine_driver_hardhea2	,input_ports_hardhea2	,init_hardhea2	,ROT0_16BIT	,	"SunA", "Hard Head 2 (v2.0)",  GAME_NOT_WORKING )
	public static GameDriver driver_brickzn	   = new GameDriver("1992"	,"brickzn"	,"suna8.java"	,rom_brickzn,null	,machine_driver_brickzn	,input_ports_brickzn	,init_brickzn3	,ROT90_16BIT	,	"SunA", "Brick Zone (v5.0)",   GAME_NOT_WORKING )
	public static GameDriver driver_brickzn3	   = new GameDriver("1992"	,"brickzn3"	,"suna8.java"	,rom_brickzn3,driver_brickzn	,machine_driver_brickzn	,input_ports_brickzn	,init_brickzn3	,ROT90_16BIT	,	"SunA", "Brick Zone (v3.0)",   GAME_NOT_WORKING )
}
