...
public class battlera
{
	...
	public static Memory_ReadAddress battlera_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x000000, 0x0fffff, MRA_ROM ),
	...
	public static Memory_WriteAddress battlera_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x000000, 0x0fffff, MWA_ROM ),
	...
	public static IO_WritePort battlera_portwrite[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x01, HuC6270_register_w ),
	...
	static RomLoadPtr rom_bldwolf = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, 0 );	/* Nothing */
	ROM_END(); }}; 
