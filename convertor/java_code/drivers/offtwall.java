...
public class offtwall
{
	...
	static RomLoadPtr rom_offtwall = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0xc0000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "otw1014.bin", 0x000000, 0x20000, 0x4d64507e );	ROM_LOAD( "otw1016.bin", 0x020000, 0x20000, 0xf5454f3a );	ROM_LOAD( "otw1018.bin", 0x040000, 0x20000, 0x17864231 );	ROM_LOAD( "otw1015.bin", 0x060000, 0x20000, 0x271f7856 );	ROM_LOAD( "otw1017.bin", 0x080000, 0x20000, 0x7f7f8012 );	ROM_LOAD( "otw1019.bin", 0x0a0000, 0x20000, 0x9efe511b );ROM_END(); }}; 
