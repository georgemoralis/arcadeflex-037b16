...
public class cbuster
{
	...
	static RomLoadPtr rom_cbuster = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "fu05-.rom",     0x00000, 0x10000, 0x8134d412 );/* Chars */
		ROM_LOAD( "fu06-.rom",     0x10000, 0x10000, 0x2f914a45 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "mab-01",        0x00000, 0x80000, 0x1080d619 );/* Tiles */
	
		ROM_REGION( 0x80000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "mab-00",        0x00000, 0x80000, 0x660eaabd );/* Tiles */
	
		ROM_REGION( 0x180000,REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "mab-02",        0x000000, 0x80000, 0x58b7231d );/* Sprites */
		...
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "mb7114h.18e",   0x0000, 0x0100, 0x3645b70f );/* Priority (not used) */
	ROM_END(); }}; 
