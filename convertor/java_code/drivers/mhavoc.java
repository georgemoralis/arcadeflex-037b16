...
public class mhavoc
{
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x01ff, MRA_RAM ),			/* 0.5K Program Ram */
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x01ff, MWA_RAM ),			/* 0.5K Program Ram */
	...
	public static Memory_ReadAddress gamma_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x07ff, MRA_RAM ),			/* Program RAM (2K)	*/
	...
	public static Memory_WriteAddress gamma_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x07ff, MWA_RAM ),			/* Program RAM (2K)	*/
	...
	static RomLoadPtr rom_mhavoc2 = new RomLoadPtr(){ public void handler(){ 
		/* Alpha Processor ROMs */
		ROM_REGION( 0x21000, REGION_CPU1, 0 );	/* Vector Generator ROM */
