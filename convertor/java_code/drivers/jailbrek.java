...
public class jailbrek
{
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x07ff, colorram_r ),
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x07ff, colorram_w, &colorram ),
	...
	PORT_START(); 	/* IN0 - $3300 */
		...
		PORT_DIPSETTING(    0x08, "30000 70000" );	PORT_DIPSETTING(    0x00, "40000 80000" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x30, "Easy" );	PORT_DIPSETTING(    0x20, "Normal" );	PORT_DIPSETTING(    0x10, "Hard" );	PORT_DIPSETTING(    0x00, "Very Hard" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unused") );
		...
		PORT_DIPSETTING(	0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x02, "Upright Controls" );	PORT_DIPSETTING(    0x02, "Single" );	PORT_DIPSETTING(    0x00, "Dual" );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Unused") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_jailbrek = new RomLoadPtr(){ public void handler(){ 
	    ...
	    ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "jailb4f.bin",  0x00000, 0x4000, 0xe3b7a226 );/* characters */
	    ROM_LOAD( "jailb5f.bin",  0x04000, 0x4000, 0x504f0912 );
	    ROM_REGION( 0x10000, REGION_GFX2, ROMREGION_DISPOSE );    ROM_LOAD( "jailb3e.bin",  0x00000, 0x4000, 0x0d269524 );/* sprites */
		...
		ROM_REGION( 0x0240, REGION_PROMS, 0 );	ROM_LOAD( "jailbbl.cl2",  0x0000, 0x0020, 0xf1909605 );/* red & green */
	...
	static RomLoadPtr rom_manhatan = new RomLoadPtr(){ public void handler(){ 
	    ROM_REGION( 2*0x10000, REGION_CPU1, 0 );    /* 64k for code + 64k for decrypted opcodes */
		ROM_LOAD( "507n03.9d",    0x8000, 0x4000, 0xe5039f7e );	ROM_LOAD( "507n02.11d",   0xc000, 0x4000, 0x143cc62c );
	    ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "507j08.4f",    0x00000, 0x4000, 0x175e1b49 );/* characters */
	    ROM_LOAD( "jailb5f.bin",  0x04000, 0x4000, 0x504f0912 );
	    ROM_REGION( 0x10000, REGION_GFX2, ROMREGION_DISPOSE );    ROM_LOAD( "jailb3e.bin",  0x00000, 0x4000, 0x0d269524 );/* sprites */
	    ROM_LOAD( "jailb4e.bin",  0x04000, 0x4000, 0x27d4f6f4 );    ROM_LOAD( "jailb5e.bin",  0x08000, 0x4000, 0x717485cb );    ROM_LOAD( "jailb3f.bin",  0x0c000, 0x4000, 0xe933086f );
		ROM_REGION( 0x0240, REGION_PROMS, 0 );	ROM_LOAD( "jailbbl.cl2",  0x0000, 0x0020, 0xf1909605 );/* red & green */
		...
		ROM_REGION( 0x2000, REGION_SOUND1, 0 );/* speech rom */
		ROM_LOAD( "507p01.8c",    0x0000, 0x2000, 0x4a1da0b7 );ROM_END(); }}; 
