...
public class hal21
{
	...
	*/
	...
	PORT_START(); 
		...
		PORT_DIPSETTING(    0x06, "Easy" );	PORT_DIPSETTING(    0x04, "Normal" );	PORT_DIPSETTING(    0x02, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x08, 0x00, DEF_STR( "Demo_Sounds") );
	...
	static RomLoadPtr rom_hal21 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "hal21p12.bin", 0x0000, 0x2000, 0x9839a7cd );/* char */
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "hal21_1.prm",  0x000, 0x400, 0x195768fc );	ROM_LOAD( "hal21_2.prm",  0x400, 0x400, 0xc5d84225 );	ROM_LOAD( "hal21_3.prm",  0x800, 0x400, 0x605afff8 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_aso = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS, 0 );	ROM_LOAD( "up02_f12.rom",  0x000, 0x00400, 0x5b0a0059 );	ROM_LOAD( "up02_f13.rom",  0x400, 0x00400, 0x37e28dd8 );	ROM_LOAD( "up02_f14.rom",  0x800, 0x00400, 0xc3fd1dd3 );ROM_END(); }}; 
