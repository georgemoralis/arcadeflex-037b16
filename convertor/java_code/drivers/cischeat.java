...
public class cischeat
{
	...
	**************************************************************************/
	...
	static InputPortPtr input_ports_cischeat = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT(  0x01, IP_ACTIVE_LOW, IPT_COIN1    );	PORT_BIT(  0x02, IP_ACTIVE_LOW, IPT_COIN2    );	PORT_BIT(  0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BITX( 0x08, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE ) 	// called "Test"
	...
	**************************************************************************/
	...
	/*	[Country]
		...
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_COIN1    );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_COIN2    );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BITX( 0x0008, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE ) // . f0100 (called "Test")
	...
	**************************************************************************/
	...
	static InputPortPtr input_ports_scudhamm = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT_IMPULSE( 0x0001, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_UNKNOWN  );// GAME OVER if pressed on the selection screen
		PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BITX( 0x0008, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE ) 	// called "Test"
		PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_START1   );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_BUTTON4  );// Select
		...
		PORT_BIT(  0x0800, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT(  0x1000, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT(  0x2000, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT(  0x4000, IP_ACTIVE_HIGH, IPT_TILT    );	PORT_BIT(  0x8000, IP_ACTIVE_LOW,  IPT_UNKNOWN );
		PORT_START(); 	// IN1 - A/D
		PORT_ANALOG( 0x00ff, 0x0000, IPT_PADDLE | IPF_CENTER, 1, 0, 0x0000, 0x00ff );
		PORT_START(); 	// IN2 - DSW
		PORT_DIPNAME( 0x0003, 0x0003, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x0000, "Easy" );	PORT_DIPSETTING(      0x0003, "Normal" );	PORT_DIPSETTING(      0x0002, "Hard" );	PORT_DIPSETTING(      0x0001, "Hardest" );	PORT_DIPNAME( 0x000c, 0x000c, "Time To Hit" );	PORT_DIPSETTING(      0x000c, "2 s" );	PORT_DIPSETTING(      0x0008, "3 s" );	PORT_DIPSETTING(      0x0004, "4 s" );	PORT_DIPSETTING(      0x0000, "5 s" );	PORT_DIPNAME( 0x0010, 0x0010, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0010, DEF_STR( "On") );
		PORT_DIPNAME( 0x0020, 0x0020, DEF_STR( "Lives") );
		PORT_DIPSETTING(      0x0020, "3" );	PORT_DIPSETTING(      0x0000, "5" );	PORT_DIPNAME( 0x0040, 0x0040, "Unknown 1-6" );	PORT_DIPSETTING(      0x0040, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		...
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x1000, 0x1000, "Unknown 2-4" );	PORT_DIPSETTING(      0x1000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x2000, 0x2000, "Unknown 2-5" );	PORT_DIPSETTING(      0x2000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x4000, 0x4000, "Unknown 2-6" );	PORT_DIPSETTING(      0x4000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	...
	**************************************************************************/
	...
	static GfxDecodeInfo cischeat_gfxdecodeinfo[] =
	{
		...
		new GfxDecodeInfo( REGION_GFX4, 0, tiles_16x16_4M,	32*16*7, 128 ), // [3] Sprites
		new GfxDecodeInfo( REGION_GFX5, 0, road_layout_1M,	32*16*3, 64  ), // [4] Road 0
		new GfxDecodeInfo( REGION_GFX5, 0, road_layout_1M,	32*16*5, 64  ), // [5] Road 1
		new GfxDecodeInfo( -1 )
	};
	...
	**************************************************************************/
	...
	static GfxDecodeInfo f1gpstar_gfxdecodeinfo[] =
	{
		...
		new GfxDecodeInfo( REGION_GFX4, 0, tiles_16x16_5M,	0x0b00, 128 ), // [3] Sprites
		new GfxDecodeInfo( REGION_GFX5, 0, road_layout_2M,	0x0300, 64  ), // [4] Road 0
		new GfxDecodeInfo( REGION_GFX6, 0, road_layout_1M,	0x0700, 64  ), // [5] Road 1
		new GfxDecodeInfo( -1 )
	};
	...
	**************************************************************************/
	...
	{
		new GfxDecodeInfo( REGION_GFX1, 0, tiles_8x8_08,		256*0, 16  ),	// [0] Scroll 0
		new GfxDecodeInfo( REGION_GFX1, 0, tiles_8x8_08,		256*0, 16  ),	// [1] UNUSED
		new GfxDecodeInfo( REGION_GFX3, 0, tiles_8x8_02,		256*1, 16  ),	// [2] Scroll 2
		new GfxDecodeInfo( REGION_GFX4, 0, tiles_16x16_quad_5M,	256*2, 128 ),	// [3] sprites
		// No Road Layers
		new GfxDecodeInfo( -1 )
	};
	...
	**************************************************************************/
	...
	static OKIM6295interface okim6295_interface_scudhamm = new OKIM6295interface
	(
		2,
		new int[] { 16000,16000 },
		new int[] { REGION_SOUND1, REGION_SOUND2 },
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_cischeat = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x080000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "ch9071v2.03", 0x000000, 0x040000, 0xdd1bb26f )
		ROM_LOAD16_BYTE( "ch9071v2.01", 0x000001, 0x040000, 0x7b65276a )
	
		ROM_REGION( 0x80000, REGION_CPU2, 0 );	ROM_LOAD16_BYTE( "ch9073.01",  0x000000, 0x040000, 0xba331526 )
		ROM_LOAD16_BYTE( "ch9073.02",  0x000001, 0x040000, 0xb45ff10f )
	
		ROM_REGION( 0x80000, REGION_CPU3, 0 );	ROM_LOAD16_BYTE( "ch9073v1.03", 0x000000, 0x040000, 0xbf1d1cbf )
		ROM_LOAD16_BYTE( "ch9073v1.04", 0x000001, 0x040000, 0x1ec8a597 )
	
		ROM_REGION( 0x40000, REGION_CPU4, 0 );	ROM_LOAD16_BYTE( "ch9071.11", 0x000000, 0x020000, 0xbc137bea )
		...
		ROM_REGION( 0x040000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ch9071.a14",  0x000000, 0x040000, 0x7a6d147f );// scroll 0
	
		ROM_REGION( 0x040000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "ch9071.t74",  0x000000, 0x040000, 0x735a2e25 );// scroll 1
	
		ROM_REGION( 0x010000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "ch9071.07",   0x000000, 0x010000, 0x3724ccc3 );// scroll 2
		...
		ROM_REGION( 0x100000, REGION_GFX5, ROMREGION_DISPOSE );	ROM_LOAD( "ch9073.r21",  0x000000, 0x080000, 0x2943d2f6 );// Road
		...
		ROM_LOAD( "ch9072.02",  0x000000, 0x040000, 0x536edde4 );	ROM_LOAD( "ch9072.03",  0x000000, 0x040000, 0x7e79151a );ROM_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_f1gpstar = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "9188a-27.v20", 0x000000, 0x040000, 0x0a9d3896 )
		ROM_LOAD16_BYTE( "9188a-22.v20", 0x000001, 0x040000, 0xde15c9ca )
	
		ROM_REGION( 0x80000, REGION_CPU2, 0 );	/* Should Use ROMs:	90015-01.W06, 90015-02.W07, 90015-03.W08, 90015-04.W09 */
		ROM_LOAD16_BYTE( "9188a-16.v10",  0x000000, 0x020000, 0xef0f7ca9 )
		ROM_LOAD16_BYTE( "9188a-11.v10",  0x000001, 0x020000, 0xde292ea3 )
	
		ROM_REGION( 0x80000, REGION_CPU3, 0 );	/* Should Use ROMs:	90015-01.W06, 90015-02.W07, 90015-03.W08, 90015-04.W09 */
		ROM_LOAD16_BYTE( "9188a-6.v10",  0x000000, 0x020000, 0x18ba0340 )
		ROM_LOAD16_BYTE( "9188a-1.v10",  0x000001, 0x020000, 0x109d2913 )
	
		ROM_REGION( 0x40000, REGION_CPU4, 0 );	ROM_LOAD16_BYTE( "9190a-2.v11", 0x000000, 0x020000, 0xacb2fd80 )
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "90015-31.r56",  0x000000, 0x080000, 0x0c8f0e2b );// scroll 0
	
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "90015-32.r57",  0x000000, 0x080000, 0x9c921cfb );// scroll 1
	
		ROM_REGION( 0x020000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "9188a-30.v10",  0x000000, 0x020000, 0x0ef1fbf1 );// scroll 2
		...
		ROM_REGION( 0x200000, REGION_GFX5, ROMREGION_DISPOSE );	ROM_LOAD( "90015-05.w10",  0x000000, 0x080000, 0x8eb48a23 );// Road 0
		...
		ROM_REGION( 0x100000, REGION_GFX6, ROMREGION_DISPOSE );	ROM_LOAD( "90015-09.w13",  0x000000, 0x080000, 0x55f49315 );// Road 1
	...
	***************************************************************************/
	...
	//	UNUSED
		...
		ROM_LOAD( "2.l",  0x000000, 0x080000, 0x889311da );	ROM_LOAD( "2.h",  0x080000, 0x080000, 0x347928fc );
		ROM_REGION( 0x100000, REGION_SOUND2, 0 );	/* Samples (4x40000) */
		ROM_LOAD( "1.l",  0x000000, 0x080000, 0x3c94aa90 );	ROM_LOAD( "1.h",  0x080000, 0x080000, 0x5caee787 );// 1xxxxxxxxxxxxxxxxxx = 0xFF
	...
	public static GameDriver driver_scudhamm	   = new GameDriver("1994"	,"scudhamm"	,"cischeat.java"	,rom_scudhamm,null	,machine_driver_scudhamm	,input_ports_scudhamm	,null	,ROT270	,	"Jaleco", "Scud Hammer"        )
}
