...
public class rpunch
{
	...
	PORT_START(); 	/* c0018 lower 8 bits */
		...
		PORT_DIPSETTING(      0x00b0, DEF_STR( "1C_5C") );
		PORT_DIPSETTING(      0x0040, DEF_STR( "1C_6C") );
		PORT_DIPNAME( 0x0100, 0x0000, "Game Time");	PORT_DIPSETTING(      0x0100, "2 min/1 min" );	PORT_DIPSETTING(      0x0000, "3 min/1.5 min" );	PORT_DIPNAME( 0x0600, 0x0000, "2P Starting Score" );	PORT_DIPSETTING(      0x0600, "0-0" );	PORT_DIPSETTING(      0x0400, "5-5" );	PORT_DIPSETTING(      0x0000, "7-7" );	PORT_DIPSETTING(      0x0200, "9-9" );	PORT_DIPNAME( 0x1800, 0x0000, "1P Starting Score" );	PORT_DIPSETTING(      0x1000, "9-11" );	PORT_DIPSETTING(      0x1800, "10-10" );	PORT_DIPSETTING(      0x0800, "10-11" );	PORT_DIPSETTING(      0x0000, "11-11" );	PORT_SERVICE( 0x2000, IP_ACTIVE_HIGH );	PORT_DIPNAME( 0x4000, 0x4000, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
	...
	static RomLoadPtr rom_rpunch = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x20000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "rpunch.20", 0x00000, 0x08000, 0xa2028d59 )
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "rpunch.92", 0x00000, 0x10000, 0x5e1870e3 );
		ROM_REGION( 0x60000, REGION_GFX1, 0 );	ROM_LOAD( "rl_c13.bin", 0x00000, 0x40000, 0x7c8403b0 );	ROM_LOAD( "rl_c10.bin", 0x40000, 0x08000, 0x312eb260 );	ROM_LOAD( "rl_c12.bin", 0x48000, 0x08000, 0xbea85219 );	ROM_FILL(               0x50000, 0x10000, 0xff )
	
		ROM_REGION( 0x60000, REGION_GFX2, 0 );	ROM_LOAD( "rl_a10.bin", 0x00000, 0x40000, 0xc2a77619 );	ROM_LOAD( "rl_a13.bin", 0x40000, 0x08000, 0xa39c2c16 );	ROM_LOAD( "rpunch.54",  0x48000, 0x08000, 0xe2969747 );	ROM_FILL(               0x50000, 0x10000, 0xff )
	
		ROM_REGION( 0x60000, REGION_GFX3, 0 );	ROM_LOAD16_BYTE( "rl_4g.bin", 0x00000, 0x20000, 0xc5cb4b7a )
		...
		ROM_REGION( 0x60000, REGION_SOUND1, 0 );	ROM_LOAD( "rl_f18.bin", 0x20000, 0x20000, 0x47840673 );//	ROM_LOAD( "rpunch.91", 0x00000, 0x0f000, 0x7512cc59 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_rabiolep = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x20000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "rl_e2.bin", 0x00000, 0x08000, 0x7d936a12 )
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "rl_f20.bin", 0x00000, 0x10000, 0xa6f50351 );
		ROM_REGION( 0x60000, REGION_GFX1, 0 );	ROM_LOAD( "rl_c13.bin", 0x00000, 0x40000, 0x7c8403b0 );	ROM_LOAD( "rl_c10.bin", 0x40000, 0x08000, 0x312eb260 );	ROM_LOAD( "rl_c12.bin", 0x48000, 0x08000, 0xbea85219 );	ROM_FILL(               0x50000, 0x10000, 0xff )
	
		ROM_REGION( 0x60000, REGION_GFX2, 0 );	ROM_LOAD( "rl_a10.bin", 0x00000, 0x40000, 0xc2a77619 );	ROM_LOAD( "rl_a13.bin", 0x40000, 0x08000, 0xa39c2c16 );	ROM_LOAD( "rl_a12.bin", 0x48000, 0x08000, 0x970b0e32 );	ROM_FILL(               0x50000, 0x10000, 0xff )
		...
		ROM_REGION( 0x60000, REGION_SOUND1, 0 );	ROM_LOAD( "rl_f18.bin", 0x20000, 0x20000, 0x47840673 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_svolley = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "sps_13.bin", 0x00000, 0x10000, 0x2fbc5dcf )
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "sps_17.bin", 0x00000, 0x10000, 0x48b89688 );
		ROM_REGION( 0x60000, REGION_GFX1, 0 );	ROM_LOAD( "sps_02.bin", 0x00000, 0x10000, 0x1a0abe75 );	ROM_LOAD( "sps_03.bin", 0x10000, 0x10000, 0x36279075 );	ROM_LOAD( "sps_04.bin", 0x20000, 0x10000, 0x7cede7d9 );	ROM_LOAD( "sps_01.bin", 0x30000, 0x08000, 0x6425e6d7 );	ROM_FILL(               0x38000, 0x08000, 0xff )
		ROM_LOAD( "sps_10.bin", 0x40000, 0x08000, 0xa12b1589 );	ROM_FILL(               0x48000, 0x18000, 0xff )
	
		ROM_REGION( 0x60000, REGION_GFX2, 0 );	ROM_LOAD( "sps_05.bin", 0x00000, 0x10000, 0xb0671d12 );	ROM_LOAD( "sps_06.bin", 0x10000, 0x10000, 0xc231957e );	ROM_LOAD( "sps_07.bin", 0x20000, 0x10000, 0x904b7709 );	ROM_LOAD( "sps_08.bin", 0x30000, 0x10000, 0x5430ffac );	ROM_LOAD( "sps_09.bin", 0x40000, 0x10000, 0x414a6278 );	ROM_FILL(               0x50000, 0x10000, 0xff )
	
		ROM_REGION( 0x60000, REGION_GFX3, 0 );	ROM_LOAD16_BYTE( "sps_20.bin", 0x00000, 0x10000, 0xc9e7206d )
		...
		ROM_REGION( 0x60000, REGION_SOUND1, 0 );	ROM_LOAD( "sps_16.bin", 0x20000, 0x20000, 0x456d0f36 );	ROM_LOAD( "sps_15.bin", 0x40000, 0x10000, 0xf33f415f );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_svolleyk = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "a14.bin", 0x00000, 0x10000, 0xdbab3bf9 )
		...
		ROM_REGION( 0x60000, REGION_GFX2, 0 );	ROM_LOAD( "sps_05.bin", 0x00000, 0x10000, 0xb0671d12 );	ROM_LOAD( "sps_06.bin", 0x10000, 0x10000, 0xc231957e );	ROM_LOAD( "sps_07.bin", 0x20000, 0x10000, 0x904b7709 );	ROM_LOAD( "sps_08.bin", 0x30000, 0x10000, 0x5430ffac );	ROM_LOAD( "sps_09.bin", 0x40000, 0x10000, 0x414a6278 );	ROM_LOAD( "a09.bin",    0x50000, 0x08000, 0xdd92dfe1 );	ROM_FILL(               0x58000, 0x08000, 0xff )
