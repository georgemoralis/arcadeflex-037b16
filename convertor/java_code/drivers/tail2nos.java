...
public class tail2nos
{
	...
	public static IO_ReadPort sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x07, 0x07, soundlatch_r ),
	#if 0
	...
	public static IO_WritePort sound_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x07, 0x07, IOWP_NOP ),	/* clear pending command */
	...
	static RomLoadPtr rom_tail2nos = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "a24",          0x00000, 0x80000, 0xb1e9de43 );	ROM_LOAD( "o1s",          0x80000, 0x40000, 0xe27a8eb4 );
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "oj1",          0x000000, 0x40000, 0x39c36b35 );	ROM_LOAD( "oj2",          0x040000, 0x40000, 0x77ccaea2 );
