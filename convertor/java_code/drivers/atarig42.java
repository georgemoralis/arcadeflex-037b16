...
public class atarig42
{
	...
	PORT_START(); 		/* e00000 */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0xf800, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();       /* e00002 */
		PORT_BIT( 0xffff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 		/* e00010 */
		PORT_BIT( 0x003f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		...
		PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0xfffe, IP_ACTIVE_HIGH, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	
	
	static InputPortPtr input_ports_guardian = new InputPortPtr(){ public void handler() { 
	PORT_START(); 		/* e00000 */
		PORT_BIT( 0x01ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON5 | IPF_PLAYER1 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 );
		PORT_START();       /* e00002 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x01f0, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON5 | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );
		PORT_START(); 		/* e00010 */
		PORT_BIT( 0x003f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		JSA_III_PORT	/* audio board port */
	...
	static MachineDriver machine_driver_atarig42 = new MachineDriver
	(
	...
	static RomLoadPtr rom_roadriot = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "rriots.12c", 0x10000, 0x4000, 0x849dd26c );	ROM_CONTINUE(           0x04000, 0xc000 );
		ROM_REGION( 0xc0000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "rriot.22d",    0x000000, 0x20000, 0xb7451f92 );/* playfield, planes 0-1 */
		ROM_LOAD( "rriot.22c",    0x020000, 0x20000, 0x90f3c6ee );	ROM_LOAD( "rriot20.21d",  0x040000, 0x20000, 0xd40de62b );/* playfield, planes 2-3 */
		ROM_LOAD( "rriot20.21c",  0x060000, 0x20000, 0xa7e836b1 );	ROM_LOAD( "rriot.20d",    0x080000, 0x20000, 0xa81ae93f );/* playfield, planes 4-5 */
		ROM_LOAD( "rriot.20c",    0x0a0000, 0x20000, 0xb8a6d15a );
		ROM_REGION( 0x020000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "rriot.22j",    0x000000, 0x20000, 0x0005bab0 );/* alphanumerics */
		...
		ROM_LOAD( "rriots.19e",  0x80000, 0x20000, 0x2db638a7 );	ROM_LOAD( "rriots.17e",  0xa0000, 0x20000, 0xe1dd7f9e );	ROM_LOAD( "rriots.15e",  0xc0000, 0x20000, 0x64d410bb );	ROM_LOAD( "rriots.12e",  0xe0000, 0x20000, 0xbffd01c8 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_roadriop = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x14000, REGION_CPU2, 0 );/* 64k for 6502 code */
		ROM_LOAD( "rriots.12c", 0x10000, 0x4000, 0x849dd26c );	ROM_CONTINUE(           0x04000, 0xc000 );
		ROM_REGION( 0xc0000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "spf.0l",    0x000000, 0x10000, 0x00000000 );/* playfield, planes 0-1 */
		ROM_LOAD( "spf.1l",    0x010000, 0x10000, 0x00000000 );	ROM_LOAD( "spf.2l",    0x020000, 0x10000, 0x00000000 );	ROM_LOAD( "spf.3l",    0x030000, 0x10000, 0x00000000 );	ROM_LOAD( "spf.0m",    0x040000, 0x10000, 0x00000000 );/* playfield, planes 2-3 */
		ROM_LOAD( "spf.1m",    0x050000, 0x10000, 0x00000000 );	ROM_LOAD( "spf.2m",    0x060000, 0x10000, 0x00000000 );	ROM_LOAD( "spf.3m",    0x070000, 0x10000, 0x00000000 );	ROM_LOAD( "spf.0h",    0x080000, 0x10000, 0x00000000 );/* playfield, planes 4-5 */
		ROM_LOAD( "spf.1h",    0x090000, 0x10000, 0x00000000 );	ROM_LOAD( "spf.2h",    0x0a0000, 0x10000, 0x00000000 );	ROM_LOAD( "spf.3h",    0x0b0000, 0x10000, 0x00000000 );
		ROM_REGION( 0x020000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "alpha.22j", 0x000000, 0x20000, 0x00000000 );/* alphanumerics */
	...
	static RomLoadPtr rom_guardian = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x14000, REGION_CPU2, 0 );/* 64k for 6502 code */
		ROM_LOAD( "0080-snd.12c", 0x10000, 0x4000, 0x0388f805 );	ROM_CONTINUE(             0x04000, 0xc000 );
		ROM_REGION( 0x180000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "0037a.23e",  0x000000, 0x80000, 0xca10b63e );/* playfield, planes 0-1 */
		...
		ROM_REGION( 0x020000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "0030.23k",   0x000000, 0x20000, 0x0fd7baa1 );/* alphanumerics */
		...
		ROM_REGION( 0x100000, REGION_SOUND1, 0 );/* 1MB for ADPCM samples */
		ROM_LOAD( "0010-snd",  0x80000, 0x80000, 0xbca27f40 );ROM_END(); }}; 
	...
	public static GameDriver driver_roadriot	   = new GameDriver("1991"	,"roadriot"	,"atarig42.java"	,rom_roadriot,null	,machine_driver_atarig42	,input_ports_roadriot	,init_roadriot	,ROT0_16BIT	,	"Atari Games", "Road Riot 4WD", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_roadriop	   = new GameDriver("1991"	,"roadriop"	,"atarig42.java"	,rom_roadriop,driver_roadriot	,machine_driver_atarig42	,input_ports_roadriot	,init_roadriot	,ROT0_16BIT	,	"Atari Games", "Road Riot 4WD (prototype)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_guardian	   = new GameDriver("1992"	,"guardian"	,"atarig42.java"	,rom_guardian,null	,machine_driver_atarig42	,input_ports_guardian	,init_guardian	,ROT0_16BIT	,	"Atari Games", "Guardians of the Hood", GAME_UNEMULATED_PROTECTION )
}
