...
public class chqflag
{
	...
	//	PORT_DIPSETTING(    0x00, "Coin Slot 2 Invalidity" );
		...
		PORT_START(); 
		PORT_BIT( 0x7f, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Unused") );	/* DIPSW #3 - SW4 */
		PORT_DIPSETTING(	0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(	0x00, DEF_STR( "On") );
	
		PORT_START(); 
		/* COINSW + STARTSW */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	/* DIPSW #3 */
		...
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_TOGGLE );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0c, IP_ACTIVE_LOW, IPT_UNKNOWN );/* if this is set, it goes directly to test mode */
		...
		PORT_ANALOG( 0xff, 0x80, IPT_AD_STICK_X | IPF_CENTER, 80, 8, 0, 0xff);INPUT_PORTS_END(); }}; 
	...
	public static GameDriver driver_chqflag	   = new GameDriver("1988"	,"chqflag"	,"chqflag.java"	,rom_chqflag,null	,machine_driver_chqflag	,input_ports_chqflag	,init_chqflag	,ROT90	,	"Konami", "Chequered Flag", GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_SOUND )
	public static GameDriver driver_chqflagj	   = new GameDriver("1988"	,"chqflagj"	,"chqflag.java"	,rom_chqflagj,driver_chqflag	,machine_driver_chqflag	,input_ports_chqflag	,init_chqflag	,ROT90	,	"Konami", "Chequered Flag (Japan)", GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_SOUND )
}
