...
public class raiders5
{
	...
	PORT_START(); 
		...
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x06, "3" );	PORT_DIPSETTING(    0x04, "4" );	PORT_DIPSETTING(    0x02, "5" );	PORT_DIPNAME( 0x08, 0x08, "1st Bonus" );	PORT_DIPSETTING(    0x08, "30000" );	PORT_DIPSETTING(    0x00, "40000" );	PORT_DIPNAME( 0x30, 0x30, "2nd Bonus" );	PORT_DIPSETTING(    0x30, "Every(?);50000" )
	...
	static RomLoadPtr rom_raiders5 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "raiders3.11f", 0x0000,  0x4000, 0x30041d58 );	ROM_LOAD( "raiders4.11g", 0x4000,  0x4000, 0xe441931c );	ROM_LOAD( "raiders5.11n", 0x8000,  0x4000, 0xc0895090 );
	ROM_END(); }}; 
	...
	public static GameDriver driver_raiders5	   = new GameDriver("1985"	,"raiders5"	,"raiders5.java"	,rom_raiders5,null	,machine_driver_raiders5	,input_ports_raiders5	,null	,ROT0_16BIT	,	"UPL", "Raiders5" )
	public static GameDriver driver_raidrs5t	   = new GameDriver("1985"	,"raidrs5t"	,"raiders5.java"	,rom_raidrs5t,driver_raiders5	,machine_driver_raiders5	,input_ports_raiders5	,null	,ROT0_16BIT	,	"UPL (Taito license)", "Raiders5 (Japan)" )
}
