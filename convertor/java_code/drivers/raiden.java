...
public class raiden
{
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x00000, 0x07fff, MRA_RAM ),
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x00000, 0x06fff, MWA_RAM ),
	...
	public static Memory_ReadAddress sub_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x00000, 0x01fff, MRA_RAM ),
	...
	public static Memory_WriteAddress sub_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x00000, 0x01fff, MWA_RAM ),
	...
	static RomLoadPtr rom_raiden = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "rai6.bin",     0x000000, 0x08000, 0x723a483b );	ROM_CONTINUE(             0x010000, 0x08000 );	ROM_COPY( REGION_CPU3, 0, 0x018000, 0x08000 )
	
		ROM_REGION( 0x010000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "rai9.bin",     0x00000, 0x08000, 0x1922b25e );/* chars */
		ROM_LOAD( "rai10.bin",    0x08000, 0x08000, 0x5f90786a );
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "raiu0919.bin", 0x00000, 0x80000, 0xda151f0b );/* tiles */
	
		ROM_REGION( 0x080000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "raiu0920.bin", 0x00000, 0x80000, 0xac1f57ac );/* tiles */
	
		ROM_REGION( 0x090000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "raiu165.bin",  0x00000, 0x80000, 0x946d7bde );/* sprites */
	...
	static RomLoadPtr rom_raidena = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "raiden08.rom", 0x000000, 0x08000, 0x731adb43 );	ROM_CONTINUE(             0x010000, 0x08000 );	ROM_COPY( REGION_CPU3, 0, 0x018000, 0x08000 )
	...
	static RomLoadPtr rom_raidenk = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x20000, REGION_CPU3, 0 );/* 64k code for sound Z80 */
		ROM_LOAD( "8b",           0x000000, 0x08000, 0x99ee7505 );	ROM_CONTINUE(             0x010000, 0x08000 );	ROM_COPY( REGION_CPU3, 0, 0x018000, 0x08000 )
