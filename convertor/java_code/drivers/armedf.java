...
public class armedf
{
	...
	public static IO_ReadPort readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x4, 0x4, soundlatch_clear_r ),
		new IO_ReadPort( 0x6, 0x6, soundlatch_r ),
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x0, 0x0, YM3812_control_port_0_w ),
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY);	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY);	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY);	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY);	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0xf000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2);	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2);	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2);	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2);	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2);	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2);	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_SERVICE( 0x0200, IP_ACTIVE_LOW );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_TILT );    /* Tilt */
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x0c, "20k" );	PORT_DIPSETTING(    0x08, "50k" );	PORT_DIPSETTING(    0x04, "60k" );	PORT_DIPSETTING(    0x00, "90k" );	PORT_DIPNAME( 0x10, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_UP     | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_DOWN   | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_LEFT   | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_RIGHT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0xf000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_UP     | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_DOWN   | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_LEFT   | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_RIGHT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_SERVICE( 0x0200, IP_ACTIVE_LOW );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_TILT );    /* Tilt */
		PORT_BIT( 0xf800, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Lives") );
		...
		PORT_DIPSETTING(    0x20, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x40, "Easy" );	PORT_DIPSETTING(    0x00, "Normal" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "2C_3C") );
		PORT_DIPSETTING(    0x08, DEF_STR( "1C_2C") );
		PORT_DIPNAME( 0x10, 0x10, "Continue Play" );	PORT_DIPSETTING(    0x10, "3" );	PORT_DIPSETTING(    0x00, "0" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	static RomLoadPtr rom_terraf = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "terrafor.008", 0x00000, 0x08000, 0xbc6f7cbc );/* characters */
	
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "terrafor.006", 0x00000, 0x10000, 0x25d23dfd );/* foreground tiles */
		ROM_LOAD( "terrafor.007", 0x10000, 0x10000, 0xb9b0fe27 );
		ROM_REGION( 0x20000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "terrafor.004", 0x00000, 0x10000, 0x2144d8e0 );/* background tiles */
		ROM_LOAD( "terrafor.005", 0x10000, 0x10000, 0x744f5c9e );
		ROM_REGION( 0x20000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "terrafor.003", 0x00000, 0x10000, 0xd74085a1 );/* sprites */
		...
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "tf.clr",       0x0000, 0x0100, 0x81244757 );/* ??? */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_kodure = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "kodure9.11e", 0x00000, 0x08000, 0xe041356e );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "kodure5.15h", 0x00000, 0x20000, 0x0b510258 );/* foreground tiles */
		ROM_LOAD( "kodure4.14h", 0x20000, 0x10000, 0xfb8e13e6 );
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "kodure14.8a", 0x00000, 0x10000, 0x94a9c3d0 );/* background tiles */
	
		ROM_REGION( 0x40000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "kodure12.8d", 0x00000, 0x20000, 0x15f4021d );/* sprites */
		ROM_LOAD( "kodure13.9d", 0x20000, 0x20000, 0xb3b6c753 );
		ROM_REGION( 0x4000, REGION_GFX5, 0 );/* data for mcu/blitter */
		ROM_LOAD( "kodure10.11c", 0x0000, 0x4000, 0xf48be21d );
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "tf.11j", 0x0000, 0x0100, 0x81244757 );/* ??? */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_cclimbr2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "10.bin", 0x00000, 0x08000, 0x7f475266 );/* characters */
	
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "7.bin",  0x00000, 0x10000, 0xcbdd3906 );/* foreground tiles */
		ROM_LOAD( "8.bin",  0x10000, 0x10000, 0xb2a613c0 );
		ROM_REGION( 0x20000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "17.bin", 0x00000, 0x10000, 0xe24bb2d7 );/* background tiles */
		ROM_LOAD( "18.bin", 0x10000, 0x10000, 0x56834554 );
		ROM_REGION( 0x40000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "15.bin", 0x00000, 0x10000, 0x4bf838be );/* sprites */
		...
		ROM_REGION( 0x4000, REGION_GFX5, 0 );/* data for mcu/blitter */
		ROM_LOAD( "9.bin",  0x0000, 0x4000, 0x740d260f );ROM_END(); }}; 
	...
	static RomLoadPtr rom_armedf = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "af_09.rom", 0x00000, 0x08000, 0x7025e92d );/* characters */
	
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "af_04.rom", 0x00000, 0x10000, 0x44d3af4f );/* foreground tiles */
		ROM_LOAD( "af_05.rom", 0x10000, 0x10000, 0x92076cab );
		ROM_REGION( 0x20000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "af_14.rom", 0x00000, 0x10000, 0x8c5dc5a7 );/* background tiles */
		ROM_LOAD( "af_13.rom", 0x10000, 0x10000, 0x136a58a3 );
		ROM_REGION( 0x40000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "af_11.rom", 0x00000, 0x20000, 0xb46c473c );/* sprites */
