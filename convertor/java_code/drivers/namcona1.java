...
public class namcona1
{
	...
	public static nvramPtr namcosna1_nvram_handler  = new nvramPtr() { public void handler(Object file, int read_or_write) {
		if (read_or_write != 0)
		{
	...
	PORT_START(); 
		...
		PORT_DIPNAME( 0x20, 0x00, "Test" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x20, DEF_STR( "On") );
		PORT_DIPNAME( 0x40, 0x00, "SERVICE" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x40, DEF_STR( "On") );
		PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_SERVICE );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON3 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_START1 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_START2 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER3 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_START3 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER4 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER4 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_START4 );
		PORT_START(); 
		PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN4 );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 
		...
		PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_SERVICE );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON4 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_BUTTON3 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_BUTTON2 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_BUTTON1 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_START1 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON4 | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_START2 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON4 | IPF_PLAYER3 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER3 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_START3 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON4 | IPF_PLAYER4 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER4 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER4 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_START4 );
		PORT_START(); 
		PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN4 );INPUT_PORTS_END(); }}; 
	...
	*/
	...
	static MachineDriver machine_driver_namcona1 = new MachineDriver(
		new MachineCPU[] {
			new MachineCPU(
				CPU_M68000,
				8000000, /* 8MHz? */
				namcona1_readmem,namcona1_writemem,null,null,
		...
		/* video hardware */
		38*8, 32*8, new rectangle( 1*8, 37*8-1, 4*8, 32*8-1 ),
	...
	static MachineDriver machine_driver_namcona1w = new MachineDriver(
		new MachineCPU[] {
			new MachineCPU(
				CPU_M68000,
				8000000, /* 8MHz? */
		...
		/* video hardware */
		38*8, 32*8, new rectangle( 0*8, 38*8-1, 4*8, 32*8-1 ),
	...
	static RomLoadPtr rom_bkrtmaq = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x680000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "mq1_ep0l.bin", 0x080001, 0x080000, 0xf029bc57 ) /* 0xc00000 */
	...
	static RomLoadPtr rom_cgangpzl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x180000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "274001l.bin", 0x080001, 0x80000, 0x8f5cdcc5 )
		ROM_LOAD16_BYTE( "274001u.bin", 0x080000, 0x80000, 0x3a816140 )
	ROM_END(); }}; 
	
	static RomLoadPtr rom_cgangpzj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x180000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "cp2-ep0l.bin", 0x080001, 0x80000, 0x2825f7ba ) /* 0xc00000 */
	...
	static RomLoadPtr rom_emeralda = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x280000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "ep0lb", 0x080001, 0x080000, 0xfcd55293 ) /* 0xc00000 */
	...
	static RomLoadPtr rom_exvania = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x580000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "ex1-ep0l.bin", 0x080001, 0x080000, 0x18c12015 ) /* 0xc00000 */
	...
	static RomLoadPtr rom_knckhead = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xa80000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "kh1-ep0l.bin", 0x080001, 0x080000, 0x94660bec ) /* 0xc00000 */
	...
	static RomLoadPtr rom_numanath = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xa80000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "nm1_ep0l.bin", 0x080001, 0x080000, 0x4398b898 ) /* 0xc00000 */
	...
	static RomLoadPtr rom_quiztou = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xa80000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "qt1_ep0l.bin", 0x080001, 0x080000, 0xb680e543 ) /* 0xc00000 */
	...
	static RomLoadPtr rom_swcourt = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x680000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "sc1-ep0l.bin", 0x080001, 0x080000, 0x145111dd ) /* 0xc00000 */
	...
	static RomLoadPtr rom_tinklpit = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x880000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "tk1-ep0l.bin", 0x080001, 0x080000, 0xfdccae42 ) /* 0xc00000 */
	...
	static RomLoadPtr rom_fa = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x680000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "fa1_ep0l.bin", 0x080001, 0x080000, 0x182eee5c ) /* 0xc00000 */
	...
	public static GameDriver driver_bkrtmaq	   = new GameDriver("1992"	,"bkrtmaq"	,"namcona1.java"	,rom_bkrtmaq,null	,machine_driver_namcona1w	,input_ports_namcona1_quiz	,init_bkrtmaq	,ROT0_16BIT	,	"Namco", "Bakuretsu Quiz Ma-Q Dai Bouken (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_cgangpzl	   = new GameDriver("1992"	,"cgangpzl"	,"namcona1.java"	,rom_cgangpzl,null	,machine_driver_namcona1w	,input_ports_namcona1_joy	,init_cgangpzl	,ROT0_16BIT	,	"Namco", "Cosmo Gang the Puzzle (US)", GAME_NO_SOUND )
	public static GameDriver driver_cgangpzj	   = new GameDriver("1992"	,"cgangpzj"	,"namcona1.java"	,rom_cgangpzj,driver_cgangpzl	,machine_driver_namcona1w	,input_ports_namcona1_joy	,init_cgangpzl	,ROT0_16BIT	,	"Namco", "Cosmo Gang the Puzzle (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_exvania	   = new GameDriver("1992"	,"exvania"	,"namcona1.java"	,rom_exvania,null	,machine_driver_namcona1	,input_ports_namcona1_joy	,init_exbania	,ROT0_16BIT	,	"Namco", "Exvania (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_fa	   = new GameDriver("1992"	,"fa"	,"namcona1.java"	,rom_fa,null	,machine_driver_namcona1	,input_ports_namcona1_joy	,init_fa	,ROT0_16BIT	,	*ROT90_16BIT*/,"Namco", "F/A (Japan)", GAME_NO_SOUND|GAME_NOT_WORKING )
	public static GameDriver driver_knckhead	   = new GameDriver("1992"	,"knckhead"	,"namcona1.java"	,rom_knckhead,null	,machine_driver_namcona1	,input_ports_namcona1_joy	,init_knckhead	,ROT0_16BIT	,	"Namco", "Knuckle Heads (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_swcourt	   = new GameDriver("1992"	,"swcourt"	,"namcona1.java"	,rom_swcourt,null	,machine_driver_namcona1w	,input_ports_namcona1_joy	,init_swcourt	,ROT0_16BIT	,	"Namco", "Super World Court (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_emeralda	   = new GameDriver("1993"	,"emeralda"	,"namcona1.java"	,rom_emeralda,null	,machine_driver_namcona1w	,input_ports_namcona1_joy	,init_emeralda	,ROT0_16BIT	,	"Namco", "Emeraldia (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_numanath	   = new GameDriver("1993"	,"numanath"	,"namcona1.java"	,rom_numanath,null	,machine_driver_namcona1w	,input_ports_namcona1_joy	,init_numanath	,ROT0_16BIT	,	"Namco", "Numan Athletics (Japan)", GAME_NO_SOUND|GAME_NOT_WORKING )
	public static GameDriver driver_quiztou	   = new GameDriver("1993"	,"quiztou"	,"namcona1.java"	,rom_quiztou,null	,machine_driver_namcona1w	,input_ports_namcona1_quiz	,init_quiztou	,ROT0_16BIT	,	"Namco", "Nettou! Gekitou! Quiztou!! (Japan)", GAME_NO_SOUND )
	public static GameDriver driver_tinklpit	   = new GameDriver("1993"	,"tinklpit"	,"namcona1.java"	,rom_tinklpit,null	,machine_driver_namcona1w	,input_ports_namcona1_joy	,init_tinklpit	,ROT0_16BIT	,	"Namco", "Tinkle Pit (Japan)", GAME_NO_SOUND )
}
