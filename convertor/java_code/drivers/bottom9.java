...
public class bottom9
{
	...
	public static Memory_ReadAddress bottom9_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x07ff, bottom9_bankedram1_r ),
	...
	public static Memory_WriteAddress bottom9_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x07ff, bottom9_bankedram1_w ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_bottom9 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	ROM_LOAD( "891b11.f23",   0x0000, 0x0100, 0xecb854aa );/* priority encoder (not used) */
	...
	static RomLoadPtr rom_mstadium = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x28000, REGION_CPU1, 0 );/* code + banked roms */
		ROM_LOAD( "891-403.k17",   0x10000, 0x10000, 0x1c00c4e8 );    ROM_LOAD( "891-402.k15",   0x20000, 0x08000, 0xb850bbce );    ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* Z80 code */
