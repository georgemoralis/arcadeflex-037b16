...
public class shangha3
{
	...
	*/
	...
	public static IO_ReadPort heberpop_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x00, YM2612_status_port_0_A_r ),
	...
	public static IO_WritePort heberpop_sound_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, YM2612_control_port_0_A_w ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_shangha3 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "s3j_ic3.v11",  0x0000, 0x40000, 0xe98ce9c8 )
		ROM_LOAD16_BYTE( "s3j_ic2.v11",  0x0001, 0x40000, 0x09174620 )
	
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "s3j_ic43.chr", 0x0000, 0x200000, 0x2dbf9d17 );
	...
	static RomLoadPtr rom_heberpop = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "hbpic31.bin",  0x0000, 0x80000, 0xc430d264 )
		ROM_LOAD16_BYTE( "hbpic32.bin",  0x0001, 0x80000, 0xbfa555a8 )
	
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "hbpic34.bin",  0x0000, 0x10000, 0x0cf056c6 );
	...
	static RomLoadPtr rom_blocken = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "ic31j.bin",    0x0000, 0x20000, 0xec8de2a3 )
		ROM_LOAD16_BYTE( "ic32j.bin",    0x0001, 0x20000, 0x79b96240 )
	
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "ic34.bin",     0x0000, 0x10000, 0x23e446ff );
		ROM_REGION( 0x380000, REGION_GFX1, 0 );/* don't dispose, read during tests */
