...
public class cop01
{
	...
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x40, 0x40, cop01_gfxbank_w ),
	...
	public static IO_ReadPort sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x06, 0x06, cop01_sound_command_r ),
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_cop01 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x02000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "cop14.15g",    0x00000, 0x2000, 0x066d1c55 );/* chars */
	
		ROM_REGION( 0x08000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "cop04.15c",    0x00000, 0x4000, 0x622d32e6 );/* tiles */
		ROM_LOAD( "cop05.16c",    0x04000, 0x4000, 0xc6ac5a35 );
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "cop10.3e",     0x00000, 0x2000, 0x444cb19d );/* sprites */
		...
		ROM_REGION( 0x0500, REGION_PROMS, 0 );	ROM_LOAD( "copproma.13d", 0x0000, 0x0100, 0x97f68a7a );/* red */
	...
	static RomLoadPtr rom_cop01a = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x02000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "cop01alt.014", 0x00000, 0x2000, 0xedd8a474 );/* chars */
	
		ROM_REGION( 0x08000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "cop04.15c",    0x00000, 0x4000, 0x622d32e6 );/* tiles */
		ROM_LOAD( "cop05.16c",    0x04000, 0x4000, 0xc6ac5a35 );
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "cop01alt.010", 0x00000, 0x2000, 0x94aee9d6 );/* sprites */
