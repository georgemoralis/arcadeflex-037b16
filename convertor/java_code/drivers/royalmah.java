...
public class royalmah
{
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x5fff, royalmah_rom_w ),
	...
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x02, 0x02, AY8910_write_port_0_w ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_royalmah = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0020, REGION_PROMS, 0 );	ROM_LOAD( "f-rom.bpr",  0x0000, 0x0020, 0xd3007282 );ROM_END(); }}; 
