...
public class magmax
{
	...
	*/
	...
	public static IO_ReadPort magmax_soundreadport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x06, 0x06, magmax_sound_r ),
	...
	PORT_START(); 	/* Player 1 controls */
		...
		PORT_DIPSETTING(      0x000c, "30000 every" );	PORT_DIPSETTING(      0x0004, "70000 every" );	PORT_DIPSETTING(      0x0008, "50000 every" );	PORT_DIPSETTING(      0x0000, "90000 every" );	PORT_DIPNAME( 0x0010, 0x0010, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPSETTING(      0x1000, "Easy" );	PORT_DIPSETTING(      0x0000, "Hard" );	PORT_DIPNAME( 0x2000, 0x2000, DEF_STR( "Flip_Screen") );
