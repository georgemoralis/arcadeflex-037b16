...
public class gottlieb
{
	...
	public static Memory_ReadAddress gottlieb_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x00000, 0x00fff, MRA_RAM ),
	...
	public static Memory_WriteAddress gottlieb_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x00000, 0x00fff, MWA_RAM, &nvram, &nvram_size ),
	...
	public static Memory_ReadAddress gottlieb_sound_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x01ff, riot_ram_r ),
	...
	public static Memory_WriteAddress gottlieb_sound_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x01ff, riot_ram_w, &riot_ram ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_reactor = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	/* 0000-0fff empty */
	...
	static RomLoadPtr rom_mplanets = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "bg0",          0x0000, 0x1000, 0x709aa24c );/* chars */
		ROM_LOAD( "bg1",          0x1000, 0x1000, 0x4921e345 );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "fg3",          0x0000, 0x2000, 0xc990b39f );/* sprites */
	...
	static RomLoadPtr rom_qbert = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "qb-bg0.bin",   0x0000, 0x1000, 0x7a9ba824 );/* chars */
		ROM_LOAD( "qb-bg1.bin",   0x1000, 0x1000, 0x22e5b891 );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "qb-fg3.bin",   0x0000, 0x2000, 0xdd436d3a );/* sprites */
	...
	static RomLoadPtr rom_insector = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "bg0",          0x0000, 0x1000, 0x0dc2037e );/* chars */
		ROM_LOAD( "bg1",          0x1000, 0x1000, 0x3dd73b94 );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "fg3",          0x0000, 0x2000, 0x9bbf5b6b );/* sprites */
	...
	static RomLoadPtr rom_screwloo = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "bg0",          0x0000, 0x1000, 0x1fd5b649 );/* chars */
		ROM_LOAD( "bg1",          0x1000, 0x1000, 0xc8ddb8ba );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "fg3",          0x0000, 0x2000, 0x97d4e63b );/* sprites */
	...
	static RomLoadPtr rom_sqbert = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "qb-bg0.bin",   0x0000, 0x1000, 0xc3118eef );/* chars */
		ROM_LOAD( "qb-bg1.bin",   0x1000, 0x1000, 0x4f6d8075 );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "qb-fg3.bin",   0x0000, 0x2000, 0xee595eda );/* sprites */
	...
	static RomLoadPtr rom_qbertqub = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "qq-bg0.bin",   0x0000, 0x1000, 0x050badde );/* chars */
		ROM_LOAD( "qq-bg1.bin",   0x1000, 0x1000, 0x8875902f );
		ROM_REGION( 0x10000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "qq-fg3.bin",   0x0000, 0x4000, 0x91a949cc );/* sprites */
	...
	static RomLoadPtr rom_krull = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "fg3.bin",      0x0000, 0x2000, 0x82d77a45 );/* sprites */
	...
	static RomLoadPtr rom_mach3 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "mach3bg0.bin", 0x0000, 0x1000, 0xea2f5257 );	ROM_LOAD( "mach3bg1.bin", 0x1000, 0x1000, 0xf543e4ce );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "mach3fg3.bin", 0x0000, 0x2000, 0x472128b4 );	ROM_LOAD( "mach3fg2.bin", 0x2000, 0x2000, 0x2a59e99e );	ROM_LOAD( "mach3fg1.bin", 0x4000, 0x2000, 0x9b88767b );	ROM_LOAD( "mach3fg0.bin", 0x6000, 0x2000, 0x0bae12a5 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_usvsthem = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "usvs.bg0",     0x0000, 0x1000, 0x8a0de09f );	ROM_LOAD( "usvs.bg1",     0x1000, 0x1000, 0x6fb64d3c );
		ROM_REGION( 0x10000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "usvs.fg3",     0x0000, 0x4000, 0x98703015 );	ROM_LOAD( "usvs.fg2",     0x4000, 0x4000, 0xd3990707 );	ROM_LOAD( "usvs.fg1",     0x8000, 0x4000, 0xa2057430 );	ROM_LOAD( "usvs.fg0",     0xc000, 0x4000, 0x7734e53f );ROM_END(); }}; 
	...
	static RomLoadPtr rom_3stooges = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "gv113fg3",     0x0000, 0x2000, 0x28071212 );/* sprites */
	...
	static RomLoadPtr rom_curvebal = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "cb-bg-0.chp",  0x0000, 0x1000, 0xd666a179 );	ROM_LOAD( "cb-bg-1.chp",  0x1000, 0x1000, 0x5e34ff4e );
		ROM_REGION( 0x8000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "cb-fg-3.chp",  0x0000, 0x2000, 0x9c9452fe );	ROM_LOAD( "cb-fg-2.chp",  0x2000, 0x2000, 0x065131af );	ROM_LOAD( "cb-fg-1.chp",  0x4000, 0x2000, 0x1b7b7f94 );	ROM_LOAD( "cb-fg-0.chp",  0x6000, 0x2000, 0xe3a8230e );ROM_END(); }}; 
