...
public class higemaru
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_higemaru = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "hg3",          0x0000, 0x2000, 0xb37b88c8 );/* characters */
	
		ROM_REGION( 0x4000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "hg1",          0x0000, 0x2000, 0xef4c2f5d );/* tiles */
		ROM_LOAD( "hg2",          0x2000, 0x2000, 0x9133f804 );
		ROM_REGION( 0x0420, REGION_PROMS, 0 );	ROM_LOAD( "hgb3",         0x0000, 0x0020, 0x629cebd8 );/* palette */
