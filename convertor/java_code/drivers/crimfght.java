...
public class crimfght
{
	...
	public static Memory_ReadAddress crimfght_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x03ff, MRA_BANK1 ),			/* banked RAM */
	...
	public static Memory_WriteAddress crimfght_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x03ff, MWA_BANK1 ),					/* banked RAM */
	...
	public static Memory_ReadAddress crimfght_readmem_sound[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x7fff, MRA_ROM ),				/* ROM 821l01.h4 */
	...
	public static Memory_WriteAddress crimfght_writemem_sound[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x7fff, MWA_ROM ),					/* ROM 821l01.h4 */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_crimfght = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "821a08.i15", 0x0000, 0x0100, 0x7da55800 );/* priority encoder (not used) */
