...
public class funkyjet
{
	...
	*/
	...
	PORT_START(); 	/* Player 1 controls */
		...
		PORT_START(); 	/* Dip switch bank 2 */
		PORT_DIPNAME( 0x80, 0x80, "Pause" );	PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Free_Play") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x20, "1" );	PORT_DIPSETTING(    0x10, "2" );	PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x00, "4" );	PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x08, "Easy" );	PORT_DIPSETTING(    0x0c, "Normal" );	PORT_DIPSETTING(    0x04, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x02, 0x02, DEF_STR( "Demo_Sounds") );
	...
	static RomLoadPtr rom_funkyjet = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "mat02", 0x000000, 0x80000, 0xe4b94c7e );/* chars */
	
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );  	ROM_LOAD( "mat00", 0x000000, 0x80000, 0xfbda0228 );/* sprites */
	...
	static RomLoadPtr rom_sotsugyo = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "02.2f", 0x000000, 0x80000, 0x337b1451 );/* chars */
	
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );  	ROM_LOAD( "00.2a", 0x000000, 0x80000, 0xd35a14ef );/* sprites */
		ROM_LOAD( "01.4a", 0x080000, 0x80000, 0xfa10dd54 );
		ROM_REGION( 0x20000, REGION_SOUND1, 0 );/* ADPCM samples */
	  	ROM_LOAD( "sb030.15h",    0x00000, 0x20000, 0x1ea43f48 );ROM_END(); }}; 
	...
	public static GameDriver driver_sotsugyo	   = new GameDriver("1995"	,"sotsugyo"	,"funkyjet.java"	,rom_sotsugyo,null	,machine_driver_funkyjet	,input_ports_sotsugyo	,null	,ROT0	,	"Mitchell Corporation (Atlus license)", "Sotsugyo Shousho", GAME_NOT_WORKING )
}
