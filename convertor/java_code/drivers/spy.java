...
public class spy
{
	...
	public static Memory_ReadAddress spy_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x07ff, spy_bankedram1_r ),
	...
	public static Memory_WriteAddress spy_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x07ff, spy_bankedram1_w, &ram ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_spy = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	ROM_LOAD( "857a10.bin",   0x0000, 0x0100, 0x32758507 );/* priority encoder (not used) */
