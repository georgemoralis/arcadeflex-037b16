...
public class twin16
{
	...
	PORT_START();       /* 0xa0001 */
		...
		PORT_DIPSETTING(    0x18, "20K and every 70K" );	PORT_DIPSETTING(    0x10, "30K and every 80K" );	PORT_DIPSETTING(    0x08, "20K only" );	PORT_DIPSETTING(    0x00, "70K only" );	PORT_DIPNAME( 0x60, 0x40, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x60, "Easy" );	PORT_DIPSETTING(    0x40, "Normal" );	PORT_DIPSETTING(    0x20, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	PORT_START();       /* 0xa0001 */
		...
		PORT_DIPSETTING(    0x04, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x18, 0x18, DEF_STR (Bonus_Life );
		PORT_DIPSETTING(    0x18, "20K and every 150K" );	PORT_DIPSETTING(    0x10, "30K and every 200K" );	PORT_DIPSETTING(    0x08, "20K only" );	PORT_DIPSETTING(    0x00, "70K only" );	PORT_DIPNAME( 0x60, 0x40, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x60, "Easy" );	PORT_DIPSETTING(    0x40, "Normal" );	PORT_DIPSETTING(    0x20, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	PORT_START();       /* 0xa0001 */
		...
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON4 |IPF_PLAYER2 );/* SERVICE2 */
		...
		PORT_DIPSETTING(    0x0a, DEF_STR( "1C_6C") );
		PORT_DIPSETTING(    0x09, DEF_STR( "1C_7C") );
		PORT_DIPSETTING(    0x00, "Invalid" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
	...
	PORT_START();       /* 0xa0001 */
		...
		PORT_DIPSETTING(    0x18, "30K and every 80K" );	PORT_DIPSETTING(    0x10, "50K and every 100K" );	PORT_DIPSETTING(    0x08, "50K only" );	PORT_DIPSETTING(    0x00, "100K only" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x60, "Easy" );	PORT_DIPSETTING(    0x40, "Normal" );	PORT_DIPSETTING(    0x20, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	static RomLoadPtr rom_devilw = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "dw-m14.rom",	0x00000,  0x4000, 0xd7338557 );/* characters */
	...
	static RomLoadPtr rom_majuu = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "687-l14.d8",	0x00000,  0x4000, 0x20ecccd6 );/* characters */
	...
	static RomLoadPtr rom_darkadv = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "n14.3f",	0x0000,  0x4000, 0xc76ac6d2 );/* characters */
	...
	static RomLoadPtr rom_cuebrick = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "903-e14.d8",	0x0000, 0x4000, 0xddbebbd5 );/* characters */
	...
	static RomLoadPtr rom_vulcan = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "vulcan.h14",	0x0000, 0x4000, 0x02f4b16f );/* characters */
	...
	static RomLoadPtr rom_gradius2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "gradius2.g14",	0x0000, 0x4000, 0x9dcdad9d );/* characters */
	...
	static RomLoadPtr rom_hpuncher = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "870f14.d8",	0x0000, 0x4000, 0xc9b46615 );/* characters */
	...
	static RomLoadPtr rom_miaj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD(	"808e14.bin",	0x0000, 0x4000, 0xb9d36525 );/* characters */
