...
public class bjtwin
{
	...
	*/
	...
	public static IO_ReadPort tharrier_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x00, YM2203_status_port_0_r ),
	...
	PORT_START(); 		/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );/* Maybe unused */
		PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );/* Maybe unused */
		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );/* Maybe unused */
	
		PORT_START();       /* IN1 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_START1 );//guess
		PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_START2 );//guess
	...
	PORT_START(); 		/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_HIGH, IPT_SPECIAL );/* Mcu status? */
	
		PORT_START();       /* IN1 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );
		PORT_START(); 	/* DSW */
	...
	PORT_START(); 		/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );// TEST in service mode
	...
	PORT_START(); 		/* IN0 */
		...
		PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x01, "4" );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Unused") );
		PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_DIPSETTING(    0x20, "Easy" );	PORT_DIPSETTING(    0x30, "Normal" );	PORT_DIPSETTING(    0x10, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x40, 0x00, "Language" );	PORT_DIPSETTING(    0x00, "English" );	PORT_DIPSETTING(    0x40, "Japanese" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 		/* IN0 */
		...
		PORT_DIPSETTING(    0x08, "Easy" );	PORT_DIPSETTING(    0x0c, "Medium" );	PORT_DIPSETTING(    0x04, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unused") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x40, "100k and every 200k" );	PORT_DIPSETTING(    0x60, "200k and every 200k" );	PORT_DIPSETTING(    0x20, "300k and every 300k" );	PORT_DIPSETTING(    0x00, "None" );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 		/* IN0 */
		...
		PORT_DIPSETTING(      0x0000, "Easy" );	PORT_DIPSETTING(      0x0006, "Normal" );	PORT_DIPSETTING(      0x0002, "Hard" );	PORT_DIPSETTING(      0x0004, "Hardest" );	PORT_SERVICE( 0x0008, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x0010, 0x0010, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x0010, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		...
		PORT_DIPSETTING(      0x0000, "2" );	PORT_DIPSETTING(      0x00C0, "3" );	PORT_DIPSETTING(      0x0080, "4" );	PORT_DIPSETTING(      0x0040, "5" );
		PORT_START();  /* DSW B */
		PORT_DIPNAME( 0x0001, 0x0001, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x0001, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	...
	PORT_START(); 		/* IN0 */
		...
		PORT_DIPSETTING(      0x0000, "1" );	PORT_DIPSETTING(      0x0002, "2" );	PORT_DIPSETTING(      0x0003, "3" );	PORT_DIPSETTING(      0x0001, "4" );	PORT_DIPNAME( 0x0004, 0x0004, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x0004, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0008, 0x0008, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x0008, DEF_STR( "Off") );
	...
	PORT_START(); 		/* IN0 */
		...
		PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x00, "Language" );	PORT_DIPSETTING(    0x00, "English" );	PORT_DIPSETTING(    0x08, "Japanese" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
	...
	PORT_START(); 		/* IN0 */
		...
		PORT_START(); 	/* DSW A */
		PORT_SERVICE( 0x01, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x02, 0x02, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
	...
	PORT_START(); 		/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );/* shown in service mode, but no effect */
		PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );/* Maybe unused */
		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );/* Maybe unused */
		...
		PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x02, "Language" );	PORT_DIPSETTING(    0x02, "Japanese" );	PORT_DIPSETTING(    0x00, "English" );	PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x08, "Easy" );	PORT_DIPSETTING(    0x0c, "Normal" );	PORT_DIPSETTING(    0x04, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0xc0, 0xc0, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x40, "2" );	PORT_DIPSETTING(    0xc0, "3" );	PORT_DIPSETTING(    0x80, "4" );
		PORT_START(); 	/* DSW B */
		PORT_DIPNAME( 0x01, 0x01, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
	...
	PORT_START(); 		/* IN0 */
		...
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* DSW A */
		PORT_DIPNAME( 0x03, 0x03, "Life Decrease Speed" );	PORT_DIPSETTING(    0x02, "Slow" );	PORT_DIPSETTING(    0x03, "Normal" );	PORT_DIPSETTING(    0x01, "Fast" );	PORT_DIPSETTING(    0x00, "Very Fast" );	PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x08, "Easy" );	PORT_DIPSETTING(    0x0c, "Normal" );	PORT_DIPSETTING(    0x04, "Hard" );	PORT_DIPSETTING(    0x00, "Very Hard" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Free_Play") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	ROM_START ( urashima )
		...
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "um-5.22j",		0x000000, 0x020000, 0x991776a2 );/* 8x8 tiles */
		...
		ROM_REGION( 0x0240, REGION_PROMS, 0 );	ROM_LOAD( "um-10.2b",      0x0000, 0x0100, 0xcfdbb86c );/* unknown */
		...
		ROM_LOAD( "um-3.22c",		0x000000, 0x080000, 0x9fd8c8fa );ROM_END(); }}; 
	...
	static RomLoadPtr rom_vandyke = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x010000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "vdk-3.222",		0x000000, 0x010000, 0x5a547c1b );/* 8x8 tiles */
	
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "vdk-01.13",		0x000000, 0x080000, 0x195a24be );/* 16x16 tiles */
	
		ROM_REGION( 0x200000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "vdk-07.202",	0x000000, 0x080000, 0x42d41f06 )	/* Sprites */
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	ROM_LOAD( "ic100.bpr", 0x0000, 0x0100, 0x98ed1c97 );/* V-sync hw (unused) */
	...
	static RomLoadPtr rom_tharrier = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "2" ,   0x00000, 0x20000, 0x78923aaa )
		ROM_LOAD16_BYTE( "3" ,   0x00001, 0x20000, 0x99cea259 )
	
		ROM_REGION( 0x010000, REGION_CPU2, 0 );	ROM_LOAD( "12" ,   0x00000, 0x10000, 0xb959f837 );
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1" ,        0x000000, 0x10000, 0xc7402e4a );
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "89050-4" ,  0x000000, 0x80000, 0x64d7d687 );
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "89050-13",	0x000000, 0x80000, 0x24db3fa4 )	/* Sprites */
		...
		ROM_REGION( 0x140, REGION_PROMS, 0 );	ROM_LOAD( "25",  0x00000, 0x100, 0xe0a009fe );	ROM_LOAD( "23",  0x00100, 0x020, 0xfc3569f4 );	ROM_LOAD( "26",  0x00120, 0x020, 0x0cbfb33e );ROM_END(); }}; 
	
	static RomLoadPtr rom_mustang = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "2.bin",    0x00000, 0x20000, 0xbd9f7c89 )
		ROM_LOAD16_BYTE( "3.bin",    0x00001, 0x20000, 0x0eec36a5 )
	
		ROM_REGION(0x10000, REGION_CPU2, 0 );/* 64k for sound cpu code */
		ROM_LOAD( "90058-7",    0x00000, 0x10000, 0x920a93c8 );
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "90058-1",    0x00000, 0x20000, 0x81ccfcad );
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "90058-4",    0x000000, 0x80000, 0xa07a2002 );
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "90058-8",    0x00000, 0x80000, 0x560bff04 )
		...
		ROM_REGION( 0x200, REGION_PROMS, 0 );	ROM_LOAD( "10.bpr",  0x00000, 0x100, 0x633ab1c9 );/* unknown */
		ROM_LOAD( "90058-11",  0x00100, 0x100, 0xcfdbb86c );/* unknown */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_mustangs = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "90058-2",    0x00000, 0x20000, 0x833aa458 )
		...
		ROM_REGION( 0x080000, REGION_SOUND2, 0 );/* OKIM6295 samples */
		ROM_LOAD( "90058-6",    0x000000, 0x80000, 0x233c1776 );
		ROM_REGION( 0x200, REGION_PROMS, 0 );	ROM_LOAD( "90058-10",  0x00000, 0x100, 0xde156d99 );/* unknown */
		ROM_LOAD( "90058-11",  0x00100, 0x100, 0xcfdbb86c );/* unknown */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_mustangb = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "mustang.14",    0x00000, 0x20000, 0x13c6363b )
		...
		ROM_LOAD( "mustang.17",    0x00000, 0x10000, 0xf6f6c4bf );ROM_END(); }}; 
	
	static RomLoadPtr rom_acrobatm = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "2.bin",    0x00000, 0x20000, 0x3fe487f4 )
		ROM_LOAD16_BYTE( "1.bin",    0x00001, 0x20000, 0x17175753 )
	
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "3.bin",   0x000000, 0x10000, 0xd86c186e );/* Characters */
	
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "gfx.01",  0x000000, 0x80000, 0x00000000 );/* Foreground */
	
		ROM_REGION( 0x80000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "gfx.02",  0x000000, 0x80000, 0x00000000 );/* Sprites */
	
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "4.bin",    0x00000, 0x10000, 0x176905fb );
		ROM_REGION( 0x010000, REGION_SOUND1, 0 );/* OKIM6295 samples */
		ROM_LOAD( "snd",    0x00000, 0x10000, 0x00000000 );ROM_END(); }}; 
	
	static RomLoadPtr rom_bioship = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "2",    0x00000, 0x20000, 0xacf56afb )
		ROM_LOAD16_BYTE( "1",    0x00001, 0x20000, 0x820ef303 )
	
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "7",         0x000000, 0x10000, 0x2f3f5a10 );/* Characters */
	
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "sbs-g.01",  0x000000, 0x80000, 0x21302e78 );/* Foreground */
	
		ROM_REGION( 0x80000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "sbs-g.03",  0x000000, 0x80000, 0x60e00d7b );/* Sprites */
	
		ROM_REGION( 0x80000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "sbs-g.02",  0x000000, 0x80000, 0xf31eb668 );/* Background */
	
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "6",    0x00000, 0x10000, 0x5f39a980 );
		ROM_REGION(0x80000, REGION_SOUND1, 0 );/* Oki sample data */
	...
	static RomLoadPtr rom_blkheart = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "3.bin",    0x000000, 0x020000, 0xa1ab3a16 );/* 8x8 tiles */
	
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "90068-5.bin", 0x000000, 0x100000, 0xa1ab4f24 );/* 16x16 tiles */
	
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_WORD_SWAP( "90068-8.bin", 0x000000, 0x100000, 0x9d3204b2 )	/* Sprites */
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	ROM_LOAD( "9.bpr",      0x0000, 0x0100, 0x98ed1c97 );/* unknown */
	...
	static RomLoadPtr rom_tdragon = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "thund.6",		0x000000, 0x20000, 0xfe365920 );/* 8x8 tiles */
	
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "thund.5",		0x000000, 0x100000, 0xd0bde826 );/* 16x16 tiles */
	
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_WORD_SWAP( "thund.4",	0x000000, 0x100000, 0x3eedc2fe )	/* Sprites */
		...
		ROM_LOAD( "thund.2",     0x00000, 0x80000, 0xecfea43e );	ROM_LOAD( "thund.3",     0x80000, 0x80000, 0xae6875a8 );
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	ROM_LOAD( "9.bin",  0x0000, 0x0100, 0xcfdbb86c );/* unknown */
	...
	static RomLoadPtr rom_tdragonb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "td_08.bin",		0x000000, 0x20000, 0x5144dc69 );/* 8x8 tiles */
	
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "td_06.bin",		0x000000, 0x80000, 0xc1be8a4d );/* 16x16 tiles */
		ROM_LOAD( "td_07.bin",		0x080000, 0x80000, 0x2c3e371f );/* 16x16 tiles */
	
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "td_10.bin",	0x000000, 0x080000, 0xbfd0ec5d )	/* Sprites */
		...
		ROM_LOAD( "td_02.bin",     0x00000, 0x10000, 0x99ee7505 );	ROM_LOAD( "td_01.bin",     0x10000, 0x10000, 0xf6f6c4bf );ROM_END(); }}; 
	
	static RomLoadPtr rom_strahl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "strahl-2.82", 0x00000, 0x20000, 0xc9d008ae )
		ROM_LOAD16_BYTE( "strahl-1.83", 0x00001, 0x20000, 0xafc3c4d6 )
	
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "strahl-3.73",  0x000000, 0x10000, 0x2273b33e );/* Characters */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "str7b2r0.275", 0x000000, 0x40000, 0x5769e3e1 );/* Tiles */
	
		ROM_REGION( 0x180000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "strl3-01.32",  0x000000, 0x80000, 0xd8337f15 );/* Sprites */
		ROM_LOAD( "strl4-02.57",  0x080000, 0x80000, 0x2a38552b );	ROM_LOAD( "strl5-03.58",  0x100000, 0x80000, 0xa0e7d210 );
		ROM_REGION( 0x80000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "str6b1w1.776", 0x000000, 0x80000, 0xbb1bb155 );/* Tiles */
	
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	ROM_LOAD( "strahl-4.66",    0x00000, 0x10000, 0x60a799c4 );
		ROM_REGION( 0x80000, REGION_SOUND1, 0 );/* Oki sample data */
		ROM_LOAD( "str8pmw1.540",    0x00000, 0x80000, 0x01d6bb6a );
		ROM_REGION( 0x80000, REGION_SOUND2, 0 );/* Oki sample data */
		ROM_LOAD( "str9pew1.639",    0x00000, 0x80000, 0x6bb3eb9f );ROM_END(); }}; 
	
	static RomLoadPtr rom_strahla = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "rom2", 0x00000, 0x20000, 0xf80a22ef )
	...
	static RomLoadPtr rom_hachamf = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "hmf_05.rom",  0x000000, 0x020000, 0x29fb04a2 );/* 8x8 tiles */
	
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "hmf_04.rom",  0x000000, 0x080000, 0x05a624e3 );/* 16x16 tiles */
	
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_WORD_SWAP( "hmf_08.rom",  0x000000, 0x100000, 0x7fd0f556 )	/* Sprites */
	
		ROM_REGION( 0x080000, REGION_SOUND1, 0 );/* OKIM6295 samples */
		ROM_LOAD( "hmf_02.rom",  0x000000, 0x080000, 0x3f1e67f2 );
		ROM_REGION( 0x080000, REGION_SOUND2, 0 );/* OKIM6295 samples */
		ROM_LOAD( "hmf_03.rom",  0x000000, 0x080000, 0xb25ed93b );ROM_END(); }}; 
	...
	static RomLoadPtr rom_macross = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "921a01",      0x000000, 0x020000, 0xbbd8242d );/* 8x8 tiles */
	
		ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "921a04",      0x000000, 0x200000, 0x4002e4bb );/* 16x16 tiles */
	
		ROM_REGION( 0x200000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_WORD_SWAP( "921a07",      0x000000, 0x200000, 0x7d2bf112 )	/* Sprites */
		...
		ROM_REGION( 0x0220, REGION_PROMS, 0 );	ROM_LOAD( "921a08",      0x0000, 0x0100, 0xcfdbb86c );/* unknown */
	...
	static RomLoadPtr rom_gunnail = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1.bin",    0x000000, 0x020000, 0x3d00a9f4 );/* 8x8 tiles */
	
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "92077-4.bin", 0x000000, 0x100000, 0xa9ea2804 );/* 16x16 tiles */
	
		ROM_REGION( 0x200000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_WORD_SWAP( "92077-7.bin", 0x000000, 0x200000, 0xd49169b3 )	/* Sprites */
		...
		ROM_REGION( 0x0220, REGION_PROMS, 0 );	ROM_LOAD( "8.bpr",      0x0000, 0x0100, 0x4299776e );/* unknown */
	...
	static RomLoadPtr rom_macross2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "mcrs2j.2",    0x00000, 0x20000, 0xb4aa8ac7 );	ROM_RELOAD(              0x10000, 0x20000 );			/* banked */
	
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "mcrs2j.1",    0x000000, 0x020000, 0xc7417410 );/* 8x8 tiles */
	
		ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "bp932an.a04", 0x000000, 0x200000, 0xc4d77ff0 );/* 16x16 tiles */
	
		ROM_REGION( 0x400000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_WORD_SWAP( "bp932an.a07", 0x000000, 0x200000, 0xaa1b21b9 )	/* Sprites */
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	ROM_LOAD( "mcrs2bpr.9",  0x0000, 0x0100, 0x435653a2 );/* unknown */
	...
	static RomLoadPtr rom_tdragon2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x30000, REGION_CPU2, 0 );	/* Z80 code */
		ROM_LOAD( "5.bin",    0x00000, 0x20000, 0xb870be61 );	ROM_RELOAD(              0x10000, 0x20000 );			/* banked */
	
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "1.bin",    0x000000, 0x020000, 0xd488aafa );/* 8x8 tiles */
	
		ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "ww930914.2", 0x000000, 0x200000, 0xf968c65d );/* 16x16 tiles */
	
		ROM_REGION( 0x400000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_WORD_SWAP( "ww930917.7", 0x000000, 0x200000, 0xb98873cb )	/* Sprites */
		...
		ROM_REGION( 0x0200, REGION_PROMS, 0 );	ROM_LOAD( "9.bpr",  0x0000, 0x0100, 0x435653a2 );/* unknown */
	...
	static RomLoadPtr rom_sabotenb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x010000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ic35.sb3",		0x000000, 0x010000, 0xeb7bc99d );/* 8x8 tiles */
	
		ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "ic32.sb4",		0x000000, 0x200000, 0x24c62205 );/* 16x16 tiles */
	
		ROM_REGION( 0x200000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_WORD_SWAP( "ic100.sb5",	0x000000, 0x200000, 0xb20f166e )	/* Sprites */
	...
	static RomLoadPtr rom_bjtwin = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x010000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "bjt.35",		0x000000, 0x010000, 0xaa13df7c );/* 8x8 tiles */
	
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "bjt.32",		0x000000, 0x100000, 0x8a4f26d0 );/* 16x16 tiles */
	
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_WORD_SWAP( "bjt.100",	0x000000, 0x100000, 0xbb06245d )	/* Sprites */
	...
	static RomLoadPtr rom_nouryoku = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x010000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ic35.3",		0x000000, 0x010000, 0x03d0c3b1 );/* 8x8 tiles */
	
		ROM_REGION( 0x200000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "ic32.4",		0x000000, 0x200000, 0x88d454fd );/* 16x16 tiles */
	
		ROM_REGION( 0x200000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD16_WORD_SWAP( "ic100.5",	0x000000, 0x200000, 0x24d3e24e )	/* Sprites */
	...
	public static GameDriver driver_strahl	   = new GameDriver("1992"	,"strahl"	,"bjtwin.java"	,rom_strahl,null	,machine_driver_strahl	,input_ports_strahl	,init_strahl	,ROT0	,	"UPL",							"Strahl (Japan set 1)", GAME_NO_SOUND )
	public static GameDriver driver_strahla	   = new GameDriver("1992"	,"strahla"	,"bjtwin.java"	,rom_strahla,driver_strahl	,machine_driver_strahl	,input_ports_strahl	,init_strahl	,ROT0	,	"UPL",							"Strahl (Japan set 2)", GAME_NO_SOUND )
	...
	public static GameDriver driver_gunnail	   = new GameDriver("1993"	,"gunnail"	,"bjtwin.java"	,rom_gunnail,null	,machine_driver_gunnail	,input_ports_gunnail	,init_nmk	,ROT270_16BIT	,	"NMK / Tecmo",					"GunNail", GAME_NO_SOUND )
	public static GameDriver driver_macross2	   = new GameDriver("1993"	,"macross2"	,"bjtwin.java"	,rom_macross2,null	,machine_driver_macross2	,input_ports_macross2	,null	,ROT0_16BIT	,	"Banpresto",					"Macross II", GAME_NO_COCKTAIL )
	public static GameDriver driver_tdragon2	   = new GameDriver("1993"	,"tdragon2"	,"bjtwin.java"	,rom_tdragon2,null	,machine_driver_macross2	,input_ports_tdragon2	,null	,ROT270_16BIT	,	"NMK",				         	"Thunder Dragon 2", GAME_NO_COCKTAIL )
