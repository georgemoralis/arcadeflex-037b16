...
public class z80bw
{
	...
	public static Memory_ReadAddress astinvad_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x1bff, MRA_ROM ),
		new Memory_ReadAddress( 0x1c00, 0x3fff, MRA_RAM ),
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	public static Memory_WriteAddress astinvad_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x1bff, MWA_ROM ),
	...
	public static IO_ReadPort astinvad_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x08, 0x08, input_port_0_r ),
	...
	public static IO_WritePort astinvad_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x04, 0x04, astinvad_sh_port_4_w ),
	...
	***************************************************************************/
	...
	public static Memory_ReadAddress spaceint_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x17ff, MRA_ROM ),
	...
	public static Memory_WriteAddress spaceint_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x17ff, MWA_ROM ),
	...
	static RomLoadPtr rom_astinvad = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0400, REGION_PROMS, 0 );	ROM_LOAD( "ai_vid_c.rom", 0x0000, 0x0400, 0xb45287ff );ROM_END(); }}; 
	...
	static RomLoadPtr rom_kamikaze = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0400, REGION_PROMS, 0 );	ROM_LOAD( "ai_vid_c.rom", 0x0000, 0x0400, BADCRC(0xb45287ff));
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_spaceint = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0100, REGION_PROMS, 0 );	ROM_LOAD( "clr", 0x0000, 0x0100, 0x13c1803f );ROM_END(); }}; 
