...
public class goindol
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_goindol = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x18000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "r4", 0x00000, 0x8000, 0x1ab84225 );/* Characters */
		ROM_LOAD( "r5", 0x08000, 0x8000, 0x4997d469 );	ROM_LOAD( "r6", 0x10000, 0x8000, 0x752904b0 );
		ROM_REGION( 0x18000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "r7", 0x00000, 0x8000, 0x362f2a27 );	ROM_LOAD( "r8", 0x08000, 0x8000, 0x9fc7946e );	ROM_LOAD( "r9", 0x10000, 0x8000, 0xe6212fe4 );
		ROM_REGION( 0x0300, REGION_PROMS, 0 );	ROM_LOAD( "am27s21.pr1", 0x0000, 0x0100, 0x361f0868 );/* palette red bits   */
