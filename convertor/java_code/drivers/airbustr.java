...
public class airbustr
{
	...
	*/
	...
	public static Memory_ReadAddress readmem[]={
		...
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0xbfff, MWA_ROM ),	// writing at 0 should cause a reset
	...
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, bankswitch_w ),
	...
	*/
	...
	public static IO_ReadPort readport2[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x02, 0x02, soundcommand2_r ),		// from sound cpu
	...
	public static IO_WritePort writeport2[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, bankswitch2_w ),			// bits 2-0 bank, bit 4 (on if dsw1-1 active)?,  bit 5?
	...
	*/
	...
	public static IO_ReadPort sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x02, 0x02, YM2203_status_port_0_r ),
	...
	public static IO_WritePort sound_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, sound_bankswitch_w ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_airbustr = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x24000, REGION_CPU1, 0 );	ROM_LOAD( "pr-14j.bin", 0x00000, 0x0c000, 0x6b9805bd );	ROM_CONTINUE(           0x10000, 0x14000 );
		ROM_REGION( 0x24000, REGION_CPU2, 0 );	ROM_LOAD( "pr-11j.bin", 0x00000, 0x0c000, 0x85464124 );	ROM_CONTINUE(           0x10000, 0x14000 );
		ROM_REGION( 0x24000, REGION_CPU3, 0 );	ROM_LOAD( "pr-21.bin",  0x00000, 0x0c000, 0x6e0a5df0 );	ROM_CONTINUE(           0x10000, 0x14000 );
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "pr-000.bin", 0x000000, 0x80000, 0x8ca68f0d );// scrolling layers
	
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "pr-001.bin", 0x000000, 0x80000, 0x7e6cb377 );// sprites
