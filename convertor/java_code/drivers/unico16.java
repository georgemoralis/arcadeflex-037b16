...
public class unico16
{
	...
	***************************************************************************/
	...
	static WRITE16_HANDLER( zeropnt_sound_bank_w )
	{
		if (ACCESSING_MSB != 0)
		{
			...
			UBytePtr src	= dst + 0x80000 + 0x20000 + 0x20000 * bank;
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_burglarx = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER1 );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER1 );	PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_BUTTON3        | IPF_PLAYER1 );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );
		...
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_COIN1    );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_COIN2    );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_SERVICE2 );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_START1   );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_START2   );	PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x00ff, IP_ACTIVE_LOW, IPT_UNKNOWN  );
		PORT_START(); 	// IN2 - $80001a.b
		PORT_BIT(     0x00ff, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_SERVICE( 0x0100, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x0200, 0x0200, DEF_STR( "Free_Play") );
		...
		PORT_DIPNAME( 0x1000, 0x1000, "Unknown 1-4" );	PORT_DIPSETTING(      0x1000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		...
		PORT_BIT(     0x00ff, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x0300, 0x0300, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(      0x0200, "None" );	PORT_DIPSETTING(      0x0300, "A" );	PORT_DIPSETTING(      0x0100, "B" );	PORT_DIPSETTING(      0x0000, "C" );	PORT_DIPNAME( 0x0400, 0x0400, "Unknown 2-2" );	PORT_DIPSETTING(      0x0400, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0800, 0x0800, "Energy" );	PORT_DIPSETTING(      0x0000, "2" );	PORT_DIPSETTING(      0x0800, "3" );	PORT_DIPNAME( 0x3000, 0x3000, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x2000, "Easy" );	PORT_DIPSETTING(      0x3000, "Normal" );	PORT_DIPSETTING(      0x1000, "Hard" );	PORT_DIPSETTING(      0x0000, "Hardest" );	PORT_DIPNAME( 0xc000, 0xc000, DEF_STR( "Lives") );
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_zeropnt = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT(  0x0001, IP_ACTIVE_HIGH, IPT_COIN1    );	PORT_BIT(  0x0002, IP_ACTIVE_HIGH, IPT_COIN2    );	PORT_BITX( 0x0004, IP_ACTIVE_HIGH, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		PORT_BIT(  0x0008, IP_ACTIVE_HIGH, IPT_UNKNOWN  );	PORT_BIT(  0x0010, IP_ACTIVE_HIGH, IPT_START1   );	PORT_BIT(  0x0020, IP_ACTIVE_HIGH, IPT_START2   );	PORT_BIT(  0x0040, IP_ACTIVE_HIGH, IPT_UNKNOWN  );	PORT_BIT(  0x0080, IP_ACTIVE_HIGH, IPT_SERVICE1 );
		PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT(  0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT(  0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN  );
		PORT_START(); 	// IN1 - $80001a.b
		PORT_BIT(     0x00ff, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_DIPNAME( 0x0100, 0x0000, "Unknown 1-0" );	PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0100, DEF_STR( "On") );
		PORT_DIPNAME( 0x0200, 0x0000, DEF_STR( "Free_Play") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0200, DEF_STR( "On") );
		PORT_DIPNAME( 0x0400, 0x0000, "Unknown 1-2" );	PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0400, DEF_STR( "On") );
		PORT_DIPNAME( 0x0800, 0x0800, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "No") );
		PORT_DIPSETTING(      0x0800, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x1000, 0x0000, "Unknown 1-4" );	PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		...
		PORT_BIT(     0x00ff, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_DIPNAME( 0x0100, 0x0000, "Unknown 2-0" );	PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0100, DEF_STR( "On") );
		PORT_DIPNAME( 0x0200, 0x0000, "Unknown 2-1" );	PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0200, DEF_STR( "On") );
		PORT_DIPNAME( 0x0400, 0x0000, "Unknown 2-2" );	PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0400, DEF_STR( "On") );
		PORT_DIPNAME( 0x0800, 0x0000, "Unknown 2-3" );	PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0800, DEF_STR( "On") );
		PORT_DIPNAME( 0x3000, 0x0000, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x1000, "Easy" );	PORT_DIPSETTING(      0x0000, "Normal" );	PORT_DIPSETTING(      0x2000, "Hard?" );	PORT_DIPSETTING(      0x3000, "Hardest?" );	PORT_DIPNAME( 0xc000, 0x0000, DEF_STR( "Lives") );
		PORT_DIPSETTING(      0x4000, "2" );	PORT_DIPSETTING(      0x0000, "3" );	PORT_DIPSETTING(      0x8000, "4" );	PORT_DIPSETTING(      0xc000, "5" );
	...
	***************************************************************************/
	...
	static YM3812interface unico16_ym3812_intf = new YM3812interface
	(
		1,
		4000000,		/* ? */
		new int[] { 20 },
	...
	static OKIM6295interface unico16_m6295_intf = new OKIM6295interface
	(
		1,
		new int[] { 8000 },		/* ? */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_zeropnt = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "zeromsk1.bin", 0x000000, 0x200000, 0x1f2768a3 );	ROM_LOAD( "zeromsk2.bin", 0x200000, 0x200000, 0xde34f33a );	ROM_LOAD( "zeromsk3.bin", 0x400000, 0x200000, 0xd7a657f7 );	ROM_LOAD( "zeromsk4.bin", 0x600000, 0x200000, 0x3aec2f8d );
		ROM_REGION( 0x800000, REGION_GFX2, ROMREGION_INVERT | ROMREGION_DISPOSE );/* 16x16x8 Layers */
		ROM_LOAD( "zeromsk6.bin", 0x000000, 0x200000, 0xe1e53cf0 );	ROM_LOAD( "zeromsk5.bin", 0x200000, 0x200000, 0x0d7d4850 );	ROM_LOAD( "zeromsk7.bin", 0x400000, 0x200000, 0xbb178f32 );	ROM_LOAD( "zeromsk8.bin", 0x600000, 0x200000, 0x672f02e5 );
		ROM_REGION( 0x80000 * 2, REGION_SOUND1, ROMREGION_SOUNDONLY );/* Samples */
		ROM_LOAD( "zero3.bin", 0x000000, 0x080000, 0xfd2384fa );	ROM_RELOAD(            0x080000, 0x080000             );
	ROM_END(); }}; 
	...
	***************************************************************************/
	...
	public static GameDriver driver_burglarx	   = new GameDriver("1997"	,"burglarx"	,"unico16.java"	,rom_burglarx,null	,machine_driver_burglarx	,input_ports_burglarx	,null	,ROT0_16BIT	,	"Unico Electronics", "Burglar X"  )
	public static GameDriver driver_zeropnt	   = new GameDriver("1998"	,"zeropnt"	,"unico16.java"	,rom_zeropnt,null	,machine_driver_zeropnt	,input_ports_zeropnt	,null	,ROT0_16BIT	,	"Unico Electronics", "Zero Point" )
}
