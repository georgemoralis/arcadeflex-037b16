...
public class gunsmoke
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_gunsmoke = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "11f_gs01.bin", 0x00000, 0x4000, 0xb61ece9b );/* Characters */
	
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "06c_gs13.bin", 0x00000, 0x8000, 0xf6769fc5 );/* 32x32 tiles planes 2-3 */
		...
		ROM_REGION( 0x40000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "06n_gs22.bin", 0x00000, 0x8000, 0xdc9c508c );/* Sprites planes 2-3 */
		...
		ROM_REGION( 0x0a00, REGION_PROMS, 0 );	ROM_LOAD( "03b_g-01.bin", 0x0000, 0x0100, 0x02f55589 );/* red component */
