...
public class blmbycar
{
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_blmbycar = new InputPortPtr(){ public void handler() { 
		...
		PORT_DIPSETTING(      0x0002, "Easy"    );	PORT_DIPSETTING(      0x0003, "Normal"  );	PORT_DIPSETTING(      0x0001, "Hard"    );	PORT_DIPSETTING(      0x0000, "Hardest" );	PORT_DIPNAME( 0x0004, 0x0004, "Joysticks" );	PORT_DIPSETTING(      0x0000, "1" );	PORT_DIPSETTING(      0x0004, "2" );	PORT_DIPNAME( 0x0018, 0x0018, "Controls" );	PORT_DIPSETTING(      0x0018, "Joystick" );//	PORT_DIPSETTING(      0x0010, "Pot Wheel" );// Preliminary
	...
	//	PORT_DIPSETTING(      0x0000, DEF_STR( "Unused") );	// Time goes to 0 rally fast!
		...
		PORT_DIPNAME( 0x4000, 0x4000, "Credits To Start" );	PORT_DIPSETTING(      0x4000, "1" );	PORT_DIPSETTING(      0x0000, "2" );	PORT_DIPNAME( 0x8000, 0x8000, DEF_STR( "Free_Play") );
		PORT_DIPSETTING(      0x8000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	
		PORT_START(); 	// IN1 - $700002.w
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN	| IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_COIN1  );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_COIN2  );
		PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN	| IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_START1  );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_START2  );
	...
	***************************************************************************/
	...
	static OKIM6295interface blmbycar_okim6295_interface = new OKIM6295interface
	(
		1,
		new int[] { 8000 },		/* ? */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_blmbycar = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "bc_rom7",   0x000000, 0x080000, 0xe55ca79b );	ROM_LOAD( "bc_rom8",   0x080000, 0x080000, 0xcdf38c96 );	ROM_LOAD( "bc_rom9",   0x100000, 0x080000, 0x0337ab3d );	ROM_LOAD( "bc_rom10",  0x180000, 0x080000, 0x5458917e );
		ROM_REGION( 0x140000, REGION_SOUND1, 0 );/* 8 bit adpcm (banked) */
		ROM_LOAD( "bc_rom1",     0x040000, 0x080000, 0xac6f8ba1 );	ROM_LOAD( "bc_rom2",     0x0c0000, 0x080000, 0xa4bc31bf );	ROM_COPY( REGION_SOUND1, 0x040000, 0x000000,   0x040000 )
	ROM_END(); }}; 
	...
	***************************************************************************/
	...
	public static GameDriver driver_blmbycar	   = new GameDriver("1994"	,"blmbycar"	,"blmbycar.java"	,rom_blmbycar,null	,machine_driver_blmbycar	,input_ports_blmbycar	,null	,ROT0	,	"ABM & Gecas", "Blomby Car" )
}
