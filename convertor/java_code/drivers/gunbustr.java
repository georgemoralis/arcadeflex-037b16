...
public class gunbustr
{
	...
	***********************************************************/
	...
	PORT_START();       /* IN0 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0002, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0004, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0008, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0010, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0020, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW,  IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW,  IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW,  IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW,  IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW,  IPT_UNKNOWN );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER1 );/* Freeze input */
		PORT_BIT( 0x0002, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0004, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0008, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0010, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0020, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_SPECIAL );/* reserved for EEROM */
		...
		PORT_START(); 	/* IN 6, P2Y */
		PORT_ANALOG( 0xff, 0x80, IPT_AD_STICK_Y | IPF_REVERSE | IPF_PLAYER2, 30, 20, 0, 0xff);INPUT_PORTS_END(); }}; 
	...
	***********************************************************/
	...
	static EEPROM_interface gunbustr_eeprom_interface = new EEPROM_interface
	(
		6,				/* address bits */
		16,				/* data bits */
		"0110",			/* read command */
	...
	static MachineDriver machine_driver_gunbustr = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_M68EC020,
				16000000,	/* 16 MHz */
				gunbustr_readmem,gunbustr_writemem,null,null,
	...
	static RomLoadPtr rom_gunbustr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "d27-01.bin", 0x00000, 0x80000, 0xf41759ce )	/* SCR 16x16 tiles */
		ROM_LOAD16_BYTE( "d27-02.bin", 0x00001, 0x80000, 0x92ab6430 )
	
		ROM_REGION( 0x400000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD32_BYTE( "d27-04.bin", 0x000003, 0x100000, 0xff8b9234 )	/* OBJ 16x16 tiles: each rom has 1 bitplane */
	...
	public static GameDriver driver_gunbustr	   = new GameDriver("1992"	,"gunbustr"	,"gunbustr.java"	,rom_gunbustr,null	,machine_driver_gunbustr	,input_ports_gunbustr	,init_gunbustr	,ROT0_16BIT	,	ORIENTATION_FLIP_X, "Taito Corporation", "Gunbuster (Japan)" )
}
