...
public class supbtime
{
	...
	PORT_START(); 	/* Player 1 controls */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 );/* Used? */
		...
		PORT_START(); 	/* Dip switch bank 2 */
		PORT_DIPNAME( 0xc0, 0xc0, "Time" );	PORT_DIPSETTING(    0x00, "1500" );	PORT_DIPSETTING(    0x80, "2000" );	PORT_DIPSETTING(    0xc0, "2500" );	PORT_DIPSETTING(    0x40, "3000" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Difficulty") );
	...
	static RomLoadPtr rom_supbtime = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "mae02.bin", 0x000000, 0x80000, 0xa715cca0 );/* chars */
	
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );  	ROM_LOAD( "mae00.bin", 0x000000, 0x80000, 0x30043094 );/* sprites */
	...
	static RomLoadPtr rom_chinatwn = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "mak-02.h2", 0x000000, 0x80000, 0x745b2c50 );/* chars */
	
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );  	ROM_LOAD( "mak-00.a2", 0x000000, 0x80000, 0x18e8cc1b );/* sprites */
		ROM_LOAD( "mak-01.a4", 0x080000, 0x80000, 0xd88ebda8 );
		ROM_REGION( 0x20000, REGION_SOUND1, 0 );/* ADPCM samples */
	  	ROM_LOAD( "gv_03-.j14",    0x00000, 0x20000, 0x948faf92 );ROM_END(); }}; 
