...
public class superchs
{
	...
	static WRITE32_HANDLER( cpua_ctrl_w )
	{
		...
		*/
		...
		if (ACCESSING_MSB != 0)
		{
			...
			if ((data & 0x8000) != 0) cpu_cause_interrupt(0,3); /* Guess */
		}
	...
	***********************************************************/
	...
	PORT_START();       /* IN0 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0002, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0004, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_BUTTON6 | IPF_PLAYER1 );/* Freeze input */
		...
		PORT_START();       /* IN1 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0002, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0004, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0008, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0010, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0020, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_SPECIAL );/* reserved for EEROM */
		PORT_BIT( 0x0100, IP_ACTIVE_LOW,  IPT_BUTTON5 | IPF_PLAYER1 );/* seat center (cockpit only) */
		PORT_BIT( 0x0200, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0400, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x0800, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BITX(0x1000, IP_ACTIVE_LOW,  IPT_BUTTON3, "Nitro", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x2000, IP_ACTIVE_LOW,  IPT_BUTTON4, "Gear Shift", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x4000, IP_ACTIVE_LOW,  IPT_BUTTON2, "Brake", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BIT( 0x8000, IP_ACTIVE_LOW,  IPT_START1 );
		...
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_2WAY | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER1 );	PORT_DIPNAME( 0x10, 0x00, "Steering type" );	PORT_DIPSETTING(    0x10, "Digital" );	PORT_DIPSETTING(    0x00, "Analogue" );INPUT_PORTS_END(); }}; 
	...
	***********************************************************/
	...
	static EEPROM_interface superchs_eeprom_interface = new EEPROM_interface
	(
		6,				/* address bits */
		16,				/* data bits */
		"0110",			/* read command */
	...
	static MachineDriver machine_driver_superchs = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_M68EC020,
				16000000,	/* 16 MHz */
				superchs_readmem,superchs_writemem,null,null,
			...
			new MachineCPU(
				CPU_M68000,
				16000000,	/* 16 MHz */
				superchs_cpub_readmem,superchs_cpub_writemem,null,null,
		...
		/* video hardware */
		40*8, 32*8, new rectangle( 0, 40*8-1, 2*8, 32*8-1 ),
	...
	static RomLoadPtr rom_superchs = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "d46-05.87", 0x00000, 0x100000, 0x150d0e4c )	/* SCR 16x16 tiles */
		ROM_LOAD16_BYTE( "d46-06.88", 0x00001, 0x100000, 0x321308be )
	
		ROM_REGION( 0x800000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD32_BYTE( "d46-01.64", 0x000003, 0x200000, 0x5c2ae92d )	/* OBJ 16x16 tiles: each rom has 1 bitplane */
	...
	public static GameDriver driver_superchs	   = new GameDriver("1992"	,"superchs"	,"superchs.java"	,rom_superchs,null	,machine_driver_superchs	,input_ports_superchs	,init_superchs	,ROT0_16BIT	,	"Taito America Corporation", "Super Chase - Criminal Termination (US)" )
}
