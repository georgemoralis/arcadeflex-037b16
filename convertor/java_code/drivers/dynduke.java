...
public class dynduke
{
	...
	public static Memory_ReadAddress sub_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x00000, 0x05fff, MRA_RAM ),
	...
	public static Memory_WriteAddress sub_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x00000, 0x05fff, MWA_RAM ),
	...
	static RomLoadPtr rom_dynduke = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "dd8.w8",       0x000000, 0x08000, 0x3c29480b );	ROM_CONTINUE(             0x010000, 0x08000 );	ROM_COPY( REGION_CPU3, 0, 0x018000, 0x08000 )
	
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "dd9.jk5",	0x000000, 0x04000, 0xf2bc9af4 );/* chars */
		ROM_LOAD( "dd10.jk3",	0x010000, 0x04000, 0xc2a9f19b );
		ROM_REGION( 0x180000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "dd.a2",		0x000000, 0x40000, 0x598f343f );/* background */
		...
		ROM_REGION( 0x100000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "dd.mn3",		0x000000, 0x40000, 0x2ee0ca98 );/* foreground */
		...
		ROM_REGION( 0x200000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE(  "dd.n1", 0x000000, 0x40000, 0xcf1db927 ) /* sprites */
	...
	static RomLoadPtr rom_dbldyn = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x20000*2, REGION_CPU3, 0 );/* sound Z80 */
		ROM_LOAD( "8.8w",         0x000000, 0x08000, 0xf4066081 );	ROM_CONTINUE(             0x010000, 0x08000 );	ROM_COPY( REGION_CPU3, 0, 0x018000, 0x08000 )
	
		ROM_REGION( 0x020000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "9.5k",	    0x004000, 0x4000, 0x16bec703 );/* chars */
