...
public class skydiver
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_skydiver = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0400, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "33163-01.h5", 0x0000, 0x0400, 0x5b9bb7c2 );
		ROM_REGION( 0x0800, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "33176-01.l5", 0x0000, 0x0400, 0x6b082a01 );	ROM_LOAD( "33177-01.k5", 0x0400, 0x0400, 0xf5541af0 );ROM_END(); }}; 
