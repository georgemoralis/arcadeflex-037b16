...
public class astrof
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_astrof = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0020, REGION_PROMS, 0 );	ROM_LOAD( "astrf.clr",    0x0000, 0x0020, 0x61329fd1 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_tomahawk = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0020, REGION_PROMS, 0 );	ROM_LOAD( "t777.clr",     0x0000, 0x0020, 0xd6a528fd );ROM_END(); }}; 
