...
public class mcr68
{
	...
	static RomLoadPtr rom_zwackery = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "pro0.bin",   0x00000, 0x4000, 0x6fb9731c )
		...
		ROM_REGION( 0x20000, REGION_CPU2, 0 );	ROM_LOAD16_BYTE( "csd7.bin",  0x00000, 0x2000, 0x5501f54b )
	...
	static RomLoadPtr rom_xenophob = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "xeno_pro.3c",  0x00000, 0x10000, 0xf44c2e60 )
		...
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "xeno_bg.11d",  0x00000, 0x08000, 0x3d2cf284 );	ROM_LOAD( "xeno_bg.12d",  0x08000, 0x08000, 0xc32288b1 );
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "xeno_fg.7j",   0x00000, 0x10000, 0xb12eddb2 );	ROM_LOAD( "xeno_fg.8j",   0x10000, 0x10000, 0x20e682f5 );	ROM_LOAD( "xeno_fg.9j",   0x20000, 0x10000, 0x82fb3e09 );	ROM_LOAD( "xeno_fg.10j",  0x30000, 0x10000, 0x6a7a3516 );ROM_END(); }}; 
	
	static RomLoadPtr rom_spyhunt2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "sh23c.bin",  0x00000, 0x10000, 0x30b91c90 )
		...
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "sh2bg0.bin",  0x00000, 0x08000, 0xcb3c3d8e );	ROM_LOAD( "sh2bg1.bin",  0x08000, 0x08000, 0x029d4af1 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "fg0.7j",   0x00000, 0x20000, 0x55ce12ea );	ROM_LOAD( "fg1.8j",   0x20000, 0x20000, 0x692afb67 );	ROM_LOAD( "fg2.9j",   0x40000, 0x20000, 0xf1aba383 );	ROM_LOAD( "fg3.10j",  0x60000, 0x20000, 0xd3475ff8 );ROM_END(); }}; 
	
	static RomLoadPtr rom_spyhnt2a = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "3c",  0x00000, 0x10000, 0x5b92aadf )
		...
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "bg0.11d",  0x00000, 0x08000, 0x81efef7a );	ROM_LOAD( "bg1.12d",  0x08000, 0x08000, 0x6a902e4d );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "fg0.7j",   0x00000, 0x20000, 0x55ce12ea );	ROM_LOAD( "fg1.8j",   0x20000, 0x20000, 0x692afb67 );	ROM_LOAD( "fg2.9j",   0x40000, 0x20000, 0xf1aba383 );	ROM_LOAD( "fg3.10j",  0x60000, 0x20000, 0xd3475ff8 );ROM_END(); }}; 
	
	static RomLoadPtr rom_blasted = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "3c",  0x00000, 0x10000, 0xb243b7df )
		...
		ROM_REGION( 0x10000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "11d",  0x00000, 0x08000, 0xd8ed5cbc );	ROM_LOAD( "12d",  0x08000, 0x08000, 0x60d00c69 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "fg0",  0x00000, 0x20000, 0x5034ae8a );	ROM_LOAD( "fg1",  0x20000, 0x20000, 0x4fbdba58 );	ROM_LOAD( "fg2",  0x40000, 0x20000, 0x8891f6f8 );	ROM_LOAD( "fg3",  0x60000, 0x20000, 0x18e4a130 );ROM_END(); }}; 
	
	static RomLoadPtr rom_archrivl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "3c-rev2",  0x00000, 0x10000, 0x60d4b760 )
		...
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "11d-rev1",  0x00000, 0x10000, 0x7eb3d7c6 );	ROM_LOAD( "12d-rev1",  0x10000, 0x10000, 0x31e68050 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "7j-rev1",   0x00000, 0x20000, 0x148ce28c );	ROM_LOAD( "8j-rev1",   0x20000, 0x20000, 0x58187ac2 );	ROM_LOAD( "9j-rev1",   0x40000, 0x20000, 0x0dd1204e );	ROM_LOAD( "10j-rev1",  0x60000, 0x20000, 0xeb3d0344 );ROM_END(); }}; 
	
	static RomLoadPtr rom_archriv2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "archrivl.4",  0x00000, 0x10000, 0x3c545740 )
	...
	static RomLoadPtr rom_pigskin = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "pigskin.a5",  0x00000, 0x10000, 0xab61c29b )
		...
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "pigskin.e2",  0x00000, 0x10000, 0x12d5737b );	ROM_LOAD( "pigskin.e1",  0x10000, 0x10000, 0x460202a9 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "pigskin.h15", 0x00000, 0x20000, 0x2655d03f );	ROM_LOAD( "pigskin.h17", 0x20000, 0x20000, 0x31c52ea7 );	ROM_LOAD( "pigskin.h18", 0x40000, 0x20000, 0xb36c4109 );	ROM_LOAD( "pigskin.h14", 0x60000, 0x20000, 0x09c87104 );ROM_END(); }}; 
	
	static RomLoadPtr rom_trisport = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "la3.a5",  0x00000, 0x10000, 0xfe1e9e37 )
		...
		ROM_REGION( 0x20000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "la2.e2",  0x00000, 0x10000, 0xf61149a0 );	ROM_LOAD( "la2.e1",  0x10000, 0x10000, 0xcf753497 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "la2.h15", 0x00000, 0x20000, 0x18a44d43 );	ROM_LOAD( "la2.h17", 0x20000, 0x20000, 0x874cd237 );	ROM_LOAD( "la2.h18", 0x40000, 0x20000, 0xf7637a18 );	ROM_LOAD( "la2.h14", 0x60000, 0x20000, 0x403f9401 );ROM_END(); }}; 
