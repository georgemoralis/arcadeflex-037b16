...
public class toaplan1
{
	...
	public static IO_ReadPort truxton_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x00, input_port_1_r ),	/* Player 1 */
		...
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x30, 0x30, toaplan1_coin_w ),	/* Coin counter/lockout */
		...
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x30, 0x30, rallybik_coin_w ),	/* Coin counter/lockout */
		new IO_WritePort( 0x60, 0x60, YM3812_control_port_0_w ),
		new IO_WritePort( 0x61, 0x61, YM3812_write_port_0_w ),
		new IO_WritePort(MEMPORT_MARKER, 0)
	};
	public static IO_ReadPort hellfire_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x00, input_port_3_r ),	/* DSW1 */
	...
	public static IO_ReadPort zerowing_sound_readport[]={
		...
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0xa0, 0xa0, toaplan1_coin_w ),	/* Coin counter/lockout */
	...
	public static IO_ReadPort outzone_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x08, 0x08, input_port_3_r ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_rallybik = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "b45-09.bin",  0x00000, 0x20000, 0x1dc7b010 );	ROM_LOAD( "b45-08.bin",  0x20000, 0x20000, 0xfab661ba );	ROM_LOAD( "b45-07.bin",  0x40000, 0x20000, 0xcd3748b4 );	ROM_LOAD( "b45-06.bin",  0x60000, 0x20000, 0x144b085c );
		ROM_REGION( 0x40000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "b45-11.rom",  0x00000, 0x10000, 0x0d56e8bb );	ROM_LOAD( "b45-10.rom",  0x10000, 0x10000, 0xdbb7c57e );	ROM_LOAD( "b45-12.rom",  0x20000, 0x10000, 0xcf5aae4e );	ROM_LOAD( "b45-13.rom",  0x30000, 0x10000, 0x1683b07c );
	...
	static RomLoadPtr rom_truxton = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "b65_08.bin",  0x00000, 0x20000, 0xd2315b37 );	ROM_LOAD( "b65_07.bin",  0x20000, 0x20000, 0xfb83252a );	ROM_LOAD( "b65_06.bin",  0x40000, 0x20000, 0x36cedcbe );	ROM_LOAD( "b65_05.bin",  0x60000, 0x20000, 0x81cd95f1 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "b65_04.bin",  0x00000, 0x20000, 0x8c6ff461 );	ROM_LOAD( "b65_03.bin",  0x20000, 0x20000, 0x58b1350b );	ROM_LOAD( "b65_02.bin",  0x40000, 0x20000, 0x1dd55161 );	ROM_LOAD( "b65_01.bin",  0x60000, 0x20000, 0xe974937f );ROM_END(); }}; 
	...
	static RomLoadPtr rom_hellfire = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "b90-04.bin",  0x00000, 0x20000, 0xea6150fc );	ROM_LOAD( "b90-05.bin",  0x20000, 0x20000, 0xbb52c507 );	ROM_LOAD( "b90-06.bin",  0x40000, 0x20000, 0xcf5b0252 );	ROM_LOAD( "b90-07.bin",  0x60000, 0x20000, 0xb98af263 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "b90-11.bin",  0x00000, 0x20000, 0xc33e543c );	ROM_LOAD( "b90-10.bin",  0x20000, 0x20000, 0x35fd1092 );	ROM_LOAD( "b90-09.bin",  0x40000, 0x20000, 0xcf01009e );	ROM_LOAD( "b90-08.bin",  0x60000, 0x20000, 0x3404a5e3 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_zerowing = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "o15-05.rom",  0x00000, 0x20000, 0x4e5dd246 );	ROM_LOAD( "o15-06.rom",  0x20000, 0x20000, 0xc8c6d428 );	ROM_LOAD( "o15-07.rom",  0x40000, 0x20000, 0xefc40e99 );	ROM_LOAD( "o15-08.rom",  0x60000, 0x20000, 0x1b019eab );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "o15-03.rom",  0x00000, 0x20000, 0x7f245fd3 );	ROM_LOAD( "o15-04.rom",  0x20000, 0x20000, 0x0b1a1289 );	ROM_LOAD( "o15-01.rom",  0x40000, 0x20000, 0x70570e43 );	ROM_LOAD( "o15-02.rom",  0x60000, 0x20000, 0x724b487f );ROM_END(); }}; 
	...
	static RomLoadPtr rom_demonwld = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "rom05",  0x00000, 0x20000, 0x6506c982 );	ROM_LOAD( "rom07",  0x20000, 0x20000, 0xa3a0d993 );	ROM_LOAD( "rom06",  0x40000, 0x20000, 0x4fc5e5f3 );	ROM_LOAD( "rom08",  0x60000, 0x20000, 0xeb53ab09 );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "rom01",  0x00000, 0x20000, 0x1b3724e9 );	ROM_LOAD( "rom02",  0x20000, 0x20000, 0x7b20a44d );	ROM_LOAD( "rom03",  0x40000, 0x20000, 0x2cacdcd0 );	ROM_LOAD( "rom04",  0x60000, 0x20000, 0x76fd3201 );
	...
	static RomLoadPtr rom_samesame = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "o17_05.bin",  0x00000, 0x20000, 0x565315f8 );	ROM_LOAD( "o17_06.bin",  0x20000, 0x20000, 0x95262d4c );	ROM_LOAD( "o17_07.bin",  0x40000, 0x20000, 0x4c4b735c );	ROM_LOAD( "o17_08.bin",  0x60000, 0x20000, 0x95c6586c );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "o17_01.bin",  0x00000, 0x20000, 0xea12e491 );	ROM_LOAD( "o17_02.bin",  0x20000, 0x20000, 0x32a13a9f );	ROM_LOAD( "o17_03.bin",  0x40000, 0x20000, 0x68723dc9 );	ROM_LOAD( "o17_04.bin",  0x60000, 0x20000, 0xfe0ecb13 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_outzone = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "rom5.bin",  0x00000, 0x80000, 0xc64ec7b6 );	ROM_LOAD( "rom6.bin",  0x80000, 0x80000, 0x64b6c5ac );
		ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "rom2.bin",  0x00000, 0x20000, 0x6bb72d16 );	ROM_LOAD( "rom1.bin",  0x20000, 0x20000, 0x0934782d );	ROM_LOAD( "rom3.bin",  0x40000, 0x20000, 0xec903c07 );	ROM_LOAD( "rom4.bin",  0x60000, 0x20000, 0x50cbf1a8 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_outzonea = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* Sound Z80 code */
		ROM_LOAD( "rom9.bin",  0x0000, 0x8000, 0x73d8e235 );
		ROM_REGION( 0x100000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "rom5.bin",  0x00000, 0x80000, 0xc64ec7b6 );	ROM_LOAD( "rom6.bin",  0x80000, 0x80000, 0x64b6c5ac );/* one pirate board uses the same data in a different layout
	...
	*/
	...
	static RomLoadPtr rom_vimana = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "vim6.bin",  0x00000, 0x20000, 0x2886878d );	ROM_LOAD( "vim5.bin",  0x20000, 0x20000, 0x61a63d7a );	ROM_LOAD( "vim4.bin",  0x40000, 0x20000, 0xb0515768 );	ROM_LOAD( "vim3.bin",  0x60000, 0x20000, 0x0b539131 );
		ROM_REGION( 0x100000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "vim1.bin",  0x00000, 0x80000, 0xcdde26cd );	ROM_LOAD( "vim2.bin",  0x80000, 0x80000, 0x1dbfc118 );
		ROM_REGION( 0x40, REGION_PROMS, 0 );	/* nibble bproms, lo/hi order to be determined */
