...
public class jackal
{
	...
	public static Memory_ReadAddress jackal_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0010, 0x0010, input_port_0_r ),
	...
	public static Memory_WriteAddress jackal_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x0003, MWA_RAM, &jackal_videoctrl ),	/* scroll + other things */
	...
	public static Memory_ReadAddress jackal_sound_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x2001, 0x2001, YM2151_status_port_0_r ),
	...
	public static Memory_WriteAddress jackal_sound_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x2000, 0x2000, YM2151_register_port_0_w ),
	...
	PORT_START(); 	/* DSW1 */
		...
		PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Flip_Screen") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_jackal = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "631t04.bin",   0x00000, 0x20000, 0x457f42f0 )
	...
	static RomLoadPtr rom_topgunr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2, 0 );    /* 64k for 2nd cpu (Graphics & Sound)*/
		ROM_LOAD( "631t01.bin",   0x8000, 0x8000, 0xb189af6a );
		ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD16_BYTE( "tgnr7h.bin",   0x00000, 0x20000, 0x50122a12 )
