...
public class cps1
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_forgottn = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "lwu11a",        0x00000, 0x20000, 0xddf78831 )
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "lw-02",         0x000000, 0x80000, 0x43e6c5c8, ROM_GROUPWORD | ROM_SKIP(6) )
		...
		ROM_REGION( 0x8000, REGION_GFX2, 0 );	ROM_COPY( REGION_GFX1, 0x000000, 0x000000, 0x8000 )	/* stars */
	...
	static RomLoadPtr rom_lostwrld = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "lw-11c.14f",    0x00000, 0x20000, 0x67e42546 )
	...
	static RomLoadPtr rom_ghouls = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "ghl29.bin",    0x00000, 0x20000, 0x166a58a2 )
		...
		ROM_REGION( 0x300000, REGION_GFX1, 0 );	ROMX_LOAD( "ghl5.bin",   0x000000, 0x80000, 0x0ba9c0b0, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_ghoulsu = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "dmu29",        0x00000, 0x20000, 0x334d85b2 )
	...
	static RomLoadPtr rom_daimakai = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "dmj_38.bin",   0x00000, 0x20000, 0x82fd1798 )
	...
	static RomLoadPtr rom_strider = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "strider.06",   0x000000, 0x80000, 0x4eee9aea, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_dwj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "09.bin",       0x000000, 0x20000, 0xc3e83c69, ROM_SKIP(7) )
	...
	static RomLoadPtr rom_willow = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "wl_gfx5.rom",  0x000000, 0x80000, 0xafa74b73, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_unsquad = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "unsquad.05",   0x000000, 0x80000, 0xbf4575d8, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_ffight = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "ff05-05m.bin", 0x000000, 0x80000, 0x9c284108, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_ffightj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "ff09.bin",     0x000000, 0x20000, 0x5b116d0d, ROM_SKIP(7) )
	...
	static RomLoadPtr rom_1941 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "41_gfx5.rom",  0x000000, 0x80000, 0x01d1cb11, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_mercs = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "so2_gfx6.rom", 0x000000, 0x80000, 0xaa6102af, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_mtwins = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "ch_gfx5.rom",  0x000000, 0x80000, 0x4ec75f15, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_msword = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "ms_gfx5.rom",  0x000000, 0x80000, 0xc00fe7e2, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_cawing = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "ca_gfx5.rom",  0x000000, 0x80000, 0x66d4cc37, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_cawingj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "caj09.bin",    0x000000, 0x20000, 0x41b0f9a6, ROM_SKIP(7) )
	...
	static RomLoadPtr rom_nemo = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "nm_gfx5.rom",  0x000000, 0x80000, 0x487b8747, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_sf2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x600000, REGION_GFX1, 0 );	ROMX_LOAD( "sf2_06.bin", 0x000000, 0x80000, 0x22c9cc8e, ROM_GROUPWORD | ROM_SKIP(6) ) /* sf2gfx02.rom */
		...
		ROM_REGION( 0x18000, REGION_CPU2, 0 );/* 64k for the audio CPU (+banks) */
		ROM_LOAD( "sf2_09.bin",    0x00000, 0x08000, 0xa4823a1b );	ROM_CONTINUE(              0x10000, 0x08000 );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );/* Samples */
		ROM_LOAD( "sf2_18.bin",       0x00000, 0x20000, 0x7f162009 );	ROM_LOAD( "sf2_19.bin",       0x20000, 0x20000, 0xbeade53f );ROM_END(); }}; 
	...
	static RomLoadPtr rom_3wonders = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "3wonders.05",  0x000000, 0x80000, 0x86aef804, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_kod = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "kod02.rom",    0x000000, 0x80000, 0xe45b8701, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_captcomm = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "gfx_01.rom",   0x000000, 0x80000, 0x7261d8ba, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_knights = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "kr_gfx1.rom",  0x000000, 0x80000, 0x9e36c1a4, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_sf2ce = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x600000, REGION_GFX1, 0 );	ROMX_LOAD( "s92_01.bin",   0x000000, 0x80000, 0x03b0d852, ROM_GROUPWORD | ROM_SKIP(6) )
		...
		ROM_REGION( 0x18000, REGION_CPU2, 0 );/* 64k for the audio CPU (+banks) */
		ROM_LOAD( "s92_09.bin",    0x00000, 0x08000, 0x08f6b60e );	ROM_CONTINUE(              0x10000, 0x08000 );
		ROM_REGION( 0x40000, REGION_SOUND1, 0 );/* Samples */
		ROM_LOAD( "s92_18.bin",    0x00000, 0x20000, 0x7f162009 );	ROM_LOAD( "s92_19.bin",    0x20000, 0x20000, 0xbeade53f );ROM_END(); }}; 
	...
	static RomLoadPtr rom_varth = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "va_gfx5.rom",  0x000000, 0x80000, 0xb1fb726e, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_cworld2j = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "q509.bin",   0x000000, 0x20000, 0x48496d80, ROM_SKIP(7) )
	...
	static RomLoadPtr rom_wof = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "tk2_gfx1.rom",   0x000000, 0x80000, 0x0d9cb9bf, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_dino = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "cd_gfx01.rom",   0x000000, 0x80000, 0x8da4f917, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_punisher = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "ps_gfx1.rom",   0x000000, 0x80000, 0x77b7ccab, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_slammast = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x600000, REGION_GFX1, 0 );	ROMX_LOAD( "mb_gfx01.rom",   0x000000, 0x80000, 0x41468e06, ROM_GROUPWORD | ROM_SKIP(6) )
		...
		ROM_REGION( 0x8000, REGION_USER1, 0 );	/* the encrypted Z80 ROM will be copied here, where the main CPU can read it. */
	
		ROM_REGION( 0x400000, REGION_SOUND1, 0 );/* QSound samples */
		ROM_LOAD( "mb_q1.bin",      0x000000, 0x80000, 0x0630c3ce );	ROM_LOAD( "mb_q2.bin",      0x080000, 0x80000, 0x354f9c21 );	ROM_LOAD( "mb_q3.bin",      0x100000, 0x80000, 0x7838487c );	ROM_LOAD( "mb_q4.bin",      0x180000, 0x80000, 0xab66e087 );	ROM_LOAD( "mb_q5.bin",      0x200000, 0x80000, 0xc789fef2 );	ROM_LOAD( "mb_q6.bin",      0x280000, 0x80000, 0xecb81b61 );	ROM_LOAD( "mb_q7.bin",      0x300000, 0x80000, 0x041e49ba );	ROM_LOAD( "mb_q8.bin",      0x380000, 0x80000, 0x59fe702a );ROM_END(); }}; 
	...
	static RomLoadPtr rom_mbomberj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x600000, REGION_GFX1, 0 );	ROMX_LOAD( "mbj_01.bin",     0x000000, 0x80000, 0xa53b1c81, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_mbombrd = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 2*0x28000, REGION_CPU2, 0 );/* QSound Z80 code + space for decrypted opcodes */
		ROM_LOAD( "mb_q.bin",       0x00000, 0x08000, 0xd6fa76d1 );	ROM_CONTINUE(               0x10000, 0x18000 );
		ROM_REGION( 0x400000, REGION_SOUND1, 0 );/* QSound samples */
		ROM_LOAD( "mb_q1.bin",      0x000000, 0x80000, 0x0630c3ce );	ROM_LOAD( "mb_q2.bin",      0x080000, 0x80000, 0x354f9c21 );	ROM_LOAD( "mb_q3.bin",      0x100000, 0x80000, 0x7838487c );	ROM_LOAD( "mb_q4.bin",      0x180000, 0x80000, 0xab66e087 );	ROM_LOAD( "mb_q5.bin",      0x200000, 0x80000, 0xc789fef2 );	ROM_LOAD( "mb_q6.bin",      0x280000, 0x80000, 0xecb81b61 );	ROM_LOAD( "mb_q7.bin",      0x300000, 0x80000, 0x041e49ba );	ROM_LOAD( "mb_q8.bin",      0x380000, 0x80000, 0x59fe702a );ROM_END(); }}; 
	...
	static RomLoadPtr rom_pnickj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "pnij09.bin",   0x000000, 0x20000, 0x48177b0a, ROM_SKIP(7) )
	...
	static RomLoadPtr rom_qad = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "qdu_09.rom", 0x000000, 0x20000, 0x8c3f9f44, ROM_SKIP(7) )
	...
	static RomLoadPtr rom_qadj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x200000, REGION_GFX1, 0 );	ROMX_LOAD( "qad01.bin",   0x000000, 0x80000, 0x9d853b57, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_qtono2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "tn2-02m.4a",   0x000000, 0x80000, 0xf2016a34, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_pang3 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x400000, REGION_GFX1, 0 );	ROMX_LOAD( "pa3-01m.2c",   0x000000, 0x100000, 0x068a152c, ROM_GROUPWORD | ROM_SKIP(6) )
		ROM_CONTINUE(              0x000004, 0x100000 );	ROMX_LOAD( "pa3-07m.2f",   0x000002, 0x100000, 0x3a4a619d, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_megaman = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x800000, REGION_GFX1, 0 );	ROMX_LOAD( "rcm_01.rom",    0x000000, 0x80000, 0x6ecdf13f, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	public static GameDriver driver_sf2	   = new GameDriver("1991"	,"sf2"	,"cps1.java"	,rom_sf2,null	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II - The World Warrior (World 910214)" )
	public static GameDriver driver_sf2ua	   = new GameDriver("1991"	,"sf2ua"	,"cps1.java"	,rom_sf2ua,driver_sf2	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II - The World Warrior (US 910206)" )
	public static GameDriver driver_sf2ub	   = new GameDriver("1991"	,"sf2ub"	,"cps1.java"	,rom_sf2ub,driver_sf2	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II - The World Warrior (US 910214)" )
	public static GameDriver driver_sf2ue	   = new GameDriver("1991"	,"sf2ue"	,"cps1.java"	,rom_sf2ue,driver_sf2	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II - The World Warrior (US 910228)" )
	public static GameDriver driver_sf2ui	   = new GameDriver("1991"	,"sf2ui"	,"cps1.java"	,rom_sf2ui,driver_sf2	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II - The World Warrior (US 910522)" )
	public static GameDriver driver_sf2j	   = new GameDriver("1991"	,"sf2j"	,"cps1.java"	,rom_sf2j,driver_sf2	,machine_driver_sf2	,input_ports_sf2j	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II - The World Warrior (Japan 911210)" )
	public static GameDriver driver_sf2ja	   = new GameDriver("1991"	,"sf2ja"	,"cps1.java"	,rom_sf2ja,driver_sf2	,machine_driver_sf2	,input_ports_sf2j	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II - The World Warrior (Japan 910214)" )
	public static GameDriver driver_sf2jc	   = new GameDriver("1991"	,"sf2jc"	,"cps1.java"	,rom_sf2jc,driver_sf2	,machine_driver_sf2	,input_ports_sf2j	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II - The World Warrior (Japan 910306)" )
	public static GameDriver driver_3wonders	   = new GameDriver("1991"	,"3wonders"	,"cps1.java"	,rom_3wonders,null	,machine_driver_cps1	,input_ports_3wonders	,init_cps1	,ROT0_16BIT	,	"Capcom", "Three Wonders (World)" )
	public static GameDriver driver_3wonderu	   = new GameDriver("1991"	,"3wonderu"	,"cps1.java"	,rom_3wonderu,driver_3wonders	,machine_driver_cps1	,input_ports_3wonders	,init_cps1	,ROT0_16BIT	,	"Capcom", "Three Wonders (US)" )
	public static GameDriver driver_wonder3	   = new GameDriver("1991"	,"wonder3"	,"cps1.java"	,rom_wonder3,driver_3wonders	,machine_driver_cps1	,input_ports_3wonders	,init_cps1	,ROT0_16BIT	,	"Capcom", "Wonder 3 (Japan)" )
	...
	public static GameDriver driver_captcomm	   = new GameDriver("1991"	,"captcomm"	,"cps1.java"	,rom_captcomm,null	,machine_driver_cps1	,input_ports_captcomm	,init_cps1	,ROT0_16BIT	,	"Capcom", "Captain Commando (World)" )
	public static GameDriver driver_captcomu	   = new GameDriver("1991"	,"captcomu"	,"cps1.java"	,rom_captcomu,driver_captcomm	,machine_driver_cps1	,input_ports_captcomm	,init_cps1	,ROT0_16BIT	,	"Capcom", "Captain Commando (US)" )
	public static GameDriver driver_captcomj	   = new GameDriver("1991"	,"captcomj"	,"cps1.java"	,rom_captcomj,driver_captcomm	,machine_driver_cps1	,input_ports_captcomm	,init_cps1	,ROT0_16BIT	,	"Capcom", "Captain Commando (Japan)" )
	public static GameDriver driver_knights	   = new GameDriver("1991"	,"knights"	,"cps1.java"	,rom_knights,null	,machine_driver_cps1	,input_ports_knights	,init_cps1	,ROT0_16BIT	,	"Capcom", "Knights of the Round (World)" )
	public static GameDriver driver_knightsu	   = new GameDriver("1991"	,"knightsu"	,"cps1.java"	,rom_knightsu,driver_knights	,machine_driver_cps1	,input_ports_knights	,init_cps1	,ROT0_16BIT	,	"Capcom", "Knights of the Round (US)" )
	public static GameDriver driver_knightsj	   = new GameDriver("1991"	,"knightsj"	,"cps1.java"	,rom_knightsj,driver_knights	,machine_driver_cps1	,input_ports_knights	,init_cps1	,ROT0_16BIT	,	"Capcom", "Knights of the Round (Japan)" )
	public static GameDriver driver_sf2ce	   = new GameDriver("1992"	,"sf2ce"	,"cps1.java"	,rom_sf2ce,null	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II' - Champion Edition (World)" )
	public static GameDriver driver_sf2ceua	   = new GameDriver("1992"	,"sf2ceua"	,"cps1.java"	,rom_sf2ceua,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II' - Champion Edition (US rev A)" )
	public static GameDriver driver_sf2ceub	   = new GameDriver("1992"	,"sf2ceub"	,"cps1.java"	,rom_sf2ceub,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II' - Champion Edition (US rev B)" )
	public static GameDriver driver_sf2cej	   = new GameDriver("1992"	,"sf2cej"	,"cps1.java"	,rom_sf2cej,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2j	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II' - Champion Edition (Japan)" )
	public static GameDriver driver_sf2rb	   = new GameDriver("1992"	,"sf2rb"	,"cps1.java"	,rom_sf2rb,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"hack",  "Street Fighter II' - Champion Edition (Rainbow set 1)" )
	public static GameDriver driver_sf2rb2	   = new GameDriver("1992"	,"sf2rb2"	,"cps1.java"	,rom_sf2rb2,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"hack",  "Street Fighter II' - Champion Edition (Rainbow set 2)" )
	public static GameDriver driver_sf2red	   = new GameDriver("1992"	,"sf2red"	,"cps1.java"	,rom_sf2red,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"hack",  "Street Fighter II' - Champion Edition (Red Wave)" )
	public static GameDriver driver_sf2v004	   = new GameDriver("1992"	,"sf2v004"	,"cps1.java"	,rom_sf2v004,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"hack",  "Street Fighter II! - Champion Edition (V004)" )
	public static GameDriver driver_sf2accp2	   = new GameDriver("1992"	,"sf2accp2"	,"cps1.java"	,rom_sf2accp2,driver_sf2ce	,machine_driver_sf2accp2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"hack",  "Street Fighter II' - Champion Edition (Accelerator Pt.II)" )
	...
	public static GameDriver driver_cworld2j	   = new GameDriver("1992"	,"cworld2j"	,"cps1.java"	,rom_cworld2j,null	,machine_driver_cps1	,input_ports_cworld2j	,init_cps1	,ROT0_16BIT	,	"Capcom", "Capcom World 2 (Japan)" )
	public static GameDriver driver_sf2t	   = new GameDriver("1992"	,"sf2t"	,"cps1.java"	,rom_sf2t,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II' - Hyper Fighting (US)" )
	public static GameDriver driver_sf2tj	   = new GameDriver("1992"	,"sf2tj"	,"cps1.java"	,rom_sf2tj,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2j	,init_cps1	,ROT0_16BIT	,	"Capcom", "Street Fighter II' Turbo - Hyper Fighting (Japan)" )
	...
	public static GameDriver driver_megaman	   = new GameDriver("1995"	,"megaman"	,"cps1.java"	,rom_megaman,null	,machine_driver_cps1	,input_ports_megaman	,init_cps1	,ROT0_16BIT	,	"Capcom", "Mega Man - The Power Battle (Asia)" )
	public static GameDriver driver_rockmanj	   = new GameDriver("1995"	,"rockmanj"	,"cps1.java"	,rom_rockmanj,driver_megaman	,machine_driver_cps1	,input_ports_megaman	,init_cps1	,ROT0_16BIT	,	"Capcom", "Rockman - The Power Battle (Japan)" )
	...
	public static GameDriver driver_pang3	   = new GameDriver("1995"	,"pang3"	,"cps1.java"	,rom_pang3,null	,machine_driver_pang3	,input_ports_pang3	,init_cps1	,ROT0_16BIT	,	"Mitchell", "Pang! 3 (Euro)" )
