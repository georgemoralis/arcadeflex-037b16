...
public class segac2
{
	...
	******************************************************************************/
	...
	static WRITE16_HANDLER( control_w )
	{
		...
		if (data != 6 && data != 7)
			if (LOG_IOCHIP != 0) logerror("%06x:control_w suspicious value = %02X (%d)\n", cpu_getpreviouspc(), data, cpu_getscanline());
	}
	...
	******************************************************************************/
	...
	static InputPortPtr input_ports_columns = new InputPortPtr(){ public void handler() {  /* Columns Input Ports */
		...
		PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );    JOYSTICK_1
	
		PORT_START(); 		/* Player 2 Controls */
	    PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );   // Button 'Rotate'
	    PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNUSED                );   // Button 2 Unused
	    PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED                );   // Button 3 Unused
		PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );    JOYSTICK_2
	...
	static InputPortPtr input_ports_columns2 = new InputPortPtr(){ public void handler() {  /* Columns 2 Input Ports */
		...
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x0c, 0x0c, "VS. Mode Credits/Match" );	PORT_DIPSETTING(    0x0c, "1" );	PORT_DIPSETTING(    0x08, "2" );	PORT_DIPSETTING(    0x04, "3" );	PORT_DIPSETTING(    0x00, "4" );	PORT_DIPNAME( 0x30, 0x30, "Flash Mode Difficulty" );	PORT_DIPSETTING(    0x20, "Easy" );    PORT_DIPSETTING(    0x30, "Medium" );	PORT_DIPSETTING(    0x10, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );    PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unused") );
	    PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
	    PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	static InputPortPtr input_ports_borench = new InputPortPtr(){ public void handler() {  /* Borench Input Ports */
		...
		PORT_START(); 		 /* Game Options */
		PORT_DIPNAME( 0x01, 0x01, "Credits to Start" );	PORT_DIPSETTING(    0x01, "1" );	PORT_DIPSETTING(    0x00, "2" );    PORT_DIPNAME( 0x02, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	    PORT_DIPNAME( 0x0c, 0x0c, "Lives 1P Mode" );	PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x0c, "2" );	PORT_DIPSETTING(    0x08, "3" );	PORT_DIPSETTING(    0x04, "4" );    PORT_DIPNAME( 0x30, 0x30, "Lives 2P Mode" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_DIPNAME( 0xc0, 0xc0, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x80, "Easy" );    PORT_DIPSETTING(    0xc0, "Medium" );	PORT_DIPSETTING(    0x40, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );INPUT_PORTS_END(); }}; 
	...
	static InputPortPtr input_ports_tfrceac = new InputPortPtr(){ public void handler() {  /* ThunderForce AC Input Ports */
		...
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x0c, "3" );	PORT_DIPSETTING(    0x08, "4" );	PORT_DIPSETTING(    0x04, "5" );	PORT_DIPNAME( 0x30, 0x30,  DEF_STR( "Bonus_Life") );
	    PORT_DIPSETTING(    0x10, "10k, 70k, 150k" );    PORT_DIPSETTING(    0x30, "20k, 100k, 200k" );    PORT_DIPSETTING(    0x20, "40k, 150k, 300k" );    PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0xc0, 0xc0, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x80, "Easy" );    PORT_DIPSETTING(    0xc0, "Medium" );	PORT_DIPSETTING(    0x40, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );INPUT_PORTS_END(); }}; 
	...
	static InputPortPtr input_ports_puyopuyo = new InputPortPtr(){ public void handler() {  /* PuyoPuyo Input Ports */
	    ...
	    PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 );       // Button 'Rotate'
	    PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNUSED  );       // Button 2 Unused == Button 1
	    PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED  );    PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );    JOYSTICK_1
		...
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, "VS. Mode Credits/Match" );	PORT_DIPSETTING(    0x04, "1" );	PORT_DIPSETTING(    0x00, "3" );	PORT_DIPNAME( 0x18, 0x18, "1P Mode Difficulty" );	PORT_DIPSETTING(    0x10, "Easy" );    PORT_DIPSETTING(    0x18, "Medium" );	PORT_DIPSETTING(    0x08, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );    PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Unused") );
	    PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
	    PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	    PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unused") );
	    PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
	    PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, "Moving Seat" );	PORT_DIPSETTING(    0x80, "No Use" );	PORT_DIPSETTING(    0x00, "In Use" );INPUT_PORTS_END(); }}; 
	...
	static InputPortPtr input_ports_stkclmns = new InputPortPtr(){ public void handler() {  /* Stack Columns Input Ports */
		...
		PORT_DIPSETTING(    0x02, "Easy" );    PORT_DIPSETTING(    0x03, "Medium" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );    PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, "Match Mode Price" );	PORT_DIPSETTING(    0x08, "1" );	PORT_DIPSETTING(    0x00, "2" );    PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unused") );
	...
	static InputPortPtr input_ports_potopoto = new InputPortPtr(){ public void handler() {  /* PotoPoto Input Ports */
		...
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, "Coin Chute Type" );	PORT_DIPSETTING(    0x04, "Common" );	PORT_DIPSETTING(    0x00, "Individual" );	PORT_DIPNAME( 0x08, 0x08, "Credits to Continue" );	PORT_DIPSETTING(    0x08, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPNAME( 0x10, 0x10, "Buy-In" );	PORT_DIPSETTING(    0x10, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x40, "Easy" );    PORT_DIPSETTING(    0x60, "Medium" );	PORT_DIPSETTING(    0x20, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x80, 0x80, "Moving Seat" );	PORT_DIPSETTING(    0x80, "No Use" );	PORT_DIPSETTING(    0x00, "In Use" );INPUT_PORTS_END(); }}; 
	...
	static InputPortPtr input_ports_zunkyou = new InputPortPtr(){ public void handler() {  /* ZunkYou Input Ports */
		...
		PORT_START(); 		 /* Game Options */
		PORT_DIPNAME( 0x01, 0x01, "Game Difficulty 1" );    PORT_DIPSETTING(    0x01, "Medium" );	PORT_DIPSETTING(    0x00, "Hard" );	PORT_DIPNAME( 0x02, 0x02, "Game Difficulty 2" );    PORT_DIPSETTING(    0x02, "Medium" );	PORT_DIPSETTING(    0x00, "Hard" );    PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x08, "1" );	PORT_DIPSETTING(    0x04, "2" );	PORT_DIPSETTING(    0x0c, "3" );	PORT_DIPSETTING(    0x00, "5" );    PORT_DIPNAME( 0x10, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	    PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Unused") );
	    PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
	...
	static InputPortPtr input_ports_ichidant = new InputPortPtr(){ public void handler() {  /*  Ichidant-R and Tant-R Input Ports */
	    ...
	    PORT_DIPSETTING(    0x04, "Easy" );    PORT_DIPSETTING(    0x06, "Medium" );    PORT_DIPSETTING(    0x02, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );    PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Unused") );
	    PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
	    PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	static InputPortPtr input_ports_bloxeedc = new InputPortPtr(){ public void handler() {  /*  Bloxeed Input Ports */
		...
		PORT_START(); 		 /* Game Options */
	    PORT_DIPNAME( 0x01, 0x01, "VS Mode Price" );    PORT_DIPSETTING(    0x00, "Same as Ordinary" );    PORT_DIPSETTING(    0x01, "Double as Ordinary" );    PORT_DIPNAME( 0x02, 0x02, "Credits to Start" );    PORT_DIPSETTING(    0x02, "1" );	PORT_DIPSETTING(    0x00, "2" );    PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Unknown") );
	    PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	static InputPortPtr input_ports_puyopuy2 = new InputPortPtr(){ public void handler() {  /*  Puyo Puyo 2 Input Ports */
		...
		PORT_START(); 		/* Player 2 Controls */
	    PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );    PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );    PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED  );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );    JOYSTICK_2
		...
		PORT_START(); 		 /* Game Options */
	    PORT_DIPNAME( 0x01, 0x01, "Rannyu Off Button" );    PORT_DIPSETTING(    0x01, "Use" );    PORT_DIPSETTING(    0x00, "No Use" );    PORT_DIPNAME( 0x02, 0x00, DEF_STR( "Demo_Sounds") );
	    PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	    PORT_DIPNAME( 0x04, 0x04, "Turn Direction" );    PORT_DIPSETTING(    0x04, "1:Right  2:Left" );    PORT_DIPSETTING(    0x00, "1:Left  2:Right");    PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Difficulty") );
	    PORT_DIPSETTING(    0x10, "Easy" );    PORT_DIPSETTING(    0x18, "Medium" );    PORT_DIPSETTING(    0x08, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );    PORT_DIPNAME( 0x60, 0x60, "VS Mode Match/1 Play" );    PORT_DIPSETTING(    0x60, "1" );    PORT_DIPSETTING(    0x40, "2" );    PORT_DIPSETTING(    0x20, "3" );    PORT_DIPSETTING(    0x00, "4" );    PORT_DIPNAME( 0x80, 0x80, "Battle Start credit" );    PORT_DIPSETTING(    0x00, "1" );    PORT_DIPSETTING(    0x80, "2" );INPUT_PORTS_END(); }}; 
	...
	******************************************************************************/
	...
	static UPD7759_interface upd7759_intf = new UPD7759_interface
	(
		1,								/* One chip */
		MASTER_CLOCK/14,				/* Clock (unsure) */
		new int[] { 50 },							/* Volume */
		new int[] { REGION_SOUND1 },				/* Memory pointer (gen.h) */
	...
	******************************************************************************/
	...
	static MachineDriver machine_driver_segac = new MachineDriver
	(
		/* machine hardware */
		new MachineCPU[] {
			new MachineCPU(
		...
		/* video hardware */
		336,224, new rectangle( 8, 327, 0, 223 ),
		NULL,
		0x1800, 0x1800,
		NULL,
		...
		0,0,0,0,
		new MachineSound[] {
			new MachineSound( SOUND_YM2612, ym3438_intf ),
			new MachineSound( SOUND_SN76496, sn76489_intf )
		},
		0
	);
	
	static MachineDriver machine_driver_segac2 = new MachineDriver
	(
		/* machine hardware */
		new MachineCPU[] {
			new MachineCPU(
		...
		new MachineSound[] {
			new MachineSound( SOUND_YM2612, ym3438_intf ),
			new MachineSound( SOUND_SN76496, sn76489_intf ),
			new MachineSound( SOUND_UPD7759, upd7759_intf )
		},
		0
	);
	...
	******************************************************************************/
	...
	static RomLoadPtr rom_bloxeedc = new RomLoadPtr(){ public void handler(){  /* Bloxeed (C System Version)  (c)1989 Sega / Elorg */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "12908.bin", 0x000000, 0x020000, 0xfc77cb91 )
	...
	static RomLoadPtr rom_columns = new RomLoadPtr(){ public void handler(){  /* Columns (US) (c)1990 Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "ic32.bin", 0x000000, 0x020000, 0xff78f740 )
	...
	static RomLoadPtr rom_columnsj = new RomLoadPtr(){ public void handler(){  /* Columns (Jpn) (c)1990 Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "epr13112.32", 0x000000, 0x020000, 0xbae6e53e )
	...
	static RomLoadPtr rom_columns2 = new RomLoadPtr(){ public void handler(){  /* Columns II - The Voyage Through Time (Jpn)  (c)1990 Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "epr13361.rom", 0x000000, 0x020000, 0xb54b5f12 )
	...
	static RomLoadPtr rom_tantrbl2 = new RomLoadPtr(){ public void handler(){  /* Tant-R (Puzzle & Action) (Alt Bootleg Running on C Board?, No Samples) */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "trb2_2.32",    0x000000, 0x080000, 0x8fc99c48 )
	...
	static RomLoadPtr rom_borench = new RomLoadPtr(){ public void handler(){  /* Borench  (c)1990 Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "ic32.bin", 0x000000, 0x040000, 0x2c54457d )
		ROM_LOAD16_BYTE( "ic31.bin", 0x000001, 0x040000, 0xb46445fc )
	
		ROM_REGION( 0x020000, REGION_SOUND1, 0 );	ROM_LOAD( "ic4.bin", 0x000000, 0x020000, 0x62b85e56 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_tfrceac = new RomLoadPtr(){ public void handler(){  /* ThunderForce AC  (c)1990 Technosoft / Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "ic32.bin", 0x000000, 0x040000, 0x95ecf202 )
		...
		ROM_REGION( 0x040000, REGION_SOUND1, 0 );	ROM_LOAD( "ic4.bin", 0x000000, 0x040000, 0xe09961f6 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_tfrceacj = new RomLoadPtr(){ public void handler(){  /* ThunderForce AC (Jpn)  (c)1990 Technosoft / Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "epr13657.32", 0x000000, 0x040000, 0xa0f38ffd )
	...
	static RomLoadPtr rom_tfrceacb = new RomLoadPtr(){ public void handler(){  /* ThunderForce AC (Bootleg)  (c)1990 Technosoft / Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "4.bin",    0x000000, 0x040000, 0xeba059d3 )
		ROM_LOAD16_BYTE( "3.bin",    0x000001, 0x040000, 0x3e5dc542 )
		/* 0x080000 - 0x100000 Empty */
		ROM_LOAD16_BYTE( "ic34.bin", 0x100000, 0x040000, 0x29f23461 )
		ROM_LOAD16_BYTE( "ic33.bin", 0x100001, 0x040000, 0x9e23734f )
	
		ROM_REGION( 0x040000, REGION_SOUND1, 0 );	ROM_LOAD( "2.bin", 0x000000, 0x020000, 0x00000000 );	ROM_LOAD( "1.bin", 0x020000, 0x020000, 0x4e2ca65a );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_tantr = new RomLoadPtr(){ public void handler(){  /* Tant-R (Puzzle & Action)  (c)1992 Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "epr15614.32", 0x000000, 0x080000, 0x557782bc )
		ROM_LOAD16_BYTE( "epr15613.31", 0x000001, 0x080000, 0x14bbb235 )
		ROM_LOAD16_BYTE( "mpr15616.34", 0x100000, 0x080000, 0x17b80202 )
		ROM_LOAD16_BYTE( "mpr15615.33", 0x100001, 0x080000, 0x36a88bd4 )
	
		ROM_REGION( 0x040000, REGION_SOUND1, 0 );	ROM_LOAD( "epr15617.4", 0x000000, 0x040000, 0x338324a1 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_tantrbl = new RomLoadPtr(){ public void handler(){  /* Tant-R (Puzzle & Action) (Bootleg)  (c)1992 Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "pa_e10.bin",  0x000000, 0x080000, 0x6c3f711f )
		ROM_LOAD16_BYTE( "pa_f10.bin",  0x000001, 0x080000, 0x75526786 )
		ROM_LOAD16_BYTE( "mpr15616.34", 0x100000, 0x080000, 0x17b80202 )
		ROM_LOAD16_BYTE( "mpr15615.33", 0x100001, 0x080000, 0x36a88bd4 )
	
		ROM_REGION( 0x040000, REGION_SOUND1, 0 );	ROM_LOAD( "pa_e03.bin", 0x000000, 0x020000, 0x72918c58 );	ROM_LOAD( "pa_e02.bin", 0x020000, 0x020000, 0x4e85b2a3 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_puyopuyo = new RomLoadPtr(){ public void handler(){  /* Puyo Puyo  (c)1992 Sega / Compile */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "epr15036", 0x000000, 0x020000, 0x5310ca1b )
		...
		ROM_REGION( 0x020000, REGION_SOUND1, 0 );	ROM_LOAD( "epr15034", 0x000000, 0x020000, 0x5688213b );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_puyopuya = new RomLoadPtr(){ public void handler(){  /* Puyo Puyo (Rev A)  (c)1992 Sega / Compile */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "ep15036a.32", 0x000000, 0x020000, 0x61b35257 )
	...
	static RomLoadPtr rom_puyopuyb = new RomLoadPtr(){ public void handler(){  /* Puyo Puyo  (c)1992 Sega / Compile  Bootleg */
	 ROM_REGION( 0x200000, REGION_CPU1, 0 ); ROM_LOAD16_BYTE( "puyopuyb.4bo", 0x000000, 0x020000, 0x89ea4d33 )
	 ...
	 ROM_REGION( 0x020000, REGION_SOUND1, 0 ); ROM_LOAD( "puyopuyb.abo", 0x000000, 0x020000, 0x79112b3b );ROM_END(); }}; 
	
	static RomLoadPtr rom_ichidant = new RomLoadPtr(){ public void handler(){  /* Ichident-R (Puzzle & Action 2)  (c)1994 Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "epr16886", 0x000000, 0x080000, 0x38208e28 )
		...
		ROM_REGION( 0x080000, REGION_SOUND1, 0 );	ROM_LOAD( "epr16884", 0x000000, 0x080000, 0xfd9dcdd6);ROM_END(); }}; 
	
	
	static RomLoadPtr rom_ichidnte = new RomLoadPtr(){ public void handler(){  /* Ichident-R (Puzzle & Action 2)  (c)1994 Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "pa2_32.bin", 0x000000, 0x080000, 0x7ba0c025 )
		ROM_LOAD16_BYTE( "pa2_31.bin", 0x000001, 0x080000, 0x5f86e5cc )
		ROM_LOAD16_BYTE( "epr16888",   0x100000, 0x080000, 0x85d73722 )
		ROM_LOAD16_BYTE( "epr16887",   0x100001, 0x080000, 0xbc3bbf25 )
	
		ROM_REGION( 0x080000, REGION_SOUND1, 0 );	ROM_LOAD( "pa2_02.bin", 0x000000, 0x080000, 0xfc7b0da5 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_stkclmns = new RomLoadPtr(){ public void handler(){  /* Stack Columns  (c)1994 Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "epr16795.32", 0x000000, 0x080000, 0xb478fd02 )
		...
		ROM_REGION( 0x020000, REGION_SOUND1, 0 );	ROM_LOAD( "epr16793.4", 0x000000, 0x020000, 0xebb2d057 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_puyopuy2 = new RomLoadPtr(){ public void handler(){  /* Puyo Puyo 2  (c)1994 Compile */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "pp2.eve", 0x000000, 0x080000, 0x1cad1149 )
		ROM_LOAD16_BYTE( "pp2.odd", 0x000001, 0x080000, 0xbeecf96d )
	
		ROM_REGION( 0x080000, REGION_SOUND1, 0 );	ROM_LOAD( "pp2.snd", 0x000000, 0x080000, 0x020ff6ef );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_potopoto = new RomLoadPtr(){ public void handler(){  /* Poto Poto  (c)1994 Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "epr16662", 0x000000, 0x040000, 0xbbd305d6 )
		ROM_LOAD16_BYTE( "epr16661", 0x000001, 0x040000, 0x5a7d14f4 )
	
		ROM_REGION( 0x040000, REGION_SOUND1, 0 );	ROM_LOAD( "epr16660", 0x000000, 0x040000, 0x8251c61c );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_zunkyou = new RomLoadPtr(){ public void handler(){  /* Zunzunkyou No Yabou  (c)1994 Sega */
		ROM_REGION( 0x200000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "epr16812.32", 0x000000, 0x080000, 0xeb088fb0 )
		...
		ROM_REGION( 0x080000, REGION_SOUND1, 0 );	ROM_LOAD( "epr16810.4", 0x000000, 0x080000, 0xd542f0fe );ROM_END(); }}; 
