...
public class taitoair
{
	...
	************************************************************/
	...
	PORT_START();   /* DSWA */
		...
		PORT_DIPSETTING(    0x02, "Mechanized" );	PORT_DIPSETTING(    0x03, "Standard" );	PORT_SERVICE( 0x04, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Demo_Sounds") );
		...
		PORT_BIT( 0x08, IP_ACTIVE_LOW,  IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW,  IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW,  IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON4 | IPF_PLAYER1 );/* freeze ??? */
		...
		PORT_ANALOG( 0xffff, 0x0000, IPT_AD_STICK_Y | IPF_PLAYER2, 30, 40, 0xf800, 0x7ff );INPUT_PORTS_END(); }}; 
	...
	************************************************************/
	...
	static YM2610interface airsys_ym2610_interface = new YM2610interface
	(
		1,	/* 1 chip */
		8000000,	/* 4 MHz */
		new int[] { 30 },
	...
	*************************************************************/
	...
	static RomLoadPtr rom_topland = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "b62-42.34", 0x00000, 0x04000, 0x389230e0 );	ROM_CONTINUE(          0x10000, 0x0c000 );
		/* Plus a TMS320C25 */
		...
		ROM_LOAD( "b62-13.1",  0x00000, 0x20000, 0xb37dc3ea );	ROM_LOAD( "b62-14.2",  0x20000, 0x20000, 0x617948a3 );	ROM_LOAD( "b62-15.3",  0x40000, 0x20000, 0xe35ffe81 );	ROM_LOAD( "b62-16.4",  0x60000, 0x20000, 0x203a5c27 );	ROM_LOAD( "b62-17.5",  0x80000, 0x20000, 0x36447066 );
	...
	static RomLoadPtr rom_ainferno = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1c000, REGION_CPU2, 0 );/* Z80 */
		ROM_LOAD( "c45-23.34", 0x00000, 0x04000, 0xd0750c78 );	ROM_CONTINUE(          0x10000, 0x0c000 );
		/* Plus a TMS320C25 */
		...
		ROM_REGION( 0xa0000, REGION_SOUND1, 0 );/* ADPCM samples */
		ROM_LOAD( "c45-01.5",  0x00000, 0x20000, 0x052997b2 );	ROM_LOAD( "c45-02.4",  0x20000, 0x20000, 0x2fc0a88e );	ROM_LOAD( "c45-03.3",  0x40000, 0x20000, 0x0e1e5b5f );	ROM_LOAD( "c45-04.2",  0x60000, 0x20000, 0x6d081044 );	ROM_LOAD( "c45-05.1",  0x80000, 0x20000, 0x6c59a808 );
		ROM_REGION( 0x20000, REGION_SOUND2, 0 );/* Delta-T samples */
