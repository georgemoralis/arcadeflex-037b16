...
public class gaiden
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_START();       /* PLAYER */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 | IPF_8WAY );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 | IPF_8WAY );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 | IPF_8WAY );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 | IPF_8WAY );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* DSW */
		...
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x3000, 0x3000, "Energy" );	PORT_DIPSETTING(      0x0000, "2" );	PORT_DIPSETTING(      0x3000, "3" );	PORT_DIPSETTING(      0x1000, "4" );	PORT_DIPSETTING(      0x2000, "5" );	PORT_DIPNAME( 0xc000, 0xc000, DEF_STR( "Lives") );
		PORT_DIPSETTING(      0x0000, "1" );	PORT_DIPSETTING(      0xc000, "2" );	PORT_DIPSETTING(      0x4000, "3" );	PORT_DIPSETTING(      0x8000, "4" );INPUT_PORTS_END(); }}; 
	
	static InputPortPtr input_ports_tknight = new InputPortPtr(){ public void handler() { 
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_START();       /* PLAYER */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 | IPF_8WAY );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 | IPF_8WAY );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 | IPF_8WAY );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 | IPF_8WAY );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* DSW */
		PORT_DIPNAME( 0x0001, 0x0001, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0001, DEF_STR( "On") );
		...
		PORT_DIPSETTING(      0x8000, "1" );	PORT_DIPSETTING(      0xc000, "2" );	PORT_DIPSETTING(      0x4000, "3" );/*	PORT_DIPSETTING(      0x0000, "2" );*/
	INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_gaiden = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x010000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "gaiden.5",     0x000000, 0x10000, 0x8d4035f7 );/* 8x8 tiles */
	
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "14.bin",       0x000000, 0x20000, 0x1ecfddaa );	ROM_LOAD( "15.bin",       0x020000, 0x20000, 0x1291a696 );	ROM_LOAD( "16.bin",       0x040000, 0x20000, 0x140b47ca );	ROM_LOAD( "17.bin",       0x060000, 0x20000, 0x7638cccb );
		ROM_REGION( 0x080000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "18.bin",       0x000000, 0x20000, 0x3fadafd6 );	ROM_LOAD( "19.bin",       0x020000, 0x20000, 0xddae9d5b );	ROM_LOAD( "20.bin",       0x040000, 0x20000, 0x08cf7a93 );	ROM_LOAD( "21.bin",       0x060000, 0x20000, 0x1ac892f5 );
		ROM_REGION( 0x100000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "gaiden.6",     0x000000, 0x20000, 0xe7ccdf9f );/* sprites A1 */
	...
	static RomLoadPtr rom_ryukendn = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x010000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "ryukendn.5",   0x000000, 0x10000, 0x765e7baa );/* 8x8 tiles */
	...
	static RomLoadPtr rom_tknight = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x010000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "tkni5.bin",    0x000000, 0x10000, 0x5ed15896 );/* 8x8 tiles */
	
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "tkni7.bin",    0x000000, 0x80000, 0x4b4d4286 );
		ROM_REGION( 0x080000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "tkni6.bin",    0x000000, 0x80000, 0xf68fafb1 );
		ROM_REGION( 0x100000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "tkni9.bin",    0x000000, 0x80000, 0xd22f4239 );/* sprites */
	...
	static RomLoadPtr rom_wildfang = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "14.3a",        0x000000, 0x20000, 0x0d20c10c );	ROM_LOAD( "15.3b",        0x020000, 0x20000, 0x3f40a6b4 );	ROM_LOAD( "16.1a",        0x040000, 0x20000, 0x0f31639e );	ROM_LOAD( "17.1b",        0x060000, 0x20000, 0xf32c158e );
		ROM_REGION( 0x080000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "tkni6.bin",    0x000000, 0x80000, 0xf68fafb1 );
		ROM_REGION( 0x100000, REGION_GFX4, ROMREGION_DISPOSE );	ROM_LOAD( "tkni9.bin",    0x000000, 0x80000, 0xd22f4239 );/* sprites */
		ROM_LOAD( "tkni8.bin",    0x080000, 0x80000, 0x4931b184 );/* sprites */
