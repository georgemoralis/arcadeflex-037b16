...
public class cloak
{
	...
	public static Memory_ReadAddress readmem2[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x0007, MRA_RAM ),
	...
	public static Memory_WriteAddress writemem2[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x0007, MWA_RAM ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_cloak = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD( "136023.305",   0x0000, 0x1000, 0xee443909 );	ROM_LOAD( "136023.306",   0x1000, 0x1000, 0xd708b132 );
		ROM_REGION( 0x2000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "136023.307",   0x0000, 0x1000, 0xc42c84a4 );	ROM_LOAD( "136023.308",   0x1000, 0x1000, 0x4fe13d58 );ROM_END(); }}; 
