...
public class shangkid
{
	...
	extern void shangkid_vh_convert_color_prom(UBytePtr palette,unsigned short *colortable,const UBytePtr color_prom);
	extern extern extern void shangkid_screenrefresh( struct osd_bitmap *bitmap, int fullfresh );
	...
	*/
	...
	public static IO_WritePort bbx_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, shangkid_bbx_AY8910_control_w ),
	...
	public static Memory_ReadAddress sound_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0xdfff, MRA_BANK2 ),
		new Memory_ReadAddress( 0xe000, 0xefff, MRA_RAM ),
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	public static Memory_WriteAddress sound_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0xdfff, MWA_NOP ), /* sample player writes to ROM area */
		new Memory_WriteAddress( 0xe000, 0xefff, MWA_RAM ),
		new Memory_WriteAddress(MEMPORT_MARKER, 0)
	};
	public static IO_ReadPort readport_sound[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x00, shangkid_soundlatch_r ),
	...
	public static IO_WritePort dynamski_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	/* ports are reversed */
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_SERVICE1 );/* service */
		PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 
	...
	PORT_START(); 
		...
		PORT_DIPSETTING(	0x01, "3" );	PORT_DIPSETTING(	0x02, "4" );	PORT_DIPSETTING(	0x03, "5" );	PORT_BITX( 0,0x00, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite",0,0 );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(	0x00, DEF_STR( "Off") );
		...
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_SERVICE1 );/* service */
		PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_4WAY | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_4WAY | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_4WAY | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_4WAY | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_BUTTON4 | IPF_PLAYER2 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_4WAY );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_4WAY );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_4WAY );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_4WAY );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON3 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_BUTTON4 );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 
		...
		*/
		...
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_SERVICE1 );/* service */
		PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );/* busy flag? */
	
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );/* kick */
		PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER2 );/* punch */
		PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON1 );/* kick */
		PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_BUTTON2 );/* punch */
		PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN );INPUT_PORTS_END(); }}; 
	
	/***************************************************************************************/
	
	static RomLoadPtr rom_chinhero = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );/* Z80 code (main) */
		ROM_LOAD( "ic2.1",		0x0000, 0x2000, 0x8974bac4 );	ROM_LOAD( "ic3.2",		0x2000, 0x2000, 0x9b7a02fe );	ROM_LOAD( "ic4.3",		0x4000, 0x2000, 0xe86d4195 );	ROM_LOAD( "ic5.4",		0x6000, 0x2000, 0x2b629d2c );	ROM_LOAD( "ic6.5",		0x8000, 0x2000, 0x35bf4a4f );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );/* Z80 code (coprocessor) */
		ROM_LOAD( "ic31.6",		0x0000, 0x2000, 0x7c56927b );	ROM_LOAD( "ic32.7",		0x2000, 0x2000, 0xd67b8045 );
		ROM_REGION( 0x10000, REGION_CPU3, 0 );/* Z80 code (sound) */
		ROM_LOAD( "ic47.8",		0x0000, 0x2000, 0x3c396062 );	ROM_LOAD( "ic48.9",		0x2000, 0x2000, 0xb14f2bab );	ROM_LOAD( "ic49.10",	0x4000, 0x2000, 0x8c0e43d1 );
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE|ROMREGION_INVERT );/* tiles */
		ROM_LOAD( "ic21.11",	0x0000,0x2000,0x3a37fb45 );	ROM_LOAD( "ic22.12",	0x2000,0x2000,0xbc21c002 );
		ROM_REGION( 0x6000, REGION_GFX2, ROMREGION_DISPOSE|ROMREGION_INVERT );/* sprites */
		ROM_LOAD( "ic114.18",	0x0000,0x2000,0xfc4183a8 );	ROM_LOAD( "ic113.17",	0x2000,0x2000,0xd713d7fe );	ROM_LOAD(  "ic99.13",	0x4000,0x2000,0xa8e2a3f4 );
		ROM_REGION( 0x6000, REGION_GFX3, ROMREGION_DISPOSE|ROMREGION_INVERT );/* sprites */
		ROM_LOAD( "ic112.16",	0x0000,0x2000,0xdd5170ca );	ROM_LOAD( "ic111.15",	0x2000,0x2000,0x20f6052e );	ROM_LOAD( "ic110.14",	0x4000,0x2000,0x9bc2d568 );
		ROM_REGION( 0xa80, REGION_PROMS, 0 );	ROM_LOAD( "v_ic36_r",	0x000,0x100,0x16ae1692 );/* red */
	...
	static RomLoadPtr rom_shangkid = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "cr00ic02.bin", 0x00000, 0x4000, 0x2e420377 );	ROM_LOAD( "cr01ic03.bin", 0x04000, 0x4000, 0x161cd358 );	ROM_LOAD( "cr02ic04.bin", 0x08000, 0x2000, 0x85b6e455 );/* banked at 0x8000 */
		...
		*/
		...
		ROM_LOAD( "cr04ic31.bin", 0x2000, 0x2000, 0xcb207885 );	ROM_LOAD( "cr05ic32.bin", 0x4000, 0x4000, 0xcf3b8d55 );	ROM_LOAD( "cr06ic33.bin", 0x8000, 0x2000, 0x0f3bdbd8 );
		/*	The Sound CPU is a dedicated Sample Player */
		ROM_REGION( 0x1e000, REGION_CPU3, 0 );/* Z80 (NEC D780C-1) */
		ROM_LOAD( "cr11ic51.bin", 0x00000, 0x4000, 0x2e2d6afe );	ROM_LOAD( "cr12ic43.bin", 0x04000, 0x4000, 0xdd29a0c8 );	ROM_LOAD( "cr13ic44.bin", 0x08000, 0x4000, 0x879d0de0 );	ROM_LOAD( "cr07ic47.bin", 0x10000, 0x4000, 0x20540f7c );	ROM_LOAD( "cr08ic48.bin", 0x14000, 0x2000, 0x392f24db );	ROM_LOAD( "cr09ic49.bin", 0x18000, 0x4000, 0xd50c96a8 );	ROM_LOAD( "cr10ic50.bin", 0x1c000, 0x2000, 0x873a5f2d );
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE|ROMREGION_INVERT );/* 8x8 tiles */
		ROM_LOAD( "cr20ic21.bin", 0x0000, 0x2000, 0xeb3cbb11 );	ROM_LOAD( "cr21ic22.bin", 0x2000, 0x2000, 0x7c6e75f4 );
		ROM_REGION( 0x18000, REGION_GFX2, ROMREGION_DISPOSE|ROMREGION_INVERT );/* 16x16 sprites */
		ROM_LOAD( "cr14i114.bin", 0x00000, 0x4000, 0xee1f348f );	ROM_LOAD( "cr15i113.bin", 0x04000, 0x4000, 0xa46398bd );	ROM_LOAD( "cr16i112.bin", 0x08000, 0x4000, 0xcbed446c );	ROM_LOAD( "cr17i111.bin", 0x0c000, 0x4000, 0xb0a44330 );	ROM_LOAD( "cr18ic99.bin", 0x10000, 0x4000, 0xff7efd7c );	ROM_LOAD( "cr19i100.bin", 0x14000, 0x4000, 0xf948f829 );
		ROM_REGION( 0xa80, REGION_PROMS, 0 );	ROM_LOAD( "cr31ic36.bin",	0x000, 256,0x9439590b );	/* 82S129 - red */
	...
	static RomLoadPtr rom_dynamski = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "dynski.2", 0x01000, 0x1000, 0x5e08a0b0 );	ROM_LOAD( "dynski.3", 0x02000, 0x1000, 0x29cfd740 );	ROM_LOAD( "dynski.4", 0x03000, 0x1000, 0xe1d47776 );	ROM_LOAD( "dynski.5", 0x04000, 0x1000, 0xe39aba1b );	ROM_LOAD( "dynski.6", 0x05000, 0x1000, 0x95780608 );	ROM_LOAD( "dynski.7", 0x06000, 0x1000, 0xb88d328b );	ROM_LOAD( "dynski.8", 0x07000, 0x1000, 0x8db5e691 );
		ROM_REGION( 0x4000, REGION_GFX1, ROMREGION_DISPOSE|ROMREGION_INVERT );/* 8x8 tiles */
		ROM_LOAD( "dynski8.3e",  0x0000, 0x2000, 0x32c354dc );	ROM_LOAD( "dynski9.2e",  0x2000, 0x2000, 0x80a6290c );
		ROM_REGION( 0x6000, REGION_GFX2, ROMREGION_DISPOSE|ROMREGION_INVERT );/* 16x16 sprites */
		ROM_LOAD( "dynski5.14b", 0x0000, 0x2000, 0xaa4ac6e2 );	ROM_LOAD( "dynski6.15b", 0x2000, 0x2000, 0x47e76886 );	ROM_LOAD( "dynski7.14d", 0x4000, 0x2000, 0xa153dfa9 );
		ROM_REGION( 0xa80, REGION_PROMS, 0 );	ROM_LOAD( "dynski.11e",		0x000, 256,0xe625aa09 );	ROM_LOAD( "dynski.4g",		0x100, 256,0x761fe465 );	ROM_LOAD( "dynskic.15f",	0x200, 256,0 /*0x025996b1*/ );	ROM_LOAD( "dynskic.15g",	0x300, 256,0 /*0x025996b1*/ );ROM_END(); }}; 
