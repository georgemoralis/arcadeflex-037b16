...
public class cps2
{
	...
	*/
	...
	static EEPROM_interface cps2_eeprom_interface = new EEPROM_interface
	(
		6,		/* address bits */
		16,		/* data bits */
		"0110",	/*  read command */
	...
	public static nvramPtr cps2_nvram_handler  = new nvramPtr() { public void handler(Object file, int read_or_write) 
	{
		if (read_or_write != 0)
			EEPROM_save(file);
		else
	...
	public static InitDriverPtr init_cps2_memory = new InitDriverPtr() { public void handler() 
	{
    ...
    PORT_START();       /* IN0 (0x00) */
	    ...
	    PORT_START();       /* IN1 (0x10) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNKNOWN );
	    PORT_START();       /* IN2 (0x20) */
	    ...
	    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_SERVICE1 );    PORT_BIT( 0x00f8, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );    PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );    PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_COIN1 );    PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_COIN2 );    PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
    ...
    PORT_START();       /* IN0 (0x00) */
	    ...
	    PORT_START();       /* IN1 (0x10) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );    PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );    PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNKNOWN );
	    PORT_START();       /* IN2 (0x20) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_SPECIAL );  /* EEPROM bit */
		PORT_BITX(0x0002, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
	    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_SERVICE1 );    PORT_BIT( 0x00f8, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );    PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );    PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_COIN1 );    PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_COIN2 );    PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
    ...
    PORT_START();       /* IN0 (0x00) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );    PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );    PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );    PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );    PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );    PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );    PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );    PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );    PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );    PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );    PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );    PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );    PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
	    PORT_START();       /* IN1 (0x10) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );    PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON5 | IPF_PLAYER1 );    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON6 | IPF_PLAYER1 );    PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );    PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON5 | IPF_PLAYER2 );    PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNKNOWN );
	    PORT_START();       /* IN2 (0x20) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_SPECIAL );  /* EEPROM bit */
		PORT_BITX(0x0002, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
	    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_SERVICE1 );    PORT_BIT( 0x00f8, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );    PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );    PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_COIN1 );    PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_COIN2 );    PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON6 | IPF_PLAYER2 );    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
    ...
    PORT_START();       /* IN0 (0x00) */
	    ...
	    PORT_START();       /* IN1 (0x10) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );    PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER3 );    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER3 );    PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER3 );    PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );    PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );    PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER3 );    PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER3 );    PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER4 );    PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER4 );    PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER4 );    PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER4 );    PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );    PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER4 );    PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER4 );    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER4 );
	    PORT_START();       /* IN2 (0x20) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_SPECIAL );  /* EEPROM bit */
		PORT_BITX(0x0002, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
	    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_SERVICE1 );    PORT_BIT( 0x00f8, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );    PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );    PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_START3 );    PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_START4 );    PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_COIN1 );    PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_COIN2 );    PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_COIN3 );    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_COIN4 );INPUT_PORTS_END(); }}; 
	
	static InputPortPtr input_ports_avsp = new InputPortPtr(){ public void handler() { 
    PORT_START();       /* IN0 (0x00) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );    PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );    PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );    PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );    PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );    PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );    PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );    PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );    PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );    PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );    PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );    PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );    PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
	    PORT_START();       /* IN1 (0x10) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );    PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER3 );    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER3 );    PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER3 );    PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );    PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );    PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER3 );    PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNKNOWN );
	    PORT_START();       /* IN2 (0x20) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_SPECIAL );  /* EEPROM bit */
		PORT_BITX(0x0002, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
	    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_SERVICE1 );    PORT_BIT( 0x00f8, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );    PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );    PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_START3 );    PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_COIN1 );    PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_COIN2 );    PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_COIN3 );    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	
	static InputPortPtr input_ports_qndream = new InputPortPtr(){ public void handler() { 
    PORT_START();       /* IN0 (0x00) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );    PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );    PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );    PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );    PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );    PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );    PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );    PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
	    PORT_START();       /* IN1 (0x10) */
    ...
    PORT_START();       /* IN0 (0x00) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );    PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );    PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );    PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );    PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );    PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );    PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );    PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );    PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );    PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );    PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );    PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
	    PORT_START();       /* IN1 (0x10) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );    PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER3 );    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER3 );    PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER3 );    PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );    PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );    PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER4 );    PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER4 );    PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER4 );    PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER4 );    PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );    PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER4 );    PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
	    PORT_START();       /* IN2 (0x20) */
	    PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_SPECIAL );  /* EEPROM bit */
		PORT_BITX(0x0002, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
	    PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_SERVICE1 );    PORT_BIT( 0x00f8, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );    PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );    PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_START3 );    PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_START4 );    PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_COIN1 );    PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_COIN2 );    PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_COIN3 );    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_COIN4 );INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_19xx = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1000000, REGION_GFX1, 0 );	ROMX_LOAD( "19x.13",   0x0000000, 0x080000, 0x427aeb18, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_armwar = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1400000, REGION_GFX1, 0 );	ROMX_LOAD( "pwg.13",   0x0000000, 0x400000, 0xae8fe08e, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_avsp = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1000000, REGION_GFX1, 0 );	ROMX_LOAD( "avp.13",   0x0000000, 0x200000, 0x8f8b5ae4, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_batcirj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1000000, REGION_GFX1, 0 );	ROMX_LOAD( "btc.13",   0x000000, 0x400000, 0xdc705bad, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_csclubj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1000000, REGION_GFX1, 0 );	ROM_FILL(              0x000000, 0x800000, 0 )
		...
		ROM_REGION( QSOUND_SIZE, REGION_CPU2, 0 );/* 64k for the audio CPU (+banks) */
		ROM_LOAD( "csc.01",   0x00000, 0x08000, 0xee162111 );	ROM_CONTINUE(         0x10000, 0x18000 );
		ROM_REGION( 0x400000, REGION_SOUND1, 0 );/* QSound samples */
	...
	static RomLoadPtr rom_cybotsj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000000, REGION_GFX1, 0 );	ROMX_LOAD( "cyb.13",   0x0000000, 0x400000, 0xf0dce192, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_ddtod = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0xc00000, REGION_GFX1, 0 );	ROMX_LOAD( "dad.13",   0x000000, 0x200000, 0xda3cb7d6, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_ddsom = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1800000, REGION_GFX1, 0 );	ROMX_LOAD( "dd2.13",   0x0000000, 0x400000, 0xa46b4e6e, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_dimahoo = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1000000, REGION_GFX1, 0 );	ROMX_LOAD( "gmd.13",   0x000000, 0x400000, 0x80dd19f0, ROM_GROUPWORD | ROM_SKIP(6) )
		...
		ROM_REGION( QSOUND_SIZE, REGION_CPU2, 0 );/* 64k for the audio CPU (+banks) */
		ROM_LOAD( "gmd.01",   0x00000, 0x08000, 0x3f9bc985 );	ROM_CONTINUE(         0x10000, 0x18000 );	ROM_LOAD( "gmd.02",   0x28000, 0x20000, 0x3fd39dde );
	...
	static RomLoadPtr rom_dstlk = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1400000, REGION_GFX1, 0 );	ROMX_LOAD( "vam.13",   0x0000000, 0x400000, 0xc51baf99, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_ecofe = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0xc00000, REGION_GFX1, 0 );	ROMX_LOAD( "uec.13",   0x000000, 0x200000, 0xdcaf1436, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_gwingj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1000000, REGION_GFX1, 0 );	ROMX_LOAD( "ggw.13",   0x000000, 0x400000, 0x105530a4, ROM_GROUPWORD | ROM_SKIP(6) )
		...
		ROM_REGION(QSOUND_SIZE, REGION_CPU2, 0 );/* 64k for the audio CPU (+banks) */
		ROM_LOAD( "ggw.01",   0x00000, 0x08000, 0x4c6351d5 );	ROM_CONTINUE(         0x10000, 0x18000 );
		ROM_REGION( 0x800000, REGION_SOUND1, 0 );/* QSound samples */
	...
	static RomLoadPtr rom_mmatrixj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000000, REGION_GFX1, 0 );	ROMX_LOAD( "mmx.13",   0x0000000, 0x400000, 0x04748718, ROM_GROUPWORD | ROM_SKIP(6) )
		...
		ROM_REGION( QSOUND_SIZE, REGION_CPU2, 0 );/* 64k for the audio CPU (+banks) */
		ROM_LOAD( "mmx.01",   0x00000, 0x08000, 0xc57e8171 );	ROM_CONTINUE(         0x10000, 0x18000 );
		ROM_REGION( 0x800000, REGION_SOUND1, 0 );/* QSound samples */
	...
	static RomLoadPtr rom_msh = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000000, REGION_GFX1, 0 );	ROMX_LOAD( "msh.13",   0x0000000, 0x400000, 0x09d14566, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_mshvsf = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000000, REGION_GFX1, 0 );	ROMX_LOAD( "mvs.13",   0x0000000, 0x400000, 0x29b05fd9, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_mvsc = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000000, REGION_GFX1, 0 );	ROMX_LOAD( "mvc.13",   0x0000000, 0x400000, 0xfa5f74bc, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_nwarr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000000, REGION_GFX1, 0 );	ROMX_LOAD( "vph.13",   0x0000000, 0x400000, 0xc51baf99, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_rckman2j = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0800000, REGION_GFX1, 0 );	ROMX_LOAD( "rm2.14",   0x000000, 0x200000, 0x9b1f00b4, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_sfaer1 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_sfa2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1400000, REGION_GFX1, 0 );	ROMX_LOAD( "sz2.13",   0x0000000, 0x400000, 0x4d1f1f22, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_sfa3 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000000, REGION_GFX1, 0 );	ROMX_LOAD( "sz3.13",   0x0000000, 0x400000, 0x0f7a60d9, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_sgemf = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1400000, REGION_GFX1, 0 );	ROMX_LOAD( "pcf.13",   0x0000000, 0x400000, 0x22d72ab9, ROM_GROUPWORD | ROM_SKIP(6) )
		...
		ROM_REGION( QSOUND_SIZE, REGION_CPU2, 0 );/* 64k for the audio CPU (+banks) */
		ROM_LOAD( "pcf.01",   0x00000, 0x08000, 0x254e5f33 );	ROM_CONTINUE(         0x10000, 0x18000 );	ROM_LOAD( "pcf.02",   0x28000, 0x20000, 0x6902f4f9 );
		ROM_REGION( 0x800000, REGION_SOUND1, 0 );/* QSound samples */
	...
	static RomLoadPtr rom_slam2e = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1200000, REGION_GFX1, 0 );	ROMX_LOAD( "smb.13",   0x0000000, 0x200000, 0xd9b2d1de, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_spf2t = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0xC00000, REGION_GFX1, 0 );	ROM_FILL(             0x000000, 0x800000, 0 )
	...
	static RomLoadPtr rom_ssf2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0xc00000, REGION_GFX1, 0 );	ROMX_LOAD( "ssf.13",   0x000000, 0x200000, 0xcf94d275, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_ssf2t = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1000000, REGION_GFX1, 0 );	ROMX_LOAD( "ssf.13",   0x000000, 0x200000, 0xcf94d275, ROM_GROUPWORD | ROM_SKIP(6) )
		ROMX_LOAD( "ssf.15",   0x000002, 0x200000, 0x5eb703af, ROM_GROUPWORD | ROM_SKIP(6) )
		ROMX_LOAD( "ssf.17",   0x000004, 0x200000, 0xffa60e0f, ROM_GROUPWORD | ROM_SKIP(6) )
		ROMX_LOAD( "ssf.19",   0x000006, 0x200000, 0x34e825c5, ROM_GROUPWORD | ROM_SKIP(6) )
		ROMX_LOAD( "ssf.14",   0x800000, 0x100000, 0xb7cc32e7, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_vhunt2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000000, REGION_GFX1, 0 );	ROMX_LOAD( "vh2.13",   0x0000000, 0x400000, 0x3b02ddaa, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_vsav = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000000, REGION_GFX1, 0 );	ROMX_LOAD( "vm3.13",   0x0000000, 0x400000, 0xfd8a11eb, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_vsav2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000000, REGION_GFX1, 0 );	ROMX_LOAD( "vs2.13",   0x0000000, 0x400000, 0x5c852f52, ROM_GROUPWORD | ROM_SKIP(6) )
	...
	static RomLoadPtr rom_xmcota = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000000, REGION_GFX1, 0 );	ROMX_LOAD( "xmn.13",   0x0000000, 0x400000, 0xbf4df073, ROM_GROUPWORD | ROM_SKIP(6) )
		...
		ROM_REGION( QSOUND_SIZE, REGION_CPU2, 0 );/* 64k for the audio CPU (+banks) */
		ROM_LOAD( "xmn.01a",  0x00000, 0x08000, 0x40f479ea );	ROM_CONTINUE(         0x10000, 0x18000 );	ROM_LOAD( "xmn.02a",  0x28000, 0x20000, 0x39d9b5ad );
		ROM_REGION( 0x400000, REGION_SOUND1, 0 );/* QSound samples */
	...
	static RomLoadPtr rom_xmcotajr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( QSOUND_SIZE, REGION_CPU2, 0 );/* 64k for the audio CPU (+banks) */
		ROM_LOAD( "xmn.01",   0x00000, 0x08000, 0x7178336e );	ROM_CONTINUE(         0x10000, 0x18000 );	ROM_LOAD( "xmn.02",   0x28000, 0x20000, 0x0ec58501 );
		ROM_REGION( 0x400000, REGION_SOUND1, 0 );/* QSound samples */
		ROM_LOAD16_WORD_SWAP( "xmn.11",   0x000000, 0x200000, 0xc848a6bc )
		ROM_LOAD16_WORD_SWAP( "xmn.12",   0x200000, 0x200000, 0x729c188f )
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_xmvsf = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x2000000, REGION_GFX1, 0 );	ROMX_LOAD( "xvs.13",   0x0000000, 0x400000, 0xf6684efd, ROM_GROUPWORD | ROM_SKIP(6) )
		...
		ROM_REGION( QSOUND_SIZE, REGION_CPU2, 0 );/* 64k for the audio CPU (+banks) */
		ROM_LOAD( "xvs.01",   0x00000, 0x08000, 0x3999e93a );	ROM_CONTINUE(         0x10000, 0x18000 );	ROM_LOAD( "xvs.02",   0x28000, 0x20000, 0x101bdee9 );
		ROM_REGION( 0x400000, REGION_SOUND1, 0 );/* QSound samples */
	...
	public static GameDriver driver_19xx	   = new GameDriver("1996"	,"19xx"	,"cps2.java"	,rom_19xx,null	,machine_driver_cps2	,input_ports_19xx	,init_cps2	,ROT270_16BIT	,	"Capcom", "19XX: The War Against Destiny (US 951207)" )
	public static GameDriver driver_19xxj	   = new GameDriver("1996"	,"19xxj"	,"cps2.java"	,rom_19xxj,driver_19xx	,machine_driver_cps2	,input_ports_19xx	,init_cps2	,ROT270_16BIT	,	"Capcom", "19XX: The War Against Destiny (Japan 951207)", GAME_NOT_WORKING )
	public static GameDriver driver_19xxh	   = new GameDriver("1996"	,"19xxh"	,"cps2.java"	,rom_19xxh,driver_19xx	,machine_driver_cps2	,input_ports_19xx	,init_cps2	,ROT270_16BIT	,	"Capcom", "19XX: The War Against Destiny (Hispanic 951218)" )
	public static GameDriver driver_armwar	   = new GameDriver("1994"	,"armwar"	,"cps2.java"	,rom_armwar,null	,machine_driver_cps2	,input_ports_avsp	,init_cps2	,ROT0_16BIT	,	"Capcom", "Armored Warriors (US 941024)" )
	public static GameDriver driver_pgear	   = new GameDriver("1994"	,"pgear"	,"cps2.java"	,rom_pgear,driver_armwar	,machine_driver_cps2	,input_ports_avsp	,init_cps2	,ROT0_16BIT	,	"Capcom", "Powered Gear: Strategic Variant Armor Equipment (Japan 941024)" )
	public static GameDriver driver_pgearr1	   = new GameDriver("1994"	,"pgearr1"	,"cps2.java"	,rom_pgearr1,driver_armwar	,machine_driver_cps2	,input_ports_avsp	,init_cps2	,ROT0_16BIT	,	"Capcom", "Powered Gear: Strategic Variant Armor Equipment (Japan 940916)" )
	public static GameDriver driver_armwara	   = new GameDriver("1994"	,"armwara"	,"cps2.java"	,rom_armwara,driver_armwar	,machine_driver_cps2	,input_ports_avsp	,init_cps2	,ROT0_16BIT	,	"Capcom", "Armored Warriors (Asia 940920)", GAME_NOT_WORKING )
	public static GameDriver driver_avsp	   = new GameDriver("1994"	,"avsp"	,"cps2.java"	,rom_avsp,null	,machine_driver_cps2	,input_ports_avsp	,init_cps2	,ROT0_16BIT	,	"Capcom", "Alien vs. Predator (Euro 940520)" )
	public static GameDriver driver_avspu	   = new GameDriver("1994"	,"avspu"	,"cps2.java"	,rom_avspu,driver_avsp	,machine_driver_cps2	,input_ports_avsp	,init_cps2	,ROT0_16BIT	,	"Capcom", "Alien vs. Predator (US 940520)" )
	public static GameDriver driver_avspj	   = new GameDriver("1994"	,"avspj"	,"cps2.java"	,rom_avspj,driver_avsp	,machine_driver_cps2	,input_ports_avsp	,init_cps2	,ROT0_16BIT	,	"Capcom", "Alien vs. Predator (Japan 940520)" )
	public static GameDriver driver_avspa	   = new GameDriver("1994"	,"avspa"	,"cps2.java"	,rom_avspa,driver_avsp	,machine_driver_cps2	,input_ports_avsp	,init_cps2	,ROT0_16BIT	,	"Capcom", "Alien vs. Predator (Asia 940520)", GAME_NOT_WORKING )
	public static GameDriver driver_batcirj	   = new GameDriver("1997"	,"batcirj"	,"cps2.java"	,rom_batcirj,null	,machine_driver_cps2	,input_ports_batcir	,init_cps2	,ROT0_16BIT	,	"Capcom", "Battle Circuit (Japan 970319)", GAME_NOT_WORKING )
	public static GameDriver driver_batcira	   = new GameDriver("1997"	,"batcira"	,"cps2.java"	,rom_batcira,driver_batcirj	,machine_driver_cps2	,input_ports_batcir	,init_cps2	,ROT0_16BIT	,	"Capcom", "Battle Circuit (Asia 970319)", GAME_NOT_WORKING )
	public static GameDriver driver_csclubj	   = new GameDriver("1997"	,"csclubj"	,"cps2.java"	,rom_csclubj,null	,machine_driver_cps2	,input_ports_sgemf	,init_cps2	,ROT0_16BIT	,	"Capcom", "Capcom Sports Club (Japan 970722)", GAME_NOT_WORKING )
	public static GameDriver driver_cscluba	   = new GameDriver("1997"	,"cscluba"	,"cps2.java"	,rom_cscluba,driver_csclubj	,machine_driver_cps2	,input_ports_sgemf	,init_cps2	,ROT0_16BIT	,	"Capcom", "Capcom Sports Club (Asia 970722)", GAME_NOT_WORKING )
	public static GameDriver driver_cybotsj	   = new GameDriver("1995"	,"cybotsj"	,"cps2.java"	,rom_cybotsj,null	,machine_driver_cps2	,input_ports_cybotsj	,init_cps2	,ROT0_16BIT	,	"Capcom", "Cyberbots: Fullmetal Madness (Japan 950420)" )
	public static GameDriver driver_ddtod	   = new GameDriver("1993"	,"ddtod"	,"cps2.java"	,rom_ddtod,null	,machine_driver_cps2	,input_ports_ddtod	,init_cps2	,ROT0_16BIT	,	"Capcom", "Dungeons & Dragons: Tower of Doom (US 940125)" )
	public static GameDriver driver_ddtodr1	   = new GameDriver("1993"	,"ddtodr1"	,"cps2.java"	,rom_ddtodr1,driver_ddtod	,machine_driver_cps2	,input_ports_ddtod	,init_cps2	,ROT0_16BIT	,	"Capcom", "Dungeons & Dragons: Tower of Doom (US 940113)" )
	public static GameDriver driver_ddtodj	   = new GameDriver("1993"	,"ddtodj"	,"cps2.java"	,rom_ddtodj,driver_ddtod	,machine_driver_cps2	,input_ports_ddtod	,init_cps2	,ROT0_16BIT	,	"Capcom", "Dungeons & Dragons: Tower of Doom (Japan 940113)" )
	public static GameDriver driver_ddtoda	   = new GameDriver("1993"	,"ddtoda"	,"cps2.java"	,rom_ddtoda,driver_ddtod	,machine_driver_cps2	,input_ports_ddtod	,init_cps2	,ROT0_16BIT	,	"Capcom", "Dungeons & Dragons: Tower of Doom (Asia 940113)", GAME_NOT_WORKING )
	public static GameDriver driver_ddsom	   = new GameDriver("1996"	,"ddsom"	,"cps2.java"	,rom_ddsom,null	,machine_driver_cps2	,input_ports_ddtod	,init_cps2	,ROT0_16BIT	,	"Capcom", "Dungeons & Dragons: Shadow over Mystara (US 960209)" )
	public static GameDriver driver_ddsomj	   = new GameDriver("1996"	,"ddsomj"	,"cps2.java"	,rom_ddsomj,driver_ddsom	,machine_driver_cps2	,input_ports_ddtod	,init_cps2	,ROT0_16BIT	,	"Capcom", "Dungeons & Dragons: Shadow over Mystara (Japan 960206)" )
	public static GameDriver driver_dimahoo	   = new GameDriver("2000"	,"dimahoo"	,"cps2.java"	,rom_dimahoo,null	,machine_driver_cps2	,input_ports_sgemf	,init_cps2	,ROT270_16BIT	,	"Capcom", "Dimahoo (US 000121)", GAME_NOT_WORKING )
	public static GameDriver driver_gmahou	   = new GameDriver("2000"	,"gmahou"	,"cps2.java"	,rom_gmahou,driver_dimahoo	,machine_driver_cps2	,input_ports_sgemf	,init_cps2	,ROT270_16BIT	,	"Capcom", "Great Mahou Daisakusen (Japan 000121)", GAME_NOT_WORKING )
	public static GameDriver driver_dstlk	   = new GameDriver("1994"	,"dstlk"	,"cps2.java"	,rom_dstlk,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Darkstalkers: The Night Warriors (US 940818)", GAME_NOT_WORKING )
	public static GameDriver driver_vampj	   = new GameDriver("1994"	,"vampj"	,"cps2.java"	,rom_vampj,driver_dstlk	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Vampire: The Night Warriors (Japan 940705)" )
	public static GameDriver driver_vampja	   = new GameDriver("1994"	,"vampja"	,"cps2.java"	,rom_vampja,driver_dstlk	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Vampire: The Night Warriors (Japan 940705 alt)" )
	public static GameDriver driver_vampa	   = new GameDriver("1994"	,"vampa"	,"cps2.java"	,rom_vampa,driver_dstlk	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Vampire: The Night Warriors (Asia 940705)", GAME_NOT_WORKING )
	public static GameDriver driver_ecofe	   = new GameDriver("1993"	,"ecofe"	,"cps2.java"	,rom_ecofe,null	,machine_driver_cps2	,input_ports_cps2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Eco Fighters (World 931203)", GAME_NOT_WORKING )
	public static GameDriver driver_uecology	   = new GameDriver("1993"	,"uecology"	,"cps2.java"	,rom_uecology,driver_ecofe	,machine_driver_cps2	,input_ports_cps2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Ultimate Ecology (Japan 931203)", GAME_NOT_WORKING )
	public static GameDriver driver_gwingj	   = new GameDriver("1999"	,"gwingj"	,"cps2.java"	,rom_gwingj,null	,machine_driver_cps2	,input_ports_cps2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Giga Wing (Japan 990223)", GAME_NOT_WORKING )
	public static GameDriver driver_mmatrixj	   = new GameDriver("2000"	,"mmatrixj"	,"cps2.java"	,rom_mmatrixj,null	,machine_driver_cps2	,input_ports_cps2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Mars Matrix: Hyper Solid Shooting (Japan 000412)", GAME_NOT_WORKING )
	public static GameDriver driver_msh	   = new GameDriver("1995"	,"msh"	,"cps2.java"	,rom_msh,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Marvel Super Heroes (US 951024)" )
	public static GameDriver driver_mshj	   = new GameDriver("1995"	,"mshj"	,"cps2.java"	,rom_mshj,driver_msh	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Marvel Super Heroes (Japan 951024)", GAME_NOT_WORKING )
	public static GameDriver driver_mshh	   = new GameDriver("1995"	,"mshh"	,"cps2.java"	,rom_mshh,driver_msh	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Marvel Super Heroes (Hispanic 951117)" )
	public static GameDriver driver_mshvsf	   = new GameDriver("1997"	,"mshvsf"	,"cps2.java"	,rom_mshvsf,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Marvel Super Heroes Vs. Street Fighter (US 970625)", GAME_NOT_WORKING )
	public static GameDriver driver_mshvsfj	   = new GameDriver("1997"	,"mshvsfj"	,"cps2.java"	,rom_mshvsfj,driver_mshvsf	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Marvel Super Heroes Vs. Street Fighter (Japan 970707)", GAME_NOT_WORKING )
	public static GameDriver driver_mshvsfj1	   = new GameDriver("1997"	,"mshvsfj1"	,"cps2.java"	,rom_mshvsfj1,driver_mshvsf	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Marvel Super Heroes Vs. Street Fighter (Japan 970702)", GAME_NOT_WORKING )
	public static GameDriver driver_mshvsfa	   = new GameDriver("1997"	,"mshvsfa"	,"cps2.java"	,rom_mshvsfa,driver_mshvsf	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Marvel Super Heroes Vs. Street Fighter (Asia 970625)", GAME_NOT_WORKING )
	public static GameDriver driver_mshvsfa1	   = new GameDriver("1997"	,"mshvsfa1"	,"cps2.java"	,rom_mshvsfa1,driver_mshvsf	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Marvel Super Heroes Vs. Street Fighter (Asia 970620)", GAME_NOT_WORKING )
	public static GameDriver driver_mvsc	   = new GameDriver("1998"	,"mvsc"	,"cps2.java"	,rom_mvsc,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Marvel Vs. Capcom: Clash of Super Heroes (US 980123)", GAME_NOT_WORKING )
	public static GameDriver driver_mvscj	   = new GameDriver("1998"	,"mvscj"	,"cps2.java"	,rom_mvscj,driver_mvsc	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Marvel Vs. Capcom: Clash of Super Heroes (Japan 980123)", GAME_NOT_WORKING )
	public static GameDriver driver_mvscjr1	   = new GameDriver("1998"	,"mvscjr1"	,"cps2.java"	,rom_mvscjr1,driver_mvsc	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Marvel Vs. Capcom: Clash of Super Heroes (Japan 980112)", GAME_NOT_WORKING )
	public static GameDriver driver_mvsch	   = new GameDriver("1998"	,"mvsch"	,"cps2.java"	,rom_mvsch,driver_mvsc	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Marvel Vs. Capcom: Clash of Super Heroes (Hispanic 980123)", GAME_NOT_WORKING )
	public static GameDriver driver_nwarr	   = new GameDriver("1995"	,"nwarr"	,"cps2.java"	,rom_nwarr,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Night Warriors: Darkstalkers Revenge (US 950406)", GAME_NOT_WORKING )
	public static GameDriver driver_vhuntj	   = new GameDriver("1995"	,"vhuntj"	,"cps2.java"	,rom_vhuntj,driver_nwarr	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Vampire Hunter: Darkstalkers Revenge (Japan 950302)", GAME_NOT_WORKING )
	public static GameDriver driver_rckman2j	   = new GameDriver("1996"	,"rckman2j"	,"cps2.java"	,rom_rckman2j,null	,machine_driver_cps2	,input_ports_cps2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Rockman 2: The Power Fighters (Japan 960708)", GAME_NOT_WORKING )
	public static GameDriver driver_qndream	   = new GameDriver("1996"	,"qndream"	,"cps2.java"	,rom_qndream,null	,machine_driver_cps2	,input_ports_qndream	,init_cps2	,ROT0_16BIT	,	"Capcom", "Quiz Nanairo Dreams: Nijiirotyou no Kiseki (Japan 960826)" )
	public static GameDriver driver_sfa	   = new GameDriver("1995"	,"sfa"	,"cps2.java"	,rom_sfa,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Alpha: Warriors' Dreams (US 950627)" )
	public static GameDriver driver_sfaer1	   = new GameDriver("1995"	,"sfaer1"	,"cps2.java"	,rom_sfaer1,driver_sfa	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Alpha: Warriors' Dreams (Euro 950727)", GAME_NOT_WORKING )
	public static GameDriver driver_sfzj	   = new GameDriver("1995"	,"sfzj"	,"cps2.java"	,rom_sfzj,driver_sfa	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Zero (Japan 950727)" )
	public static GameDriver driver_sfzjr1	   = new GameDriver("1995"	,"sfzjr1"	,"cps2.java"	,rom_sfzjr1,driver_sfa	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Zero (Japan 950627)" )
	public static GameDriver driver_sfzjr2	   = new GameDriver("1995"	,"sfzjr2"	,"cps2.java"	,rom_sfzjr2,driver_sfa	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Zero (Japan 950605)" )
	public static GameDriver driver_sfzh	   = new GameDriver("1995"	,"sfzh"	,"cps2.java"	,rom_sfzh,driver_sfa	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Zero (Hispanic 950627)", GAME_NOT_WORKING )
	public static GameDriver driver_sfa2	   = new GameDriver("1996"	,"sfa2"	,"cps2.java"	,rom_sfa2,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Alpha 2 (US 960306)" )
	public static GameDriver driver_sfz2j	   = new GameDriver("1996"	,"sfz2j"	,"cps2.java"	,rom_sfz2j,driver_sfa2	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Zero 2 (Japan 960227)" )
	public static GameDriver driver_sfz2aj	   = new GameDriver("1996"	,"sfz2aj"	,"cps2.java"	,rom_sfz2aj,driver_sfa2	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Zero 2 Alpha (Japan 960805)" )
	public static GameDriver driver_sfz2ah	   = new GameDriver("1996"	,"sfz2ah"	,"cps2.java"	,rom_sfz2ah,driver_sfa2	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Zero 2 Alpha (Hispanic 960813)", GAME_NOT_WORKING )
	public static GameDriver driver_sfa3	   = new GameDriver("1998"	,"sfa3"	,"cps2.java"	,rom_sfa3,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Alpha 3 (US 980904)", GAME_NOT_WORKING )
	public static GameDriver driver_sfa3r1	   = new GameDriver("1998"	,"sfa3r1"	,"cps2.java"	,rom_sfa3r1,driver_sfa3	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Alpha 3 (US 980629)", GAME_NOT_WORKING )
	public static GameDriver driver_sfz3j	   = new GameDriver("1998"	,"sfz3j"	,"cps2.java"	,rom_sfz3j,driver_sfa3	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Zero 3 (Japan 980727)", GAME_NOT_WORKING )
	public static GameDriver driver_sfz3jr1	   = new GameDriver("1998"	,"sfz3jr1"	,"cps2.java"	,rom_sfz3jr1,driver_sfa3	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Street Fighter Zero 3 (Japan 980629)" )
	public static GameDriver driver_sgemf	   = new GameDriver("1997"	,"sgemf"	,"cps2.java"	,rom_sgemf,null	,machine_driver_cps2	,input_ports_sgemf	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Gem Fighter Mini Mix (US 970904)", GAME_NOT_WORKING )
	public static GameDriver driver_pfghtj	   = new GameDriver("1997"	,"pfghtj"	,"cps2.java"	,rom_pfghtj,driver_sgemf	,machine_driver_cps2	,input_ports_sgemf	,init_cps2	,ROT0_16BIT	,	"Capcom", "Pocket Fighter (Japan 970904)", GAME_NOT_WORKING )
	public static GameDriver driver_sgemfh	   = new GameDriver("1997"	,"sgemfh"	,"cps2.java"	,rom_sgemfh,driver_sgemf	,machine_driver_cps2	,input_ports_sgemf	,init_cps2	,ROT0_16BIT	,	"Capcom", "Pocket Fighter (Hispanic 970904)", GAME_NOT_WORKING )
	public static GameDriver driver_slam2e	   = new GameDriver("1994"	,"slam2e"	,"cps2.java"	,rom_slam2e,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Ring of Destruction: Slammasters II (Euro 940902)" )
	public static GameDriver driver_smbomber	   = new GameDriver("1994"	,"smbomber"	,"cps2.java"	,rom_smbomber,driver_slam2e	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Muscle Bomber: The International Blowout (Japan 940808)", GAME_NOT_WORKING )
	public static GameDriver driver_spf2t	   = new GameDriver("1996"	,"spf2t"	,"cps2.java"	,rom_spf2t,null	,machine_driver_cps2	,input_ports_19xx	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Puzzle Fighter 2 Turbo (US 960620)", GAME_NOT_WORKING )
	public static GameDriver driver_spf2xj	   = new GameDriver("1996"	,"spf2xj"	,"cps2.java"	,rom_spf2xj,driver_spf2t	,machine_driver_cps2	,input_ports_19xx	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Puzzle Fighter 2 X (Japan 960531)" )
	public static GameDriver driver_ssf2	   = new GameDriver("1993"	,"ssf2"	,"cps2.java"	,rom_ssf2,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Street Fighter 2: The New Challengers (US 930911)" )
	public static GameDriver driver_ssf2a	   = new GameDriver("1993"	,"ssf2a"	,"cps2.java"	,rom_ssf2a,driver_ssf2	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Street Fighter 2: The New Challengers (Asia 930911)", GAME_NOT_WORKING )
	public static GameDriver driver_ssf2j	   = new GameDriver("1993"	,"ssf2j"	,"cps2.java"	,rom_ssf2j,driver_ssf2	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Street Fighter 2: The New Challengers (Japan 931005)" )
	public static GameDriver driver_ssf2jr1	   = new GameDriver("1993"	,"ssf2jr1"	,"cps2.java"	,rom_ssf2jr1,driver_ssf2	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Street Fighter 2: The New Challengers (Japan 930911)" )
	public static GameDriver driver_ssf2jr2	   = new GameDriver("1993"	,"ssf2jr2"	,"cps2.java"	,rom_ssf2jr2,driver_ssf2	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Street Fighter 2: The New Challengers (Japan 930910)" )
	public static GameDriver driver_ssf2t	   = new GameDriver("1994"	,"ssf2t"	,"cps2.java"	,rom_ssf2t,driver_ssf2	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Street Fighter 2 Turbo (World 940223)" )
	public static GameDriver driver_ssf2ta	   = new GameDriver("1994"	,"ssf2ta"	,"cps2.java"	,rom_ssf2ta,driver_ssf2	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Street Fighter 2 Turbo (Asia 940223)" )
	public static GameDriver driver_ssf2tu	   = new GameDriver("1994"	,"ssf2tu"	,"cps2.java"	,rom_ssf2tu,driver_ssf2	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Street Fighter 2 Turbo (US 940223)" )
	public static GameDriver driver_ssf2xj	   = new GameDriver("1994"	,"ssf2xj"	,"cps2.java"	,rom_ssf2xj,driver_ssf2	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Super Street Fighter 2 X: Grand Master Challenge (Japan 940223)" )
	public static GameDriver driver_vhunt2	   = new GameDriver("1997"	,"vhunt2"	,"cps2.java"	,rom_vhunt2,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Vampire Hunter 2: Darkstalkers Revenge (Japan 970913)", GAME_NOT_WORKING )
	public static GameDriver driver_vsav	   = new GameDriver("1997"	,"vsav"	,"cps2.java"	,rom_vsav,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Vampire Savior: The Lord of Vampire (US 970519)", GAME_NOT_WORKING )
	public static GameDriver driver_vsavj	   = new GameDriver("1997"	,"vsavj"	,"cps2.java"	,rom_vsavj,driver_vsav	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Vampire Savior: The Lord of Vampire (Japan 970519)" )
	public static GameDriver driver_vsavh	   = new GameDriver("1997"	,"vsavh"	,"cps2.java"	,rom_vsavh,driver_vsav	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Vampire Savior: The Lord of Vampire (Hispanic 970519)", GAME_NOT_WORKING )
	public static GameDriver driver_vsav2	   = new GameDriver("1997"	,"vsav2"	,"cps2.java"	,rom_vsav2,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "Vampire Savior 2: The Lord of Vampire (Japan 970913)", GAME_NOT_WORKING )
	public static GameDriver driver_xmcota	   = new GameDriver("1994"	,"xmcota"	,"cps2.java"	,rom_xmcota,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "X-Men: Children of the Atom (US 950105)" )
	public static GameDriver driver_xmcotaj	   = new GameDriver("1994"	,"xmcotaj"	,"cps2.java"	,rom_xmcotaj,driver_xmcota	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "X-Men: Children of the Atom (Japan 941219)" )
	public static GameDriver driver_xmcotaj1	   = new GameDriver("1994"	,"xmcotaj1"	,"cps2.java"	,rom_xmcotaj1,driver_xmcota	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "X-Men: Children of the Atom (Japan 941217)" )
	public static GameDriver driver_xmcotajr	   = new GameDriver("1994"	,"xmcotajr"	,"cps2.java"	,rom_xmcotajr,driver_xmcota	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "X-Men: Children of the Atom (Japan 941208 rent version)" )
	public static GameDriver driver_xmvsf	   = new GameDriver("1996"	,"xmvsf"	,"cps2.java"	,rom_xmvsf,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "X-Men Vs. Street Fighter (US 961004)" )
	public static GameDriver driver_xmvsfj	   = new GameDriver("1996"	,"xmvsfj"	,"cps2.java"	,rom_xmvsfj,driver_xmvsf	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "X-Men Vs. Street Fighter (Japan 960910)", GAME_NOT_WORKING )
	public static GameDriver driver_xmvsfa	   = new GameDriver("1996"	,"xmvsfa"	,"cps2.java"	,rom_xmvsfa,driver_xmvsf	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "X-Men Vs. Street Fighter (Asia 961023)", GAME_NOT_WORKING )
	public static GameDriver driver_xmvsfh	   = new GameDriver("1996"	,"xmvsfh"	,"cps2.java"	,rom_xmvsfh,driver_xmvsf	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0_16BIT	,	"Capcom", "X-Men Vs. Street Fighter (Hispanic 961004)", GAME_NOT_WORKING )
}
