...
public class cinemat
{
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_SERVICE( SW7,	   SW7OFF );	PORT_DIPNAME( SW6,	   SW6ON,		  "Scores" );	PORT_DIPSETTING(	   SW6ON,		  "Individual" );	PORT_DIPSETTING(	   SW6OFF,		  "Combined" );	PORT_DIPNAME( SW5,	   SW5OFF,		  DEF_STR( "Demo_Sounds") );
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_SERVICE( SW7,     SW7ON );	PORT_DIPNAME( SW5,     SW5ON,         DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(       SW5OFF,        DEF_STR( "Off") );
		PORT_DIPSETTING(       SW5ON,         DEF_STR( "On") );
