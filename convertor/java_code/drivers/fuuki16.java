...
public class fuuki16
{
	...
	***************************************************************************/
	...
	public static Memory_ReadAddress fuuki16_sound_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x5fff, MRA_ROM		),	// ROM
	...
	public static Memory_WriteAddress fuuki16_sound_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0x5fff, MWA_ROM		),	// ROM
	...
	public static IO_ReadPort fuuki16_sound_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x11, 0x11, soundlatch_r				),	// From Main CPU
	...
	public static IO_WritePort fuuki16_sound_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x00, fuuki16_sound_rombank_w 	),	// ROM Bank
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_gogomile = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER1 );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN                      );// There's code that uses
		...
		PORT_SERVICE( 0x0001, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x0002, 0x0002, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPSETTING(      0x0010, "China" );	PORT_DIPSETTING(      0x0030, "Japan"  );	PORT_DIPSETTING(      0x0000, "Korea" );	PORT_DIPSETTING(      0x0020, "USA"    );	PORT_DIPNAME( 0x00c0, 0x00c0, DEF_STR( "Lives") );
		PORT_DIPSETTING(      0x0000, "2" );	PORT_DIPSETTING(      0x00c0, "3" );	PORT_DIPSETTING(      0x0080, "4" );	PORT_DIPSETTING(      0x0040, "5" );
		PORT_DIPNAME( 0x0100, 0x0100, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(      0x0100, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0200, 0x0200, "Unknown 2-1" );	PORT_DIPSETTING(      0x0200, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	...
	//	PORT_DIPSETTING(      0x0020, "2" );// 2 3
		...
		PORT_DIPNAME( 0x0080, 0x0080, "? Senin Mode ?" );	PORT_DIPSETTING(      0x0080, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static YM2203interface fuuki16_ym2203_intf = new YM2203interface
	(
		1,
		4000000,		/* ? */
		new int[] { YM2203_VOL(15,15) },
		new ReadHandlerPtr[] { 0 },			/* Port A Read  */
		new ReadHandlerPtr[] { 0 },			/* Port B Read  */
		new WriteHandlerPtr[] { 0 },			/* Port A Write */
		new WriteHandlerPtr[] { 0 },			/* Port B Write */
		new WriteYmHandlerPtr[] { 0 }			/* IRQ handler  */
	);
	
	static YM3812interface fuuki16_ym3812_intf = new YM3812interface
	(
		1,
		4000000,		/* ? */
		new int[] { 15 },
	...
	static OKIM6295interface fuuki16_m6295_intf = new OKIM6295interface
	(
		1,
		new int[] { 8000 },		/* ? */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_gogomile = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "lh5370h8.11", 0x000000, 0x200000, 0x9961c925 );	ROM_LOAD( "lh5370ha.12", 0x200000, 0x200000, 0x5f2a87de );	ROM_LOAD( "lh5370h7.15", 0x400000, 0x200000, 0x34921680 );	ROM_LOAD( "lh5370h9.16", 0x600000, 0x200000, 0xe0118483 );
		...
		ROM_LOAD( "lh538n1d.25", 0x000000, 0x080000, 0x01622a95 );	ROM_CONTINUE(            0x000000, 0x080000             );// english half first
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_gogomilj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x28000, REGION_CPU2, 0 );	/* Z80 Code */
		ROM_LOAD( "fs1.24", 0x00000, 0x08000, 0x4e4bd371 );	ROM_CONTINUE(       0x10000, 0x18000             );
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );/* 16x16x4 Sprites */
		ROM_LOAD( "lh537k2r.20", 0x000000, 0x200000, 0x525dbf51 );
		ROM_REGION( 0x800000, REGION_GFX2, ROMREGION_DISPOSE );/* 16x16x8 Tiles */
		ROM_LOAD( "lh5370h8.11", 0x000000, 0x200000, 0x9961c925 );	ROM_LOAD( "lh5370ha.12", 0x200000, 0x200000, 0x5f2a87de );	ROM_LOAD( "lh5370h7.15", 0x400000, 0x200000, 0x34921680 );	ROM_LOAD( "lh5370h9.16", 0x600000, 0x200000, 0xe0118483 );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_pbancho = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x28000, REGION_CPU2, 0 );	/* Z80 Code */
		ROM_LOAD( "rom24.no4", 0x00000, 0x08000, 0xdfbfdb81 );	ROM_CONTINUE(          0x10000, 0x18000             );
		ROM_REGION( 0x200000, REGION_GFX1, ROMREGION_DISPOSE );/* 16x16x4 Sprites */
		ROM_LOAD( "rom20.58", 0x000000, 0x200000, 0x4dad0a2e );
		ROM_REGION( 0x400000, REGION_GFX2, ROMREGION_DISPOSE );/* 16x16x8 Tiles */
		ROM_LOAD( "rom11.61", 0x000000, 0x200000, 0x7f1213b9 );	ROM_LOAD( "rom15.59", 0x200000, 0x200000, 0xb83dcb70 );
		ROM_REGION( 0x200000, REGION_GFX3, ROMREGION_DISPOSE );/* 16x16x4 Tiles */
	...
	***************************************************************************/
	...
	public static GameDriver driver_gogomile	   = new GameDriver("1995"	,"gogomile"	,"fuuki16.java"	,rom_gogomile,null	,machine_driver_fuuki16	,input_ports_gogomile	,null	,ROT0_16BIT	,	"Fuuki", "Go Go! Mile Smile",                GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_SOUND )
	public static GameDriver driver_gogomilj	   = new GameDriver("1995"	,"gogomilj"	,"fuuki16.java"	,rom_gogomilj,driver_gogomile	,machine_driver_fuuki16	,input_ports_gogomilj	,null	,ROT0_16BIT	,	"Fuuki", "Susume! Mile Smile (Japan)",       GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_SOUND )
	public static GameDriver driver_pbancho	   = new GameDriver("1996"	,"pbancho"	,"fuuki16.java"	,rom_pbancho,null	,machine_driver_fuuki16	,input_ports_pbancho	,null	,ROT0_16BIT	,	"Fuuki", "Gyakuten!! Puzzle Bancho (Japan)", GAME_IMPERFECT_GRAPHICS )
}
