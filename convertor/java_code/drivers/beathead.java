...
public class beathead
{
	...
	PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER2 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 );
		PORT_START(); 
		PORT_BIT( 0x000f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_SPECIAL );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_SPECIAL );	PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT( 0xff80, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0006, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0xfff0, IP_ACTIVE_LOW, IPT_UNUSED );
	...
	static RomLoadPtr rom_beathead = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "bhsnd.bin",  0x10000, 0x4000, 0xdfd33f02 );	ROM_CONTINUE(           0x04000, 0xc000 );
		...
		ROM_LOAD( "bhpcm0.bin",  0x80000, 0x20000, 0x609ca626 );	ROM_LOAD( "bhpcm1.bin",  0xa0000, 0x20000, 0x35511509 );	ROM_LOAD( "bhpcm2.bin",  0xc0000, 0x20000, 0xf71a840a );	ROM_LOAD( "bhpcm3.bin",  0xe0000, 0x20000, 0xfedd4936 );ROM_END(); }}; 
	...
	*/
	...
	public static GameDriver driver_beathead	   = new GameDriver("1993"	,"beathead"	,"beathead.java"	,rom_beathead,null	,machine_driver_beathead	,input_ports_beathead	,init_beathead	,ROT0_16BIT	,	"Atari Games", "BeatHead (prototype)" )
}
