...
public class shanghai
{
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x00000, 0x03fff, MRA_RAM ),
		new Memory_ReadAddress( 0x80000, 0xfffff, MRA_ROM ),
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x00000, 0x03fff, MWA_RAM ),
		new Memory_WriteAddress( 0x80000, 0xfffff, MWA_ROM ),
		new Memory_WriteAddress(MEMPORT_MARKER, 0)
	};
	public static IO_ReadPort readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x01, HD63484_status_r ),
	...
	public static IO_WritePort writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x01, HD63484_address_w ),
	...
	public static IO_WritePort shangha2_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x30, 0x31, HD63484_address_w ),
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x0c, 0x08, "2 Players Move Time" );	PORT_DIPSETTING(    0x0c, "8" );	PORT_DIPSETTING(    0x08, "10" );	PORT_DIPSETTING(    0x04, "12" );	PORT_DIPSETTING(    0x00, "14" );	PORT_DIPNAME( 0x30, 0x20, "Bonus Time for Making Pair" );	PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_DIPSETTING(    0x00, "6" );	PORT_DIPNAME( 0xc0, 0x40, "Start Time" );	PORT_DIPSETTING(    0xc0, "30" );	PORT_DIPSETTING(    0x80, "60" );	PORT_DIPSETTING(    0x40, "90" );	PORT_DIPSETTING(    0x00, "120" );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x06, "Easy" );	PORT_DIPSETTING(    0x04, "Normal" );	PORT_DIPSETTING(    0x02, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x08, 0x00, "2 Players Move Time" );	PORT_DIPSETTING(    0x08, "8" );	PORT_DIPSETTING(    0x00, "10" );	PORT_DIPNAME( 0x30, 0x20, "Bonus Time for Making Pair" );	PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_DIPSETTING(    0x00, "6" );	PORT_DIPNAME( 0xc0, 0x40, "Start Time" );	PORT_DIPSETTING(    0xc0, "30" );	PORT_DIPSETTING(    0x80, "60" );	PORT_DIPSETTING(    0x40, "90" );	PORT_DIPSETTING(    0x00, "120" );
		PORT_START(); 	/* DSW1 */
		PORT_DIPNAME( 0x03, 0x03, "Mystery Tiles" );	PORT_DIPSETTING(    0x03, "0" );	PORT_DIPSETTING(    0x02, "4" );	PORT_DIPSETTING(    0x01, "6" );	PORT_DIPSETTING(    0x00, "8" );	PORT_DIPNAME( 0x1c, 0x1c, DEF_STR( "Coin_B") );
		PORT_DIPSETTING(    0x00, DEF_STR( "5C_1C") );
		PORT_DIPSETTING(    0x04, DEF_STR( "4C_1C") );
		PORT_DIPSETTING(    0x08, DEF_STR( "3C_1C") );
		PORT_DIPSETTING(    0x0c, DEF_STR( "2C_1C") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_shanghai = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "shg-22a.rom", 0xa0001, 0x10000, 0xe0a085be )
	...
	static RomLoadPtr rom_shangha2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1, 0 );	ROM_LOAD16_BYTE( "sht-27j", 0x80001, 0x20000, 0x969cbf00 )
	...
	public static GameDriver driver_shangha2	   = new GameDriver("1989"	,"shangha2"	,"shanghai.java"	,rom_shangha2,null	,machine_driver_shangha2	,input_ports_shangha2	,null	,ROT0_16BIT	,	"Sunsoft", "Shanghai II (Japan)" )
}
