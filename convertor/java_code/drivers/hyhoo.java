...
public class hyhoo
{
	...
	public static IO_ReadPort readport_hyhoo[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x0000, 0xffff, io_hyhoo_r ),
	...
	public static IO_WritePort writeport_hyhoo[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x0000, 0xffff, io_hyhoo_w ),
	...
	PORT_START(); 	/* (0) DIPSW-A */
		...
		PORT_DIPSETTING(    0x01, "3" );	PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x03, "1 (Hard); )
		PORT_DIPNAME( 0x0C, 0x00, "Quiz Count" );	PORT_DIPSETTING(    0x0C, "12" );	PORT_DIPSETTING(    0x08, "16" );	PORT_DIPSETTING(    0x04, "18" );	PORT_DIPSETTING(    0x00, "20" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Coinage") );
		...
		PORT_DIPNAME( 0x01, 0x01, "Bonus Game" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x01, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x02, "Sexy Quiz" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x02, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, "Picture Quiz" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x04, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, "Max Players" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x08, "4" );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x20, 0x20, "Commemoration Medal Payout" );	PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0xC0, 0xC0, "Medal Allotment Rate" );	PORT_DIPSETTING(    0xC0, "80%" );	PORT_DIPSETTING(    0x80, "85%" );	PORT_DIPSETTING(    0x40, "90%" );	PORT_DIPSETTING(    0x00, "95%" );
		PORT_START(); 	/* (2) PORT 0 */
		...
		PORT_BITX(0x01, IP_ACTIVE_LOW, 0, "P1-A", KEYCODE_Z, IP_JOY_NONE );	PORT_BITX(0x02, IP_ACTIVE_LOW, 0, "P1-B", KEYCODE_X, IP_JOY_NONE );	PORT_BITX(0x04, IP_ACTIVE_LOW, 0, "P1-C", KEYCODE_C, IP_JOY_NONE );	PORT_BITX(0x08, IP_ACTIVE_LOW, 0, "P2-A", KEYCODE_V, IP_JOY_NONE );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P2-B", KEYCODE_B, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P2-C", KEYCODE_N, IP_JOY_NONE );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
		...
		PORT_BITX(0x01, IP_ACTIVE_LOW, 0, "P3-A", KEYCODE_A, IP_JOY_NONE );	PORT_BITX(0x02, IP_ACTIVE_LOW, 0, "P3-B", KEYCODE_S, IP_JOY_NONE );	PORT_BITX(0x04, IP_ACTIVE_LOW, 0, "P3-C", KEYCODE_D, IP_JOY_NONE );	PORT_BITX(0x08, IP_ACTIVE_LOW, 0, "P4-A", KEYCODE_F, IP_JOY_NONE );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P4-B", KEYCODE_G, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P4-C", KEYCODE_H, IP_JOY_NONE );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* (0) DIPSW-A */
		...
		PORT_DIPSETTING(    0x00, "4 (Easy); )
		PORT_DIPSETTING(    0x01, "3" );	PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x03, "1 (Hard); )
		PORT_DIPNAME( 0x0C, 0x0C, "Quiz Count" );	PORT_DIPSETTING(    0x0C, "8" );	PORT_DIPSETTING(    0x08, "10" );	PORT_DIPSETTING(    0x04, "12" );	PORT_DIPSETTING(    0x00, "14" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Coinage") );
		PORT_DIPSETTING(    0x30, DEF_STR( "1C_1C") );
		PORT_DIPSETTING(    0x20, DEF_STR( "1C_2C") );
		PORT_DIPSETTING(    0x10, DEF_STR( "1C_4C") );
		PORT_DIPSETTING(    0x00, DEF_STR( "1C_5C") );
		PORT_DIPNAME( 0x40, 0x00, "Game Sounds" );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, "Sexy Quiz" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
	...
	static RomLoadPtr rom_hyhoo = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "hy1506-1.1i", 0x000000, 0x80000, 0x42c9fa34 );	ROM_LOAD( "hy1506-1.2i", 0x080000, 0x80000, 0x4c14972f );	ROM_LOAD( "hy1506-1.3i", 0x100000, 0x80000, 0x4a18c783 );	ROM_LOAD( "hy1506-1.4i", 0x180000, 0x80000, 0xdf26de46 );	ROM_LOAD( "hyhoo.3",     0x280000, 0x10000, 0xb641c5a6 );ROM_END(); }}; 
	
	static RomLoadPtr rom_hyhoo2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );/* program */
		ROM_LOAD( "hyhoo2.2",  0x00000, 0x08000, 0xd8733cdc );	ROM_LOAD( "hyhoo2.1",  0x08000, 0x08000, 0x4a1d9493 );
		ROM_REGION( 0x10000, REGION_SOUND1, 0 );/* voice */
		ROM_LOAD( "hyhoo2.3",  0x00000, 0x10000, 0xd7e82b23 );
		ROM_REGION( 0x380000, REGION_GFX1, 0 );/* gfx */
		ROM_LOAD( "hy1506-1.1i", 0x000000, 0x80000, 0x42c9fa34 );	ROM_LOAD( "hy1506-1.2i", 0x080000, 0x80000, 0x4c14972f );	ROM_LOAD( "hy1506-1.3i", 0x100000, 0x80000, 0x4a18c783 );	ROM_LOAD( "hy1506-1.4i", 0x180000, 0x80000, 0xdf26de46 );	ROM_LOAD( "hyhoo2.s01",  0x200000, 0x10000, 0x20f93ff0 );	ROM_LOAD( "hyhoo2.s02",  0x210000, 0x10000, 0x82a2b590 );	ROM_LOAD( "hyhoo2.s03",  0x220000, 0x10000, 0xa921b5ba );	ROM_LOAD( "hyhoo2.s04",  0x230000, 0x10000, 0xea389c82 );	ROM_LOAD( "hyhoo2.s05",  0x240000, 0x10000, 0x89ca44fa );	ROM_LOAD( "hyhoo2.s06",  0x250000, 0x10000, 0xf9bebf40 );	ROM_LOAD( "hyhoo2.s07",  0x260000, 0x10000, 0x3a219376 );	ROM_LOAD( "hyhoo2.s08",  0x270000, 0x10000, 0xac008d3f );	ROM_LOAD( "hyhoo2.s09",  0x280000, 0x10000, 0x5b364a79 );	ROM_LOAD( "hyhoo2.s10",  0x290000, 0x10000, 0x944b01bb );	ROM_LOAD( "hyhoo2.s11",  0x2a0000, 0x10000, 0x5f4e455b );	ROM_LOAD( "hyhoo2.s12",  0x2b0000, 0x10000, 0x92a07b8a );ROM_END(); }}; 
	
	
	//     YEAR,     NAME,   PARENT,  MACHINE,    INPUT,     INIT,      MONITOR, COMPANY, FULLNAME, FLAGS
	public static GameDriver driver_hyhoo	   = new GameDriver("1987"	,"hyhoo"	,"hyhoo.java"	,rom_hyhoo,null	,machine_driver_hyhoo	,input_ports_hyhoo	,init_hyhoo	,ROT90_16BIT	,	"Nichibutsu", "Taisen Quiz HYHOO (Japan)", 0 )
	public static GameDriver driver_hyhoo2	   = new GameDriver("1987"	,"hyhoo2"	,"hyhoo.java"	,rom_hyhoo2,null	,machine_driver_hyhoo2	,input_ports_hyhoo2	,init_hyhoo2	,ROT90_16BIT	,	"Nichibutsu", "Taisen Quiz HYHOO 2 (Japan)", 0 )
}
