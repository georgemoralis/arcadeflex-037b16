...
public class sailorws
{
	...
	static UBytePtr sailorws_palette, *mscoutm_palette;
	static UBytePtr sailorws_paltbl0, *sailorws_paltbl1;
	...
	******************************************************************************/
	public static VhUpdatePtr sailorws_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int x, y;
	...
	public static VhUpdatePtr mscoutm_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int x, y;
		unsigned short color;
