...
public class cave
{
	...
	*/
	...
	/* 3 Layers */
	public static VhStartPtr hotdogst_vh_start = new VhStartPtr() { public int handler() 
	{
		tilemap_0 = tilemap_create(	get_tile_info_0,
									tilemap_scan_rows,
									TILEMAP_TRANSPARENT,
	...
	/* 2 Layers */
	public static VhStartPtr mazinger_vh_start = new VhStartPtr() { public int handler() 
	{
		tilemap_0 = tilemap_create(	get_tile_info_0,
									tilemap_scan_rows,
									TILEMAP_TRANSPARENT,
	...
	*/
	...
	static void do_blit_zoom16_cave( const struct sprite_cave *sprite ){
		...
		{
			const UBytePtr pen_data = sprite.pen_data -1 -sprite.line_offset;
	...
	static void do_blit_zoom16_cave_zb( const struct sprite_cave *sprite ){
	...
	
		{
			...
			UINT16 *zbf = (UINT16 *)((UBytePtr )sprite_zbuf + (blit.clip_right-blit.clip_left)*y1*2);
	...
	***************************************************************************/
	...
	public static VhUpdatePtr donpachi_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int delta = 0;
	...
	public static VhUpdatePtr ddonpach_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		{		/* scroll hack */
	...
	public static VhUpdatePtr esprade_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		{		/* scroll hack */
	...
	public static VhUpdatePtr guwange_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int delta;
	...
	public static VhUpdatePtr dfeveron_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int delta = 0;
	...
	public static VhUpdatePtr uopoko_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int delta = 0;
	...
	public static VhUpdatePtr hotdogst_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		scrollx_0=cave_vctrl_0[0];
		scrolly_0=cave_vctrl_0[1];
							...
							if( prev_tile_type == TILE_MASKED ){
								...
								for(;;){
									...
									if (cnt2 != 0){
										...
										for(j=cnt2;j>0;j--){
											UINT8 data = *mask1++;
											if ((data & 0x80) != 0) dest1[0] = source1[0];
											if ((data & 0x40) != 0) dest1[1] = source1[1];
											if ((data & 0x20) != 0) dest1[2] = source1[2];
											if ((data & 0x10) != 0) dest1[3] = source1[3];
											if ((data & 0x08) != 0) dest1[4] = source1[4];
											if ((data & 0x04) != 0) dest1[5] = source1[5];
											if ((data & 0x02) != 0) dest1[6] = source1[6];
											if ((data & 0x01) != 0) dest1[7] = source1[7];
											source1+=8;
											dest1+=8;
										}
										xp+=cnt2*8;
