...
public class metro
{
	...
	public static GetTileInfoPtr metro_K053936_get_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
	...
	***************************************************************************/
	...
	public static GetTileInfoPtr get_tile_info_0 = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info(tile_index,0,metro_vram_0); } };
	public static GetTileInfoPtr get_tile_info_1 = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info(tile_index,1,metro_vram_1); } };
	public static GetTileInfoPtr get_tile_info_2 = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info(tile_index,2,metro_vram_2); } };
	
	public static GetTileInfoPtr get_tile_info_0_8bit = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info_8bit(tile_index,0,metro_vram_0); } };
	public static GetTileInfoPtr get_tile_info_1_8bit = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info_8bit(tile_index,1,metro_vram_1); } };
	public static GetTileInfoPtr get_tile_info_2_8bit = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info_8bit(tile_index,2,metro_vram_2); } };
	
	public static GetTileInfoPtr get_tile_info_0_16x16_8bit = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info_16x16_8bit(tile_index,0,metro_vram_0); } };
	public static GetTileInfoPtr get_tile_info_1_16x16_8bit = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info_16x16_8bit(tile_index,1,metro_vram_1); } };
	public static GetTileInfoPtr get_tile_info_2_16x16_8bit = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info_16x16_8bit(tile_index,2,metro_vram_2); } };
	...
	***************************************************************************/
	...
	void metro_draw_sprites(struct osd_bitmap *bitmap, int pri)
	{
		...
		UBytePtr base_gfx	=	memory_region(region);
		UBytePtr gfx_max	=	base_gfx + memory_region_length(region);
	...
	***************************************************************************/
	...
	public static VhUpdatePtr metro_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	...
	{	int msk = 0;
		...
		if (has_zoom != 0) K053936_zoom_draw(bitmap);
		...
		if ((layers_ctrl & 1) != 0)	drawlayer(bitmap,(metro_videoregs[0x10/2] & 0x30)>>4);
		if ((layers_ctrl & 8) && (sprite_pri == 2))	for (i = 0; i < 0x20; i++)	metro_draw_sprites(bitmap, i);
		if ((layers_ctrl & 2) != 0)	drawlayer(bitmap,(metro_videoregs[0x10/2] & 0x0c)>>2);
		if ((layers_ctrl & 8) && (sprite_pri == 1))	for (i = 0; i < 0x20; i++)	metro_draw_sprites(bitmap, i);
		if ((layers_ctrl & 4) != 0)	drawlayer(bitmap,(metro_videoregs[0x10/2] & 0x03));
