...
public class snk
{
	...
	void tnk3_draw_sprites( struct osd_bitmap *bitmap, int xscroll, int yscroll )
	{
		...
		const UBytePtr finish = source+50*4;
	...
	public static VhUpdatePtr sgladiat_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
