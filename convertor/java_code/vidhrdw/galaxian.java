...
public class galaxian
{
	...
	UBytePtr galaxian_videoram;
	UBytePtr galaxian_spriteram;
	...
	static void *stars_blink_timer;
	       void galaxian_init_stars(UBytePtr *palette);
	...
	***************************************************************************/
	...
	void galaxian_init_stars(UBytePtr *palette)
	{
		...
		galaxian_stars_on = 0;
		stars_blink_state = 0;
		if (stars_blink_timer != 0)  timer_remove(stars_blink_timer);
	...
	public static timer_callback stars_blink_callback = new timer_callback() { public void handler(int param) 
	{
		stars_blink_state++;
	} };
