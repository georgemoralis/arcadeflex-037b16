...
public class cninja
{
	...
	public static VhUpdatePtr edrandy_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int pf23_control;
	...
	public static VhUpdatePtr robocop2_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
