...
public class namcona1
{
	...
	public static GetTileInfoPtr tilemap_get_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		data16_t *source;
	...
	public static VhUpdatePtr namcona1_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int bg_to_show = -1;
		int which;
		int priority;
