...
public class rastan
{
	...
	public static VhEofCallbackPtr opwolf_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
	...
	public static VhUpdatePtr opwolf_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int layer[2];
