...
public class vsnes
{
	...
	***************************************************************************/
	public static VhUpdatePtr vsnes_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		/* render the ppu */
	...
	public static VhUpdatePtr vsdual_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		/* render the ppu's */
		ppu2c03b_render( 0, bitmap, 0, 0, 0, 0 );
