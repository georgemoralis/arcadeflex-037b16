...
public class taito_b
{
	...
	*/
	...
	public static VhUpdatePtr taitob_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		/* Update tilemaps */
	...
	public static VhUpdatePtr ashura_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		/* Update tilemaps */
		TC0180VCU_set_scroll();
		TC0180VCU_tilemap_update();
	...
	public static VhUpdatePtr crimec_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		/* Update tilemaps */
		TC0180VCU_set_scroll();
		TC0180VCU_tilemap_update();
	...
	public static VhUpdatePtr masterw_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		/* Update tilemaps */
		TC0180VCU_set_scroll();
		TC0180VCU_tilemap_update();
