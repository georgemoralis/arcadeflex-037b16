	...
	***************************************************************************/
	...
	static void mark_sprite_colors(void)
	{
		...
		for (offs = 0x03f8 / 2 ; offs >= 0 ; offs -= 0x008 / 2)
		{
			...
			if (tile_offs != 0)	/* Null offset => no sprite */
			{
	...
	public static VhUpdatePtr syvalion_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	...
	public static VhUpdatePtr recordbr_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		TC0080VCO_tilemap_update();
	...
	public static VhUpdatePtr dleague_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		TC0080VCO_tilemap_update();
