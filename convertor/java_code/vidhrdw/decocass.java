...
public class decocass
{
	...
	UBytePtr decocass_charram;
	UBytePtr decocass_fgvideoram;
	UBytePtr decocass_colorram;
	UBytePtr decocass_bgvideoram; /* shares bits D0-3 with tileram! */
	UBytePtr decocass_tileram;
	UBytePtr decocass_objectram;
	...
	public static GetTileInfoPtr get_bg_l_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
	...
	public static GetTileInfoPtr get_bg_r_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int color = (color_center_bot >> 7) & 1;
		SET_TILE_INFO(
				2,
