...
public class slapshot
{
	...
	************************************************************/
	...
	public static VhEofCallbackPtr taito_no_buffer_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
	...
	********************************************************************/
	...
	public static VhUpdatePtr slapshot_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		UINT8 layer[5];
		UINT8 tilepri[5];
		UINT8 spritepri[4];
