...
public class esd16
{
	...
	***************************************************************************/
	...
	public static VhUpdatePtr esd16_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int layers_ctrl = -1;
	...
	{	int msk = 0;
		...
		if ((layers_ctrl & 4) != 0)	esd16_draw_sprites(bitmap);
	} };
}
