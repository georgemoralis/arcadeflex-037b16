...
public class taito_z
{
	...
	*********************************************************/
	...
	static void chasehq_update_palette (void)
	{
		...
		for (offs = 0;offs < spriteram_size/2;offs += 4)
		{
			...
			if (tilenum != 0)
			{
				if ((zoomx & 0x40) != 0)	// 128x128 sprites, $0-$3ffff in spritemap rom, OBJA
				{
				...
				else if ((zoomx & 0x20) != 0)	// 64x128 sprites, $40000-$5ffff in spritemap rom, OBJB
				{
		...
		for (offs = 0;offs < spriteram_size/2;offs += 4)
		{
			...
			else if (((zoomx-1) & 0x60)==0)	// 32x128 sprites, $60000-$7ffff in spritemap rom, OBJB
			{
				...
				for (sprite_chunk=0;sprite_chunk<16;sprite_chunk++)
				{
					...
					px = k;
					py = j;
					if (flipx != 0)  px = 1-k;	/* pick tiles back to front for x and y flips */
					if (flipy != 0)  py = 7-j;
	...
	**************************************************************/
	...
	public static VhUpdatePtr contcirc_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		UINT8 layer[3];
	...
	public static VhUpdatePtr chasehq_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		UINT8 layer[3];
	...
	public static VhUpdatePtr bshark_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		UINT8 layer[3];
	...
	public static VhUpdatePtr sci_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		UINT8 layer[3];
	...
	public static VhUpdatePtr aquajack_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		UINT8 layer[3];
	...
	public static VhUpdatePtr spacegun_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		UINT8 layer[3];
	...
	public static VhUpdatePtr dblaxle_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		UINT8 layer[5];
		UINT16 priority;
