...
public class namcos2
{
	...
	***************************************************************************/
	...
	public static GetTileInfoPtr get_tile_info0 = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info(tile_index,videoram16+0x0000,0); } };
	public static GetTileInfoPtr get_tile_info1 = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info(tile_index,videoram16+0x1000,2); } };
	public static GetTileInfoPtr get_tile_info2 = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info(tile_index,videoram16+0x2000,4); } };
	public static GetTileInfoPtr get_tile_info3 = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info(tile_index,videoram16+0x3000,6); } };
	public static GetTileInfoPtr get_tile_info4 = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info(tile_index,videoram16+0x4008,8); } };
	public static GetTileInfoPtr get_tile_info5 = new GetTileInfoPtr() { public void handler(int tile_index)  { get_tile_info(tile_index,videoram16+0x4408,10); } };
	
	public static GetTileInfoPtr get_tile_info_roz = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int tile;
