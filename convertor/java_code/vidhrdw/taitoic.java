...
public class taitoic
{
	...
	public static GetTileInfoPtr PC080SN_get_bg_tile_info_0 = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		common_get_PC080SN_bg_tile_info(PC080SN_bg_ram[0],PC080SN_bg_gfx[0],tile_index);
	} };
	
	public static GetTileInfoPtr PC080SN_get_fg_tile_info_0 = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		common_get_PC080SN_fg_tile_info(PC080SN_fg_ram[0],PC080SN_bg_gfx[0],tile_index);
	} };
	
	public static GetTileInfoPtr PC080SN_get_bg_tile_info_1 = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		common_get_PC080SN_bg_tile_info(PC080SN_bg_ram[1],PC080SN_bg_gfx[1],tile_index);
	} };
	
	public static GetTileInfoPtr PC080SN_get_fg_tile_info_1 = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
	...
	public static GetTileInfoPtr TC0080VCO_get_bg0_tile_info_0 = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int color, tile;
	...
	public static GetTileInfoPtr TC0080VCO_get_bg1_tile_info_0 = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int color, tile;
	...
	public static GetTileInfoPtr TC0080VCO_get_tx_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int tile;
	...
	public static GetTileInfoPtr TC0100SCN_get_bg_tile_info_2 = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		common_get_bg0_tile_info(TC0100SCN_bg_ram[2],TC0100SCN_bg_gfx[2],tile_index,
				TC0100SCN_chip_colbank[2],TC0100SCN_dblwidth[2]);
	} };
	
	public static GetTileInfoPtr TC0100SCN_get_fg_tile_info_2 = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		common_get_bg1_tile_info(TC0100SCN_fg_ram[2],TC0100SCN_bg_gfx[2],tile_index,
				TC0100SCN_chip_colbank[2],TC0100SCN_dblwidth[2]);
	} };
	
	public static GetTileInfoPtr TC0100SCN_get_tx_tile_info_2 = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
