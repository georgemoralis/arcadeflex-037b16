...
public class twincobr
{
	...
	public static VhUpdatePtr toaplan0_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	...
	public static VhEofCallbackPtr toaplan0_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
