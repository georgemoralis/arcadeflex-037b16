...
public class toaplan2
{
	...
	***************************************************************************/
	...
	public static GetTileInfoPtr batrider_get_top0_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
	...
	public static GetTileInfoPtr batrider_get_fg0_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int color, tile_number, attrib, tile;
	...
	public static GetTileInfoPtr batrider_get_bg0_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int color, tile_number, attrib, tile;
	...
	***************************************************************************/
	...
	public static VhUpdatePtr dogyuun_1_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int priority;
	...
	public static VhUpdatePtr truxton2_0_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		toaplan2_0_vh_screenrefresh(bitmap, full_refresh);
		tilemap_draw(bitmap,tx_tilemap,0,0);
	} };
	
	public static VhUpdatePtr batrider_0_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int priority;
	...
	public static VhEofCallbackPtr batrider_0_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
		/** Shift sprite RAM buffers  ***  Used to fix sprite lag **/
		memcpy(spriteram16_now[0],spriteram16_next[0],TOAPLAN2_SPRITERAM_SIZE);
		memcpy(spriteram16_next[0],spriteram16_new[0],TOAPLAN2_SPRITERAM_SIZE);
