...
public class wgp
{
	...
	public static GetTileInfoPtr get_piv0_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		common_get_piv_tile_info(0,tile_index);
	} };
	
	public static GetTileInfoPtr get_piv1_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		common_get_piv_tile_info(1,tile_index);
	} };
	
	public static GetTileInfoPtr get_piv2_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
	...
	**************************************************************/
	...
	public static VhUpdatePtr wgp_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int a,b,i,j;
		UINT8 layer[3];
