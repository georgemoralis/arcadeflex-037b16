...
public class argus
{
	...
	***************************************************************************/
	...
	public static GetTileInfoPtr argus_get_tx_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int hi, lo;
	...
	public static GetTileInfoPtr argus_get_bg0_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int hi, lo;
	...
	public static GetTileInfoPtr argus_get_bg1_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int hi, lo;
	...
	public static GetTileInfoPtr valtric_get_tx_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int hi, lo;
	...
	public static GetTileInfoPtr valtric_get_bg_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
	...
	public static GetTileInfoPtr butasan_get_tx_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int hi, lo;
	...
	public static GetTileInfoPtr butasan_get_bg0_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int hi, lo;
		int attrib;
	...
	public static GetTileInfoPtr butasan_get_bg1_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
	...
	***************************************************************************/
	...
	public static VhUpdatePtr argus_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	...
	public static VhUpdatePtr valtric_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		tilemap_update(ALL_TILEMAPS);
	...
	public static VhUpdatePtr butasan_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		tilemap_update(ALL_TILEMAPS);
