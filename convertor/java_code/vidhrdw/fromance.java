...
public class fromance
{
	...
	static UBytePtr fromance_videoram[2];
	static UBytePtr fromance_dirty[2];
	static UBytePtr fromance_paletteram;
	...
	******************************************************************************/
	...
	{
		if (fromance_paletteram != 0) free(fromance_paletteram);
	...
	******************************************************************************/
	...
	public static VhUpdatePtr fromance_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
