...
public class cps1
{
	...
	***************************************************************************/
	...
	/*****************************************************/
	static void do_blit_16_cps2_zb(const UBytePtr pen_data,const UINT32 *pal_data,int flipx,int flipy,int sx,int sy, int pri_sp)
	{
	...
	static void do_blit_8_cps2_zb(const UBytePtr pen_data,const UINT32 *pal_data,int flipx,int flipy,int sx,int sy, int pri_sp)
	{
		int x1,x2, y1,y2, dx,dy;
		int xcount0 = 0, ycount0 = 0;
	...
	static void do_blit_zb(const UBytePtr pen_data,int flipx,int flipy,int sx,int sy, int pri_sp)
	{
		int x1,x2, y1,y2, dx,dy;
		int xcount0 = 0, ycount0 = 0;
	...
	***************************************************************************/
	...
	static data16_t *cps2_objbase(void)
	{
		...
		if ((cps2_objram_bank_lagged & 1) != 0) baseptr ^= 0x0080;
	...
	***************************************************************************/
	...
	profiler_mark(PROFILER_USER1);
			...
			if ((sprite_zbuf_baseval & 0xffff0000) != 0)
			{
