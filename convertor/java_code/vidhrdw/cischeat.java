...
public class cischeat
{
	...
	**************************************************************************/
	...
	public static VhUpdatePtr scudhamm_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int megasys1_active_layers1, flag;
	...
	//	else fillbitmap(bitmap,palette_transparent_pen,&Machine.visible_area);
	//	cischeat_tmap_DRAW(1)
		if ((megasys1_active_layers & 0x08) != 0)	cischeat_draw_sprites(bitmap,0,15);
		cischeat_tmap_DRAW(2)
