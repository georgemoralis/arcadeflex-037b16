...
public class niyanpai
{
	...
	static UBytePtr niyanpai_paltbl0, *niyanpai_paltbl1, *niyanpai_paltbl2;
	...
	******************************************************************************/
	public static VhUpdatePtr niyanpai_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int x, y;
