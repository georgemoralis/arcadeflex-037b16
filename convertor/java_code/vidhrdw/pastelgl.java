...
public class pastelgl
{
	...
	static UBytePtr pastelgl_videoram;
	static UBytePtr pastelgl_paltbl;
	...
	******************************************************************************/
	public static VhUpdatePtr pastelgl_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int x, y;
		unsigned char color;
