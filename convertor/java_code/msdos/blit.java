...
public class blit
{
	...
	INLINE void copyline_1x_32bpp(UBytePtr src,short seg,unsigned long address,int width2)
	{
		int i;
		UINT32 *s=(UINT32 *)src;
	...
	INLINE void copyline_2x_32bpp(UBytePtr src,short seg,unsigned long address,int width2)
	{
		int i;
		UINT32 *s=(UINT32 *)src;
	...
	INLINE void copyline_3x_32bpp(UBytePtr src,short seg,unsigned long address,int width2)
	{
		int i;
		UINT32 *s=(UINT32 *)src;
	...
	INLINE void copyline_4x_32bpp(UBytePtr src,short seg,unsigned long address,int width2)
	{
		int i;
		UINT32 *s=(UINT32 *)src;
